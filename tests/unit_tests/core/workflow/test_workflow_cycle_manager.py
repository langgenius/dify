...
def mock_app_generate_entity():
    ...
    entity.app_config.tenant_id = "test-tenant-id"
    entity.app_config.app_id = "test-app-id"
    return entity
...
def test_init(workflow_cycle_manager, mock_app_generate_entity, mock_workflow_system_variables, mock_node_execution_repository):
...
def test_handle_node_execution_start(workflow_cycle_manager, mock_workflow_run):
    ...
    event.node_data.title = "Test Node"
