...
<p align="center">
  ...
  <a href="https://docs.dify.ai/documentation/pages/getting-started/introduction/getting-started/introduction/self-hosting/quick-start/docker-compose">Tự triển khai</a> ·
  <a href="https://docs.dify.ai/documentation/pages/getting-started/introduction/getting-started/introduction">Tài liệu</a> ·
...
- **Tự triển khai Dify Community Edition</br>**
  ...
  Sử dụng [tài liệu](https://docs.dify.ai/documentation/pages/getting-started/introduction/getting-started/introduction) của chúng tôi để tham khảo thêm và nhận hướng dẫn chi tiết hơn.
...
> Nếu bạn muốn đóng góp cho Dify hoặc phát triển thêm, hãy tham khảo [hướng dẫn triển khai từ mã nguồn](https://docs.dify.ai/documentation/pages/getting-started/introduction/getting-started/introduction/self-hosting/advanced-deployments/local-source-code) của chúng tôi
