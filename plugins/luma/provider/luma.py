...
from tools.acedata_client import AceDataLumaClient, AceDataLumaError, _normalize_token


class LumaProvider(ToolProvider):
    def _validate_credentials(self, credentials: dict[str, Any]) -> None:
        ...
        client = AceDataLumaClient(bearer_token=token)
        try:
            ...
            if isinstance(e, AceDataLumaError):
