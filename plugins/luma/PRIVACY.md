...
This document describes how the luma plugin handles your data.

### Scope

This privacy statement applies only to the luma plugin and to data
processed through its features. It does not cover any other plugins, tools,
or services you may use alongside it.

### Data We Collect

Depending on how you use the plugin, luma may process the following
categories of data:
...
luma plugin through the official project repository or distribution
