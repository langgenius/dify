...
class AceDataVeoClient:
    def __init__(self, bearer_token: str, base_url: str = "https://api.acedata.cloud") -> None:
        ...
        if not token:
            raise AceDataVeoError(code="token_empty", message="Empty bearer token.")
    ...
    def retrieve_task(self, *, task_id: str, timeout_s: int = 60) -> dict[str, Any]:
        ...
        return self._post(path="/veo/tasks", payload=payload, timeout_s=timeout_s)
    ...
    def _post(self, *, path: str, payload: dict[str, Any], timeout_s: int) -> dict[str, Any]:
        ...
        try:
            ...
            raise AceDataVeoError(code="request_failed", message=str(e)) from e
