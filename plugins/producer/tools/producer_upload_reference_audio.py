...
from tools.acedata_client import AceDataProducerClient, AceDataProducerError


class ProducerUploadReferenceAudioTool(Tool):
    def _invoke(self, tool_parameters: dict[str, Any]) -> Generator[ToolInvokeMessage, None, None]:
        ...
        try:
            result = client.upload(audio_url=audio_url, timeout_s=1800)
