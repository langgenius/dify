...
describe("retrieval candidates", () => {
  it("maps database rows to retrieval candidates with citation and metadata", () => {
    const row: DatabaseRow = {
      ...
      document_title: "Renewal policy.pdf",
      document_metadata: { owner: "team-a" },
      document_type: "pdf",
      document_version: 3,
      end_offset: 120,
      knowledge_space_name: "Legal knowledge",
      logical_document_id: "018f0d60-7a49-7cc2-9c1b-5b36f18f2c47",
      logical_document_revision: 4,
    ...
    expect(mapRetrievalCandidateRow(row, "fts")).toMatchObject({
      citation: {
        ...
        documentTitle: "Renewal policy.pdf",
        documentVersion: 3,
        endOffset: 120,
        knowledgeSpaceName: "Legal knowledge",
        logicalDocumentId: "018f0d60-7a49-7cc2-9c1b-5b36f18f2c47",
