...
export const KNOWLEDGE_FS_ERROR_CATALOG = {
  ...
  DOCUMENT_COMPILATION_LEASE_LOST: descriptor(
    "conflict",
    "Document processing lost its execution lease and will be picked up again.",
    "automatic",
    409,
    "retry",
  ),
  ...
  DOCUMENT_PARSER_UNSUPPORTED_TYPE: descriptor(
    "validation",
    "The document format is not supported by the configured parser.",
    "never",
    422,
    "reupload",
  ),
  DOCUMENT_PDF_RENDER_FAILED: descriptor(
    "dependency",
    "Pages of the PDF could not be rendered for image extraction.",
    "manual",
    502,
    "retry",
  ),
  ...
  MODEL_RUNTIME_RESPONSE_INVALID: descriptor(
    "dependency",
    "The selected model returned a response that could not be used.",
    "manual",
    502,
    "retry",
  ),
  ...
  SOURCE_CONNECTION_UNAVAILABLE: descriptor(
    "configuration",
    "The data source connection is missing or no longer usable.",
    "after_configuration",
    422,
    "configure_source",
  ),
  SOURCE_CRAWL_PAGE_NOT_FOUND: descriptor(
    "not_found",
    "A selected crawl page is no longer available at the data source.",
    "never",
    404,
    "configure_source",
  ),
  SOURCE_CRAWL_PROVIDER_UNAVAILABLE: descriptor(
    "dependency",
    "The website crawl provider did not respond.",
    "manual",
    503,
    "retry",
  ),
  SOURCE_CRAWL_RESULT_LIMIT_EXCEEDED: descriptor(
    "validation",
    "The website crawl returned more pages than the configured limit allows.",
    "never",
    422,
    "configure_source",
  ),
  ...
  SOURCE_IMPORT_PARTIAL_FAILURE: descriptor(
    "dependency",
    "Some documents from the data source could not be imported.",
    "manual",
    503,
    "retry",
  ),
  ...
  SOURCE_ONLINE_DOCUMENT_UNAVAILABLE: descriptor(
    "dependency",
    "The online-document provider is not available for this data source.",
    "manual",
    503,
    "configure_source",
  ),
  ...
  SOURCE_ONLINE_DRIVE_UNAVAILABLE: descriptor(
    "dependency",
    "The online-drive provider is not available for this data source.",
    "manual",
    503,
    "configure_source",
  ),
  ...
  SOURCE_PROVIDER_REJECTED: descriptor(
    "dependency",
    "The data source provider rejected the request or returned an unusable response.",
    "manual",
    502,
    "configure_source",
  ),
  SOURCE_PROVIDER_TIMEOUT: descriptor(
    "timeout",
    "The data source provider did not respond in time.",
    "manual",
    503,
    "retry",
  ),
  SOURCE_PROVIDER_UNAVAILABLE: descriptor(
    "dependency",
    "The data source provider could not be reached.",
    "manual",
    503,
    "retry",
  ),
  ...
  SOURCE_WORKFLOW_CONTENT_MISSING: descriptor(
    "dependency",
    "The data source returned a document without content.",
    "manual",
    503,
    "retry",
  ),
  SOURCE_WORKFLOW_CONTENT_TOO_LARGE: descriptor(
    "validation",
    "A document from the data source exceeds the maximum supported size.",
    "never",
    413,
    "configure_source",
  ),
  SOURCE_WORKFLOW_EXTERNAL_TIMEOUT: descriptor(
    "timeout",
    "The data source operation timed out while waiting for the provider.",
    "manual",
    503,
    "retry",
  ),
...
function normalizeKnowledgeFsErrorCode(code: string): string {
  ...
  const aliases: Readonly<Record<string, string>> = {
    ...
    DIFY_DATASOURCE_RUNTIME_REQUEST_FAILED: "SOURCE_PROVIDER_UNAVAILABLE",
    DIFY_DATASOURCE_RUNTIME_RESPONSE_INVALID: "SOURCE_PROVIDER_REJECTED",
    DIFY_DATASOURCE_RUNTIME_RESPONSE_TOO_LARGE: "SOURCE_PROVIDER_REJECTED",
    DIFY_DATASOURCE_RUNTIME_TIMEOUT: "SOURCE_PROVIDER_TIMEOUT",
    ...
    DIFY_MODEL_RUNTIME_RESPONSE_INVALID: "MODEL_RUNTIME_RESPONSE_INVALID",
    DIFY_MODEL_RUNTIME_RESPONSE_TOO_LARGE: "MODEL_RUNTIME_RESPONSE_INVALID",
    DIFY_MODEL_RUNTIME_TIMEOUT: "MODEL_RUNTIME_TIMEOUT",
    DIFY_OBJECT_STORAGE_REQUEST_FAILED: "DOCUMENT_COMPILATION_RETRYABLE",
    EMBEDDING_PROVIDER_INPUT: "MODEL_RUNTIME_FAILED",
    EMBEDDING_PROVIDER_RESPONSE_INVALID: "MODEL_RUNTIME_RESPONSE_INVALID",
