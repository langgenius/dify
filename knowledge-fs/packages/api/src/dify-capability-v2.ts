...
const READ_ACTIONS: ReadonlySet<string> = new Set([
  ...
  "golden-questions.read",
  "knowledge_spaces.list",
  "knowledge_spaces.metadata.read",
...
export const DIFY_CAPABILITY_V2_OPERATIONS: readonly DifyCapabilityV2Operation[] = [
  ...
  },
  {
    ...
    pathTemplate: "/knowledge-spaces/{id}/fs/ls",
    resource: { pathParameter: "id" },
    resourceType: "knowledge_space",
  },
  {
    ...
    pathTemplate: "/knowledge-spaces/{id}/fs/tree",
    resource: { pathParameter: "id" },
    resourceType: "knowledge_space",
  },
  {
    ...
    pathTemplate: "/knowledge-spaces/{id}/fs/grep",
    resource: { pathParameter: "id" },
    resourceType: "knowledge_space",
  },
  {
    ...
    pathTemplate: "/knowledge-spaces/{id}/fs/find",
    resource: { pathParameter: "id" },
    resourceType: "knowledge_space",
  },
  {
    ...
    pathTemplate: "/knowledge-spaces/{id}/fs/diff",
    resource: { pathParameter: "id" },
    resourceType: "knowledge_space",
  },
  {
    ...
    pathTemplate: "/knowledge-spaces/{id}/fs/cat",
    resource: { pathParameter: "id" },
    resourceType: "knowledge_space",
  },
  {
    ...
    pathTemplate: "/knowledge-spaces/{id}/fs/stat",
    resource: { pathParameter: "id" },
    resourceType: "knowledge_space",
  },
  {
    ...
    pathTemplate: "/knowledge-spaces/{id}/fs/open_node",
    resource: { pathParameter: "id" },
    resourceType: "knowledge_space",
  },
  {
    ...
    pathTemplate: "/knowledge-spaces/{id}/documents/{documentId}/multimodal/{itemId}/asset",
  ...
  },
  {
    ...
    pathTemplate: "/knowledge-spaces/{id}/overview/attention",
    resource: { pathParameter: "id" },
    resourceType: "knowledge_space",
  },
  {
    ...
    pathTemplate: "/knowledge-spaces/{id}/overview/activity",
    resource: { pathParameter: "id" },
    resourceType: "knowledge_space",
  },
  {
  ...
  },
  {
    ...
    pathTemplate: "/knowledge-spaces/{id}/metadata-fields",
    resource: { pathParameter: "id" },
    resourceType: "knowledge_space",
  },
  {
  ...
  },
  {
    ...
    pathTemplate: "/knowledge-spaces/{id}/metadata-fields/{fieldId}",
    resource: { pathParameter: "id" },
    resourceType: "knowledge_space",
  },
  {
  ...
  },
  {
    ...
    pathTemplate: "/knowledge-spaces/{id}/document-references/resolve",
    resource: { pathParameter: "id" },
    resourceType: "knowledge_space",
  },
  {
  ...
  },
  {
    ...
    parentResource: { pathParameter: "id" },
    pathTemplate: "/knowledge-spaces/{id}/logical-documents/{documentId}/availability",
    resource: { pathParameter: "documentId" },
    resourceType: "document",
  },
  {
    ...
    pathTemplate: "/knowledge-spaces/{id}/logical-documents/bulk/availability",
    resource: { pathParameter: "id" },
    resourceType: "knowledge_space",
  },
  {
  ...
  },
  {
    ...
    pathTemplate: "/namespace/source-preview-jobs",
    resource: { namespace: true },
    resourceType: "namespace",
  },
  {
    action: "namespace_source_previews.read",
    allowedCallerKinds: CONTROL_PLANE_CALLERS,
    method: "GET",
    operationId: "getNamespaceSourcePreview",
    pathTemplate: "/namespace/source-preview-jobs/{jobId}",
    resource: { namespace: true },
    resourceType: "namespace",
  },
  {
    action: "namespace_source_previews.cancel",
    allowedCallerKinds: CONTROL_PLANE_CALLERS,
    method: "DELETE",
  ...
  {
    action: "namespace_source_previews.consume",
    allowedCallerKinds: CONTROL_PLANE_CALLERS,
    method: "POST",
    operationId: "consumeNamespaceSourcePreview",
    parentResource: { pathParameter: "id" },
    pathTemplate: "/knowledge-spaces/{id}/sources/{sourceId}/namespace-preview-import",
    resource: { pathParameter: "sourceId" },
    resourceType: "source",
  },
  {
  ...
  },
  {
    ...
    pathTemplate: "/knowledge-spaces/{id}/golden-questions",
    resource: { pathParameter: "id" },
    resourceType: "knowledge_space",
  },
  {
  ...
  },
  {
    ...
    pathTemplate: "/knowledge-spaces/{id}/golden-questions/evidence-matches",
    resource: { pathParameter: "id" },
    resourceType: "knowledge_space",
  },
  {
    ...
    pathTemplate: "/knowledge-spaces/{id}/golden-questions/bulk-import",
    resource: { pathParameter: "id" },
    resourceType: "knowledge_space",
  },
  {
    ...
    pathTemplate: "/knowledge-spaces/{id}/golden-questions/{questionId}",
    resource: { pathParameter: "id" },
    resourceType: "knowledge_space",
  },
  {
  ...
  },
  {
    ...
    pathTemplate: "/knowledge-spaces/{id}/quality/bad-cases",
    resource: { pathParameter: "id" },
    resourceType: "knowledge_space",
  },
  {
  ...
  },
  {
    ...
    pathTemplate: "/knowledge-spaces/{id}/quality/bad-cases/{badCaseId}",
    resource: { pathParameter: "id" },
    resourceType: "knowledge_space",
  },
  {
  ...
  },
  {
    ...
    pathTemplate: "/knowledge-spaces/{id}/quality/replay-runs",
    resource: { pathParameter: "id" },
    resourceType: "knowledge_space",
  },
  {
  ...
  },
  {
    ...
    pathTemplate: "/knowledge-spaces/{id}/quality/replay-runs/{runId}",
    resource: { pathParameter: "id" },
    resourceType: "knowledge_space",
  },
  {
    ...
    pathTemplate: "/knowledge-spaces/{id}/quality/bad-cases/{badCaseId}/trace-reference",
    resource: { pathParameter: "id" },
    resourceType: "knowledge_space",
  },
  {
