...
<p align="center">
  ...
  <a href="https://docs.dify.ai/getting-started/introduction/self-hosting/quick-start/docker-compose">Auto-hospedagem</a> ·
  <a href="https://docs.dify.ai/getting-started/introduction">Documentação</a> ·
...
- **Auto-hospedagem do Dify Community Edition</br>**
  ...
  Use nossa [documentação](https://docs.dify.ai/getting-started/introduction) para referências adicionais e instruções mais detalhadas.
...
> Se você deseja contribuir com o Dify ou fazer desenvolvimento adicional, consulte nosso [guia para implantar a partir do código fonte](https://docs.dify.ai/getting-started/introduction/self-hosting/advanced-deployments/local-source-code).
