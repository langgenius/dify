...
func (c *httpStubClient) CreateFileDownloadURL(_ context.Context, transferMethod string, reference, url *string, audience FileURLAudience) (*FileDownloadResponse, error) {
