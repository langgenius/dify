...
export const validateE2eEnv = () =>
  createEnv({
    ...
    runtimeEnv: {
      ...
      E2E_PARALLEL_STARTUP: process.env.E2E_PARALLEL_STARTUP,
    ...
    server: {
      ...
      E2E_PARALLEL_STARTUP: z.enum(['0', '1']).optional(),
      ...
      E2E_SHELLCTL_CONTAINER_NAME: z.string().min(1).optional(),
