...
Feature: Main page automated WCAG checks
  ...
  Scenario: Studio page has no automatically detectable WCAG Level AA violations outside color contrast
    Given I am signed in as the default E2E admin
    When I open the "Studio" main page
    Then I should be on the "Studio" main page
    And the current page should have no automatically detectable WCAG Level AA violations except the "color-contrast" rule
