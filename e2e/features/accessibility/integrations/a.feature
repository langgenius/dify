@accessibility @axe @wcag-a @wcag-page-integrations @authenticated
Feature: Integrations page automated WCAG Level A check
  Axe checks only automatically detectable issues and does not establish WCAG conformance.

  Scenario: Integrations page has no automatically detectable WCAG Level A violations
