...
<p align="center">
  ...
  <a href="https://docs.dify.ai/getting-started/introduction/self-hosting/quick-start/docker-compose">셀프-호스팅</a> ·
  <a href="https://docs.dify.ai/getting-started/introduction">문서</a> ·
...
수십 개의 추론 제공업체와 자체 호스팅 솔루션에서 제공하는 수백 개의 독점 및 오픈 소스 LLM과 원활하게 통합되며, GPT, Mistral, Llama3 및 모든 OpenAI API 호환 모델을 포함합니다. 지원되는 모델 제공업체의 전체 목록은 [여기](https://docs.dify.ai/getting-started/introduction/workspace/model-providers)에서 확인할 수 있습니다.
...
- **셀프-호스팅 Dify 커뮤니티 에디션</br>**
  ...
  추가 참조 및 더 심층적인 지침은 [문서](https://docs.dify.ai/getting-started/introduction)를 사용하세요.
