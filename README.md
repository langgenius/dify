...
**5. Agent**:
Autonomous agents with their own sandbox: they run commands, install software, and handle files to tackle open-ended tasks. Describe the agent you want and let Dify help you build it. Give it skills, connect tools from Dify Marketplace, MCP servers, or your own APIs, and put it to work as a chat app or as a step in a workflow.
