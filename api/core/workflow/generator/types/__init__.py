...
- Error types and constants for workflow generation
...
Usage:
    ...
    # For error handling:
    from core.workflow.generator.types import WorkflowGenerationError, ErrorType, ErrorCode

    # For constants:
    from core.workflow.generator.types import PLACEHOLDER_VALUE, MAX_RETRIES
"""
