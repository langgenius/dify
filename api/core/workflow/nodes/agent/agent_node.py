        ...
        for message in message_stream:
            if message.type in {
                ...
                agent_log = AgentLogEvent(
                    id=node_execution_id,  # node execution id for GraphBaseNodeEvent
                    node_id=node_id,  # node id for GraphBaseNodeEvent
                    node_type=NodeType.AGENT,  # node type for GraphBaseNodeEvent
                    message_id=message.message.id,  # message id for AgentLogEvent
