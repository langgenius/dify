...
class LLMNode(BaseNode):
    ...
    def _run(self, variable_pool: VariablePool) -> NodeRunResult:
        ...
        try:
            ...
            prompt_messages, stop = self._fetch_prompt_messages(
                node_data=node_data,
                query=variable_pool.get(['sys', SystemVariable.QUERY.value])
    ...
    def _fetch_inputs(self, node_data: LLMNodeData, variable_pool: VariablePool) -> dict[str, str]:
        ...
        for variable_selector in variable_selectors:
            variable_value = variable_pool.get(variable_selector.value_selector)
    ...
    def _fetch_context(self, node_data: LLMNodeData, variable_pool: VariablePool) -> Optional[str]:
        ...
        context_value = variable_pool.get(node_data.context.variable_selector)
        if context_value:
    ...
    def _fetch_memory(self, node_data_memory: Optional[MemoryConfig],
        ...
        # get conversation id
        conversation_id = variable_pool.get(['sys', SystemVariable.CONVERSATION_ID.value])
