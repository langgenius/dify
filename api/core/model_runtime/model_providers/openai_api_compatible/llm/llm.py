...
class OAIAPICompatLargeLanguageModel(_CommonOAI_API_Compat, LargeLanguageModel):
    ...
    def validate_credentials(self, model: str, credentials: dict) -> None:
        ...
        try:
            ...
            if (completion_type is LLMMode.CHAT and ('object' not in json_result or json_result['object'] == '')):
                json_result['object'] = 'chat.completion'
            elif (completion_type is LLMMode.COMPLETION and ('object' not in json_result or json_result['object'] == '')):
