...
class NovitaLargeLanguageModel(OAIAPICompatLargeLanguageModel):
    ...
    def _invoke(self, model: str, credentials: dict,
        ...
        return super()._invoke(model, cred_with_endpoint, prompt_messages, model_parameters, tools, stop, stream, user, extra_headers)
    ...
    def _add_custom_parameters(cls, credentials: dict, model: str) -> None:
        ...
        # credentials['endpoint_url'] = f'https://api.novita.ai/api/v1'
