            ...
            parameter_rules=[
                ...
                ParameterRule(
                    ...
                    help=I18nObject(
                        ...
                        "This can be a duration string (e.g., '10m' or '24h'), a number in seconds "
                        "(e.g., 3600), a negative number to keep the model loaded indefinitely, or '0' "
                        "to unload the model immediately after generating a response. (Default: 5m)"
                    ),
                ),
                ParameterRule(
                    name="format",
