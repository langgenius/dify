    ...
    def _generate_worker(
        ...
        with preserve_flask_contexts(flask_app, context_vars=context):
            ...
            logger.debug(
                ...
                bool(getattr(application_generate_entity, "tool_results", None)),
                getattr(application_generate_entity, "tool_call_mode", None),
                application_generate_entity.conversation_id,
            )
            if getattr(application_generate_entity, "tool_results", None) and getattr(
                application_generate_entity, "tool_call_mode", None
            ) == "structured":
