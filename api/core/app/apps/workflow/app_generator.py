...
from core.repositories.workflow_execution_factory import create_workflow_execution_repository
from core.repositories.workflow_node_execution_factory import create_workflow_node_execution_repository
...
class WorkflowAppGenerator(BaseAppGenerator):
    ...
    def generate(
        ...
        *,
        ...
        workflow_execution_repository = create_workflow_execution_repository(
