...
class PauseStatePersistenceLayer(Layer):
    ...
    def persist_pending_pause(self, *, workflow_trace: WorkflowTraceRecorder | None = None) -> None:
        ...
        state = WorkflowResumptionContext(
            ...
            ops_trace_state=workflow_trace.save_pause_state() if workflow_trace is not None else None,
        )
