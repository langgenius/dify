...
def create_provider_encrypter(tenant_id: str, config: list[BasicProviderConfig], cache: ProviderConfigCache) -> tuple[ProviderConfigEncrypter, ProviderConfigCache]:
