...
def get(url, max_retries=DEFAULT_MAX_RETRIES, **kwargs):
    return make_request('GET', url, max_retries=max_retries, **kwargs)


def post(url, max_retries=DEFAULT_MAX_RETRIES, **kwargs):
    return make_request('POST', url, max_retries=max_retries, **kwargs)


def put(url, max_retries=DEFAULT_MAX_RETRIES, **kwargs):
    return make_request('PUT', url, max_retries=max_retries, **kwargs)


def patch(url, max_retries=DEFAULT_MAX_RETRIES, **kwargs):
    return make_request('PATCH', url, max_retries=max_retries, **kwargs)


def delete(url, max_retries=DEFAULT_MAX_RETRIES, **kwargs):
    return make_request('DELETE', url, max_retries=max_retries, **kwargs)


def head(url, max_retries=DEFAULT_MAX_RETRIES, **kwargs):
