...
# This module now lives at <repo>/dify/api/core/dsl_agent/source_context.py.
# parents[2] == the Dify `api` dir; parents[4] == the repo root that holds dify/ and dify-official-plugins/.
DIFY_API_DIR = Path(__file__).resolve().parents[2]
