...
class ElasticSearchJaConfig(BaseModel):
    host: str
    port: int
    username: str
    password: str
...
class ElasticSearchJaVector(BaseVector):
    def __init__(self, index_name: str, config: ElasticSearchJaConfig, attributes: list):
    ...
    def _init_client(self, config: ElasticSearchJaConfig) -> Elasticsearch:
        try:
...
class ElasticSearchJaVectorFactory(AbstractVectorFactory):
