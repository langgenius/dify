...
class AliyunMySQLVectorConfig(BaseModel):
    host: str
    port: int
    user: str
    password: str
...
class AliyunMySQLVector(BaseVector):
    def __init__(self, collection_name: str, config: AliyunMySQLVectorConfig):
...
class AliyunMySQLVectorFactory(AbstractVectorFactory):
    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> AliyunMySQLVector:
        if dataset.index_struct_dict:
            ...
            dataset.index_struct = json.dumps(self.gen_index_struct_dict(VectorType.ALIYUN_MYSQL, collection_name))
        return AliyunMySQLVector(
            collection_name=collection_name,
            config=AliyunMySQLVectorConfig(
                host=dify_config.ALIYUN_MYSQL_HOST or "localhost",
                port=dify_config.ALIYUN_MYSQL_PORT,
