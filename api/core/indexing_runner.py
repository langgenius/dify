...
class IndexingRunner:
    ...
    def run(self, dataset_documents: list[DatasetDocument]):
        ...
        for dataset_document in dataset_documents:
            ...
            except DocumentIsPausedExceptionError:
                raise DocumentIsPausedExceptionError("Document paused, document id: {}".format(dataset_document.id))
    ...
    def _check_document_paused_status(document_id: str):
        ...
        if result:
            raise DocumentIsPausedExceptionError()
...
class DocumentIsPausedExceptionError(Exception):
    pass
