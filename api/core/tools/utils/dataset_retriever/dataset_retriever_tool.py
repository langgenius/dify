    ...
    def _run(self, query: str) -> str:
        ...
        if dataset.provider == "external":
            ...
            if self.return_resource and retrieval_resource_list:
                ...
                for position, item in enumerate(retrieval_resource_list, start=1):  # type: ignore[assignment, operator]
                    item.position = position  # type: ignore[assignment, attr-defined]
                for hit_callback in self.hit_callbacks:
