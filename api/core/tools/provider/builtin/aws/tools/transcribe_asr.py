...
class TranscribeTool(BuiltinTool):
    ...
    def _invoke(self, 
        ...
        try:
            ...
            extra_args = {"IdentifyLanguage": identify_language,
            ...
            # upload to s3 bucket
            s3_path_result, error = upload_file_from_url_to_s3(self.s3_client, 
                url=file_url, 
            ...
            transcript_file_uri, error = self._transcribe_audio(audio_file_uri=s3_path_result,
                                                                file_type=file_type,
                                                               **extra_args,
                                                                )
