...
def add_RateAPIServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'flexport.procurement.rates.v1.RateAPI', rpc_method_handlers)
...
class RateAPI(object):
    ...
    def FindRates(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.procurement.rates.v1.RateAPI/FindRates',
    ...
    def FindRate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.procurement.rates.v1.RateAPI/FindRate',
