...
from flexport.pricingrequests.migration.v1beta1 import migration_api_pb2 as flexport_dot_pricingrequests_dot_migration_dot_v1beta1_dot_migration__api__pb2


class MigrationAPIStub(object):
...
class MigrationAPIServicer(object):
    """Specialized methods that encompass moving data from the monolith to the Pricing Requests NIS outside of normal business logic rules.
    """
...
class MigrationAPI(object):
    ...
    def SyncBid(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.pricingrequests.migration.v1beta1.MigrationAPI/SyncBid',
