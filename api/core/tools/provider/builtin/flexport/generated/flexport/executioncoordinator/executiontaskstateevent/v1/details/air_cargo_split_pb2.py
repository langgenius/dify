...
_AIRCARGOSPLIT = DESCRIPTOR.message_types_by_name["AirCargoSplit"]
_SCHEDULELEG = DESCRIPTOR.message_types_by_name["ScheduleLeg"]
AirCargoSplit = _reflection.GeneratedProtocolMessageType(
    "AirCargoSplit",
    (_message.Message,),
    {
        "DESCRIPTOR": _AIRCARGOSPLIT,
        "__module__": "flexport.executioncoordinator.executiontaskstateevent.v1.details.air_cargo_split_pb2",
        # @@protoc_insertion_point(class_scope:flexport.executioncoordinator.executiontaskstateevent.v1.AirCargoSplit)
    },
)
_sym_db.RegisterMessage(AirCargoSplit)

ScheduleLeg = _reflection.GeneratedProtocolMessageType(
    "ScheduleLeg",
    (_message.Message,),
    {
        "DESCRIPTOR": _SCHEDULELEG,
        "__module__": "flexport.executioncoordinator.executiontaskstateevent.v1.details.air_cargo_split_pb2",
        # @@protoc_insertion_point(class_scope:flexport.executioncoordinator.executiontaskstateevent.v1.ScheduleLeg)
    },
)
_sym_db.RegisterMessage(ScheduleLeg)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _AIRCARGOSPLIT._serialized_start = 281
    _AIRCARGOSPLIT._serialized_end = 474
    _SCHEDULELEG._serialized_start = 477
    _SCHEDULELEG._serialized_end = 1222
