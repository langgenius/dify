...
_EXCEPTIONREVISIONENTITY = DESCRIPTOR.message_types_by_name["ExceptionRevisionEntity"]
ExceptionRevisionEntity = _reflection.GeneratedProtocolMessageType(
    "ExceptionRevisionEntity",
    (_message.Message,),
    {
        "DESCRIPTOR": _EXCEPTIONREVISIONENTITY,
        "__module__": "flexport.monolith.exceptions.exception.v1.exception_revision_entity_pb2",
        # @@protoc_insertion_point(class_scope:flexport.monolith.exceptions.exception.v1.ExceptionRevisionEntity)
    },
)
_sym_db.RegisterMessage(ExceptionRevisionEntity)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _RESOLUTIONTYPE._serialized_start = 1430
    _RESOLUTIONTYPE._serialized_end = 1552
    _EXCEPTIONREVISIONENTITY._serialized_start = 216
    _EXCEPTIONREVISIONENTITY._serialized_end = 1428
