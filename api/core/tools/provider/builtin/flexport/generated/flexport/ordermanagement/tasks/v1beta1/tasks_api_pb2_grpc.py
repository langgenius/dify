...
from flexport.ordermanagement.tasks.v1beta1 import tasks_api_pb2 as flexport_dot_ordermanagement_dot_tasks_dot_v1beta1_dot_tasks__api__pb2


class OrderManagementTaskAPIStub(object):
...
class OrderManagementTaskAPIServicer(object):
    """Services for Order Management to create tasks and adjust their statuses.
...
class OrderManagementTaskAPI(object):
    """Services for Order Management to create tasks and adjust their statuses.
    ...
    def CreateTask(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.ordermanagement.tasks.v1beta1.OrderManagementTaskAPI/CreateTask',
    ...
    def SetTaskStatus(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.ordermanagement.tasks.v1beta1.OrderManagementTaskAPI/SetTaskStatus',
