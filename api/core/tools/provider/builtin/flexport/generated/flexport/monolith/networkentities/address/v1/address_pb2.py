...
_ADDRESSDTO = DESCRIPTOR.message_types_by_name["AddressDTO"]
AddressDTO = _reflection.GeneratedProtocolMessageType(
    "AddressDTO",
    (_message.Message,),
    {
        "DESCRIPTOR": _ADDRESSDTO,
        "__module__": "flexport.monolith.networkentities.address.v1.address_pb2",
        # @@protoc_insertion_point(class_scope:flexport.monolith.networkentities.address.v1.AddressDTO)
    },
)
_sym_db.RegisterMessage(AddressDTO)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _ADDRESSDTO._serialized_start = 141
    _ADDRESSDTO._serialized_end = 801
