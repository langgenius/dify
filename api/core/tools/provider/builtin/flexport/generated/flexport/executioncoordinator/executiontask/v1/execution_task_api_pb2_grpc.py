...
import grpc
from flexport.executioncoordinator.executiontask.v1 import (
    execution_task_api_pb2 as flexport_dot_executioncoordinator_dot_executiontask_dot_v1_dot_execution__task__api__pb2,
)
...
class ExecutionTaskAPI:
    ...
    @staticmethod
    def ListExecutionTaskRevisions(
        request,
        target,
        options=(),
        channel_credentials=None,
