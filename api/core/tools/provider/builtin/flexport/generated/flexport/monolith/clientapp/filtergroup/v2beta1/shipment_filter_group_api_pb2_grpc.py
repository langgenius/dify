...
from flexport.monolith.clientapp.filtergroup.v2beta1 import shipment_filter_group_api_pb2 as flexport_dot_monolith_dot_clientapp_dot_filtergroup_dot_v2beta1_dot_shipment__filter__group__api__pb2


class ShipmentFilterGroupAPIStub(object):
...
class ShipmentFilterGroupAPIServicer(object):
    """This API handles the backward sync from SIS to Monolith
    """
...
class ShipmentFilterGroupAPI(object):
    """This API handles the backward sync from SIS to Monolith
    """

    @staticmethod
    def UpsertShipmentFilterGroup(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.monolith.clientapp.filtergroup.v2beta1.ShipmentFilterGroupAPI/UpsertShipmentFilterGroup',
