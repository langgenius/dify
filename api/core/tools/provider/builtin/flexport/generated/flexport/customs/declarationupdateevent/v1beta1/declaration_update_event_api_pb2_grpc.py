...
import grpc
from flexport.customs.declarationupdateevent.v1beta1 import (
    declaration_update_event_api_pb2 as flexport_dot_customs_dot_declarationupdateevent_dot_v1beta1_dot_declaration__update__event__api__pb2,
)


class DeclarationUpdateEventAPIStub:
...
class DeclarationUpdateEventAPIServicer:
    """The DeclarationUpdateEventAPI allows a customs authority integration to transmit the results of a customs
    declaration update to another system.
    """
...
class DeclarationUpdateEventAPI:
    """The DeclarationUpdateEventAPI allows a customs authority integration to transmit the results of a customs
    declaration update to another system.
    """

    @staticmethod
    def HandleDeclarationUpdateEvent(
        request,
        target,
        options=(),
