...
import grpc
from flexport.monolith.messaging.v1beta1 import (
    messaging_api_pb2 as flexport_dot_monolith_dot_messaging_dot_v1beta1_dot_messaging__api__pb2,
)


class MessagingAPIStub:
