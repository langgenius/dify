...
from flexport.pricingrequests.hello.v1beta1 import hello_api_pb2 as flexport_dot_pricingrequests_dot_hello_dot_v1beta1_dot_hello__api__pb2
...
class HelloAPI(object):
    ...
    def Hello(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.pricingrequests.hello.v1beta1.HelloAPI/Hello',
    ...
    def HelloCore(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.pricingrequests.hello.v1beta1.HelloAPI/HelloCore',
    ...
    def BigYikes(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.pricingrequests.hello.v1beta1.HelloAPI/BigYikes',
