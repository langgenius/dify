...
from flexport.consolplanner.air.v1beta1 import air_service_api_pb2 as flexport_dot_consolplanner_dot_air_dot_v1beta1_dot_air__service__api__pb2


class AirServiceAPIStub(object):
...
class AirServiceAPIServicer(object):
    """This service is used to query/mutate `air` data in the consol_planner NIS.
    As this service contains all other services, we should seek to deprecate it
    and place each endpoint into an appropriate service.
    """
...
class AirServiceAPI(object):
    ...
    @staticmethod
    def ResolveShipmentRoute(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.consolplanner.air.v1beta1.AirServiceAPI/ResolveShipmentRoute',
    ...
    def GetAirBuildPlans(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.consolplanner.air.v1beta1.AirServiceAPI/GetAirBuildPlans',
    ...
    @staticmethod
    def ListAirPlanningShipment(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.consolplanner.air.v1beta1.AirServiceAPI/ListAirPlanningShipment',
    ...
    @staticmethod
    def ListFaeRecommendationFeedback(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.consolplanner.air.v1beta1.AirServiceAPI/ListFaeRecommendationFeedback',
    ...
    def PublishAirEPC(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.consolplanner.air.v1beta1.AirServiceAPI/PublishAirEPC',
