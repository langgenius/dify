...
class InboundImporterSecurityFilingServiceAPIStub(object):
...
class InboundImporterSecurityFilingServiceAPIServicer(object):
    """The API for the Inbound Importer Security Filing Engine.
    """
...
class InboundImporterSecurityFilingServiceAPI(object):
    """The API for the Inbound Importer Security Filing Engine.
    """

    @staticmethod
    def UpsertInboundImporterSecurityFiling(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.inboundimportersecurityfiling.v1beta1.InboundImporterSecurityFilingServiceAPI/UpsertInboundImporterSecurityFiling',
    ...
    @staticmethod
    def GetInboundImporterSecurityFilings(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.inboundimportersecurityfiling.v1beta1.InboundImporterSecurityFilingServiceAPI/GetInboundImporterSecurityFilings',
    ...
    @staticmethod
    def AttachInboundIsfToEo(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.inboundimportersecurityfiling.v1beta1.InboundImporterSecurityFilingServiceAPI/AttachInboundIsfToEo',
    ...
    @staticmethod
    def GetInboundIsfByStableId(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.inboundimportersecurityfiling.v1beta1.InboundImporterSecurityFilingServiceAPI/GetInboundIsfByStableId',
