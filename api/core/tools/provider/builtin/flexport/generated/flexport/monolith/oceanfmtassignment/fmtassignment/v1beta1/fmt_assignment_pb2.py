...
_FMTASSIGNMENTUPDATESOURCE = DESCRIPTOR.enum_types_by_name["FmtAssignmentUpdateSource"]
FmtAssignmentUpdateSource = enum_type_wrapper.EnumTypeWrapper(_FMTASSIGNMENTUPDATESOURCE)
...
_FMTASSIGNMENT = DESCRIPTOR.message_types_by_name["FmtAssignment"]
_ROUTE = DESCRIPTOR.message_types_by_name["Route"]
_ROUTESEGMENT = DESCRIPTOR.message_types_by_name["RouteSegment"]
_PORTCALL = DESCRIPTOR.message_types_by_name["PortCall"]
_FMTASSIGNMENTCREATED = DESCRIPTOR.message_types_by_name["FmtAssignmentCreated"]
_FMTASSIGNMENTDELETED = DESCRIPTOR.message_types_by_name["FmtAssignmentDeleted"]
FmtAssignment = _reflection.GeneratedProtocolMessageType(
    "FmtAssignment",
    (_message.Message,),
    {
        "DESCRIPTOR": _FMTASSIGNMENT,
        "__module__": "flexport.monolith.oceanfmtassignment.fmtassignment.v1beta1.fmt_assignment_pb2",
        # @@protoc_insertion_point(class_scope:flexport.monolith.oceanfmtassignment.fmtassignment.v1beta1.FmtAssignment)
    },
)
_sym_db.RegisterMessage(FmtAssignment)
...
Route = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        "DESCRIPTOR": _ROUTE,
        "__module__": "flexport.monolith.oceanfmtassignment.fmtassignment.v1beta1.fmt_assignment_pb2",
        # @@protoc_insertion_point(class_scope:flexport.monolith.oceanfmtassignment.fmtassignment.v1beta1.Route)
    },
)
...
RouteSegment = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "flexport.monolith.oceanfmtassignment.fmtassignment.v1beta1.fmt_assignment_pb2",
        # @@protoc_insertion_point(class_scope:flexport.monolith.oceanfmtassignment.fmtassignment.v1beta1.RouteSegment)
    },
)
_sym_db.RegisterMessage(RouteSegment)

PortCall = _reflection.GeneratedProtocolMessageType(
    "PortCall",
    (_message.Message,),
    {
        "DESCRIPTOR": _PORTCALL,
        "__module__": "flexport.monolith.oceanfmtassignment.fmtassignment.v1beta1.fmt_assignment_pb2",
        # @@protoc_insertion_point(class_scope:flexport.monolith.oceanfmtassignment.fmtassignment.v1beta1.PortCall)
    },
)
_sym_db.RegisterMessage(PortCall)

FmtAssignmentCreated = _reflection.GeneratedProtocolMessageType(
    "FmtAssignmentCreated",
    (_message.Message,),
    {
        "DESCRIPTOR": _FMTASSIGNMENTCREATED,
        "__module__": "flexport.monolith.oceanfmtassignment.fmtassignment.v1beta1.fmt_assignment_pb2",
        # @@protoc_insertion_point(class_scope:flexport.monolith.oceanfmtassignment.fmtassignment.v1beta1.FmtAssignmentCreated)
    },
)
_sym_db.RegisterMessage(FmtAssignmentCreated)

FmtAssignmentDeleted = _reflection.GeneratedProtocolMessageType(
    "FmtAssignmentDeleted",
    (_message.Message,),
    {
        "DESCRIPTOR": _FMTASSIGNMENTDELETED,
        "__module__": "flexport.monolith.oceanfmtassignment.fmtassignment.v1beta1.fmt_assignment_pb2",
        # @@protoc_insertion_point(class_scope:flexport.monolith.oceanfmtassignment.fmtassignment.v1beta1.FmtAssignmentDeleted)
    },
)
_sym_db.RegisterMessage(FmtAssignmentDeleted)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _FMTASSIGNMENTCREATED.fields_by_name["created_time"]._options = None
    _FMTASSIGNMENTCREATED.fields_by_name["created_time"]._serialized_options = b"\030\001"
    _FMTASSIGNMENTDELETED.fields_by_name["deleted_time"]._options = None
    _FMTASSIGNMENTDELETED.fields_by_name["deleted_time"]._serialized_options = b"\030\001"
    _TRANSPORTATIONMODE._serialized_start = 3207
    _TRANSPORTATIONMODE._serialized_end = 3352
    _VOYAGETYPE._serialized_start = 3355
    _VOYAGETYPE._serialized_end = 3535
    _FMTASSIGNMENTUPDATESOURCE._serialized_start = 3538
    _FMTASSIGNMENTUPDATESOURCE._serialized_end = 3695
    _FMTASSIGNMENT._serialized_start = 268
    _FMTASSIGNMENT._serialized_end = 1714
    _ROUTE._serialized_start = 1716
    _ROUTE._serialized_end = 1815
    _ROUTESEGMENT._serialized_start = 1818
    _ROUTESEGMENT._serialized_end = 2395
    _PORTCALL._serialized_start = 2398
    _PORTCALL._serialized_end = 2594
    _FMTASSIGNMENTCREATED._serialized_start = 2597
    _FMTASSIGNMENTCREATED._serialized_end = 2899
    _FMTASSIGNMENTDELETED._serialized_start = 2902
    _FMTASSIGNMENTDELETED._serialized_end = 3204
