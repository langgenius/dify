...
from flexport.quoting.quoteshare.v1beta1 import quote_share_api_pb2 as flexport_dot_quoting_dot_quoteshare_dot_v1beta1_dot_quote__share__api__pb2


class QuoteShareAPIStub(object):
...
class QuoteShareAPIServicer(object):
    """Methods concerning client-facing quote lifecycle.
    """
...
class QuoteShareAPI(object):
    """Methods concerning client-facing quote lifecycle.
    """

    @staticmethod
    def ShareQuotesForRfq(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.quoting.quoteshare.v1beta1.QuoteShareAPI/ShareQuotesForRfq',
    ...
    def VoidQuoteByFID(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.quoting.quoteshare.v1beta1.QuoteShareAPI/VoidQuoteByFID',
    ...
    def FetchQuoteByFID(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.quoting.quoteshare.v1beta1.QuoteShareAPI/FetchQuoteByFID',
    ...
    def AcceptQuoteByFID(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.quoting.quoteshare.v1beta1.QuoteShareAPI/AcceptQuoteByFID',
    ...
    def VoidQuoteByDBID(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.quoting.quoteshare.v1beta1.QuoteShareAPI/VoidQuoteByDBID',
    ...
    def FetchQuoteByDBID(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.quoting.quoteshare.v1beta1.QuoteShareAPI/FetchQuoteByDBID',
    ...
    def AcceptQuoteByDBID(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.quoting.quoteshare.v1beta1.QuoteShareAPI/AcceptQuoteByDBID',
