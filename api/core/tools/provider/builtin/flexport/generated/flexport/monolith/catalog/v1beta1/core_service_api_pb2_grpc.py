...
from flexport.monolith.catalog.v1beta1 import (
    core_service_api_pb2 as flexport_dot_monolith_dot_catalog_dot_v1beta1_dot_core__service__api__pb2,
)


class CoreServiceAPIStub:
...
class CoreServiceAPI:
    ...
    @staticmethod
    def GetServiceChargeToTemplateTable(
        request,
        target,
        options=(),
        channel_credentials=None,
