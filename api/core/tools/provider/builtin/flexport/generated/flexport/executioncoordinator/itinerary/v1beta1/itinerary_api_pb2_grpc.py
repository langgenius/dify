...
import grpc
from flexport.executioncoordinator.itinerary.v1beta1 import (
    itinerary_api_pb2 as flexport_dot_executioncoordinator_dot_itinerary_dot_v1beta1_dot_itinerary__api__pb2,
)


class ItineraryAPIStub:
...
class ItineraryUpdateAPIServicer:
    """Missing associated documentation comment in .proto file."""
...
class ItineraryUpdateAPI:
    """Missing associated documentation comment in .proto file."""

    @staticmethod
    def UpdatePartialRoute(
        request,
        target,
        options=(),
        channel_credentials=None,
