...
from flexport.customs.declarationtransmission.v1beta1 import declaration_transmission_api_pb2 as flexport_dot_customs_dot_declarationtransmission_dot_v1beta1_dot_declaration__transmission__api__pb2


class DeclarationTransmissionAPIStub(object):
...
class DeclarationTransmissionAPIServicer(object):
    """The DeclarationTransmissionAPI service allows users to transmit customs declaration
    information to government adapter services. The service is meant to be agnostic to the type of
    declaration and the country for which the declaration is made.
...
class DeclarationTransmissionAPI(object):
    """The DeclarationTransmissionAPI service allows users to transmit customs declaration
    information to government adapter services. The service is meant to be agnostic to the type of
    declaration and the country for which the declaration is made.
    ...
    @staticmethod
    def CreateDeclarationTransmission(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.customs.declarationtransmission.v1beta1.DeclarationTransmissionAPI/CreateDeclarationTransmission',
    ...
    @staticmethod
    def ListDeclarationTransmissions(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.customs.declarationtransmission.v1beta1.DeclarationTransmissionAPI/ListDeclarationTransmissions',
