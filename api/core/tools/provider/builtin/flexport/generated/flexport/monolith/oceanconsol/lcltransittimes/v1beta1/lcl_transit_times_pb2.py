...
SERVICE_LEVEL_FLEXIBLE = 3


_LCLTRANSITTIMESREQUEST = DESCRIPTOR.message_types_by_name["LclTransitTimesRequest"]
_LCLTRANSITTIMESRESPONSE = DESCRIPTOR.message_types_by_name["LclTransitTimesResponse"]
_ONTIMEEXECUTIONTIMES = DESCRIPTOR.message_types_by_name["OnTimeExecutionTimes"]
_QUOTEDTRANSITTIMES = DESCRIPTOR.message_types_by_name["QuotedTransitTimes"]
LclTransitTimesRequest = _reflection.GeneratedProtocolMessageType(
    "LclTransitTimesRequest",
    (_message.Message,),
    {
        "DESCRIPTOR": _LCLTRANSITTIMESREQUEST,
        "__module__": "flexport.monolith.oceanconsol.lcltransittimes.v1beta1.lcl_transit_times_pb2",
        # @@protoc_insertion_point(class_scope:flexport.monolith.oceanconsol.lcltransittimes.v1beta1.LclTransitTimesRequest)
    },
)
_sym_db.RegisterMessage(LclTransitTimesRequest)

LclTransitTimesResponse = _reflection.GeneratedProtocolMessageType(
    "LclTransitTimesResponse",
    (_message.Message,),
    {
        "DESCRIPTOR": _LCLTRANSITTIMESRESPONSE,
        "__module__": "flexport.monolith.oceanconsol.lcltransittimes.v1beta1.lcl_transit_times_pb2",
        # @@protoc_insertion_point(class_scope:flexport.monolith.oceanconsol.lcltransittimes.v1beta1.LclTransitTimesResponse)
    },
)
_sym_db.RegisterMessage(LclTransitTimesResponse)

OnTimeExecutionTimes = _reflection.GeneratedProtocolMessageType(
    "OnTimeExecutionTimes",
    (_message.Message,),
    {
        "DESCRIPTOR": _ONTIMEEXECUTIONTIMES,
        "__module__": "flexport.monolith.oceanconsol.lcltransittimes.v1beta1.lcl_transit_times_pb2",
        # @@protoc_insertion_point(class_scope:flexport.monolith.oceanconsol.lcltransittimes.v1beta1.OnTimeExecutionTimes)
    },
)
_sym_db.RegisterMessage(OnTimeExecutionTimes)

QuotedTransitTimes = _reflection.GeneratedProtocolMessageType(
    "QuotedTransitTimes",
    (_message.Message,),
    {
        "DESCRIPTOR": _QUOTEDTRANSITTIMES,
        "__module__": "flexport.monolith.oceanconsol.lcltransittimes.v1beta1.lcl_transit_times_pb2",
        # @@protoc_insertion_point(class_scope:flexport.monolith.oceanconsol.lcltransittimes.v1beta1.QuotedTransitTimes)
    },
)
_sym_db.RegisterMessage(QuotedTransitTimes)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _SERVICELEVEL._serialized_start = 1558
    _SERVICELEVEL._serialized_end = 1682
    _LCLTRANSITTIMESREQUEST._serialized_start = 169
    _LCLTRANSITTIMESREQUEST._serialized_end = 756
    _LCLTRANSITTIMESRESPONSE._serialized_start = 759
    _LCLTRANSITTIMESRESPONSE._serialized_end = 1113
    _ONTIMEEXECUTIONTIMES._serialized_start = 1116
    _ONTIMEEXECUTIONTIMES._serialized_end = 1389
    _QUOTEDTRANSITTIMES._serialized_start = 1392
    _QUOTEDTRANSITTIMES._serialized_end = 1556
