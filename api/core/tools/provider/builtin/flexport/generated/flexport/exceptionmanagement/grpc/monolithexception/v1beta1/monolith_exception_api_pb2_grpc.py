...
import grpc
from flexport.exceptionmanagement.grpc.monolithexception.v1beta1 import (
    monolith_exception_api_pb2 as flexport_dot_exceptionmanagement_dot_grpc_dot_monolithexception_dot_v1beta1_dot_monolith__exception__api__pb2,
)


class MonolithExceptionAPIStub:
...
class MonolithExceptionAPIServicer:
    """An API for fetching DomainAgnostic related data to NIS"""
...
class MonolithExceptionAPI:
    """An API for fetching DomainAgnostic related data to NIS"""

    @staticmethod
    def SubstituteShipmentInfo(
        request,
        target,
        options=(),
