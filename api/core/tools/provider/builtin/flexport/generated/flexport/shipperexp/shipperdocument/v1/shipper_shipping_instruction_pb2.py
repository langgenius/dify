...
_SHIPPERSHIPPINGINSTRUCTION = DESCRIPTOR.message_types_by_name["ShipperShippingInstruction"]
_SHIPPERSHIPPINGINSTRUCTIONCONTENT = DESCRIPTOR.message_types_by_name["ShipperShippingInstructionContent"]
_SHIPPERSHIPPINGINSTRUCTIONCONTAINER = DESCRIPTOR.message_types_by_name["ShipperShippingInstructionContainer"]
_SHIPPERSHIPPINGINSTRUCTIONCONTAINERCARGO = DESCRIPTOR.message_types_by_name["ShipperShippingInstructionContainerCargo"]
_SHIPPERSHIPPINGINSTRUCTIONPRODUCT = DESCRIPTOR.message_types_by_name["ShipperShippingInstructionProduct"]
ShipperShippingInstruction = _reflection.GeneratedProtocolMessageType(
    "ShipperShippingInstruction",
    (_message.Message,),
    {
        "DESCRIPTOR": _SHIPPERSHIPPINGINSTRUCTION,
        "__module__": "flexport.shipperexp.shipperdocument.v1.shipper_shipping_instruction_pb2",
        # @@protoc_insertion_point(class_scope:flexport.shipperexp.shipperdocument.v1.ShipperShippingInstruction)
    },
)
_sym_db.RegisterMessage(ShipperShippingInstruction)

ShipperShippingInstructionContent = _reflection.GeneratedProtocolMessageType(
    "ShipperShippingInstructionContent",
    (_message.Message,),
    {
        "DESCRIPTOR": _SHIPPERSHIPPINGINSTRUCTIONCONTENT,
        "__module__": "flexport.shipperexp.shipperdocument.v1.shipper_shipping_instruction_pb2",
        # @@protoc_insertion_point(class_scope:flexport.shipperexp.shipperdocument.v1.ShipperShippingInstructionContent)
    },
)
_sym_db.RegisterMessage(ShipperShippingInstructionContent)

ShipperShippingInstructionContainer = _reflection.GeneratedProtocolMessageType(
    "ShipperShippingInstructionContainer",
    (_message.Message,),
    {
        "DESCRIPTOR": _SHIPPERSHIPPINGINSTRUCTIONCONTAINER,
        "__module__": "flexport.shipperexp.shipperdocument.v1.shipper_shipping_instruction_pb2",
        # @@protoc_insertion_point(class_scope:flexport.shipperexp.shipperdocument.v1.ShipperShippingInstructionContainer)
    },
)
_sym_db.RegisterMessage(ShipperShippingInstructionContainer)

ShipperShippingInstructionContainerCargo = _reflection.GeneratedProtocolMessageType(
    "ShipperShippingInstructionContainerCargo",
    (_message.Message,),
    {
        "DESCRIPTOR": _SHIPPERSHIPPINGINSTRUCTIONCONTAINERCARGO,
        "__module__": "flexport.shipperexp.shipperdocument.v1.shipper_shipping_instruction_pb2",
        # @@protoc_insertion_point(class_scope:flexport.shipperexp.shipperdocument.v1.ShipperShippingInstructionContainerCargo)
    },
)
_sym_db.RegisterMessage(ShipperShippingInstructionContainerCargo)

ShipperShippingInstructionProduct = _reflection.GeneratedProtocolMessageType(
    "ShipperShippingInstructionProduct",
    (_message.Message,),
    {
        "DESCRIPTOR": _SHIPPERSHIPPINGINSTRUCTIONPRODUCT,
        "__module__": "flexport.shipperexp.shipperdocument.v1.shipper_shipping_instruction_pb2",
        # @@protoc_insertion_point(class_scope:flexport.shipperexp.shipperdocument.v1.ShipperShippingInstructionProduct)
    },
)
_sym_db.RegisterMessage(ShipperShippingInstructionProduct)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _SHIPPERSHIPPINGINSTRUCTION._serialized_start = 266
    _SHIPPERSHIPPINGINSTRUCTION._serialized_end = 678
    _SHIPPERSHIPPINGINSTRUCTIONCONTENT._serialized_start = 681
    _SHIPPERSHIPPINGINSTRUCTIONCONTENT._serialized_end = 1410
    _SHIPPERSHIPPINGINSTRUCTIONCONTAINER._serialized_start = 1413
    _SHIPPERSHIPPINGINSTRUCTIONCONTAINER._serialized_end = 1648
    _SHIPPERSHIPPINGINSTRUCTIONCONTAINERCARGO._serialized_start = 1651
    _SHIPPERSHIPPINGINSTRUCTIONCONTAINERCARGO._serialized_end = 1996
    _SHIPPERSHIPPINGINSTRUCTIONPRODUCT._serialized_start = 1999
    _SHIPPERSHIPPINGINSTRUCTIONPRODUCT._serialized_end = 2183
