...
from flexport.airprocurement.surchargesprovider.v1beta1 import surcharges_provider_api_pb2 as flexport_dot_airprocurement_dot_surchargesprovider_dot_v1beta1_dot_surcharges__provider__api__pb2
...
class SurchargesProviderAPI(object):
    ...
    def FindODCharges(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.airprocurement.surchargesprovider.v1beta1.SurchargesProviderAPI/FindODCharges',
