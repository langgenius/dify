...
_CARGOMANIFESTMASTERBILLOFLADING = DESCRIPTOR.message_types_by_name["CargoManifestMasterBillOfLading"]
CargoManifestMasterBillOfLading = _reflection.GeneratedProtocolMessageType(
    "CargoManifestMasterBillOfLading",
    (_message.Message,),
    {
        "DESCRIPTOR": _CARGOMANIFESTMASTERBILLOFLADING,
        "__module__": "flexport.customscargomanifestquery.entities.v1beta1.cargo_manifest_master_bill_of_lading_pb2",
        # @@protoc_insertion_point(class_scope:flexport.customscargomanifestquery.entities.v1beta1.CargoManifestMasterBillOfLading)
    },
)
_sym_db.RegisterMessage(CargoManifestMasterBillOfLading)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _CARGOMANIFESTMASTERBILLOFLADING._serialized_start = 703
    _CARGOMANIFESTMASTERBILLOFLADING._serialized_end = 2040
