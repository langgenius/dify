...
import grpc
from flexport.authorization.checker.v1 import (
    checker_api_pb2 as flexport_dot_authorization_dot_checker_dot_v1_dot_checker__api__pb2,
)


class CheckerAPIStub:
