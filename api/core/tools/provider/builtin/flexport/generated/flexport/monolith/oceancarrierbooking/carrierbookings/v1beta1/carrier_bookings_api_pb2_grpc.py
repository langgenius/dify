...
from flexport.monolith.oceancarrierbooking.carrierbookings.v1beta1 import carrier_bookings_api_pb2 as flexport_dot_monolith_dot_oceancarrierbooking_dot_carrierbookings_dot_v1beta1_dot_carrier__bookings__api__pb2


class CarrierBookingsAPIStub(object):
...
class CarrierBookingsAPIServicer(object):
    """This API will be deprecated soon in favor of OEX NIS, please do not add anything here.
    """
...
class CarrierBookingsAPI(object):
    """This API will be deprecated soon in favor of OEX NIS, please do not add anything here.
    """

    @staticmethod
    def FindCarrierBookingByFid(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.monolith.oceancarrierbooking.carrierbookings.v1beta1.CarrierBookingsAPI/FindCarrierBookingByFid',
    ...
    @staticmethod
    def ListCarrierBookingsByExecutionTaskFid(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.monolith.oceancarrierbooking.carrierbookings.v1beta1.CarrierBookingsAPI/ListCarrierBookingsByExecutionTaskFid',
    ...
    @staticmethod
    def FindCarrierBookingByDocumentableFid(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.monolith.oceancarrierbooking.carrierbookings.v1beta1.CarrierBookingsAPI/FindCarrierBookingByDocumentableFid',
