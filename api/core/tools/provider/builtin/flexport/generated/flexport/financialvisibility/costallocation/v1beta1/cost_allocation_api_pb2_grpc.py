...
from flexport.financialvisibility.costallocation.v1beta1 import cost_allocation_api_pb2 as flexport_dot_financialvisibility_dot_costallocation_dot_v1beta1_dot_cost__allocation__api__pb2


class CostAllocationAPIStub(object):
...
class CostAllocationAPIServicer(object):
    """The CostAllocation definition.
    """
...
class CostAllocationAPI(object):
    ...
    def Register(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.financialledger.costallocation.v1beta1.CostAllocationAPI/Register',
