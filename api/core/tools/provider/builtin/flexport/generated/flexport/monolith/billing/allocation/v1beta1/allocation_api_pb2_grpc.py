...
from flexport.monolith.billing.allocation.v1beta1 import allocation_api_pb2 as flexport_dot_monolith_dot_billing_dot_allocation_dot_v1beta1_dot_allocation__api__pb2
...
class AllocationAPI(object):
    ...
    @staticmethod
    def GetShipmentAllocation(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.monolith.billing.allocation.v1beta1.AllocationAPI/GetShipmentAllocation',
    ...
    @staticmethod
    def ExpandConsolShipments(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.monolith.billing.allocation.v1beta1.AllocationAPI/ExpandConsolShipments',
