...
import grpc
from flexport.procurement.ingestion.pie.engine.v1beta1 import (
    procurement_ingestion_engine_api_pb2 as flexport_dot_procurement_dot_ingestion_dot_pie_dot_engine_dot_v1beta1_dot_procurement__ingestion__engine__api__pb2,
)
