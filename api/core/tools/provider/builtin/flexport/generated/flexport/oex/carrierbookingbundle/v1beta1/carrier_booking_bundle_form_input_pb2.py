...
_BOOKINGCONTENTINPUT = DESCRIPTOR.message_types_by_name["BookingContentInput"]
_BOOKINGINTEGRATIONINPUT = DESCRIPTOR.message_types_by_name["BookingIntegrationInput"]
_BOOKINGVOYAGEINPUT = DESCRIPTOR.message_types_by_name["BookingVoyageInput"]
_SHIPPINGORDERINPUT = DESCRIPTOR.message_types_by_name["ShippingOrderInput"]
_CARRIERBOOKINGBUNDLEINPUT = DESCRIPTOR.message_types_by_name["CarrierBookingBundleInput"]
_CARRIERBOOKINGBUNDLEFORMINPUT = DESCRIPTOR.message_types_by_name["CarrierBookingBundleFormInput"]
BookingContentInput = _reflection.GeneratedProtocolMessageType(
    "BookingContentInput",
    (_message.Message,),
    {
        "DESCRIPTOR": _BOOKINGCONTENTINPUT,
        "__module__": "flexport.oex.carrierbookingbundle.v1beta1.carrier_booking_bundle_form_input_pb2",
        # @@protoc_insertion_point(class_scope:flexport.oex.carrierbookingbundle.v1beta1.BookingContentInput)
    },
)
_sym_db.RegisterMessage(BookingContentInput)

BookingIntegrationInput = _reflection.GeneratedProtocolMessageType(
    "BookingIntegrationInput",
    (_message.Message,),
    {
        "DESCRIPTOR": _BOOKINGINTEGRATIONINPUT,
        "__module__": "flexport.oex.carrierbookingbundle.v1beta1.carrier_booking_bundle_form_input_pb2",
        # @@protoc_insertion_point(class_scope:flexport.oex.carrierbookingbundle.v1beta1.BookingIntegrationInput)
    },
)
_sym_db.RegisterMessage(BookingIntegrationInput)

BookingVoyageInput = _reflection.GeneratedProtocolMessageType(
    "BookingVoyageInput",
    (_message.Message,),
    {
        "DESCRIPTOR": _BOOKINGVOYAGEINPUT,
        "__module__": "flexport.oex.carrierbookingbundle.v1beta1.carrier_booking_bundle_form_input_pb2",
        # @@protoc_insertion_point(class_scope:flexport.oex.carrierbookingbundle.v1beta1.BookingVoyageInput)
    },
)
_sym_db.RegisterMessage(BookingVoyageInput)

ShippingOrderInput = _reflection.GeneratedProtocolMessageType(
    "ShippingOrderInput",
    (_message.Message,),
    {
        "DESCRIPTOR": _SHIPPINGORDERINPUT,
        "__module__": "flexport.oex.carrierbookingbundle.v1beta1.carrier_booking_bundle_form_input_pb2",
        # @@protoc_insertion_point(class_scope:flexport.oex.carrierbookingbundle.v1beta1.ShippingOrderInput)
    },
)
_sym_db.RegisterMessage(ShippingOrderInput)

CarrierBookingBundleInput = _reflection.GeneratedProtocolMessageType(
    "CarrierBookingBundleInput",
    (_message.Message,),
    {
        "DESCRIPTOR": _CARRIERBOOKINGBUNDLEINPUT,
        "__module__": "flexport.oex.carrierbookingbundle.v1beta1.carrier_booking_bundle_form_input_pb2",
        # @@protoc_insertion_point(class_scope:flexport.oex.carrierbookingbundle.v1beta1.CarrierBookingBundleInput)
    },
)
_sym_db.RegisterMessage(CarrierBookingBundleInput)

CarrierBookingBundleFormInput = _reflection.GeneratedProtocolMessageType(
    "CarrierBookingBundleFormInput",
    (_message.Message,),
    {
        "DESCRIPTOR": _CARRIERBOOKINGBUNDLEFORMINPUT,
        "__module__": "flexport.oex.carrierbookingbundle.v1beta1.carrier_booking_bundle_form_input_pb2",
        # @@protoc_insertion_point(class_scope:flexport.oex.carrierbookingbundle.v1beta1.CarrierBookingBundleFormInput)
    },
)
_sym_db.RegisterMessage(CarrierBookingBundleFormInput)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _BOOKINGCONTENTINPUT._serialized_start = 234
    _BOOKINGCONTENTINPUT._serialized_end = 982
    _BOOKINGINTEGRATIONINPUT._serialized_start = 985
    _BOOKINGINTEGRATIONINPUT._serialized_end = 2751
    _BOOKINGVOYAGEINPUT._serialized_start = 2754
    _BOOKINGVOYAGEINPUT._serialized_end = 3512
    _SHIPPINGORDERINPUT._serialized_start = 3515
    _SHIPPINGORDERINPUT._serialized_end = 4041
    _CARRIERBOOKINGBUNDLEINPUT._serialized_start = 4044
    _CARRIERBOOKINGBUNDLEINPUT._serialized_end = 4899
    _CARRIERBOOKINGBUNDLEFORMINPUT._serialized_start = 4902
    _CARRIERBOOKINGBUNDLEFORMINPUT._serialized_end = 5177
