...
from flexport.operatingprocedures.procedures.v1 import procedure_api_pb2 as flexport_dot_operatingprocedures_dot_procedures_dot_v1_dot_procedure__api__pb2
...
class ProcedureAPI(object):
    ...
    def GetDestinationCoordinationProcedures(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.operatingprocedures.procedures.v1.ProcedureAPI/GetDestinationCoordinationProcedures',
