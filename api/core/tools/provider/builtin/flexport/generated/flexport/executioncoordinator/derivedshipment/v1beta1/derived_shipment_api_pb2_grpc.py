...
from flexport.executioncoordinator.derivedshipment.v1beta1 import derived_shipment_api_pb2 as flexport_dot_executioncoordinator_dot_derivedshipment_dot_v1beta1_dot_derived__shipment__api__pb2


class DerivedShipmentAPIStub(object):
...
class DerivedShipmentAPIServicer(object):
    """An API for interacting with DerivedShipment entities.
    """
...
class DerivedShipmentAPI(object):
    """An API for interacting with DerivedShipment entities.
    """

    @staticmethod
    def GetDerivedShipment(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.executioncoordinator.derivedshipment.v1beta1.DerivedShipmentAPI/GetDerivedShipment',
    ...
    @staticmethod
    def BatchGetDerivedShipmentsByShipmentFids(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.executioncoordinator.derivedshipment.v1beta1.DerivedShipmentAPI/BatchGetDerivedShipmentsByShipmentFids',
    ...
    @staticmethod
    def ListDerivedShipmentRevisions(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.executioncoordinator.derivedshipment.v1beta1.DerivedShipmentAPI/ListDerivedShipmentRevisions',
    ...
    @staticmethod
    def UpsertDerivedShipment(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.executioncoordinator.derivedshipment.v1beta1.DerivedShipmentAPI/UpsertDerivedShipment',
    ...
    @staticmethod
    def DeleteDerivedShipment(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.executioncoordinator.derivedshipment.v1beta1.DerivedShipmentAPI/DeleteDerivedShipment',
