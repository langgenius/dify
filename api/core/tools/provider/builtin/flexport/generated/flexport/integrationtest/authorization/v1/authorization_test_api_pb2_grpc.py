...
from flexport.integrationtest.authorization.v1 import authorization_test_api_pb2 as flexport_dot_integrationtest_dot_authorization_dot_v1_dot_authorization__test__api__pb2


class AuthorizationTestAPIStub(object):
...
class AuthorizationTestAPIServicer(object):
    """The API for authorization integration tests.
    """
...
class AuthorizationTestAPI(object):
    """The API for authorization integration tests.
    """

    @staticmethod
    def ServerInterceptorTestRegular(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.integrationtest.authorization.v1.AuthorizationTestAPI/ServerInterceptorTestRegular',
    ...
    @staticmethod
    def ServerInterceptorNoMandatoryAuth(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.integrationtest.authorization.v1.AuthorizationTestAPI/ServerInterceptorNoMandatoryAuth',
