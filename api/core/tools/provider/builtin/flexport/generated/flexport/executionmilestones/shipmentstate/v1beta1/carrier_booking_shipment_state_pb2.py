...
_CARRIERBOOKINGSHIPMENTSTATE = DESCRIPTOR.message_types_by_name["CarrierBookingShipmentState"]
_CARRIERBOOKINGEXTRACT = DESCRIPTOR.message_types_by_name["CarrierBookingExtract"]
...
CarrierBookingShipmentState = _reflection.GeneratedProtocolMessageType(
    "CarrierBookingShipmentState",
    (_message.Message,),
    {
        "DESCRIPTOR": _CARRIERBOOKINGSHIPMENTSTATE,
        "__module__": "flexport.executionmilestones.shipmentstate.v1beta1.carrier_booking_shipment_state_pb2",
        # @@protoc_insertion_point(class_scope:flexport.executionmilestones.shipmentstate.v1beta1.CarrierBookingShipmentState)
    },
)
_sym_db.RegisterMessage(CarrierBookingShipmentState)

CarrierBookingExtract = _reflection.GeneratedProtocolMessageType(
    "CarrierBookingExtract",
    (_message.Message,),
    {
        "DESCRIPTOR": _CARRIERBOOKINGEXTRACT,
        "__module__": "flexport.executionmilestones.shipmentstate.v1beta1.carrier_booking_shipment_state_pb2",
        # @@protoc_insertion_point(class_scope:flexport.executionmilestones.shipmentstate.v1beta1.CarrierBookingExtract)
    },
)
_sym_db.RegisterMessage(CarrierBookingExtract)
...
ShippingOrder = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "flexport.executionmilestones.shipmentstate.v1beta1.carrier_booking_shipment_state_pb2",
        # @@protoc_insertion_point(class_scope:flexport.executionmilestones.shipmentstate.v1beta1.ShippingOrder)
    },
)
...
CarrierBookingContainerRequest = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "flexport.executionmilestones.shipmentstate.v1beta1.carrier_booking_shipment_state_pb2",
        # @@protoc_insertion_point(class_scope:flexport.executionmilestones.shipmentstate.v1beta1.CarrierBookingContainerRequest)
    },
)
...
BookingContainer = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "flexport.executionmilestones.shipmentstate.v1beta1.carrier_booking_shipment_state_pb2",
        # @@protoc_insertion_point(class_scope:flexport.executionmilestones.shipmentstate.v1beta1.BookingContainer)
    },
)
...
BookingIntegration = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "flexport.executionmilestones.shipmentstate.v1beta1.carrier_booking_shipment_state_pb2",
        # @@protoc_insertion_point(class_scope:flexport.executionmilestones.shipmentstate.v1beta1.BookingIntegration)
    },
)
...
CarrierContract = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "flexport.executionmilestones.shipmentstate.v1beta1.carrier_booking_shipment_state_pb2",
        # @@protoc_insertion_point(class_scope:flexport.executionmilestones.shipmentstate.v1beta1.CarrierContract)
    },
)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _CARRIERBOOKINGEXTRACT.fields_by_name["carrier_booking_container_requests"]._options = None
    _CARRIERBOOKINGEXTRACT.fields_by_name["carrier_booking_container_requests"]._serialized_options = b"\030\001"
    _CARRIERBOOKINGSTATUS._serialized_start = 3070
    _CARRIERBOOKINGSTATUS._serialized_end = 3501
    _CARRIERBOOKINGRELEASESTATUS._serialized_start = 3504
    _CARRIERBOOKINGRELEASESTATUS._serialized_end = 3732
    _CARRIERBOOKINGSHIPMENTSTATE._serialized_start = 245
    _CARRIERBOOKINGSHIPMENTSTATE._serialized_end = 405
    _CARRIERBOOKINGEXTRACT._serialized_start = 408
    _CARRIERBOOKINGEXTRACT._serialized_end = 1988
    _SHIPPINGORDER._serialized_start = 1991
    _SHIPPINGORDER._serialized_end = 2128
    _CARRIERBOOKINGCONTAINERREQUEST._serialized_start = 2130
    _CARRIERBOOKINGCONTAINERREQUEST._serialized_end = 2248
    _BOOKINGCONTAINER._serialized_start = 2250
    _BOOKINGCONTAINER._serialized_end = 2314
    _BOOKINGINTEGRATION._serialized_start = 2317
    _BOOKINGINTEGRATION._serialized_end = 3010
    _BOOKINGINTEGRATION_BOOKINGINTEGRATIONPARTNER._serialized_start = 2506
    _BOOKINGINTEGRATION_BOOKINGINTEGRATIONPARTNER._serialized_end = 2810
    _BOOKINGINTEGRATION_BOOKINGPLACEDEXTERNALLY._serialized_start = 2813
    _BOOKINGINTEGRATION_BOOKINGPLACEDEXTERNALLY._serialized_end = 2963
    _CARRIERCONTRACT._serialized_start = 3012
    _CARRIERCONTRACT._serialized_end = 3067
