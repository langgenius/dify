...
_TRUCKINGDRAYAGEWAREHOUSEVISITTYPECHANGED = DESCRIPTOR.message_types_by_name["TruckingDrayageWarehouseVisitTypeChanged"]
TruckingDrayageWarehouseVisitTypeChanged = _reflection.GeneratedProtocolMessageType(
    "TruckingDrayageWarehouseVisitTypeChanged",
    (_message.Message,),
    {
        "DESCRIPTOR": _TRUCKINGDRAYAGEWAREHOUSEVISITTYPECHANGED,
        "__module__": "flexport.executioncoordinator.executiontaskstateevent.v1.details.trucking_drayage_warehouse_visit_type_changed_pb2",
        # @@protoc_insertion_point(class_scope:flexport.executioncoordinator.executiontaskstateevent.v1.TruckingDrayageWarehouseVisitTypeChanged)
    },
)
_sym_db.RegisterMessage(TruckingDrayageWarehouseVisitTypeChanged)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _TRUCKINGDRAYAGEWAREHOUSEVISITTYPECHANGED._serialized_start = 260
    _TRUCKINGDRAYAGEWAREHOUSEVISITTYPECHANGED._serialized_end = 644
