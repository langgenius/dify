...
import grpc
from flexport.operatingprocedures.procedures.v3beta1 import (
    procedure_api_pb2 as flexport_dot_operatingprocedures_dot_procedures_dot_v3beta1_dot_procedure__api__pb2,
)
...
class ProcedureAPI:
    ...
    @staticmethod
    def GetMultipleClientsFilteredProcedures(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def GetProceduresMatchingShipment(
        request,
        target,
        options=(),
        channel_credentials=None,
