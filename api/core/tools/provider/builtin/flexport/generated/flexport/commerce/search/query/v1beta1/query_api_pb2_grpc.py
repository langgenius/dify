...
from flexport.commerce.search.query.v1beta1 import query_api_pb2 as flexport_dot_commerce_dot_search_dot_query_dot_v1beta1_dot_query__api__pb2
...
class QueryAPI(object):
    ...
    def Query(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.commerce.search.query.v1beta1.QueryAPI/Query',
    ...
    def QueryCollection(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.commerce.search.query.v1beta1.QueryAPI/QueryCollection',
    ...
    def QueryAddresses(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.commerce.search.query.v1beta1.QueryAPI/QueryAddresses',
