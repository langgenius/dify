...
from flexport.monolith.compliance.dangerousgoods.rpc.v1beta1 import document_scraper_shipment_details_api_pb2 as flexport_dot_monolith_dot_compliance_dot_dangerousgoods_dot_rpc_dot_v1beta1_dot_document__scraper__shipment__details__api__pb2


class DocumentScraperShipmentDetailsAPIStub(object):
...
class DocumentScraperShipmentDetailsAPIServicer(object):
    """API for fetching shipment data needed for DocumentScraper screening decisions.
    """
...
class DocumentScraperShipmentDetailsAPI(object):
    """API for fetching shipment data needed for DocumentScraper screening decisions.
    """

    @staticmethod
    def GetDocumentScraperShipmentDetails(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.monolith.compliance.dangerousgoods.rpc.v1beta1.DocumentScraperShipmentDetailsAPI/GetDocumentScraperShipmentDetails',
