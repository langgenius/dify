...
from flexport.compliance.restrictedcountry.rpc.v1beta1 import restricted_country_api_pb2 as flexport_dot_compliance_dot_restrictedcountry_dot_rpc_dot_v1beta1_dot_restricted__country__api__pb2


class RestrictedCountryAPIStub(object):
...
class RestrictedCountryAPIServicer(object):
    """Restricted Country Api.
    """
...
class RestrictedCountryAPI(object):
    """Restricted Country Api.
    """

    @staticmethod
    def GetRestrictedCountryHits(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.compliance.restrictedcountry.rpc.v1beta1.RestrictedCountryAPI/GetRestrictedCountryHits',
    ...
    def UpdateHitStatus(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.compliance.restrictedcountry.rpc.v1beta1.RestrictedCountryAPI/UpdateHitStatus',
