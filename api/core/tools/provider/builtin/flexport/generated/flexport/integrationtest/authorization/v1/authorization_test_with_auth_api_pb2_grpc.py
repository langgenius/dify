...
from flexport.integrationtest.authorization.v1 import authorization_test_with_auth_api_pb2 as flexport_dot_integrationtest_dot_authorization_dot_v1_dot_authorization__test__with__auth__api__pb2


class AuthorizationTestWithAuthAPIStub(object):
...
class AuthorizationTestWithAuthAPIServicer(object):
    """The API for authorization integration tests.
    """
...
class AuthorizationTestWithAuthAPI(object):
    """The API for authorization integration tests.
    """

    @staticmethod
    def ServerInterceptorTestRegularWithAuthCheck(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.integrationtest.authorization.v1.AuthorizationTestWithAuthAPI/ServerInterceptorTestRegularWithAuthCheck',
    ...
    @staticmethod
    def ServerInterceptorNoMandatoryAuthWithAuthCheck(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.integrationtest.authorization.v1.AuthorizationTestWithAuthAPI/ServerInterceptorNoMandatoryAuthWithAuthCheck',
