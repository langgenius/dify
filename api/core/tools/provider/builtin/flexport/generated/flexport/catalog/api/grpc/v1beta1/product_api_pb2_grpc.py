...
from flexport.catalog.api.grpc.v1beta1 import product_api_pb2 as flexport_dot_catalog_dot_api_dot_grpc_dot_v1beta1_dot_product__api__pb2


class ProductEntryAPIStub(object):
...
class ProductEntryAPIServicer(object):
    """Document based product entry based on predefined product schema
    """
...
class ProductEntryAPI(object):
    """Document based product entry based on predefined product schema
    """

    @staticmethod
    def CreateProductEntry(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.catalog.api.grpc.v1beta1.ProductEntryAPI/CreateProductEntry',
    ...
    @staticmethod
    def SearchProductEntries(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.catalog.api.grpc.v1beta1.ProductEntryAPI/SearchProductEntries',
