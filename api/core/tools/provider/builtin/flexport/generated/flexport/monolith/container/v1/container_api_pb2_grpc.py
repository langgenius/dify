...
from flexport.monolith.container.v1 import container_api_pb2 as flexport_dot_monolith_dot_container_dot_v1_dot_container__api__pb2


class ContainerAPIStub(object):
...
class ContainerAPIServicer(object):
    """Retrieve container information from the monolith.
    Note that this only gets static information about a physical container,
    without any shipment specific information.
    """
...
class ContainerAPI(object):
    ...
    def GetContainer(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.monolith.container.v1.ContainerAPI/GetContainer',
    ...
    @staticmethod
    def GetContainerByContainerNumber(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.monolith.container.v1.ContainerAPI/GetContainerByContainerNumber',
    ...
    def CreateContainer(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.monolith.container.v1.ContainerAPI/CreateContainer',
