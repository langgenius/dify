...
_DRAFTBILLENTITY = DESCRIPTOR.message_types_by_name["DraftBillEntity"]
_SOURCEBILLVALUE = DESCRIPTOR.message_types_by_name["SourceBillValue"]
_DRAFTBILLALLOCATIONVALUE = DESCRIPTOR.message_types_by_name["DraftBillAllocationValue"]
_DRAFTBILLITEMVALUE = DESCRIPTOR.message_types_by_name["DraftBillItemValue"]
DraftBillEntity = _reflection.GeneratedProtocolMessageType(
    "DraftBillEntity",
    (_message.Message,),
    {
        "DESCRIPTOR": _DRAFTBILLENTITY,
        "__module__": "flexport.billing.entityevent.v1beta1.draft_bill_entity_pb2",
        # @@protoc_insertion_point(class_scope:flexport.billing.entityevent.v1beta1.DraftBillEntity)
    },
)
_sym_db.RegisterMessage(DraftBillEntity)

SourceBillValue = _reflection.GeneratedProtocolMessageType(
    "SourceBillValue",
    (_message.Message,),
    {
        "DESCRIPTOR": _SOURCEBILLVALUE,
        "__module__": "flexport.billing.entityevent.v1beta1.draft_bill_entity_pb2",
        # @@protoc_insertion_point(class_scope:flexport.billing.entityevent.v1beta1.SourceBillValue)
    },
)
_sym_db.RegisterMessage(SourceBillValue)

DraftBillAllocationValue = _reflection.GeneratedProtocolMessageType(
    "DraftBillAllocationValue",
    (_message.Message,),
    {
        "DESCRIPTOR": _DRAFTBILLALLOCATIONVALUE,
        "__module__": "flexport.billing.entityevent.v1beta1.draft_bill_entity_pb2",
        # @@protoc_insertion_point(class_scope:flexport.billing.entityevent.v1beta1.DraftBillAllocationValue)
    },
)
_sym_db.RegisterMessage(DraftBillAllocationValue)

DraftBillItemValue = _reflection.GeneratedProtocolMessageType(
    "DraftBillItemValue",
    (_message.Message,),
    {
        "DESCRIPTOR": _DRAFTBILLITEMVALUE,
        "__module__": "flexport.billing.entityevent.v1beta1.draft_bill_entity_pb2",
        # @@protoc_insertion_point(class_scope:flexport.billing.entityevent.v1beta1.DraftBillItemValue)
    },
)
_sym_db.RegisterMessage(DraftBillItemValue)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _DRAFTBILLENTITY.fields_by_name["has_conflicts"]._options = None
    _DRAFTBILLENTITY.fields_by_name["has_conflicts"]._serialized_options = b"\030\001"
    _DRAFTBILLENTITY._serialized_start = 219
    _DRAFTBILLENTITY._serialized_end = 1024
    _SOURCEBILLVALUE._serialized_start = 1027
    _SOURCEBILLVALUE._serialized_end = 1235
    _DRAFTBILLALLOCATIONVALUE._serialized_start = 1238
    _DRAFTBILLALLOCATIONVALUE._serialized_end = 1593
    _DRAFTBILLITEMVALUE._serialized_start = 1596
    _DRAFTBILLITEMVALUE._serialized_end = 1840
