...
_PARTYDETAIL = DESCRIPTOR.message_types_by_name["PartyDetail"]
PartyDetail = _reflection.GeneratedProtocolMessageType(
    "PartyDetail",
    (_message.Message,),
    {
        "DESCRIPTOR": _PARTYDETAIL,
        "__module__": "flexport.compliance.entityevent.v1beta1.party_detail_pb2",
        # @@protoc_insertion_point(class_scope:flexport.compliance.entityevent.v1beta1.PartyDetail)
    },
)
_sym_db.RegisterMessage(PartyDetail)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _PARTYDETAIL._serialized_start = 282
    _PARTYDETAIL._serialized_end = 534
