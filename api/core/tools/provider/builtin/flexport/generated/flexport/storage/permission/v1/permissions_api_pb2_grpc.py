...
import grpc
from flexport.storage.permission.v1 import (
    permissions_api_pb2 as flexport_dot_storage_dot_permission_dot_v1_dot_permissions__api__pb2,
)


class PermissionsAPIStub:
