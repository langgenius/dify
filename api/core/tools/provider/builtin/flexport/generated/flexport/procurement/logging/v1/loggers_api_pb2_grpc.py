...
from flexport.procurement.logging.v1 import loggers_api_pb2 as flexport_dot_procurement_dot_logging_dot_v1_dot_loggers__api__pb2


class LoggersAPIStub(object):
...
class LoggersAPIServicer(object):
    """Logging configuration API for NIS Procurement Service.
    """
...
class LoggersAPI(object):
    """Logging configuration API for NIS Procurement Service.
    """

    @staticmethod
    def GetLoggerLevels(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.procurement.logging.v1.LoggersAPI/GetLoggerLevels',
    ...
    @staticmethod
    def ConfigureLoggerLevels(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.procurement.logging.v1.LoggersAPI/ConfigureLoggerLevels',
