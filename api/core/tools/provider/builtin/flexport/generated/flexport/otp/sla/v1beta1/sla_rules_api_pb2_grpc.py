...
class SlaRulesAPIServicer(object):
    """API to get OTE from rules engine for trucking.
    """
...
def add_SlaRulesAPIServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'flexport.otp.sla.v1beta1.SlaRulesAPI', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class SlaRulesAPI(object):
    """API to get OTE from rules engine for trucking.
    """

    @staticmethod
    def GetAirSla(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.otp.sla.v1beta1.SlaRulesAPI/GetAirSla',
    ...
    def GetOceanSla(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.otp.sla.v1beta1.SlaRulesAPI/GetOceanSla',
    ...
    def GetTruckingSla(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.otp.sla.v1beta1.SlaRulesAPI/GetTruckingSla',
