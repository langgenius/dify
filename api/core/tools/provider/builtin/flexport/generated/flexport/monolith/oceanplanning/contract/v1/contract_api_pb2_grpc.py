...
import grpc
from flexport.monolith.oceanplanning.contract.v1 import (
    contract_api_pb2 as flexport_dot_monolith_dot_oceanplanning_dot_contract_dot_v1_dot_contract__api__pb2,
)


class ContractAPIStub:
