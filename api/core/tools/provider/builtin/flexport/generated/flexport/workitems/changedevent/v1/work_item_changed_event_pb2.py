...
_WORKITEMCHANGEDEVENT = DESCRIPTOR.message_types_by_name["WorkItemChangedEvent"]
_WORKITEMINFO = DESCRIPTOR.message_types_by_name["WorkItemInfo"]
WorkItemChangedEvent = _reflection.GeneratedProtocolMessageType(
    "WorkItemChangedEvent",
    (_message.Message,),
    {
        "DESCRIPTOR": _WORKITEMCHANGEDEVENT,
        "__module__": "flexport.workitems.changedevent.v1.work_item_changed_event_pb2",
        # @@protoc_insertion_point(class_scope:flexport.workitems.changedevent.v1.WorkItemChangedEvent)
    },
)
_sym_db.RegisterMessage(WorkItemChangedEvent)
...
WorkItemInfo = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "flexport.workitems.changedevent.v1.work_item_changed_event_pb2",
        # @@protoc_insertion_point(class_scope:flexport.workitems.changedevent.v1.WorkItemInfo)
    },
)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _WORKITEMCHANGEDEVENT._serialized_start = 165
    _WORKITEMCHANGEDEVENT._serialized_end = 411
    _WORKITEMINFO._serialized_start = 413
    _WORKITEMINFO._serialized_end = 486
