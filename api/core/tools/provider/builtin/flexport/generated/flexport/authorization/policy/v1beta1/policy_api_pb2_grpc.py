...
from flexport.authorization.policy.v1beta1 import policy_api_pb2 as flexport_dot_authorization_dot_policy_dot_v1beta1_dot_policy__api__pb2
...
class PolicyAPI(object):
    ...
    @staticmethod
    def GetAllNonObjectLevelRolePermissions(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.authorization.policy.v1beta1.PolicyAPI/GetAllNonObjectLevelRolePermissions',
