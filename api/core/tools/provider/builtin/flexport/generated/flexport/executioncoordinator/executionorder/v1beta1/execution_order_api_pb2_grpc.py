...
from flexport.executioncoordinator.executionorder.v1beta1 import execution_order_api_pb2 as flexport_dot_executioncoordinator_dot_executionorder_dot_v1beta1_dot_execution__order__api__pb2


class ExecutionOrderAPIStub(object):
...
class ExecutionOrderAPIServicer(object):
    """define beta version EO APIs
    """
...
class ExecutionOrderAPI(object):
    """define beta version EO APIs
    """

    @staticmethod
    def CreateExecutionOrder(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.executioncoordinator.executionorder.v1beta1.ExecutionOrderAPI/CreateExecutionOrder',
    ...
    @staticmethod
    def UpdateExecutionOrderStatus(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.executioncoordinator.executionorder.v1beta1.ExecutionOrderAPI/UpdateExecutionOrderStatus',
