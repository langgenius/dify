...
_SERVICENOTCOSTEDEVENT = DESCRIPTOR.message_types_by_name["ServiceNotCostedEvent"]
ServiceNotCostedEvent = _reflection.GeneratedProtocolMessageType(
    "ServiceNotCostedEvent",
    (_message.Message,),
    {
        "DESCRIPTOR": _SERVICENOTCOSTEDEVENT,
        "__module__": "flexport.financialvisibility.servicenotcostedevent.v1beta1.service_not_costed_event_pb2",
        # @@protoc_insertion_point(class_scope:flexport.financialvisibility.servicenotcostedevent.v1beta1.ServiceNotCostedEvent)
    },
)
_sym_db.RegisterMessage(ServiceNotCostedEvent)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _SERVICENOTCOSTEDEVENT._serialized_start = 285
    _SERVICENOTCOSTEDEVENT._serialized_end = 708
