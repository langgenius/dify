...
_VALUEADDEDEXECUTIONOFFERINGS = DESCRIPTOR.message_types_by_name["ValueAddedExecutionOfferings"]
ValueAddedExecutionOfferings = _reflection.GeneratedProtocolMessageType(
    "ValueAddedExecutionOfferings",
    (_message.Message,),
    {
        "DESCRIPTOR": _VALUEADDEDEXECUTIONOFFERINGS,
        "__module__": "flexport.executioncoordinator.executionoffering.v1.value_added_execution_offerings_pb2",
        # @@protoc_insertion_point(class_scope:flexport.executioncoordinator.executionoffering.v1.ValueAddedExecutionOfferings)
    },
)
_sym_db.RegisterMessage(ValueAddedExecutionOfferings)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _VALUEADDEDEXECUTIONOFFERINGS._serialized_start = 658
    _VALUEADDEDEXECUTIONOFFERINGS._serialized_end = 1224
