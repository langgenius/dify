...
import grpc
from flexport.freightinvoice.invoicingsop.v1beta1 import (
    invoicing_sop_api_pb2 as flexport_dot_freightinvoice_dot_invoicingsop_dot_v1beta1_dot_invoicing__sop__api__pb2,
)


class InvoicingSopAPIStub:
