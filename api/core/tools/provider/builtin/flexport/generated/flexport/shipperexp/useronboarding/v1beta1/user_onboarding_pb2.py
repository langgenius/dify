...
_USERONBOARDINGSUBMITTED = DESCRIPTOR.message_types_by_name["UserOnboardingSubmitted"]
UserOnboardingSubmitted = _reflection.GeneratedProtocolMessageType(
    "UserOnboardingSubmitted",
    (_message.Message,),
    {
        "DESCRIPTOR": _USERONBOARDINGSUBMITTED,
        "__module__": "flexport.shipperexp.useronboarding.v1beta1.user_onboarding_pb2",
        # @@protoc_insertion_point(class_scope:flexport.shipperexp.useronboarding.v1beta1.UserOnboardingSubmitted)
    },
)
_sym_db.RegisterMessage(UserOnboardingSubmitted)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _USERONBOARDINGSUBMITTED._serialized_start = 285
    _USERONBOARDINGSUBMITTED._serialized_end = 568
