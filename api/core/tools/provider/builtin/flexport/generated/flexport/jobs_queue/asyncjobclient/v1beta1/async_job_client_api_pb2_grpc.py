...
import grpc
from flexport.jobs_queue.asyncjobclient.v1beta1 import (
    async_job_client_api_pb2 as flexport_dot_jobs__queue_dot_asyncjobclient_dot_v1beta1_dot_async__job__client__api__pb2,
)


class AsyncJobClientAPIStub:
...
class AsyncJobClientAPIServicer:
    """The protocol for handling async jobs that were callback'ed from the jobs queue server.
    All gRPC services that want to make async jobs with jobs queue, should set up these
    rpc endpoints.
