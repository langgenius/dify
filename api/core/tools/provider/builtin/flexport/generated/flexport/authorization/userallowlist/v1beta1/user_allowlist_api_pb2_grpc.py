...
import grpc
from flexport.authorization.userallowlist.v1beta1 import (
    user_allowlist_api_pb2 as flexport_dot_authorization_dot_userallowlist_dot_v1beta1_dot_user__allowlist__api__pb2,
)


class UserAllowlistAPIStub:
...
class UserAllowlistAPIServicer:
    """The gRPC API for http://go/user-allowlists."""
...
class UserAllowlistAPI:
    """The gRPC API for http://go/user-allowlists."""

    @staticmethod
    def HasAccessToService(
        request,
        target,
        options=(),
