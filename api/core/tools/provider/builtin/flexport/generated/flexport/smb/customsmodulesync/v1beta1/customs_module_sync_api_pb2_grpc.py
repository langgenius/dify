...
import grpc
from flexport.smb.customsmodulesync.v1beta1 import (
    customs_module_sync_api_pb2 as flexport_dot_smb_dot_customsmodulesync_dot_v1beta1_dot_customs__module__sync__api__pb2,
)


class CustomsModuleSyncAPIStub:
...
class CustomsModuleSyncAPIServicer:
    """This service syncs and retrieves data from core."""
...
class CustomsModuleSyncAPI:
    """This service syncs and retrieves data from core."""

    @staticmethod
    def SendCustomsBondData(
        request,
        target,
        options=(),
    ...
    @staticmethod
    def SendCustomsInformationData(
        request,
        target,
        options=(),
        channel_credentials=None,
