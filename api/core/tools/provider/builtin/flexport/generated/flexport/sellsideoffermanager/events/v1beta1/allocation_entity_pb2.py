...
_ALLOCATIONENTITY = DESCRIPTOR.message_types_by_name["AllocationEntity"]
AllocationEntity = _reflection.GeneratedProtocolMessageType(
    "AllocationEntity",
    (_message.Message,),
    {
        "DESCRIPTOR": _ALLOCATIONENTITY,
        "__module__": "flexport.sellsideoffermanager.events.v1beta1.allocation_entity_pb2",
        # @@protoc_insertion_point(class_scope:flexport.sellsideoffermanager.events.v1beta1.AllocationEntity)
    },
)
_sym_db.RegisterMessage(AllocationEntity)

if _descriptor._USE_C_DESCRIPTORS == False:
    DESCRIPTOR._options = None
    _ALLOCATIONENTITY._serialized_start = 184
    _ALLOCATIONENTITY._serialized_end = 1097
