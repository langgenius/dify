...
from flexport.shipmentplanner.solve.v1beta1 import solve_api_pb2 as flexport_dot_shipmentplanner_dot_solve_dot_v1beta1_dot_solve__api__pb2


class SolveAPIStub(object):
...
class SolveAPI(object):
    """Missing associated documentation comment in .proto file."""

    @staticmethod
    def GetLCLShipmentRouteOptions(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.shipmentplanner.solve.v1beta1.SolveAPI/GetLCLShipmentRouteOptions',
    ...
    @staticmethod
    def PublishLCLShipmentRouteSolution(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.shipmentplanner.solve.v1beta1.SolveAPI/PublishLCLShipmentRouteSolution',
