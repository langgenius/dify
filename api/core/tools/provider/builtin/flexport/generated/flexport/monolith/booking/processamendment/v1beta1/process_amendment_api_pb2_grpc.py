...
import grpc
from flexport.monolith.booking.processamendment.v1beta1 import (
    process_amendment_api_pb2 as flexport_dot_monolith_dot_booking_dot_processamendment_dot_v1beta1_dot_process__amendment__api__pb2,
)


class ProcessAmendmentAPIStub:
...
class ProcessAmendmentAPIServicer:
    """This service is used internally for the booking service to send a message to core
    to apply or reject a booking amendment.
    """
...
class ProcessAmendmentAPI:
    ...
    @staticmethod
    def CreateApprovalNeededActionItem(
        request,
        target,
        options=(),
        channel_credentials=None,
