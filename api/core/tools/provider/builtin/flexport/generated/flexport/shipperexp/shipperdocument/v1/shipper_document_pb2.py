...
_SHIPPERDOCUMENT = DESCRIPTOR.message_types_by_name["ShipperDocument"]
_SHIPPERDOCUMENTCONTENT = DESCRIPTOR.message_types_by_name["ShipperDocumentContent"]
ShipperDocument = _reflection.GeneratedProtocolMessageType(
    "ShipperDocument",
    (_message.Message,),
    {
        "DESCRIPTOR": _SHIPPERDOCUMENT,
        "__module__": "flexport.shipperexp.shipperdocument.v1.shipper_document_pb2",
        # @@protoc_insertion_point(class_scope:flexport.shipperexp.shipperdocument.v1.ShipperDocument)
    },
)
_sym_db.RegisterMessage(ShipperDocument)

ShipperDocumentContent = _reflection.GeneratedProtocolMessageType(
    "ShipperDocumentContent",
    (_message.Message,),
    {
        "DESCRIPTOR": _SHIPPERDOCUMENTCONTENT,
        "__module__": "flexport.shipperexp.shipperdocument.v1.shipper_document_pb2",
        # @@protoc_insertion_point(class_scope:flexport.shipperexp.shipperdocument.v1.ShipperDocumentContent)
    },
)
_sym_db.RegisterMessage(ShipperDocumentContent)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _SHIPPERDOCUMENT._serialized_start = 189
    _SHIPPERDOCUMENT._serialized_end = 322
    _SHIPPERDOCUMENTCONTENT._serialized_start = 325
    _SHIPPERDOCUMENTCONTENT._serialized_end = 1423
