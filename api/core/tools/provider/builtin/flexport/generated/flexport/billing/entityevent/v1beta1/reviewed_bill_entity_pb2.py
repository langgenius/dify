...
_REVIEWEDBILLENTITY = DESCRIPTOR.message_types_by_name["ReviewedBillEntity"]
_REVIEWEDBILLALLOCATIONVALUE = DESCRIPTOR.message_types_by_name["ReviewedBillAllocationValue"]
_REVIEWEDBILLITEMVALUE = DESCRIPTOR.message_types_by_name["ReviewedBillItemValue"]
ReviewedBillEntity = _reflection.GeneratedProtocolMessageType(
    "ReviewedBillEntity",
    (_message.Message,),
    {
        "DESCRIPTOR": _REVIEWEDBILLENTITY,
        "__module__": "flexport.billing.entityevent.v1beta1.reviewed_bill_entity_pb2",
        # @@protoc_insertion_point(class_scope:flexport.billing.entityevent.v1beta1.ReviewedBillEntity)
    },
)
_sym_db.RegisterMessage(ReviewedBillEntity)

ReviewedBillAllocationValue = _reflection.GeneratedProtocolMessageType(
    "ReviewedBillAllocationValue",
    (_message.Message,),
    {
        "DESCRIPTOR": _REVIEWEDBILLALLOCATIONVALUE,
        "__module__": "flexport.billing.entityevent.v1beta1.reviewed_bill_entity_pb2",
        # @@protoc_insertion_point(class_scope:flexport.billing.entityevent.v1beta1.ReviewedBillAllocationValue)
    },
)
_sym_db.RegisterMessage(ReviewedBillAllocationValue)

ReviewedBillItemValue = _reflection.GeneratedProtocolMessageType(
    "ReviewedBillItemValue",
    (_message.Message,),
    {
        "DESCRIPTOR": _REVIEWEDBILLITEMVALUE,
        "__module__": "flexport.billing.entityevent.v1beta1.reviewed_bill_entity_pb2",
        # @@protoc_insertion_point(class_scope:flexport.billing.entityevent.v1beta1.ReviewedBillItemValue)
    },
)
_sym_db.RegisterMessage(ReviewedBillItemValue)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _REVIEWEDBILLENTITY._serialized_start = 222
    _REVIEWEDBILLENTITY._serialized_end = 934
    _REVIEWEDBILLALLOCATIONVALUE._serialized_start = 937
    _REVIEWEDBILLALLOCATIONVALUE._serialized_end = 1298
    _REVIEWEDBILLITEMVALUE._serialized_start = 1301
    _REVIEWEDBILLITEMVALUE._serialized_end = 1548
