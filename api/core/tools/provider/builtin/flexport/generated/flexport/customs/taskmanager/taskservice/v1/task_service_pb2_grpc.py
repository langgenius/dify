...
import grpc
from flexport.customs.taskmanager.taskservice.v1 import (
    task_service_pb2 as flexport_dot_customs_dot_taskmanager_dot_taskservice_dot_v1_dot_task__service__pb2,
)


class TaskServiceAPIStub:
