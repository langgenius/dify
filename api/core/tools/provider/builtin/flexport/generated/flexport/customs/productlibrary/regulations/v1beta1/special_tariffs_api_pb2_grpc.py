...
from flexport.customs.productlibrary.regulations.v1beta1 import (
    special_tariffs_api_pb2 as flexport_dot_customs_dot_productlibrary_dot_regulations_dot_v1beta1_dot_special__tariffs__api__pb2,
)


class SpecialTariffsAPIStub:
...
class SpecialTariffsAPIServicer:
    """Service that provides Special Tariffs for given HS code/s."""
...
class SpecialTariffsAPI:
    """Service that provides Special Tariffs for given HS code/s."""

    @staticmethod
    def GetSpecialTariffsForHsCode(
        request,
        target,
        options=(),
    ...
    @staticmethod
    def BatchListSpecialTariffsForHsCodes(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def UpdateSpecialTariffCodeCache(
        request,
        target,
        options=(),
        channel_credentials=None,
