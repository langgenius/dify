...
from flexport.authorization.grant.v2 import grant_api_pb2 as flexport_dot_authorization_dot_grant_dot_v2_dot_grant__api__pb2
...
class GrantAPI(object):
    ...
    def CreateRoleGrant(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.authorization.grant.v2.GrantAPI/CreateRoleGrant',
    ...
    def GetRoleGrants(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.authorization.grant.v2.GrantAPI/GetRoleGrants',
    ...
    def RevokeRoleGrant(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.authorization.grant.v2.GrantAPI/RevokeRoleGrant',
    ...
    def GetRolesForApp(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.authorization.grant.v2.GrantAPI/GetRolesForApp',
    ...
    @staticmethod
    def ListRoleGrantsForRole(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/flexport.authorization.grant.v2.GrantAPI/ListRoleGrantsForRole',
