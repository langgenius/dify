...
import grpc
from flexport.quoting.quote.v1beta1 import (
    quote_api_pb2 as flexport_dot_quoting_dot_quote_dot_v1beta1_dot_quote__api__pb2,
)
...
class QuoteAPI:
    ...
    @staticmethod
    def GetQuotesJsonByShipmentFid(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def ListShipmentsWithActiveAllocations(
        request,
        target,
        options=(),
        channel_credentials=None,
