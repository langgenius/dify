...
from flexport.carriershippingdoc.kinesiseventpublisher.v1beta1 import kinesis_event_publisher_api_pb2 as flexport_dot_carriershippingdoc_dot_kinesiseventpublisher_dot_v1beta1_dot_kinesis__event__publisher__api__pb2


class KinesisEventPublisherAPIStub(object):
...
class KinesisEventPublisherAPIServicer(object):
    """Missing associated documentation comment in .proto file."""
...
class KinesisEventPublisherAPI(object):
    """Missing associated documentation comment in .proto file."""

    @staticmethod
    def PublishOceanFreightReleaseReceivedEtse(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.carriershippingdoc.kinesiseventpublisher.v1beta1.KinesisEventPublisherAPI/PublishOceanFreightReleaseReceivedEtse',
