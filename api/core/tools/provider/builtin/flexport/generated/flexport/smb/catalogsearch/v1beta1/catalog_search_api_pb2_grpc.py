...
from flexport.smb.catalogsearch.v1beta1 import catalog_search_api_pb2 as flexport_dot_smb_dot_catalogsearch_dot_v1beta1_dot_catalog__search__api__pb2


class CatalogSearchAPIStub(object):
...
class CatalogSearchAPIServicer(object):
    """Public Catalog Search API used by SMB marketplace apps.
    """
...
class CatalogSearchAPI(object):
    """Public Catalog Search API used by SMB marketplace apps.
    """

    @staticmethod
    def CatalogSearch(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.smb.catalogsearch.v1beta1.CatalogSearchAPI/CatalogSearch',
