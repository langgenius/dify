...
from flexport.smb.smbbooking.v1beta1 import smb_booking_api_pb2 as flexport_dot_smb_dot_smbbooking_dot_v1beta1_dot_smb__booking__api__pb2


class SmbBookingAPIStub(object):
...
class SmbBookingAPIServicer(object):
    """API for SmbBooking data
    """
...
class SmbBookingAPI(object):
    """API for SmbBooking data
    """

    @staticmethod
    def GetSmbBooking(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.smb.smbbooking.v1beta1.SmbBookingAPI/GetSmbBooking',
    ...
    @staticmethod
    def ListSmbBookingsByClient(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.smb.smbbooking.v1beta1.SmbBookingAPI/ListSmbBookingsByClient',
