...
from flexport.smb.onboarding.v1beta1 import onboarding_api_pb2 as flexport_dot_smb_dot_onboarding_dot_v1beta1_dot_onboarding__api__pb2
...
class OnboardingAPI(object):
    ...
    @staticmethod
    def CreateOnboardingRegistration(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.smb.onboarding.v1beta1.OnboardingAPI/CreateOnboardingRegistration',
    ...
    def TriggerOnboarding(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.smb.onboarding.v1beta1.OnboardingAPI/TriggerOnboarding',
