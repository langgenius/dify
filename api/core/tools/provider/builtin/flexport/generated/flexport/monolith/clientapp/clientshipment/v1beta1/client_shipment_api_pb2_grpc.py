...
import grpc
from flexport.monolith.clientapp.clientshipment.v1beta1 import (
    client_shipment_api_pb2 as flexport_dot_monolith_dot_clientapp_dot_clientshipment_dot_v1beta1_dot_client__shipment__api__pb2,
)


class ClientShipmentAPIStub:
...
class ClientShipmentAPIServicer:
    """This API sync the client shipment data back to monorail."""
...
class ClientShipmentAPI:
    """This API sync the client shipment data back to monorail."""

    @staticmethod
    def UpsertClientShipmentFidCache(
        request,
        target,
        options=(),
