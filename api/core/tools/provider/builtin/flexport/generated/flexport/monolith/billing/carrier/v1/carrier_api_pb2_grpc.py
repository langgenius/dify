...
from flexport.monolith.billing.carrier.v1 import carrier_api_pb2 as flexport_dot_monolith_dot_billing_dot_carrier_dot_v1_dot_carrier__api__pb2
...
class CarrierAPI(object):
    ...
    def GetCarrier(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.monolith.billing.carrier.v1.CarrierAPI/GetCarrier',
    ...
    @staticmethod
    def GetCarrierBillingSources(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.monolith.billing.carrier.v1.CarrierAPI/GetCarrierBillingSources',
