...
def add_RateAPIServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'flexport.catalog.rate.v1.RateAPI', rpc_method_handlers)
...
class RateAPI(object):
    ...
    def EvaluateRates(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.catalog.rate.v1.RateAPI/EvaluateRates',
    ...
    def CalculateSellRate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.catalog.rate.v1.RateAPI/CalculateSellRate',
