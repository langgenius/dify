...
_IMPORTDECLARATIONITEM = DESCRIPTOR.message_types_by_name["ImportDeclarationItem"]
_ADDITIONALREFERENCE = DESCRIPTOR.message_types_by_name["AdditionalReference"]
_TAXCALCULATION = DESCRIPTOR.message_types_by_name["TaxCalculation"]
_PACKAGING = DESCRIPTOR.message_types_by_name["Packaging"]
_IMPORTDECLARATIONITEM_VALUATIONMETHOD = _IMPORTDECLARATIONITEM.enum_types_by_name["ValuationMethod"]
_TAXCALCULATION_METHODOFPAYMENT = _TAXCALCULATION.enum_types_by_name["MethodOfPayment"]
ImportDeclarationItem = _reflection.GeneratedProtocolMessageType(
    "ImportDeclarationItem",
    (_message.Message,),
    {
        "DESCRIPTOR": _IMPORTDECLARATIONITEM,
        "__module__": "flexport.customs.declaration.gb.v1beta1.import_declaration_item_pb2",
        # @@protoc_insertion_point(class_scope:flexport.customs.declaration.gb.v1beta1.ImportDeclarationItem)
    },
)
_sym_db.RegisterMessage(ImportDeclarationItem)
...
AdditionalReference = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "flexport.customs.declaration.gb.v1beta1.import_declaration_item_pb2",
        # @@protoc_insertion_point(class_scope:flexport.customs.declaration.gb.v1beta1.AdditionalReference)
    },
)
_sym_db.RegisterMessage(AdditionalReference)

TaxCalculation = _reflection.GeneratedProtocolMessageType(
    "TaxCalculation",
    (_message.Message,),
    {
        "DESCRIPTOR": _TAXCALCULATION,
        "__module__": "flexport.customs.declaration.gb.v1beta1.import_declaration_item_pb2",
        # @@protoc_insertion_point(class_scope:flexport.customs.declaration.gb.v1beta1.TaxCalculation)
    },
)
_sym_db.RegisterMessage(TaxCalculation)

Packaging = _reflection.GeneratedProtocolMessageType(
    "Packaging",
    (_message.Message,),
    {
        "DESCRIPTOR": _PACKAGING,
        "__module__": "flexport.customs.declaration.gb.v1beta1.import_declaration_item_pb2",
        # @@protoc_insertion_point(class_scope:flexport.customs.declaration.gb.v1beta1.Packaging)
    },
)
_sym_db.RegisterMessage(Packaging)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _IMPORTDECLARATIONITEM._serialized_start = 526
    _IMPORTDECLARATIONITEM._serialized_end = 3142
    _IMPORTDECLARATIONITEM_VALUATIONMETHOD._serialized_start = 2753
    _IMPORTDECLARATIONITEM_VALUATIONMETHOD._serialized_end = 3050
    _ADDITIONALREFERENCE._serialized_start = 3145
    _ADDITIONALREFERENCE._serialized_end = 3388
    _TAXCALCULATION._serialized_start = 3391
    _TAXCALCULATION._serialized_end = 3989
    _TAXCALCULATION_METHODOFPAYMENT._serialized_start = 3510
    _TAXCALCULATION_METHODOFPAYMENT._serialized_end = 3983
    _PACKAGING._serialized_start = 3992
    _PACKAGING._serialized_end = 4131
