...
_AUDITFEEDBACK = DESCRIPTOR.message_types_by_name["AuditFeedback"]
DocumentDigitization = _reflection.GeneratedProtocolMessageType(
    "DocumentDigitization",
    (_message.Message,),
    {
        "DESCRIPTOR": _DOCUMENTDIGITIZATION,
        "__module__": "flexport.documentflow.documentdigitization.v1beta1.document_digitization_pb2",
        # @@protoc_insertion_point(class_scope:flexport.documentflow.documentdigitization.v1beta1.DocumentDigitization)
    },
)
...
ChangeLog = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "flexport.documentflow.documentdigitization.v1beta1.document_digitization_pb2",
        # @@protoc_insertion_point(class_scope:flexport.documentflow.documentdigitization.v1beta1.ChangeLog)
    },
)
_sym_db.RegisterMessage(ChangeLog)

AuditFeedback = _reflection.GeneratedProtocolMessageType(
    "AuditFeedback",
    (_message.Message,),
    {
        "DESCRIPTOR": _AUDITFEEDBACK,
        "__module__": "flexport.documentflow.documentdigitization.v1beta1.document_digitization_pb2",
        # @@protoc_insertion_point(class_scope:flexport.documentflow.documentdigitization.v1beta1.AuditFeedback)
    },
)
_sym_db.RegisterMessage(AuditFeedback)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _DOCUMENTDIGITIZATION._serialized_start = 586
    _DOCUMENTDIGITIZATION._serialized_end = 1278
    _CHANGELOG._serialized_start = 1281
    _CHANGELOG._serialized_end = 1750
    _AUDITFEEDBACK._serialized_start = 1753
    _AUDITFEEDBACK._serialized_end = 2117
