...
from flexport.finance_platform.shipment_hold.v1beta1 import shipment_hold_api_pb2 as flexport_dot_finance__platform_dot_shipment__hold_dot_v1beta1_dot_shipment__hold__api__pb2


class ShipmentHoldAPIStub(object):
...
class ShipmentHoldAPIServicer(object):
    """API to retrieve a shipment's financial hold reasons.
    """
...
class ShipmentHoldAPI(object):
    """API to retrieve a shipment's financial hold reasons.
    """

    @staticmethod
    def GetShipmentHold(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.finance_platform.shipment_hold.v1beta1.ShipmentHoldAPI/GetShipmentHold',
