...
import grpc
from flexport.authorization.retriever.v1beta1 import (
    retriever_api_pb2 as flexport_dot_authorization_dot_retriever_dot_v1beta1_dot_retriever__api__pb2,
)


class RetrieverAPIStub:
...
class RetrieverAPI:
    ...
    @staticmethod
    def FilterResourcesForOperation(
        request,
        target,
        options=(),
        channel_credentials=None,
