...
from flexport.booking.errhandler.v1beta1 import error_handler_api_pb2 as flexport_dot_booking_dot_errhandler_dot_v1beta1_dot_error__handler__api__pb2


class ErrorHandlerAPIStub(object):
...
class ErrorHandlerAPIServicer(object):
    """We need to expose a http endpoint for the frontend of kotlin error handler to get data.
    """
...
class ErrorHandlerAPI(object):
    ...
    def ListBlockedEvents(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.booking.errhandler.v1beta1.ErrorHandlerAPI/ListBlockedEvents',
