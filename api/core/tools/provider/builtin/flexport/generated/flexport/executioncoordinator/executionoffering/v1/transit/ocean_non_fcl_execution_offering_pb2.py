...
_OCEANNONFCLROLE = DESCRIPTOR.enum_types_by_name["OceanNonFclRole"]
OceanNonFclRole = enum_type_wrapper.EnumTypeWrapper(_OCEANNONFCLROLE)
_OCEANNONFCLBOUNDARY = DESCRIPTOR.enum_types_by_name["OceanNonFclBoundary"]
OceanNonFclBoundary = enum_type_wrapper.EnumTypeWrapper(_OCEANNONFCLBOUNDARY)
...
_OCEANNONFCLEXECUTIONOFFERING = DESCRIPTOR.message_types_by_name["OceanNonFclExecutionOffering"]
_OCEANNONFCLFULLSERVICEINFO = DESCRIPTOR.message_types_by_name["OceanNonFclFullServiceInfo"]
...
_OCEANNONFCLSPECIFICROUTE = DESCRIPTOR.message_types_by_name["OceanNonFclSpecificRoute"]
OceanNonFclExecutionOffering = _reflection.GeneratedProtocolMessageType(
    "OceanNonFclExecutionOffering",
    (_message.Message,),
    {
        "DESCRIPTOR": _OCEANNONFCLEXECUTIONOFFERING,
        "__module__": "flexport.executioncoordinator.executionoffering.v1.transit.ocean_non_fcl_execution_offering_pb2",
        # @@protoc_insertion_point(class_scope:flexport.executioncoordinator.executionoffering.v1.OceanNonFclExecutionOffering)
    },
)
_sym_db.RegisterMessage(OceanNonFclExecutionOffering)

OceanNonFclFullServiceInfo = _reflection.GeneratedProtocolMessageType(
    "OceanNonFclFullServiceInfo",
    (_message.Message,),
    {
        "DESCRIPTOR": _OCEANNONFCLFULLSERVICEINFO,
        "__module__": "flexport.executioncoordinator.executionoffering.v1.transit.ocean_non_fcl_execution_offering_pb2",
        # @@protoc_insertion_point(class_scope:flexport.executioncoordinator.executionoffering.v1.OceanNonFclFullServiceInfo)
    },
)
_sym_db.RegisterMessage(OceanNonFclFullServiceInfo)
...
OceanNonFclTransitTime = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "flexport.executioncoordinator.executionoffering.v1.transit.ocean_non_fcl_execution_offering_pb2",
        # @@protoc_insertion_point(class_scope:flexport.executioncoordinator.executionoffering.v1.OceanNonFclTransitTime)
    },
)
...
OceanNonFcLOteMilestones = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "flexport.executioncoordinator.executionoffering.v1.transit.ocean_non_fcl_execution_offering_pb2",
        # @@protoc_insertion_point(class_scope:flexport.executioncoordinator.executionoffering.v1.OceanNonFcLOteMilestones)
    },
)
_sym_db.RegisterMessage(OceanNonFcLOteMilestones)

OceanNonFclSpecificRoute = _reflection.GeneratedProtocolMessageType(
    "OceanNonFclSpecificRoute",
    (_message.Message,),
    {
        "DESCRIPTOR": _OCEANNONFCLSPECIFICROUTE,
        "__module__": "flexport.executioncoordinator.executionoffering.v1.transit.ocean_non_fcl_execution_offering_pb2",
        # @@protoc_insertion_point(class_scope:flexport.executioncoordinator.executionoffering.v1.OceanNonFclSpecificRoute)
    },
)
_sym_db.RegisterMessage(OceanNonFclSpecificRoute)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _OCEANNONFCLTRANSITTIMESTART._serialized_start = 3588
    _OCEANNONFCLTRANSITTIMESTART._serialized_end = 3768
    _OCEANNONFCLTRANSITTIMEEND._serialized_start = 3771
    _OCEANNONFCLTRANSITTIMEEND._serialized_end = 3952
    _OCEANNONFCLROLE._serialized_start = 3954
    _OCEANNONFCLROLE._serialized_end = 4079
    _OCEANNONFCLBOUNDARY._serialized_start = 4082
    _OCEANNONFCLBOUNDARY._serialized_end = 4490
    _OCEANNONFCLEXECUTIONOFFERING._serialized_start = 524
    _OCEANNONFCLEXECUTIONOFFERING._serialized_end = 2303
    _OCEANNONFCLFULLSERVICEINFO._serialized_start = 2306
    _OCEANNONFCLFULLSERVICEINFO._serialized_end = 2522
    _OCEANNONFCLTRANSITTIME._serialized_start = 2525
    _OCEANNONFCLTRANSITTIME._serialized_end = 3075
    _OCEANNONFCLOTEMILESTONES._serialized_start = 3078
    _OCEANNONFCLOTEMILESTONES._serialized_end = 3371
    _OCEANNONFCLSPECIFICROUTE._serialized_start = 3374
    _OCEANNONFCLSPECIFICROUTE._serialized_end = 3585
