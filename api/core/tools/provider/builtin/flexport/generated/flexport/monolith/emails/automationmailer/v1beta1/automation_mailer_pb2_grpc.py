...
import grpc
from flexport.monolith.emails.automationmailer.v1beta1 import (
    automation_mailer_pb2 as flexport_dot_monolith_dot_emails_dot_automationmailer_dot_v1beta1_dot_automation__mailer__pb2,
)


class AutomationMailerAPIStub:
...
class AutomationMailerAPIServicer:
    """This API wrapper is used to get default email fields such default CCs.
    Relevant automated emails sent to both a partner and broker, broker only will be included here.
...
class AutomationMailerAPI:
    ...
    @staticmethod
    def GetSendArrivalNoticeDefaultCc(
        request,
        target,
        options=(),
        channel_credentials=None,
