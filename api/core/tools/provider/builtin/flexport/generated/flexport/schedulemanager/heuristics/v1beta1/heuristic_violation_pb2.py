...
_HEURISTICVIOLATION = DESCRIPTOR.message_types_by_name["HeuristicViolation"]
HeuristicViolation = _reflection.GeneratedProtocolMessageType(
    "HeuristicViolation",
    (_message.Message,),
    {
        "DESCRIPTOR": _HEURISTICVIOLATION,
        "__module__": "flexport.schedulemanager.heuristics.v1beta1.heuristic_violation_pb2",
        # @@protoc_insertion_point(class_scope:flexport.schedulemanager.heuristics.v1beta1.HeuristicViolation)
    },
)
_sym_db.RegisterMessage(HeuristicViolation)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _HEURISTICVIOLATION._serialized_start = 433
    _HEURISTICVIOLATION._serialized_end = 1230
