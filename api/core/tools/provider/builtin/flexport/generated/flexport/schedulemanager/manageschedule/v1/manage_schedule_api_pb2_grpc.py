...
from flexport.schedulemanager.manageschedule.v1 import manage_schedule_api_pb2 as flexport_dot_schedulemanager_dot_manageschedule_dot_v1_dot_manage__schedule__api__pb2


class ManageScheduleAPIStub(object):
...
class ManageScheduleAPIServicer(object):
    """APIs for proposing and/or requesting schedules changes and fetching outcomes/metadata from those processes.
    """
...
class ManageScheduleAPI(object):
    """APIs for proposing and/or requesting schedules changes and fetching outcomes/metadata from those processes.
    """

    @staticmethod
    def UpdateScheduleDates(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.schedulemanager.manageschedule.v1.ManageScheduleAPI/UpdateScheduleDates',
    ...
    @staticmethod
    def EvaluateScheduleDates(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.schedulemanager.manageschedule.v1.ManageScheduleAPI/EvaluateScheduleDates',
