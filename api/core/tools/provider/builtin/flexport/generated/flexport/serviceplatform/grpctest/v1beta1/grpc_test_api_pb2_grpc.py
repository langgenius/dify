...
from flexport.serviceplatform.grpctest.v1beta1 import grpc_test_api_pb2 as flexport_dot_serviceplatform_dot_grpctest_dot_v1beta1_dot_grpc__test__api__pb2


class GrpcTestAPIStub(object):
...
class GrpcTestAPIServicer(object):
    """This service is used internally by Service Platform team to experiment with gRPC.
    """
...
class GrpcTestAPI(object):
    ...
    def DoNothing(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.serviceplatform.grpctest.v1beta1.GrpcTestAPI/DoNothing',
    ...
    def Sleep(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.serviceplatform.grpctest.v1beta1.GrpcTestAPI/Sleep',
    ...
    def Fail(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.serviceplatform.grpctest.v1beta1.GrpcTestAPI/Fail',
    ...
    def Recurse(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.serviceplatform.grpctest.v1beta1.GrpcTestAPI/Recurse',
    ...
    def HealthProbe(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.serviceplatform.grpctest.v1beta1.GrpcTestAPI/HealthProbe',
    ...
    def WorkHard(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.serviceplatform.grpctest.v1beta1.GrpcTestAPI/WorkHard',
