...
import grpc
from flexport.monolith.dotorg.carboncalculationhelper.v1beta1 import (
    carbon_calculation_helper_api_pb2 as flexport_dot_monolith_dot_dotorg_dot_carboncalculationhelper_dot_v1beta1_dot_carbon__calculation__helper__api__pb2,
)


class CarbonCalculationHelperAPIStub:
...
class CarbonCalculationHelperAPIServicer:
    """DotOrg API to provide data from the monolith to feed to NIS carbon calculator"""
...
class CarbonCalculationHelperAPI:
    """DotOrg API to provide data from the monolith to feed to NIS carbon calculator"""

    @staticmethod
    def BuildRequestLegsForShipment(
        request,
        target,
        options=(),
