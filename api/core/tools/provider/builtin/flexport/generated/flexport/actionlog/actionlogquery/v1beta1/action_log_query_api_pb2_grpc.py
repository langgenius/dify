...
from flexport.actionlog.actionlogquery.v1beta1 import action_log_query_api_pb2 as flexport_dot_actionlog_dot_actionlogquery_dot_v1beta1_dot_action__log__query__api__pb2


class ActionLogQueryAPIStub(object):
    """
...
class ActionLogQueryAPIServicer(object):
    """
    * Service Boundary Documentation:
    * -------------------------------
...
class ActionLogQueryAPI(object):
    """
    * Service Boundary Documentation:
    * -------------------------------
    ...
    * Interested in learning more about ActionLog? Check out go/actionlog to understand more about the product
    ...
    def GetActionLogs(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.actionlog.actionlogquery.v1beta1.ActionLogQueryAPI/GetActionLogs',
