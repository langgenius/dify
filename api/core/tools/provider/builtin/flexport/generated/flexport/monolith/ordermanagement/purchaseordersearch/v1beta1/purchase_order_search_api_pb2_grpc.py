...
import grpc
from flexport.monolith.ordermanagement.purchaseordersearch.v1beta1 import (
    purchase_order_search_api_pb2 as flexport_dot_monolith_dot_ordermanagement_dot_purchaseordersearch_dot_v1beta1_dot_purchase__order__search__api__pb2,
)


class PurchaseOrderSearchAPIStub:
...
class PurchaseOrderSearchAPIServicer:
    """An API to search for purchase orders based on their identifiers."""
...
class PurchaseOrderSearchAPI:
    """An API to search for purchase orders based on their identifiers."""

    @staticmethod
    def ListPurchaseOrdersByName(
        request,
        target,
        options=(),
    ...
    @staticmethod
    def ListPurchaseOrdersByShipment(
        request,
        target,
        options=(),
        channel_credentials=None,
