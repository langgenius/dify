...
from flexport.oceanplanning.carrierconstraint.v1 import carrier_constraint_api_pb2 as flexport_dot_oceanplanning_dot_carrierconstraint_dot_v1_dot_carrier__constraint__api__pb2


class CarrierConstraintAPIStub(object):
...
class CarrierConstraintAPIServicer(object):
    """The carrier constraint service grpc API end point.
    """
...
class CarrierConstraintAPI(object):
    """The carrier constraint service grpc API end point.
    """

    @staticmethod
    def GetCarrierConstraintByRegion(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.oceanplanning.carrierconstraint.v1.CarrierConstraintAPI/GetCarrierConstraintByRegion',
