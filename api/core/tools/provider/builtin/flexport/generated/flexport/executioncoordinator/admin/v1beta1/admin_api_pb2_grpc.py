...
import grpc
from flexport.executioncoordinator.admin.v1beta1 import (
    admin_api_pb2 as flexport_dot_executioncoordinator_dot_admin_dot_v1beta1_dot_admin__api__pb2,
)
...
class AdminAPI:
    ...
    @staticmethod
    def ThrowErrorForSentryTesting(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def CaptureErrorForSentryTesting(
        request,
        target,
        options=(),
        channel_credentials=None,
