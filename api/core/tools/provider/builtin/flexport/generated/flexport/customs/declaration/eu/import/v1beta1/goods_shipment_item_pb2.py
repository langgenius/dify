...
_GOODSSHIPMENTITEM = DESCRIPTOR.message_types_by_name["GoodsShipmentItem"]
_GOODSSHIPMENTITEM_PROCEDURE = _GOODSSHIPMENTITEM.nested_types_by_name["Procedure"]
_GOODSSHIPMENTITEM_VALUATIONMETHOD = _GOODSSHIPMENTITEM.enum_types_by_name["ValuationMethod"]
GoodsShipmentItem = _reflection.GeneratedProtocolMessageType(
    "GoodsShipmentItem",
    (_message.Message,),
    {
        "Procedure": _reflection.GeneratedProtocolMessageType(
            ...
            (_message.Message,),
            {
                "DESCRIPTOR": _GOODSSHIPMENTITEM_PROCEDURE,
                "__module__": "flexport.customs.declaration.eu.import.v1beta1.goods_shipment_item_pb2",
                # @@protoc_insertion_point(class_scope:flexport.customs.declaration.eu.import.v1beta1.GoodsShipmentItem.Procedure)
            },
        ),
        "DESCRIPTOR": _GOODSSHIPMENTITEM,
        "__module__": "flexport.customs.declaration.eu.import.v1beta1.goods_shipment_item_pb2",
        # @@protoc_insertion_point(class_scope:flexport.customs.declaration.eu.import.v1beta1.GoodsShipmentItem)
    },
)
_sym_db.RegisterMessage(GoodsShipmentItem)
_sym_db.RegisterMessage(GoodsShipmentItem.Procedure)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _GOODSSHIPMENTITEM._serialized_start = 711
    _GOODSSHIPMENTITEM._serialized_end = 3543
    _GOODSSHIPMENTITEM_PROCEDURE._serialized_start = 3175
    _GOODSSHIPMENTITEM_PROCEDURE._serialized_end = 3243
    _GOODSSHIPMENTITEM_VALUATIONMETHOD._serialized_start = 3246
    _GOODSSHIPMENTITEM_VALUATIONMETHOD._serialized_end = 3543
