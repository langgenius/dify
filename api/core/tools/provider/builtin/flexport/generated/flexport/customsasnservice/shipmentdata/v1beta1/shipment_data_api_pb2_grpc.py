...
import grpc
from flexport.customsasnservice.shipmentdata.v1beta1 import (
    shipment_data_api_pb2 as flexport_dot_customsasnservice_dot_shipmentdata_dot_v1beta1_dot_shipment__data__api__pb2,
)


class ShipmentDataAPIStub:
...
class ShipmentDataAPI:
    """Missing associated documentation comment in .proto file."""

    @staticmethod
    def UpsertShipmentData(
        request,
        target,
        options=(),
