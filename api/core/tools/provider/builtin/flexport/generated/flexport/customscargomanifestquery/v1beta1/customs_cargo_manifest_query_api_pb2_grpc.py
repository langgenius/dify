...
from flexport.customscargomanifestquery.v1beta1 import customs_cargo_manifest_query_api_pb2 as flexport_dot_customscargomanifestquery_dot_v1beta1_dot_customs__cargo__manifest__query__api__pb2


class CustomsCargoManifestQueryAPIStub(object):
...
class CustomsCargoManifestQueryAPIServicer(object):
    """Missing associated documentation comment in .proto file."""
...
class CustomsCargoManifestQueryAPI(object):
    """Missing associated documentation comment in .proto file."""

    @staticmethod
    def RegisterMasterBillNumbers(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.customscargomanifestquery.v1beta1.CustomsCargoManifestQueryAPI/RegisterMasterBillNumbers',
    ...
    def GetCargoManifest(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.customscargomanifestquery.v1beta1.CustomsCargoManifestQueryAPI/GetCargoManifest',
    ...
    @staticmethod
    def RefreshAndGetCargoManifest(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.customscargomanifestquery.v1beta1.CustomsCargoManifestQueryAPI/RefreshAndGetCargoManifest',
