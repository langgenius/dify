...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'flexport.billing.entityevent.v1beta1.bill_audit_entity_pb2', _globals)
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_BILLAUDITSECTIONTYPE'].values_by_name["BILL_AUDIT_SECTION_TYPE_BILL_EPC_DATA"]._serialized_options = b'\010\001'
  _globals['_BILLAUDITSECTIONTYPE'].values_by_name["BILL_AUDIT_SECTION_TYPE_SHIPMENT_EPC_DATA"]._options = None
  _globals['_BILLAUDITSECTIONTYPE'].values_by_name["BILL_AUDIT_SECTION_TYPE_SHIPMENT_EPC_DATA"]._serialized_options = b'\010\001'
  _globals['_BILLAUDITSECTIONTYPE'].values_by_name["BILL_AUDIT_SECTION_TYPE_VENDOR_CURRENCY_DATA"]._options = None
  _globals['_BILLAUDITSECTIONTYPE'].values_by_name["BILL_AUDIT_SECTION_TYPE_VENDOR_CURRENCY_DATA"]._serialized_options = b'\010\001'
  _globals['_BILLAUDITSECTIONTYPE'].values_by_name["BILL_AUDIT_SECTION_TYPE_SHIPMENT_FLAGS"]._options = None
  _globals['_BILLAUDITSECTIONTYPE'].values_by_name["BILL_AUDIT_SECTION_TYPE_SHIPMENT_FLAGS"]._serialized_options = b'\010\001'
  ...
  _globals['_BILLAUDITISSUETYPE'].values_by_name["BILL_AUDIT_ISSUE_TYPE_UNEXPECTED_VENDOR_CURRENCY"]._serialized_options = b'\010\001'
  _globals['_BILLAUDITSECTIONVALUE'].fields_by_name['bill_epc_data_audit_section_metadata']._options = None
  _globals['_BILLAUDITSECTIONVALUE'].fields_by_name['bill_epc_data_audit_section_metadata']._serialized_options = b'\030\001'
  _globals['_BILLAUDITSECTIONVALUE'].fields_by_name['shipment_epc_data_audit_section_metadata']._options = None
  _globals['_BILLAUDITSECTIONVALUE'].fields_by_name['shipment_epc_data_audit_section_metadata']._serialized_options = b'\030\001'
  _globals['_BILLAUDITSECTIONVALUE'].fields_by_name['vendor_currency_data_audit_section_metadata']._options = None
  _globals['_BILLAUDITSECTIONVALUE'].fields_by_name['vendor_currency_data_audit_section_metadata']._serialized_options = b'\030\001'
  _globals['_BILLAUDITSECTIONVALUE'].fields_by_name['shipment_flags_audit_section_metadata']._options = None
  _globals['_BILLAUDITSECTIONVALUE'].fields_by_name['shipment_flags_audit_section_metadata']._serialized_options = b'\030\001'
  ...
  _globals['_BILLAUDITISSUEVALUE'].fields_by_name['unexpected_vendor_currency_audit_issue_metadata']._serialized_options = b'\030\001'
