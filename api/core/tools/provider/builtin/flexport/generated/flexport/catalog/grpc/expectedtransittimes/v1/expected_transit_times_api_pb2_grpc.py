...
from flexport.catalog.grpc.expectedtransittimes.v1 import expected_transit_times_api_pb2 as flexport_dot_catalog_dot_grpc_dot_expectedtransittimes_dot_v1_dot_expected__transit__times__api__pb2


class ExpectedTransitTimesAPIStub(object):
...
class ExpectedTransitTimesAPIServicer(object):
    """Missing associated documentation comment in .proto file."""
...
class ExpectedTransitTimesAPI(object):
    """Missing associated documentation comment in .proto file."""

    @staticmethod
    def UpsertExpectedTransitTimes(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.catalog.grpc.expectedtransittimes.v1.ExpectedTransitTimesAPI/UpsertExpectedTransitTimes',
    ...
    @staticmethod
    def RefreshExpectedTransitTimes(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.catalog.grpc.expectedtransittimes.v1.ExpectedTransitTimesAPI/RefreshExpectedTransitTimes',
