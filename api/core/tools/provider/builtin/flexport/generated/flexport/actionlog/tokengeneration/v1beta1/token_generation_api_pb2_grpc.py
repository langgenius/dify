...
import grpc
from flexport.actionlog.tokengeneration.v1beta1 import (
    token_generation_api_pb2 as flexport_dot_actionlog_dot_tokengeneration_dot_v1beta1_dot_token__generation__api__pb2,
)


class TokenGenerationAPIStub:
    """
...
class TokenGenerationAPIServicer:
    """
    * Service Boundary Documentation:
    * -------------------------------
    * The Token generation API for the Action Log Network isolated service.
