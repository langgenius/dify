...
from flexport.originops.grpcserver.shipmentstatus.v1 import shipment_status_api_pb2 as flexport_dot_originops_dot_grpcserver_dot_shipmentstatus_dot_v1_dot_shipment__status__api__pb2


class ShipmentStatusAPIStub(object):
...
class ShipmentStatusAPIServicer(object):
    """An API for rendering/mutating queues status of a shipment in origin ops service.
    """
...
class ShipmentStatusAPI(object):
    """An API for rendering/mutating queues status of a shipment in origin ops service.
    """

    @staticmethod
    def GetShipmentStatus(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.originops.grpcserver.shipmentstatus.v1.ShipmentStatusAPI/GetShipmentStatus',
