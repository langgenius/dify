...
_SORTBYDTO = DESCRIPTOR.enum_types_by_name["SortByDto"]
SortByDto = enum_type_wrapper.EnumTypeWrapper(_SORTBYDTO)
...
_CLIENTOFFERINGDTO = DESCRIPTOR.message_types_by_name["ClientOfferingDto"]
_CLIENTOFFERINGQUERYATTRIBUTESDTO = DESCRIPTOR.message_types_by_name["ClientOfferingQueryAttributesDto"]
ClientOfferingDto = _reflection.GeneratedProtocolMessageType(
    "ClientOfferingDto",
    (_message.Message,),
    {
        "DESCRIPTOR": _CLIENTOFFERINGDTO,
        "__module__": "flexport.catalog.offering.v2beta1.offering_pb2",
        # @@protoc_insertion_point(class_scope:flexport.catalog.offering.v2beta1.ClientOfferingDto)
    },
)
_sym_db.RegisterMessage(ClientOfferingDto)

ClientOfferingQueryAttributesDto = _reflection.GeneratedProtocolMessageType(
    "ClientOfferingQueryAttributesDto",
    (_message.Message,),
    {
        "DESCRIPTOR": _CLIENTOFFERINGQUERYATTRIBUTESDTO,
        "__module__": "flexport.catalog.offering.v2beta1.offering_pb2",
        # @@protoc_insertion_point(class_scope:flexport.catalog.offering.v2beta1.ClientOfferingQueryAttributesDto)
    },
)
_sym_db.RegisterMessage(ClientOfferingQueryAttributesDto)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _SORTBYDTO._serialized_start = 4477
    _SORTBYDTO._serialized_end = 4613
    _CLIENTOFFERINGDTO._serialized_start = 1158
    _CLIENTOFFERINGDTO._serialized_end = 3137
    _CLIENTOFFERINGQUERYATTRIBUTESDTO._serialized_start = 3140
    _CLIENTOFFERINGQUERYATTRIBUTESDTO._serialized_end = 4474
