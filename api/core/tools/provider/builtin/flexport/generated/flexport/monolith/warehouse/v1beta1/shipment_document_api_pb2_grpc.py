...
from flexport.monolith.warehouse.v1beta1 import shipment_document_api_pb2 as flexport_dot_monolith_dot_warehouse_dot_v1beta1_dot_shipment__document__api__pb2


class ShipmentDocumentAPIStub(object):
...
class ShipmentDocumentAPIServicer(object):
    """Missing associated documentation comment in .proto file."""
...
class ShipmentDocumentAPI(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def SearchDocuments(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.monolith.warehouse.v1beta1.ShipmentDocumentAPI/SearchDocuments',
    ...
    def DownloadDocument(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.monolith.warehouse.v1beta1.ShipmentDocumentAPI/DownloadDocument',
    ...
    @staticmethod
    def PreSignedUploadUrl(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.monolith.warehouse.v1beta1.ShipmentDocumentAPI/PreSignedUploadUrl',
    ...
    def UploadDocuments(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.monolith.warehouse.v1beta1.ShipmentDocumentAPI/UploadDocuments',
