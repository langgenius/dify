...
_DOCUMENTCHANGED = DESCRIPTOR.message_types_by_name["DocumentChanged"]
DocumentChanged = _reflection.GeneratedProtocolMessageType(
    "DocumentChanged",
    (_message.Message,),
    {
        "DESCRIPTOR": _DOCUMENTCHANGED,
        "__module__": "flexport.originops.documentchanged.v1.document_changed_pb2",
        # @@protoc_insertion_point(class_scope:flexport.originops.documentchanged.v1.DocumentChanged)
    },
)
_sym_db.RegisterMessage(DocumentChanged)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _DOCUMENTCHANGED._serialized_start = 202
    _DOCUMENTCHANGED._serialized_end = 874
