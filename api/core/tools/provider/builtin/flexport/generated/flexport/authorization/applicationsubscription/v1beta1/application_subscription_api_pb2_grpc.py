...
from flexport.authorization.applicationsubscription.v1beta1 import application_subscription_api_pb2 as flexport_dot_authorization_dot_applicationsubscription_dot_v1beta1_dot_application__subscription__api__pb2


class ApplicationSubscriptionAPIStub(object):
...
class ApplicationSubscriptionAPIServicer(object):
    """These APIs will be exposed as json over Http.
    """
...
class ApplicationSubscriptionAPI(object):
    """These APIs will be exposed as json over Http.
    """

    @staticmethod
    def CreateApplicationSubscription(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.authorization.applicationsubscription.v1beta1.ApplicationSubscriptionAPI/CreateApplicationSubscription',
    ...
    @staticmethod
    def UpdateApplicationSubscriptionStatus(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.authorization.applicationsubscription.v1beta1.ApplicationSubscriptionAPI/UpdateApplicationSubscriptionStatus',
    ...
    @staticmethod
    def GetApplicationSubscriptionStatus(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.authorization.applicationsubscription.v1beta1.ApplicationSubscriptionAPI/GetApplicationSubscriptionStatus',
