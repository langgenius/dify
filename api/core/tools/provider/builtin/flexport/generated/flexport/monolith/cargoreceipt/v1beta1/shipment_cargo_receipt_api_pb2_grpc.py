...
import grpc
from flexport.monolith.cargoreceipt.v1beta1 import (
    shipment_cargo_receipt_api_pb2 as flexport_dot_monolith_dot_cargoreceipt_dot_v1beta1_dot_shipment__cargo__receipt__api__pb2,
)


class ShipmentCargoReceiptAPIStub:
...
class ShipmentCargoReceiptAPIServicer:
    """Missing associated documentation comment in .proto file."""
...
class ShipmentCargoReceiptAPI:
    """Missing associated documentation comment in .proto file."""

    @staticmethod
    def ListShipmentCargoReceiptsByShipmentId(
        request,
        target,
        options=(),
    ...
    @staticmethod
    def ListShipmentCargoReceiptsByShipmentIds(
        request,
        target,
        options=(),
        channel_credentials=None,
