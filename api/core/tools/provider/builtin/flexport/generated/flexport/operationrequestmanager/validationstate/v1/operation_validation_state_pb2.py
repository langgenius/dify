...
_OPERATIONVALIDATIONSTATE = DESCRIPTOR.message_types_by_name["OperationValidationState"]
OperationValidationState = _reflection.GeneratedProtocolMessageType(
    "OperationValidationState",
    (_message.Message,),
    {
        "DESCRIPTOR": _OPERATIONVALIDATIONSTATE,
        "__module__": "flexport.operationrequestmanager.validationstate.v1.operation_validation_state_pb2",
        # @@protoc_insertion_point(class_scope:flexport.operationrequestmanager.validationstate.v1.OperationValidationState)
    },
)
_sym_db.RegisterMessage(OperationValidationState)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _OPERATIONVALIDATIONSTATE._serialized_start = 316
    _OPERATIONVALIDATIONSTATE._serialized_end = 658
