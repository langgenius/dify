...
from flexport.monolith.funnelmanagement.affiliation.v1beta1 import affiliation_api_pb2 as flexport_dot_monolith_dot_funnelmanagement_dot_affiliation_dot_v1beta1_dot_affiliation__api__pb2


class AffiliationAPIStub(object):
...
class AffiliationAPIServicer(object):
    """The affiliation service definition.
    """
...
class AffiliationAPI(object):
    ...
    def Affiliate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.monolith.funnelmanagement.affiliation.v1beta1.AffiliationAPI/Affiliate',
    ...
    def VerifyAffiliation(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.monolith.funnelmanagement.affiliation.v1beta1.AffiliationAPI/VerifyAffiliation',
