...
import grpc
from flexport.monolith.networkentities.companyentity.v1 import (
    company_entity_api_pb2 as flexport_dot_monolith_dot_networkentities_dot_companyentity_dot_v1_dot_company__entity__api__pb2,
)


class CompanyEntityAPIStub:
...
class CompanyEntityAPIServicer:
    """This service is used by any NIS to retrieve CompanyEntity from monolith DB.
    Initially it will be used by Finance team's lately extracted NIS.
    Production readiness: https://docs.google.com/document/d/1u5ps7A5tS-Mj-hd3AT8A_tH4U5L1uNOzVQb-UdoFen0/edit#
    """
...
class CompanyEntityAPI:
    ...
    @staticmethod
    def GetCompanyEntityByExternalRef(
        request,
        target,
        options=(),
        channel_credentials=None,
