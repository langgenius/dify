...
import grpc
from flexport.customsciservice.splitcommercialinvoicesyncapi.v1beta1 import (
    split_commercial_invoice_sync_api_pb2 as flexport_dot_customsciservice_dot_splitcommercialinvoicesyncapi_dot_v1beta1_dot_split__commercial__invoice__sync__api__pb2,
)


class SplitCommercialInvoiceSyncAPIStub:
...
class SplitCommercialInvoiceSyncAPIServicer:
    """Once split CIs are successfully processed we will sync them to core in one job."""
...
def add_SplitCommercialInvoiceSyncAPIServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
        "flexport.customsciservice.splitcommercialinvoicesyncapi.v1beta1.SplitCommercialInvoiceSyncAPI",
        rpc_method_handlers,
    )
...
class SplitCommercialInvoiceSyncAPI:
    """Once split CIs are successfully processed we will sync them to core in one job."""
