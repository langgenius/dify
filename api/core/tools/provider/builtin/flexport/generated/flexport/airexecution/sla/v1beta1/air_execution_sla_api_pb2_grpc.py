...
from flexport.airexecution.sla.v1beta1 import air_execution_sla_api_pb2 as flexport_dot_airexecution_dot_sla_dot_v1beta1_dot_air__execution__sla__api__pb2


class AirExecutionSlaAPIStub(object):
...
class AirExecutionSlaAPIServicer(object):
    """This service is used by an NIS to get the air execution sla.
    """
...
class AirExecutionSlaAPI(object):
    """This service is used by an NIS to get the air execution sla.
    """

    @staticmethod
    def GetAirExecutionSla(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.airexecution.sla.v1beta1.AirExecutionSlaAPI/GetAirExecutionSla',
    ...
    @staticmethod
    def ListAirExecutionSla(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.airexecution.sla.v1beta1.AirExecutionSlaAPI/ListAirExecutionSla',
