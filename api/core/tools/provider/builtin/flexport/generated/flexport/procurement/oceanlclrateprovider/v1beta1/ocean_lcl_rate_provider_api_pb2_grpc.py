...
from flexport.procurement.oceanlclrateprovider.v1beta1 import ocean_lcl_rate_provider_api_pb2 as flexport_dot_procurement_dot_oceanlclrateprovider_dot_v1beta1_dot_ocean__lcl__rate__provider__api__pb2


class OceanLclRateProviderAPIStub(object):
...
class OceanLclRateProviderAPIServicer(object):
    """Service used to retrieve Ocean Lcl Rates.
    """
...
class OceanLclRateProviderAPI(object):
    """Service used to retrieve Ocean Lcl Rates.
    """

    @staticmethod
    def RequestRates(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.procurement.oceanlclrateprovider.v1beta1.OceanLclRateProviderAPI/RequestRates',
    ...
    def S3RatesReady(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flexport.procurement.oceanlclrateprovider.v1beta1.OceanLclRateProviderAPI/S3RatesReady',
