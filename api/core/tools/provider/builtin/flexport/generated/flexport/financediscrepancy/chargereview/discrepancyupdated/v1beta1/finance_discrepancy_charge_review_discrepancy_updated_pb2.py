...
_DISCREPANCYSTATUS = DESCRIPTOR.enum_types_by_name["DiscrepancyStatus"]
DiscrepancyStatus = enum_type_wrapper.EnumTypeWrapper(_DISCREPANCYSTATUS)
DISCREPANCY_STATUS_INVALID = 0
DISCREPANCY_STATUS_OFFERING_CORRECTED = 1
DISCREPANCY_STATUS_DISAGREE = 2


_DISCREPANCYUPDATED = DESCRIPTOR.message_types_by_name["DiscrepancyUpdated"]
DiscrepancyUpdated = _reflection.GeneratedProtocolMessageType(
    "DiscrepancyUpdated",
    (_message.Message,),
    {
        "DESCRIPTOR": _DISCREPANCYUPDATED,
        "__module__": "flexport.financediscrepancy.chargereview.discrepancyupdated.v1beta1.finance_discrepancy_charge_review_discrepancy_updated_pb2",
        # @@protoc_insertion_point(class_scope:flexport.financediscrepancy.chargereview.discrepancyupdated.v1beta1.DiscrepancyUpdated)
    },
)
_sym_db.RegisterMessage(DiscrepancyUpdated)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _DISCREPANCYSTATUS._serialized_start = 559
    _DISCREPANCYSTATUS._serialized_end = 686
    _DISCREPANCYUPDATED._serialized_start = 234
    _DISCREPANCYUPDATED._serialized_end = 557
