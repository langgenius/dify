...
class DuplicateDocumentIndexingTaskProxy(BatchDocumentIndexingProxy):
    ...
    NORMAL_TASK_FUNC: ClassVar[Callable[..., Any]] = normal_duplicate_document_indexing_task
    PRIORITY_TASK_FUNC: ClassVar[Callable[..., Any]] = priority_duplicate_document_indexing_task
