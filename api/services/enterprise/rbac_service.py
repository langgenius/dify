...
def _legacy_my_permissions(
    tenant_id: str, account_id: str | None, *, session: Session | scoped_session
...
class RBACService:
    ...
    class MemberRoles:
        @staticmethod
        def get(
            tenant_id: str, account_id: str | None, member_account_id: str, *, session: Session | scoped_session
        ) -> MemberRolesResponse:
