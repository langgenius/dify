...
class ImportTargetResolver:
    ...
    def resolve(self, request: ImportRequest, *, session: Session | scoped_session) -> ImportTarget:
    ...
    def _resolve_tenant_by_id_or_name(self, value: str, *, session: Session | scoped_session) -> Tenant | None:
...
class MigrationImportService:
    ...
    def import_package(self, request: ImportRequest, *, session: Session | scoped_session) -> ImportResult:
    ...
    def _find_existing_app(
        self, app_id: str | None, tenant_id: str, *, session: Session | scoped_session
    ) -> App | None:
    ...
    def _find_api_tool_provider(
        self, tenant_id: str, provider_name: str, *, session: Session | scoped_session
    ...
    def _ensure_workflow_app_is_published(
        self, target: ImportTarget, account: Account, app_id: str, *, session: Session | scoped_session
    ) -> None:
