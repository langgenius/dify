...
class FeatureService:
    ...
    def get_system_features(cls) -> SystemFeatureModel:
        ...
        # When enabled, only expose AceDataCloud OAuth login on the console sign-in page.
        # This matches the `ENABLE_ACEDATACLOUD_OAUTH_LOGIN` config description and docker env comment.
        if system_features.enable_acedatacloud_oauth_login:
    ...
    def _fulfill_system_params_from_env(cls, system_features: SystemFeatureModel):
        ...
        system_features.enable_acedatacloud_oauth_login = (
            dify_config.ENABLE_ACEDATACLOUD_OAUTH_LOGIN is True
            and isinstance(dify_config.ACEDATACLOUD_AUTH_BASE_URL, str)
            and bool(dify_config.ACEDATACLOUD_AUTH_BASE_URL)
        )
