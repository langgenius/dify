...
KNOWLEDGE_FS_CAPABILITY_OPERATIONS: Final[Mapping[str, KnowledgeFSCapabilityOperation]] = MappingProxyType(
    {
        ...
        "listKnowledgeFs": KnowledgeFSCapabilityOperation(
            "knowledge_fs.ls",
            _STANDARD_CALLERS,
            "GET",
        ...
        "treeKnowledgeFs": KnowledgeFSCapabilityOperation(
            "knowledge_fs.tree",
            _STANDARD_CALLERS,
            "GET",
        ...
        "grepKnowledgeFs": KnowledgeFSCapabilityOperation(
            "knowledge_fs.grep",
            _STANDARD_CALLERS,
            "GET",
        ...
        "findKnowledgeFs": KnowledgeFSCapabilityOperation(
            "knowledge_fs.find",
            _STANDARD_CALLERS,
            "GET",
        ...
        "diffKnowledgeFs": KnowledgeFSCapabilityOperation(
            "knowledge_fs.diff",
            _STANDARD_CALLERS,
            "GET",
        ...
        "catKnowledgeFs": KnowledgeFSCapabilityOperation(
            "knowledge_fs.cat",
            _STANDARD_CALLERS,
            "GET",
        ...
        "statKnowledgeFs": KnowledgeFSCapabilityOperation(
            "knowledge_fs.stat",
            _STANDARD_CALLERS,
            "GET",
        ...
        "listKnowledgeSpaceMetadataFields": KnowledgeFSCapabilityOperation(
        ...
        "createKnowledgeSpaceMetadataField": KnowledgeFSCapabilityOperation(
            "knowledge_spaces.metadata.write",
            _STANDARD_CALLERS,
            "POST",
            "/knowledge-spaces/{id}/metadata-fields",
            "knowledge_space",
        ),
        "updateKnowledgeSpaceMetadataField": KnowledgeFSCapabilityOperation(
            "knowledge_spaces.metadata.write",
            _STANDARD_CALLERS,
            "PATCH",
        ...
        "deleteKnowledgeSpaceMetadataField": KnowledgeFSCapabilityOperation(
            "knowledge_spaces.metadata.write",
            _STANDARD_CALLERS,
            "DELETE",
            "/knowledge-spaces/{id}/metadata-fields/{fieldId}",
        ...
        "createNamespaceSourcePreview": KnowledgeFSCapabilityOperation(
            "namespace_source_previews.create",
            _CONTROL_PLANE_CALLERS,
            "POST",
            "/namespace/source-preview-jobs",
            "namespace",
        ),
        "getNamespaceSourcePreview": KnowledgeFSCapabilityOperation(
            "namespace_source_previews.read",
            _CONTROL_PLANE_CALLERS,
            "GET",
            "/namespace/source-preview-jobs/{jobId}",
            "namespace",
        ),
        "cancelNamespaceSourcePreview": KnowledgeFSCapabilityOperation(
            "namespace_source_previews.cancel",
            _CONTROL_PLANE_CALLERS,
            "DELETE",
            "/namespace/source-preview-jobs/{jobId}",
            "namespace",
        ),
        "consumeNamespaceSourcePreview": KnowledgeFSCapabilityOperation(
            "namespace_source_previews.consume",
            _CONTROL_PLANE_CALLERS,
            "POST",
        ...
        "listGoldenQuestions": KnowledgeFSCapabilityOperation(
        ...
        "createGoldenQuestion": KnowledgeFSCapabilityOperation(
        ...
        "deleteGoldenQuestion": KnowledgeFSCapabilityOperation(
            "golden-questions.write",
            _STANDARD_CALLERS,
            "DELETE",
            "/knowledge-spaces/{id}/golden-questions/{questionId}",
        ...
        "listQualityBadCases": KnowledgeFSCapabilityOperation(
            "quality.read",
            _STANDARD_CALLERS,
            "GET",
        ...
        "createQualityBadCase": KnowledgeFSCapabilityOperation(
            "quality.write",
            _STANDARD_CALLERS,
            "POST",
            "/knowledge-spaces/{id}/quality/bad-cases",
        ...
        "getQualityBadCase": KnowledgeFSCapabilityOperation(
            "quality.read",
            _STANDARD_CALLERS,
            "GET",
        ...
        "updateQualityBadCase": KnowledgeFSCapabilityOperation(
            "quality.write",
            _STANDARD_CALLERS,
            "PATCH",
            "/knowledge-spaces/{id}/quality/bad-cases/{badCaseId}",
        ...
        "createQualityReplay": KnowledgeFSCapabilityOperation(
            "quality.write",
            _STANDARD_CALLERS,
            "POST",
