...
class NodeOutputInspectorService:
    ...
    def snapshot_workflow_run(
        self, *, app_model: App, workflow_run_id: str, session: Session | scoped_session
    ...
    def node_detail(
        self, *, app_model: App, workflow_run_id: str, node_id: str, session: Session | scoped_session
    ) -> NodeOutputsView:
