...
class SkillToolInferenceService:
    ...
    def infer(self, *, tenant_id: str, agent_id: str, slug: str, session: Session | scoped_session) -> dict[str, Any]:
    ...
    def _load_skill_md(self, *, tenant_id: str, agent_id: str, slug: str, session: Session | scoped_session) -> str:
        try:
