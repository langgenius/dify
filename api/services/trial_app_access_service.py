...
class TrialAppAccessService:
    ...
    def get_access(self, *, app_id: str, account_id: str, check_usage: bool = True) -> TrialAppRef:
        ...
        if check_usage and access.used_count is not None and access.used_count >= access.trial_limit:
