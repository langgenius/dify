...
class FeatureModel(FeatureResponseModel):
    ...
    # Dify Builder execution consumes this internally; it is not part of the Console response contract.
    skill_learning_policy: str = Field(default="ask", exclude=True)
