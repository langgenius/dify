...
class OpsService:
    @classmethod
    def get_tracing_app_config(cls, app_id: str, tracing_provider: str, session: Session | scoped_session):
        """
    ...
    def create_tracing_app_config(
        cls, app_id: str, tracing_provider: str, tracing_config: dict[str, Any], session: Session | scoped_session
    ):
        """
    ...
    @classmethod
    def delete_tracing_app_config(cls, app_id: str, tracing_provider: str, session: Session | scoped_session):
        """
