...
class KnowledgeFSDocumentCreateAcceptedResponse(
    RootModel[KnowledgeFSDocumentStagedUploadAcceptedResponse | KnowledgeFSDocumentUploadAcceptedResponse]
):
