...
KNOWLEDGE_FS_PRODUCT_OPERATIONS: Final[MappingProxyType[str, KnowledgeFSProductOperation]] = MappingProxyType(
    {
        ...
        "resumeResearchTask": _operation(
            "POST",
            "resumeResearchTask",
            KnowledgeFSProductPermission.QUERY,
            "/research-tasks/{id}/resume",
            "json",
        ...
        "listSourceWorkflows": _operation(
            "GET",
            "listSourceWorkflows",
            KnowledgeFSProductPermission.READ,
        ...
        "getDeletionJob": _operation(
            "GET",
            "getDurableDeletionJob",
            KnowledgeFSProductPermission.READ,
            "/deletion-jobs/{jobId}",
            "json",
        ...
        "retryDeletionJob": _operation(
            "POST",
            "retryDurableDeletionJob",
        ...
        "getDeletionBatch": _operation(
            "GET",
            "getDurableDeletionBatch",
            KnowledgeFSProductPermission.READ,
            "/deletion-batches/{batchId}",
            "json",
            resource_resolver="job",
            max_request_bytes=16 * 1024,
            max_response_bytes=2 * 1024 * 1024,
        ...
        "listDocumentProcessingTasks": _operation(
            "GET",
        ...
        "getDocumentProcessingTask": _operation(
            "GET",
