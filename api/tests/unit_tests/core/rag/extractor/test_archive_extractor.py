...
class TestArchiveExtractor:
    ...
    def test_is_safe_path_valid(self):
        ...
        safe_paths = ["file.txt", "folder/file.txt", "deep/nested/folder/file.txt"]
    ...
    def test_is_safe_path_invalid(self):
        ...
        unsafe_paths = ["../file.txt", "folder/../../../file.txt", "/absolute/path/file.txt", "folder\\..\\file.txt"]
    ...
    def test_process_extracted_file_text(self, mock_processor_class):
        ...
        mock_processor = Mock()
        mock_processor.extract.return_value = [Document(page_content="Test content", metadata={"source": test_file})]
        mock_processor_class.return_value = mock_processor

        # Test processing
        documents = self.extractor._process_extracted_file(test_file, "test.txt", "test.zip", "zip")
    ...
    def test_process_extracted_file_unsupported(self, mock_processor_class):
        ...
        # Test processing
        documents = self.extractor._process_extracted_file(test_file, "test.unknown", "test.zip", "zip")
