...
class TestExtractProcessorLoaders:
    ...
    def test_load_from_url_builds_temp_file_with_correct_suffix(self, monkeypatch: pytest.MonkeyPatch, url, headers, expected_suffix):
...
class TestExtractProcessorFileRouting:
    ...
    def _run_extract_for_extension(self, monkeypatch: pytest.MonkeyPatch, extension: str, etl_type: str, is_automatic: bool = False):
    ...
    def test_extract_routes_file_extensions_for_default_mode(self, monkeypatch: pytest.MonkeyPatch, extension, expected_extractor):
...
class TestExtractProcessorDatasourceRouting:
    ...
    def test_extract_routes_website_datasource_providers(self, monkeypatch: pytest.MonkeyPatch, provider: str, expected: str):
        factory = _patch_all_extractors(monkeypatch)
