...
class TestNormalizeEntityName:
    ...
    def test_spelling_variants_merge_to_one_key(self):
        assert normalize_entity_name("ACME Corp") == normalize_entity_name("acme corp")

    def test_display_name_keeps_original_casing(self):
...
class TestParseExtraction:
    ...
    def test_malformed_output_yields_empty_extraction(self):
        result = EntityRelationExtractor.parse_extraction("I could not find any entities, sorry!")

        assert result.entities == []
        assert result.relations == []

    def test_relation_endpoints_are_backfilled_as_entities(self):
    ...
    def test_duplicate_entities_merge_keeping_richest_description(self):
        raw = """
        {
          "entities": [
    ...
    def test_self_referential_relations_are_dropped(self):
        raw = """
        {
          "entities": [{"name": "Acme", "type": "ORGANIZATION"}],
    ...
    def test_predicate_is_normalized_to_snake_case(self):
        raw = """
        {
          "entities": [],
    ...
    def test_missing_predicate_falls_back_to_related_to(self):
        raw = """
        {
          "entities": [],
