...
class TestIsSupportGraphSearch:
    ...
    def test_methods_that_walk_the_graph(self, retrieval_method: RetrievalMethod):
    ...
    def test_single_mode_methods_stay_unchanged(self, retrieval_method: RetrievalMethod):
    ...
    def test_graph_search_does_not_trigger_vector_or_fulltext_legs(self):
