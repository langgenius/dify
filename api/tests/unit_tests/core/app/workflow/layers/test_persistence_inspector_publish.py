...
The hook lives in ``services/workflow_persistence.py``:
...
from services import workflow_persistence as persistence_mod
from services.workflow_persistence import WorkflowPersistenceLayer
