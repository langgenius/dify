...
def test_branch_merge_streaming_scenario():
    ...
    graph_config = {
        ...
        "nodes": {
            ...
            "llm": {"data": {"type": "llm"}},
            "answer": {"data": {"type": "answer", "answer": "Result: {{#llm.text#}}"}},
    ...
    answer_routes = AnswerStreamGeneratorRouter.init(
        node_id_config_mapping=graph_config["nodes"], reverse_edge_mapping=graph.reverse_edge_mapping
    )
    graph.answer_stream_generate_routes = answer_routes

    # Create variable pool
    variable_pool = VariablePool(system_variables={}, user_inputs={}, environment_variables={})
...
def test_complex_nested_branch_merge():
    ...
    graph_config = {
        ...
        "nodes": {
            ...
            "llm": {"data": {"type": "llm"}},
            "answer": {"data": {"type": "answer", "answer": "Complex result: {{#llm.text#}}"}},
        },
    }
