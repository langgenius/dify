...
from core.workflow.nodes.variable_operator.v1 import VariableOperatorNode
from core.workflow.nodes.variable_operator.v1.node_data import WriteMode
...
def test_overwrite_string_variable():
    ...
    with mock.patch("core.workflow.nodes.variable_operator.v1.node.update_conversation_variable") as mock_run:
        list(node.run())
