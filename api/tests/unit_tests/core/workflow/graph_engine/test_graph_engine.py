...
def test_run_parallel_in_chatflow(mock_close, mock_remove):
    graph_config = {
        ...
        "nodes": [
            ...
            {"data": {"type": "answer", "title": "answer1", "answer": "1", "outputs": []}, "id": "answer1"},
            {
                "data": {"type": "answer", "title": "answer2", "answer": "2", "outputs": []},
                "id": "answer2",
            },
            {
                "data": {"type": "answer", "title": "answer3", "answer": "3", "outputs": []},
                "id": "answer3",
            },
            {
                "data": {"type": "answer", "title": "answer4", "answer": "4", "outputs": []},
                "id": "answer4",
            },
            {
                "data": {"type": "answer", "title": "answer5", "answer": "5", "outputs": []},
                "id": "answer5",
            },
        ],
    }
