...
uv run pytest api/tests/unit_tests/graphon/graph_engine/test_graph_engine.py

# Run with specific test patterns
uv run pytest api/tests/unit_tests/graphon/graph_engine/test_graph_engine.py -k "test_echo"

# Run with verbose output
uv run pytest api/tests/unit_tests/graphon/graph_engine/test_graph_engine.py -v
```
...
uv run pytest api/tests/unit_tests/graphon/graph_engine/test_auto_mock_system.py

# Run examples
uv run python api/tests/unit_tests/graphon/graph_engine/test_mock_example.py

# Run simple validation
uv run python api/tests/unit_tests/graphon/graph_engine/test_mock_simple.py
```
...
uv run pytest api/tests/unit_tests/graphon/graph_engine/

# Run with coverage
uv run pytest api/tests/unit_tests/graphon/graph_engine/ --cov=graphon.graph_engine

# Run in parallel
uv run pytest api/tests/unit_tests/graphon/graph_engine/ -n auto
```
