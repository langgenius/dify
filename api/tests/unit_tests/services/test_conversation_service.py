...
class ConversationServiceTestDataFactory:
    ...
    def create_conversation_mock(
        ...
        **kwargs,
        ...
        conversation.created_at = kwargs.get("created_at", datetime.now(tz=timezone.utc))
        conversation.updated_at = kwargs.get("updated_at", datetime.now(tz=timezone.utc))
        for key, value in kwargs.items():
    ...
    def create_message_mock(
        ...
        **kwargs,
        ...
        message.created_at = kwargs.get("created_at", datetime.now(tz=timezone.utc))
        for key, value in kwargs.items():
    ...
    def create_conversation_variable_mock(
        ...
        **kwargs,
        ...
        variable.created_at = kwargs.get("created_at", datetime.now(tz=timezone.utc))
        variable.updated_at = kwargs.get("updated_at", datetime.now(tz=timezone.utc))
...
class TestConversationServiceHelpers:
    ...
    def test_build_filter_condition_with_descending_sort(self):
        ...
        mock_conversation.updated_at = datetime.now(tz=timezone.utc)
    ...
    def test_build_filter_condition_with_ascending_sort(self):
        ...
        # Arrange
        mock_conversation = ConversationServiceTestDataFactory.create_conversation_mock()
        mock_conversation.created_at = datetime.now(tz=timezone.utc)
...
class TestConversationServiceConversationalVariable:
    ...
    def test_get_conversational_variable_with_last_id(self, mock_get_conversation, mock_session_factory):
        ...
        variable = ConversationServiceTestDataFactory.create_conversation_variable_mock(created_at=datetime.now(tz=timezone.utc))
