...
class TestProviderApiKeyAuthCredentialValidator:
    @pytest.mark.parametrize(
        ...
        [
            (
                "firecrawl",
                "services.data_source.auth.firecrawl.firecrawl.FirecrawlAuth",
                DataSourceApiKeyAuthCredentials("bearer", "test_key", {}),
            ),
            (
                "watercrawl",
                "services.data_source.auth.watercrawl.watercrawl.WatercrawlAuth",
                DataSourceApiKeyAuthCredentials("x-api-key", "test_key", {}),
            ),
            (
                "jinareader",
                "services.data_source.auth.jina.jina.JinaAuth",
                DataSourceApiKeyAuthCredentials("bearer", "test_key", {}),
            ),
        ],
    )
