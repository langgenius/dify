...
class TestAppModelConfigService:
    ...
    def test_should_route_validation_to_correct_manager_based_on_app_mode(self, app_mode, selected_manager):
    ...
    def test_should_raise_value_error_when_app_mode_is_not_supported(self):
