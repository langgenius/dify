...
class TestAccountService:
    ...
    def test_load_user_switches_from_archived_current_tenant(self, sqlite_session: Session):
        account = Account(name="Test User", email="test@example.com")
    ...
    def test_load_user_returns_none_without_normal_tenant(self, sqlite_session: Session):
        account = Account(name="Test User", email="test@example.com")
        archived_tenant = Tenant(name="Archived Workspace", status=TenantStatus.ARCHIVE)
