...
def test_get_published_workflow_returns_none_when_pipeline_has_no_workflow_id(rag_pipeline_service: RagPipelineService) -> None:
...
def test_get_all_published_workflow_returns_empty_for_unpublished_pipeline(rag_pipeline_service: RagPipelineService) -> None:
    pipeline = _make_pipeline(workflow_id=None)
...
def test_sync_draft_workflow_creates_new_when_none_exists(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
...
def test_sync_draft_workflow_raises_on_hash_mismatch(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
...
def test_get_default_block_config_returns_config_for_valid_type(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
...
def test_update_workflow_updates_allowed_fields(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
...
def test_update_workflow_returns_none_when_not_found(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    session = mocker.Mock()
...
def test_get_rag_pipeline_paginate_workflow_runs_delegates(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
...
def test_get_rag_pipeline_workflow_run_delegates(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    expected = mocker.Mock()
    repo_mock = mocker.Mock()
...
def test_is_workflow_exist_returns_true_when_draft_exists(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
...
def test_is_workflow_exist_returns_false_when_no_draft(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
...
def test_run_datasource_workflow_node_website_crawl(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
...
def test_run_datasource_node_preview_online_document(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
...
def test_publish_customized_pipeline_template_success(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    # 1. Setup mocks
...
def test_publish_workflow_raises_when_draft_workflow_missing(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    session = mocker.Mock()
    session.scalar.return_value = None
    pipeline = _make_pipeline()
    account = _make_account()
...
def test_get_default_block_config_returns_none_when_mapped_type_missing(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    from graphon.enums import BuiltinNodeTypes
...
def test_get_default_block_config_injects_http_request_filter(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    from graphon.enums import BuiltinNodeTypes
...
def test_run_draft_workflow_node_raises_when_workflow_missing(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    pipeline = _make_pipeline()
    account = _make_account()
    mocker.patch.object(rag_pipeline_service, "get_draft_workflow", return_value=None)
...
def test_run_draft_workflow_node_saves_execution_and_variables(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
...
def test_run_datasource_workflow_node_returns_error_when_workflow_missing(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
...
def test_run_datasource_workflow_node_online_document_success(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    from core.datasource.entities.datasource_entities import DatasourceProviderType
...
def test_run_datasource_workflow_node_online_drive_success(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    from core.datasource.entities.datasource_entities import DatasourceProviderType
...
def test_handle_node_run_result_default_value_strategy(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    from datetime import datetime
...
def test_get_first_step_parameters_raises_when_datasource_node_missing(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
...
def test_get_second_step_parameters_handles_string_and_list_variable_references(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    workflow = SimpleNamespace(
        rag_pipeline_variables=[
...
def test_get_rag_pipeline_workflow_run_node_executions_empty_when_run_missing(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    pipeline = _make_pipeline()
...
def test_get_rag_pipeline_workflow_run_node_executions_returns_sorted_executions(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    mocker.patch("services.rag_pipeline.rag_pipeline.db", mocker.Mock(engine=mocker.Mock()))
    pipeline = _make_pipeline()
...
def test_get_recommended_plugins_returns_empty_when_no_active_plugins(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    mock_db = mocker.patch("services.rag_pipeline.rag_pipeline.db")
...
def test_get_recommended_plugins_returns_installed_and_uninstalled(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
...
def test_get_node_last_run_delegates_to_repository(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    mocker.patch("services.rag_pipeline.rag_pipeline.db", mocker.Mock(engine=mocker.Mock()))
    repo = mocker.Mock()
...
def test_set_datasource_variables_raises_when_node_id_missing(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    pipeline = SimpleNamespace(id="p1", tenant_id="t1")
    workflow = mocker.Mock()
...
def test_get_default_block_configs_skips_empty_configs(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    from graphon.enums import BuiltinNodeTypes
...
def test_run_datasource_workflow_node_returns_error_when_node_missing(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    pipeline = SimpleNamespace(id="p1", tenant_id="t1")
...
def test_run_datasource_workflow_node_online_document_exception(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    pipeline = SimpleNamespace(id="p1", tenant_id="t1")
    workflow = SimpleNamespace(
        graph_dict={
            "nodes": [
...
def test_run_datasource_node_preview_raises_for_stream_non_string(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
...
def test_get_first_step_parameters_returns_empty_when_no_rag_variables(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    workflow = SimpleNamespace(
...
def test_get_second_step_parameters_filters_first_step_variables(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    workflow = SimpleNamespace(
        graph_dict={
            "nodes": [
                {
...
def test_retry_error_document_raises_when_execution_log_not_found(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
...
def test_get_datasource_plugins_raises_when_workflow_not_found(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
...
def test_handle_node_run_result_raises_when_no_terminal_event(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    node_instance = SimpleNamespace(
        workflow_id="wf-1",
        node_type="start",
        title="Start",
...
def test_handle_node_run_result_marks_document_error_for_published_invoke(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
...
def test_run_datasource_node_preview_raises_for_unsupported_provider(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    pipeline = SimpleNamespace(id="p1", tenant_id="t1")
    workflow = SimpleNamespace(
        graph_dict={
            "nodes": [
...
def test_publish_customized_pipeline_template_raises_for_missing_pipeline(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
...
def test_publish_customized_pipeline_template_raises_for_missing_workflow_id(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    pipeline = _make_pipeline(workflow_id=None)
    mocker.patch("services.rag_pipeline.rag_pipeline.db.session.get", return_value=pipeline)
...
def test_get_pipeline_raises_when_dataset_missing(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    mocker.patch("services.rag_pipeline.rag_pipeline.db.session.scalar", return_value=None)
...
def test_get_pipeline_raises_when_pipeline_missing(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    dataset = SimpleNamespace(pipeline_id="p1")
...
def test_publish_workflow_skips_dataset_update_for_non_knowledge_nodes(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
...
def test_get_default_block_config_returns_none_when_default_empty(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    from graphon.enums import BuiltinNodeTypes
...
def test_run_datasource_workflow_node_handles_variable_parameter_types(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    from core.datasource.entities.datasource_entities import DatasourceProviderType
...
def test_run_datasource_workflow_node_online_drive_branch(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    from core.datasource.entities.datasource_entities import DatasourceProviderType
...
def test_run_datasource_node_preview_not_published_uses_draft(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    from core.datasource.entities.datasource_entities import DatasourceMessage
...
def test_run_free_workflow_node_delegates_to_handle_result(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
...
def test_publish_customized_pipeline_template_raises_when_workflow_missing(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
...
def test_publish_customized_pipeline_template_raises_when_dataset_missing(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    pipeline = _make_pipeline(workflow_id="wf-1")
    workflow = _make_workflow(workflow_id="wf-1")
    mock_db = mocker.patch("services.rag_pipeline.rag_pipeline.db")
    mock_db.engine = mocker.Mock()
...
def test_get_recommended_plugins_skips_manifest_when_missing(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
...
def test_retry_error_document_raises_when_pipeline_missing(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
...
def test_retry_error_document_raises_when_workflow_missing(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    exec_log = SimpleNamespace(pipeline_id="p1")
...
def test_get_datasource_plugins_returns_empty_for_non_datasource_nodes(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    dataset = _make_dataset()
    pipeline = _make_pipeline()
    workflow = SimpleNamespace(
...
def test_publish_workflow_raises_when_knowledge_index_dataset_missing(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    draft = SimpleNamespace(
        type="workflow",
...
def test_run_datasource_node_preview_raises_when_workflow_missing(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    mocker.patch.object(rag_pipeline_service, "get_published_workflow", return_value=None)
...
def test_run_datasource_node_preview_raises_when_node_missing(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    mocker.patch.object(
...
def test_run_datasource_node_preview_keeps_existing_user_input(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    from core.datasource.entities.datasource_entities import DatasourceMessage
...
def test_run_datasource_node_preview_ignores_non_variable_messages(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    workflow = SimpleNamespace(
        graph_dict={
            "nodes": [
                {
...
def test_set_datasource_variables_raises_when_workflow_missing(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    mocker.patch.object(rag_pipeline_service, "get_draft_workflow", return_value=None)
...
def test_get_datasource_plugins_handles_empty_datasource_data_and_non_published(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    dataset = _make_dataset()
    pipeline = _make_pipeline()
    workflow = SimpleNamespace(
...
def test_get_datasource_plugins_extracts_user_inputs_and_credentials(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    dataset = _make_dataset()
    pipeline = _make_pipeline()
    workflow = SimpleNamespace(
        graph_dict={
...
def test_get_pipeline_returns_pipeline_when_found(mocker: MockerFixture, rag_pipeline_service: RagPipelineService) -> None:
    dataset = _make_dataset()
    pipeline = _make_pipeline()
    mocker.patch("services.rag_pipeline.rag_pipeline.db.session.scalar", side_effect=[dataset, pipeline])
