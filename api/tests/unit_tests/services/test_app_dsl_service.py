...
@pytest.mark.parametrize(
    "payload",
    [
        '{"import_mode":"yaml-content","yaml_content":""}',
        '{"tenant_id":"tenant-1","import_mode":"yaml-content","yaml_content":""}',
        '{"account_id":"account-1","import_mode":"yaml-content","yaml_content":""}',
    ],
)
