...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"auth_type": "unknown"}, ApiProviderAuthType.NONE),
        ({"auth_type": None}, ApiProviderAuthType.NONE),
...
def test_convert_mcp_schema_to_parameter_should_resolve_union_and_null_types() -> None:
    # Arrange
    schema = {
        "type": "object",
        "required": ["choice"],
...
def test_convert_mcp_schema_to_parameter_should_handle_allof_and_preserve_complex_input_schema() -> None:
    # Arrange
    schema = {
        "type": "object",
        "properties": {
...
def test_convert_mcp_schema_to_parameter_should_guard_against_deeply_nested_union_types() -> None:
    # Arrange
