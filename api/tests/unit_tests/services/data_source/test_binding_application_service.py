...
@pytest.mark.parametrize(("action", "disabled"), [(BindingAction.ENABLE, False), (BindingAction.DISABLE, True)])
...
@pytest.mark.parametrize(
    ...
    [
        (BindingAction.ENABLE, "not_found", DataSourceBindingNotFoundError, "Data source binding not found"),
        (BindingAction.ENABLE, "already_enabled", DataSourceBindingStateError, "Data source is already enabled"),
        (BindingAction.DISABLE, "already_disabled", DataSourceBindingStateError, "Data source is already disabled"),
    ],
)
