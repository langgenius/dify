...
def test_submission_actor_and_structured_values_round_trip(actor) -> None:
    submission = FormSubmission(
        ...
        input_snapshot=FrozenJSONObject.from_mapping({"reason": "Looks good", "score": 3}),
        canonical_values=FrozenJSONObject.from_mapping({"reason": "Looks good", "score": 3}),
        submitted_at=_NOW,
        created_at=_NOW,
        updated_at=_NOW,
    )
...
def test_submission_mapper_rejects_malformed_structured_values() -> None:
    submission = FormSubmission(
        ...
        selected_action_id="approve",
        input_snapshot=FrozenJSONObject.from_mapping({"value": 1}),
        canonical_values=FrozenJSONObject.from_mapping({"value": 1}),
        submitted_at=_NOW,
        created_at=_NOW,
        updated_at=_NOW,
    )
...
@pytest.mark.parametrize(
    ...
    [
        FormAuthorizationAuditEvent(
            ...
            payload=FrozenJSONObject.from_mapping({"selected_action_id": "approve"}),
            occurred_at=_NOW,
            created_at=_NOW,
            updated_at=_NOW,
        ),
        ...
        FormAuthorizationAuditEvent(
            ...
            authorization_proof=None,
            payload=FrozenJSONObject.from_mapping({"proof_type": "email_otp"}),
            occurred_at=_NOW,
            created_at=_NOW,
            updated_at=_NOW,
        ),
...
def test_record_values_reject_inconsistent_event_and_submission_invariants() -> None:
    ...
    with pytest.raises(ValueError, match="must not be blank"):
        FormSubmission(
            ...
            actor=AccountSubmissionActor(AccountId("account-1")),
            selected_action_id="  ",
            input_snapshot=FrozenJSONObject.from_mapping({}),
            canonical_values=FrozenJSONObject.from_mapping({}),
            submitted_at=_NOW,
            created_at=_NOW,
            updated_at=_NOW,
        )
