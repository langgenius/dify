...
def test_patch_union_schema_markdown_fills_regular_definition_union_property(tmp_path: Path):
    module = _load_generate_swagger_markdown_docs_module()
...
def test_patch_union_schema_markdown_ignores_specs_without_definitions(tmp_path: Path):
    module = _load_generate_swagger_markdown_docs_module()
    spec_path = tmp_path / "console-swagger.json"
