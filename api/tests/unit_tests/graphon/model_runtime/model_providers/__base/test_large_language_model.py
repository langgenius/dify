...
import graphon.model_runtime.model_providers.__base.large_language_model as llm_module
...
from graphon.model_runtime.entities.model_entities import ModelType, PriceInfo
from graphon.model_runtime.model_providers.__base.large_language_model import _build_llm_result_from_chunks
...
def test_invoke_non_stream_normalizes_and_sets_prompt_messages(llm: _TestLLM, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "graphon.model_runtime.model_providers.__base.large_language_model._invoke_llm_via_runtime",
...
def test_invoke_triggers_error_callbacks_and_raises_transformed(llm: _TestLLM, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "graphon.model_runtime.model_providers.__base.large_language_model._invoke_llm_via_runtime", boom
    )
    cb = SpyCallback()
