...
from graphon.model_runtime.model_providers.__base.large_language_model import _increase_tool_call
...
def test__increase_tool_call():
    ...
    with patch(
        "graphon.model_runtime.model_providers.__base.large_language_model._gen_tool_call_id", mock_id_generator
    ):
...
def test__increase_tool_call__no_id_no_name_first_delta_should_raise():
    ...
    with patch("graphon.model_runtime.model_providers.__base.large_language_model._gen_tool_call_id", MagicMock()):
