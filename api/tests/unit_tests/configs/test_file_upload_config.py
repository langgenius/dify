...
def test_paid_plan_file_size_limit_uses_its_default(monkeypatch: pytest.MonkeyPatch):
...
def test_paid_plan_file_size_limit_can_be_configured_separately(monkeypatch: pytest.MonkeyPatch):
    monkeypatch.setenv("UPLOAD_FILE_SIZE_LIMIT", "23")
