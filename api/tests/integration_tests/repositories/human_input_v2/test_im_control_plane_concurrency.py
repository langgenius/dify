...
def _integration(integration_id: str, workspace_id: str) -> IMIntegration:
    return IMIntegration.create(
        integration_id=IntegrationId(integration_id),
        workspace_id=WorkspaceId(workspace_id),
        provider_tenant=ProviderTenantIdentity(IMProvider.FEISHU, f"provider-{workspace_id}"),
...
def _cleanup(session_maker, integration_ids: tuple[str, ...]) -> None:
