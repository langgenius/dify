...
class TestAdvancedPromptTemplateService:
    ...
    def test_get_prompt_baichuan_model_success(self, container_session: Session, mock_external_service_dependencies):
        """
    ...
    def test_get_prompt_common_model_success(self, container_session: Session, mock_external_service_dependencies):
        """
    ...
    def test_get_common_prompt_chat_app_chat_mode(self, container_session: Session, mock_external_service_dependencies):
        """
    ...
    def test_get_common_prompt_no_context(self, container_session: Session, mock_external_service_dependencies):
        """
    ...
    def test_get_completion_prompt_with_context(self, container_session: Session, mock_external_service_dependencies):
        """
    ...
    def test_get_chat_prompt_with_context(self, container_session: Session, mock_external_service_dependencies):
        """
    ...
    def test_get_chat_prompt_without_context(self, container_session: Session, mock_external_service_dependencies):
        """
    ...
    def test_get_baichuan_prompt_no_context(self, container_session: Session, mock_external_service_dependencies):
        """
    ...
    def test_get_prompt_edge_cases(self, container_session: Session, mock_external_service_dependencies):
        """
        ...
        # Test edge cases
        edge_cases: list[AdvancedPromptTemplateArgs] = [
    ...
    def test_template_immutability(self, container_session: Session, mock_external_service_dependencies):
        """
    ...
    def test_baichuan_template_immutability(self, container_session: Session, mock_external_service_dependencies):
        """
    ...
    def test_context_integration_consistency(self, container_session: Session, mock_external_service_dependencies):
        """
        ...
        test_scenarios: list[AdvancedPromptTemplateArgs] = [
            {
                "app_mode": AppMode.CHAT,
                "model_mode": "completion",
                "model_name": "gpt-3.5-turbo",
