...
class TestTagService:
    @pytest.fixture
    def current_user_stub(self) -> Generator[_CurrentUserStub, None, None]:
    ...
    def test_get_tags_success(self, db_session_with_containers: Session, current_user_stub: _CurrentUserStub) -> None:

        fake = Faker()
        account, tenant = self._create_test_account_and_tenant(db_session_with_containers, current_user_stub)

        tags = self._create_test_tags(db_session_with_containers, current_user_stub, tenant.id, TagType.KNOWLEDGE, 3)

        dataset = self._create_test_dataset(db_session_with_containers, current_user_stub, tenant.id)
        self._create_test_tag_bindings(db_session_with_containers, current_user_stub, tags[:2], dataset.id, tenant.id)
    ...
    def test_get_tags_with_keyword_filter(
        self, db_session_with_containers: Session, current_user_stub: _CurrentUserStub
    ) -> None:

        fake = Faker()
        account, tenant = self._create_test_account_and_tenant(db_session_with_containers, current_user_stub)

        tags = self._create_test_tags(db_session_with_containers, current_user_stub, tenant.id, TagType.APP, 3)
    ...
    def test_get_tags_empty_result(
        self, db_session_with_containers: Session, current_user_stub: _CurrentUserStub
    ) -> None:
    ...
    def test_get_target_ids_by_tag_ids_success(
        ...
        for i in range(2):
            ...
            self._create_test_tag_bindings(
                db_session_with_containers, current_user_stub, tags_to_bind, dataset.id, tenant.id
            )
    ...
    def test_get_target_ids_by_tag_ids_match_all(
        ...
        account, tenant = self._create_test_account_and_tenant(db_session_with_containers, current_user_stub)
        tags = self._create_test_tags(db_session_with_containers, current_user_stub, tenant.id, TagType.KNOWLEDGE, 2)
        dataset_with_all_tags = self._create_test_dataset(db_session_with_containers, current_user_stub, tenant.id)
        dataset_with_one_tag = self._create_test_dataset(db_session_with_containers, current_user_stub, tenant.id)
        self._create_test_tag_bindings(
    ...
    def test_get_tag_by_tag_name_success(
        self, db_session_with_containers: Session, current_user_stub: _CurrentUserStub
    ) -> None:
        ...
        tags = self._create_test_tags(db_session_with_containers, current_user_stub, tenant.id, TagType.APP, 2)
    ...
    def test_get_tag_by_tag_name_no_matches(
        ...
        result = TagService.get_tag_by_tag_name(
            TagType.KNOWLEDGE, tenant.id, "nonexistent_tag", db_session_with_containers
        )
    ...
    def test_get_tags_by_target_id_success(
        ...
        app = self._create_test_app(db_session_with_containers, current_user_stub, tenant.id)
        self._create_test_tag_bindings(db_session_with_containers, current_user_stub, tags, app.id, tenant.id)
    ...
    def test_save_tags_success(self, db_session_with_containers: Session, current_user_stub: _CurrentUserStub) -> None:
    ...
    def test_get_tag_binding_count_success(
        ...
        dataset = self._create_test_dataset(db_session_with_containers, current_user_stub, tenant.id)
        self._create_test_tag_bindings(db_session_with_containers, current_user_stub, [tags[0]], dataset.id, tenant.id)
    ...
    def test_delete_tag_success(self, db_session_with_containers: Session, current_user_stub: _CurrentUserStub) -> None:

        fake = Faker()
        account, tenant = self._create_test_account_and_tenant(db_session_with_containers, current_user_stub)

        tag = self._create_test_tags(db_session_with_containers, current_user_stub, tenant.id, TagType.APP, 1)[0]

        app = self._create_test_app(db_session_with_containers, current_user_stub, tenant.id)
        self._create_test_tag_bindings(db_session_with_containers, current_user_stub, [tag], app.id, tenant.id)
    ...
    def test_delete_tag_not_found_error(
        self, db_session_with_containers: Session, current_user_stub: _CurrentUserStub
    ) -> None:
    ...
    def test_save_tag_binding_success(
        self, db_session_with_containers: Session, current_user_stub: _CurrentUserStub
    ) -> None:
    ...
    def test_save_tag_binding_invalid_target_type(
        ...
        tag = self._create_test_tags(db_session_with_containers, current_user_stub, tenant.id, TagType.KNOWLEDGE, 1)[0]
    ...
    def test_delete_tag_binding_success(
        self, db_session_with_containers: Session, current_user_stub: _CurrentUserStub
    ) -> None:
        ...
        dataset = self._create_test_dataset(db_session_with_containers, current_user_stub, tenant.id)
        self._create_test_tag_bindings(db_session_with_containers, current_user_stub, tags, dataset.id, tenant.id)
