...
class TestDatasetServiceDeleteDataset:
    ...
    def test_delete_dataset_with_documents_success(self, container_session: Session):
        ...
        # Arrange
        owner, tenant = DatasetDeleteIntegrationDataFactory.create_account_with_tenant(container_session)
    ...
    def test_delete_dataset_with_doc_form_none_indexing_technique_exists(self, container_session: Session):
    ...
    def test_delete_dataset_not_found(self, container_session: Session):
        ...
        # Arrange
        owner, _ = DatasetDeleteIntegrationDataFactory.create_account_with_tenant(container_session)
        ...
        with patch(
            ...
            result = DatasetService.delete_dataset(missing_dataset_id, owner, session=container_session)
