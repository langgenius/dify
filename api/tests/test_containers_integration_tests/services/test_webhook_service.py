...
class TestWebhookService:
    ...
    def test_trigger_workflow_execution_no_tenant_owner(self, test_data, mock_external_dependencies, flask_app_with_containers):
    ...
    def test_generate_webhook_response_custom_json(self):
        ...
        node_config = {
            "data": {
                "status_code": 201,
                "response_body": '{"result": "created", "id": 123}'
            }
        }
    ...
    def test_generate_webhook_response_custom_text(self):
        ...
        node_config = {
            "data": {
                "status_code": 202,
                "response_body": "Request accepted for processing"
            }
        }
