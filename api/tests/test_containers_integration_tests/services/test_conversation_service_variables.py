...
class ConversationServiceVariableIntegrationFactory:
    ...
    def create_variable(
        ...
        *,
        ...
        container_session.add(row)
        container_session.commit()
        return row


@pytest.fixture
def real_conversation_service_session_factory(container_app: Flask):
    del container_app


class TestConversationServiceVariables:
    def test_get_conversational_variable_success(
        self, container_session: Session, real_conversation_service_session_factory
    ):
        del real_conversation_service_session_factory
        factory = ConversationServiceVariableIntegrationFactory
        app, account = factory.create_app_and_account(container_session)
        conversation = factory.create_conversation(container_session, app, account)
    ...
    def test_update_conversation_variable_success(
        ...
        persisted = container_session.get(ConversationVariable, (existing.id, conversation.id))
...
class TestConversationServicePaginationWithContainers:
    def test_pagination_by_last_id_raises_error_when_last_id_missing(self, container_session: Session):
        factory = ConversationServiceVariableIntegrationFactory
        app, account = factory.create_app_and_account(container_session)
    ...
    def test_pagination_by_last_id_with_default_desc_updated_at(self, container_session: Session):
        factory = ConversationServiceVariableIntegrationFactory
        app, account = factory.create_app_and_account(container_session)
    ...
    def test_pagination_by_last_id_with_name_sort(self, container_session: Session):
        factory = ConversationServiceVariableIntegrationFactory
        app, account = factory.create_app_and_account(container_session)
        alpha = factory.create_conversation(container_session, app, account, name="Alpha")
        beta = factory.create_conversation(container_session, app, account, name="Beta")
        gamma = factory.create_conversation(container_session, app, account, name="Gamma")
    ...
    def test_pagination_filters_to_end_user_api_source(self, container_session: Session):
        factory = ConversationServiceVariableIntegrationFactory
        app, account = factory.create_app_and_account(container_session)
        end_user = factory.create_end_user(container_session, app)
    ...
    def test_pagination_filters_to_account_console_source(self, container_session: Session):
        factory = ConversationServiceVariableIntegrationFactory
        app, account = factory.create_app_and_account(container_session)
        end_user = factory.create_end_user(container_session, app)
        account_conversation = factory.create_conversation(
