...
class TestWorkflowDraftVariableService:
    ...
    def _create_test_app(
        self, container_session: Session, mock_external_service_dependencies, fake: Faker | None = None
    ):
        """
    ...
    def _create_test_workflow(self, container_session: Session, app, fake: Faker | None = None):
        """
    ...
    def _create_test_variable(
        ...
        fake = fake or Faker()
        if user_id is None:
            app = container_session.query(App).filter_by(id=app_id).first()
        ...
        container_session.add(variable)
        container_session.commit()
        return variable

    def test_get_variable_success(self, container_session: Session, mock_external_service_dependencies):
        """
        ...
        """
        fake = Faker()
        app = self._create_test_app(container_session, mock_external_service_dependencies, fake=fake)
        ...
        service = WorkflowDraftVariableService(container_session)
    ...
    def test_get_variable_not_found(self, container_session: Session, mock_external_service_dependencies):
        """
    ...
    def test_get_draft_variables_by_selectors_success(
        ...
        var1 = self._create_test_variable(
            container_session, app.id, CONVERSATION_VARIABLE_NODE_ID, "var1", var1_value, fake=fake
        )
        var2 = self._create_test_variable(
            container_session, app.id, CONVERSATION_VARIABLE_NODE_ID, "var2", var2_value, fake=fake
        )
    ...
    def test_list_node_variables_success(self, container_session: Session, mock_external_service_dependencies):
        """
    ...
    def test_list_conversation_variables_success(self, container_session: Session, mock_external_service_dependencies):
        """
        ...
        conv_var1 = self._create_test_variable(
            container_session, app.id, CONVERSATION_VARIABLE_NODE_ID, "conv_var1", conv_var1_value, fake=fake
        )
        conv_var2 = self._create_test_variable(
            container_session, app.id, CONVERSATION_VARIABLE_NODE_ID, "conv_var2", conv_var2_value, fake=fake
        )
    ...
    def test_update_variable_success(self, container_session: Session, mock_external_service_dependencies):
        """
        ...
        container_session.refresh(variable)
        assert variable.name == "new_name"
        assert variable.get_value().value == new_value.value
        assert variable.last_edited_at is not None

    def test_update_variable_not_editable(self, container_session: Session, mock_external_service_dependencies):
        """
    ...
    def test_reset_conversation_variable_success(self, container_session: Session, mock_external_service_dependencies):
        """
        ...
        fake = Faker()
        app = self._create_test_app(container_session, mock_external_service_dependencies, fake=fake)
        workflow = self._create_test_workflow(container_session, app, fake=fake)
    ...
    def test_delete_variable_success(self, container_session: Session, mock_external_service_dependencies):
        """
        ...
        test_value = StringSegment(value=fake.word())
        variable = self._create_test_variable(
            container_session, app.id, CONVERSATION_VARIABLE_NODE_ID, "test_var", test_value, fake=fake
        )

        assert container_session.query(WorkflowDraftVariable).filter_by(id=variable.id).first() is not None
        service = WorkflowDraftVariableService(container_session)
        service.delete_variable(variable)
        assert container_session.query(WorkflowDraftVariable).filter_by(id=variable.id).first() is None

    def test_delete_workflow_variables_success(self, container_session: Session, mock_external_service_dependencies):
        """
        ...
        other_app = self._create_test_app(container_session, mock_external_service_dependencies, fake=fake)
        ...
        app_variables = container_session.query(WorkflowDraftVariable).filter_by(app_id=app.id).all()
        other_app_variables = container_session.query(WorkflowDraftVariable).filter_by(app_id=other_app.id).all()
        ...
        app_variables_after = container_session.query(WorkflowDraftVariable).filter_by(app_id=app.id).all()
        other_app_variables_after = container_session.query(WorkflowDraftVariable).filter_by(app_id=other_app.id).all()
    ...
    def test_draft_variables_are_isolated_between_users(
        ...
        user_a_remaining = (
            container_session.query(WorkflowDraftVariable).filter_by(app_id=app.id, user_id=user_a).count()
        )
        user_b_remaining = (
            container_session.query(WorkflowDraftVariable).filter_by(app_id=app.id, user_id=user_b).count()
        )
        assert user_a_remaining == 0
        assert user_b_remaining == 1

    def test_delete_node_variables_success(self, container_session: Session, mock_external_service_dependencies):
        """
        ...
        target_node_variables = (
            container_session.query(WorkflowDraftVariable).filter_by(app_id=app.id, node_id=node_id).all()
        )
        other_node_variables = (
            container_session.query(WorkflowDraftVariable).filter_by(app_id=app.id, node_id="other_node").all()
        )
        conv_variables = (
            container_session.query(WorkflowDraftVariable)
    ...
    def test_list_system_variables_success(self, container_session: Session, mock_external_service_dependencies):
        """
        ...
        self._create_test_variable(
            container_session, app.id, CONVERSATION_VARIABLE_NODE_ID, "conv_var", conv_var_value, fake=fake
        )
        service = WorkflowDraftVariableService(container_session)
    ...
    def test_get_variable_by_name_success(self, container_session: Session, mock_external_service_dependencies):
        """
        ...
        conv_var = self._create_test_variable(
            container_session, app.id, CONVERSATION_VARIABLE_NODE_ID, "test_conv_var", test_value, fake=fake
        )
    ...
    def test_get_variable_by_name_not_found(self, container_session: Session, mock_external_service_dependencies):
        """
