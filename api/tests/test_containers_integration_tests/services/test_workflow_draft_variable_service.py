...
class TestWorkflowDraftVariableService:
    ...
    def _create_test_app(
        self, db_session_with_containers: Session, mock_external_service_dependencies, fake: Faker = None
    ):
        """
    ...
    def _create_test_workflow(self, db_session_with_containers: Session, app, fake: Faker = None):
        """
