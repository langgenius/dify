...
class TestDisableSegmentFromIndexTask:
    ...
    def _create_test_account_and_tenant(self, container_session: Session) -> tuple[Account, Tenant]:
        """
    ...
    def _create_test_dataset(self, container_session: Session, tenant: Tenant, account: Account) -> Dataset:
        """
    ...
    def test_disable_segment_success(self, container_session: Session, mock_index_processor):
        """
        ...
        dataset = self._create_test_dataset(container_session, tenant, account)
        document = self._create_test_document(container_session, dataset, tenant, account)
        segment = self._create_test_segment(container_session, document, dataset, tenant, account)
        ...
        container_session.refresh(segment)
        assert segment.id is not None

    def test_disable_segment_not_found(self, container_session: Session, mock_index_processor):
        """
    ...
    def test_disable_segment_not_completed(self, container_session: Session, mock_index_processor):
        """
        ...
        segment = self._create_test_segment(
            container_session, document, dataset, tenant, account, status=SegmentStatus.INDEXING, enabled=True
        )
    ...
    def test_disable_segment_no_dataset(self, container_session: Session, mock_index_processor):
        """
    ...
    def test_disable_segment_no_document(self, container_session: Session, mock_index_processor):
        """
    ...
    def test_disable_segment_document_disabled(self, container_session: Session, mock_index_processor):
        """
    ...
    def test_disable_segment_document_archived(self, container_session: Session, mock_index_processor):
        """
    ...
    def test_disable_segment_document_indexing_not_completed(self, container_session: Session, mock_index_processor):
        """
    ...
    def test_disable_segment_index_processor_exception(self, container_session: Session, mock_index_processor):
        """
    ...
    def test_disable_segment_different_doc_forms(self, container_session: Session, mock_index_processor):
        """
        ...
        for doc_form in doc_forms:
            ...
            account, tenant = self._create_test_account_and_tenant(container_session)
            dataset = self._create_test_dataset(container_session, tenant, account)
            document = self._create_test_document(container_session, dataset, tenant, account, doc_form=doc_form)
            segment = self._create_test_segment(container_session, document, dataset, tenant, account)
    ...
    def test_disable_segment_redis_cache_handling(self, container_session: Session, mock_index_processor):
        """
        ...
        segment2 = self._create_test_segment(container_session, document, dataset, tenant, account)
        result2 = disable_segment_from_index_task(segment2.id)

        # Assert: Verify task still works without cache
        assert result2 is None

    def test_disable_segment_performance_timing(self, container_session: Session, mock_index_processor):
        """
    ...
    def test_disable_segment_database_session_management(self, container_session: Session, mock_index_processor):
        """
    ...
    def test_disable_segment_concurrent_execution(self, container_session: Session, mock_index_processor):
        """
