...
class TestDeleteDraftVariablesBatch:
    ...
    def test_delete_draft_variables_batch_logs_progress(self, mock_offload_cleanup, db_session_with_containers, caplog: pytest.LogCaptureFixture):
...
class TestDeleteDraftVariableOffloadData:
    ...
    @patch("extensions.ext_storage.storage")
    def test_delete_draft_variable_offload_data_storage_failure(self, mock_storage, db_session_with_containers, caplog: pytest.LogCaptureFixture):
