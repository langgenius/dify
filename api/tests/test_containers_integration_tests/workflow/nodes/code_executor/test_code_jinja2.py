...
class TestJinja2CodeExecutor(CodeExecutorTestMixin):
    ...
    def test_jinja2(self, container_app: Flask):
    ...
    def test_jinja2_with_code_template(self, container_app: Flask):
    ...
    def test_jinja2_get_runner_script(self, container_app: Flask):
    ...
    def test_jinja2_template_with_special_characters(self, container_app: Flask):
        """
