...
class TestJavaScriptCodeExecutor(CodeExecutorTestMixin):
    ...
    def test_javascript_plain(self, container_app: Flask):
    ...
    def test_javascript_json(self, container_app: Flask):
    ...
    def test_javascript_with_code_template(self, container_app: Flask):
    ...
    def test_javascript_get_runner_script(self, container_app: Flask):
