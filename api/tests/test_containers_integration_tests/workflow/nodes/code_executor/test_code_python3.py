...
class TestPython3CodeExecutor(CodeExecutorTestMixin):
    ...
    def test_python3_plain(self, container_app: Flask):
    ...
    def test_python3_json(self, container_app: Flask):
    ...
    def test_python3_with_code_template(self, container_app: Flask):
    ...
    def test_python3_get_runner_script(self, container_app: Flask):
