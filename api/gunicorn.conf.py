...
#
# To ensure correct behavior, defer any initialization or imports that depend
# on monkey-patching to the `post_patch` hook below, or use a
# gevent_events subscriber as shown.
#
...
# NOTE(QuantumGhost): here we cannot use post_fork to patch gRPC, as gRPC
# gevent compatibility must be enabled after patching stdlib.
