...
@studio_ns.route("/apps/<uuid:app_id>/workflow/statistics/daily-terminals")
...
@studio_ns.route("/apps/<uuid:app_id>/workflow/statistics/token-costs")
...
@studio_ns.route("/apps/<uuid:app_id>/workflow/statistics/average-app-interactions")
