...
workflow_draft_variable_without_value_model = studio_ns.model(
    "WorkflowDraftVariableWithoutValue", _WORKFLOW_DRAFT_VARIABLE_WITHOUT_VALUE_FIELDS
)

workflow_draft_variable_model = studio_ns.model("WorkflowDraftVariable", _WORKFLOW_DRAFT_VARIABLE_FIELDS)

workflow_draft_env_variable_model = studio_ns.model("WorkflowDraftEnvVariable", _WORKFLOW_DRAFT_ENV_VARIABLE_FIELDS)
...
workflow_draft_env_variable_list_model = studio_ns.model(
...
workflow_draft_variable_list_without_value_model = studio_ns.model(
...
workflow_draft_variable_list_model = studio_ns.model(
...
@studio_ns.route("/apps/<uuid:app_id>/workflows/draft/variables")
class WorkflowVariableCollectionApi(Resource):
    @studio_ns.expect(studio_ns.models[WorkflowDraftVariableListQuery.__name__])
    @studio_ns.doc("get_workflow_variables")
    @studio_ns.doc(description="Get draft workflow variables")
    @studio_ns.doc(params={"app_id": "Application ID"})
    @studio_ns.doc(params={"page": "Page number (1-100000)", "limit": "Number of items per page (1-100)"})
    @studio_ns.response(
    ...
    @studio_ns.doc("delete_workflow_variables")
    @studio_ns.doc(description="Delete all draft workflow variables")
    @studio_ns.response(204, "Workflow variables deleted successfully")
    @_api_prerequisite
...
@studio_ns.route("/apps/<uuid:app_id>/workflows/draft/nodes/<string:node_id>/variables")
class NodeVariableCollectionApi(Resource):
    @studio_ns.doc("get_node_variables")
    @studio_ns.doc(description="Get variables for a specific node")
    @studio_ns.doc(params={"app_id": "Application ID", "node_id": "Node ID"})
    @studio_ns.response(200, "Node variables retrieved successfully", workflow_draft_variable_list_model)
    @_api_prerequisite
    ...
    @studio_ns.doc("delete_node_variables")
    @studio_ns.doc(description="Delete all variables for a specific node")
    @studio_ns.response(204, "Node variables deleted successfully")
    @_api_prerequisite
...
@studio_ns.route("/apps/<uuid:app_id>/workflows/draft/variables/<uuid:variable_id>")
class VariableApi(Resource):
    _PATCH_NAME_FIELD = "name"
    _PATCH_VALUE_FIELD = "value"

    @studio_ns.doc("get_variable")
    @studio_ns.doc(description="Get a specific workflow variable")
    @studio_ns.doc(params={"app_id": "Application ID", "variable_id": "Variable ID"})
    @studio_ns.response(200, "Variable retrieved successfully", workflow_draft_variable_model)
    @studio_ns.response(404, "Variable not found")
    @_api_prerequisite
    ...
    @studio_ns.doc("update_variable")
    @studio_ns.doc(description="Update a workflow variable")
    @studio_ns.expect(studio_ns.models[WorkflowDraftVariableUpdatePayload.__name__])
    @studio_ns.response(200, "Variable updated successfully", workflow_draft_variable_model)
    @studio_ns.response(404, "Variable not found")
    @_api_prerequisite
    @marshal_with(workflow_draft_variable_model)
    def patch(self, app_model: App, variable_id: str):
        ...
        args_model = WorkflowDraftVariableUpdatePayload.model_validate(studio_ns.payload or {})
    ...
    @studio_ns.doc("delete_variable")
    @studio_ns.doc(description="Delete a workflow variable")
    @studio_ns.response(204, "Variable deleted successfully")
    @studio_ns.response(404, "Variable not found")
    @_api_prerequisite
...
@studio_ns.route("/apps/<uuid:app_id>/workflows/draft/variables/<uuid:variable_id>/reset")
class VariableResetApi(Resource):
    @studio_ns.doc("reset_variable")
    @studio_ns.doc(description="Reset a workflow variable to its default value")
    @studio_ns.doc(params={"app_id": "Application ID", "variable_id": "Variable ID"})
    @studio_ns.response(200, "Variable reset successfully", workflow_draft_variable_model)
    @studio_ns.response(204, "Variable reset (no content)")
    @studio_ns.response(404, "Variable not found")
    @_api_prerequisite
...
@studio_ns.route("/apps/<uuid:app_id>/workflows/draft/conversation-variables")
class ConversationVariableCollectionApi(Resource):
    @studio_ns.doc("get_conversation_variables")
    @studio_ns.doc(description="Get conversation variables for workflow")
    @studio_ns.doc(params={"app_id": "Application ID"})
    @studio_ns.response(200, "Conversation variables retrieved successfully", workflow_draft_variable_list_model)
    @studio_ns.response(404, "Draft workflow not found")
    @_api_prerequisite
    @marshal_with(workflow_draft_variable_list_model)
    def get(self, app_model: App):
    ...
    @studio_ns.expect(studio_ns.models[ConversationVariableUpdatePayload.__name__])
    @studio_ns.doc("update_conversation_variables")
    @studio_ns.doc(description="Update conversation variables for workflow draft")
    @studio_ns.doc(params={"app_id": "Application ID"})
    @studio_ns.response(200, "Conversation variables updated successfully")
    @setup_required
    @login_required
    @account_initialization_required
    @edit_permission_required
    ...
    def post(self, app_model: App):
        payload = ConversationVariableUpdatePayload.model_validate(studio_ns.payload or {})
...
@studio_ns.route("/apps/<uuid:app_id>/workflows/draft/system-variables")
class SystemVariableCollectionApi(Resource):
    @studio_ns.doc("get_system_variables")
    @studio_ns.doc(description="Get system variables for workflow")
    @studio_ns.doc(params={"app_id": "Application ID"})
    @studio_ns.response(200, "System variables retrieved successfully", workflow_draft_variable_list_model)
    @_api_prerequisite
    @marshal_with(workflow_draft_variable_list_model)
    def get(self, app_model: App):
...
@studio_ns.route("/apps/<uuid:app_id>/workflows/draft/environment-variables")
class EnvironmentVariableCollectionApi(Resource):
    @studio_ns.doc("get_environment_variables")
    @studio_ns.doc(description="Get environment variables for workflow")
    @studio_ns.doc(params={"app_id": "Application ID"})
    @studio_ns.response(200, "Environment variables retrieved successfully")
    @studio_ns.response(404, "Draft workflow not found")
    @_api_prerequisite
    def get(self, app_model: App):
        """
    ...
    @studio_ns.expect(studio_ns.models[EnvironmentVariableUpdatePayload.__name__])
    @studio_ns.doc("update_environment_variables")
    @studio_ns.doc(description="Update environment variables for workflow draft")
    @studio_ns.doc(params={"app_id": "Application ID"})
    @studio_ns.response(200, "Environment variables updated successfully")
    @setup_required
    @login_required
    @account_initialization_required
    @edit_permission_required
    @get_app_model(mode=[AppMode.ADVANCED_CHAT, AppMode.WORKFLOW])
    def post(self, app_model: App):
        payload = EnvironmentVariableUpdatePayload.model_validate(studio_ns.payload or {})
