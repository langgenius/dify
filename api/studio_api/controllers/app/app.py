...
class AppListApi(Resource):
    ...
    def post(self):
        """Create app"""
        current_user, current_tenant_id = current_account_with_tenant()
        args = CreateAppPayload.model_validate(studio_ns.payload)
...
class AppApi(Resource):
    ...
    def put(self, app_model):
        """Update app"""
        args = UpdateAppPayload.model_validate(studio_ns.payload)
...
class AppCopyApi(Resource):
    ...
    def post(self, app_model):
        ...
        args = CopyAppPayload.model_validate(studio_ns.payload or {})
...
class AppNameApi(Resource):
    ...
    @edit_permission_required
    def post(self, app_model):
        args = AppNamePayload.model_validate(studio_ns.payload)
...
class AppIconApi(Resource):
    ...
    @edit_permission_required
    def post(self, app_model):
        args = AppIconPayload.model_validate(studio_ns.payload or {})
...
class AppSiteStatus(Resource):
    ...
    @edit_permission_required
    def post(self, app_model):
        args = AppSiteStatusPayload.model_validate(studio_ns.payload)
...
class AppApiStatus(Resource):
    ...
    @get_app_model(mode=None)
    def post(self, app_model):
        args = AppApiStatusPayload.model_validate(studio_ns.payload)
...
class AppTraceApi(Resource):
    ...
    def post(self, app_model):
        # add app trace
        args = AppTracePayload.model_validate(studio_ns.payload)
