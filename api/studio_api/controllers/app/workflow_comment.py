...
@studio_ns.route("/apps/<uuid:app_id>/workflow/comments")
class WorkflowCommentListApi(Resource):
    ...
    def post(self, app_model: App):
        ...
        payload = WorkflowCommentCreatePayload.model_validate(studio_ns.payload or {})
...
@studio_ns.route("/apps/<uuid:app_id>/workflow/comments/<string:comment_id>")
class WorkflowCommentDetailApi(Resource):
    ...
    def put(self, app_model: App, comment_id: str):
        ...
        payload = WorkflowCommentUpdatePayload.model_validate(studio_ns.payload or {})
...
@studio_ns.route("/apps/<uuid:app_id>/workflow/comments/<string:comment_id>/resolve")
...
@studio_ns.route("/apps/<uuid:app_id>/workflow/comments/<string:comment_id>/replies")
class WorkflowCommentReplyApi(Resource):
    ...
    def post(self, app_model: App, comment_id: str):
        ...
        payload = WorkflowCommentReplyPayload.model_validate(studio_ns.payload or {})
...
@studio_ns.route("/apps/<uuid:app_id>/workflow/comments/<string:comment_id>/replies/<string:reply_id>")
...
@studio_ns.route("/apps/<uuid:app_id>/workflow/comments/mention-users")
