...
class AgentRosterListApi(Resource):
    ...
    def post(self):
        ...
        payload = RosterAgentCreatePayload.model_validate(studio_ns.payload or {})
...
@studio_ns.route("/agents/invite-options")
...
@studio_ns.route("/agents/<uuid:agent_id>")
class AgentRosterDetailApi(Resource):
    ...
    def patch(self, agent_id):
        account, tenant_id = current_account_with_tenant()
        payload = RosterAgentUpdatePayload.model_validate(studio_ns.payload or {})
...
@studio_ns.route("/agents/<uuid:agent_id>/versions")
...
@studio_ns.route("/agents/<uuid:agent_id>/versions/<uuid:version_id>")
