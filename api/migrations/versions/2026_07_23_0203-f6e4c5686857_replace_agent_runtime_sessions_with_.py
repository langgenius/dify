...
def upgrade():
    ...
    with op.batch_alter_table('agent_workspace_bindings', schema=None) as batch_op:
        batch_op.create_index('agent_workspace_binding_agent_active_unique', ['tenant_id', 'workspace_id', 'agent_id', 'active_guard'], unique=True)
...
def downgrade():
    ...
    with op.batch_alter_table('agent_workspace_bindings', schema=None) as batch_op:
        ...
        batch_op.drop_index('agent_workspace_binding_agent_active_unique')
