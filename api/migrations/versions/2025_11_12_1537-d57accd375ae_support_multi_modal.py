...
def upgrade():
    ...
    with op.batch_alter_table('segment_attachment_bindings', schema=None) as batch_op:
        ...
        batch_op.create_index('segment_attachment_binding_dataset_idx', ['dataset_id'], unique=False)
        batch_op.create_index('segment_attachment_binding_document_idx', ['document_id'], unique=False)
        batch_op.create_index('segment_attachment_binding_segment_idx', ['segment_id'], unique=False)
        batch_op.create_index('segment_attachment_binding_tenant_idx', ['tenant_id'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('segment_attachment_bindings', schema=None) as batch_op:
        batch_op.drop_index('segment_attachment_binding_tenant_idx')
        batch_op.drop_index('segment_attachment_binding_segment_idx')
        batch_op.drop_index('segment_attachment_binding_document_idx')
        batch_op.drop_index('segment_attachment_binding_dataset_idx')
