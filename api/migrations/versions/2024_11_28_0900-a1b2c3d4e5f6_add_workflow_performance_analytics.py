...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('workflow_run_id', models.StringUUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('node_execution_id', models.StringUUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('dismissed_by', models.StringUUID(), nullable=True),
