...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('successful_nodes', sa.Integer(), nullable=False, server_default='0'),
        sa.Column('failed_nodes', sa.Integer(), nullable=False, server_default='0'),
        sa.Column('cached_nodes', sa.Integer(), nullable=False, server_default='0'),
        ...
        sa.Column('cache_hit_rate', sa.Float(), nullable=False, server_default='0.0', comment='Percentage of cache hits'),
        ...
        sa.PrimaryKeyConstraint('id', name='workflow_performance_metrics_pkey'),
    ...
    op.create_index('idx_wf_perf_status', 'workflow_performance_metrics', ['execution_status'])
    ...
    op.create_table(
        ...
        sa.Column('node_execution_id', models.types.StringUUID(), nullable=False),
        ...
        sa.Column('extra_info', sa.JSON(), nullable=True),
        sa.PrimaryKeyConstraint('id', name='workflow_node_performance_pkey'),
    ...
    op.create_index('idx_wf_node_perf_workflow_run_id', 'workflow_node_performance', ['workflow_run_id'])
    ...
    op.create_table(
        ...
        sa.Column('recommendation_steps', sa.JSON(), nullable=False),
        ...
        sa.Column('sample_workflow_runs', sa.JSON(), nullable=True),
        sa.Column('status', sa.String(length=20), nullable=False, server_default='active', comment='active, dismissed, implemented, obsolete'),
        sa.Column('dismissed_by', models.types.StringUUID(), nullable=True),
        sa.Column('dismissed_at', sa.DateTime(), nullable=True),
        sa.Column('dismissed_reason', sa.Text(), nullable=True),
        sa.Column('extra_info', sa.JSON(), nullable=True),
        sa.PrimaryKeyConstraint('id', name='workflow_optimization_recommendations_pkey')
    )
    ...
    op.create_table(
        ...
        sa.Column('total_time_saved', sa.Float(), nullable=False, server_default='0.0', comment='Cumulative time saved'),
        sa.Column('extra_info', sa.JSON(), nullable=True),
        sa.PrimaryKeyConstraint('id', name='workflow_cache_entries_pkey')
    )
    ...
    op.create_table(
        ...
        sa.Column('extra_info', sa.JSON(), nullable=True),
        sa.PrimaryKeyConstraint('id', name='workflow_performance_trends_pkey'),
...
def downgrade():
    ...
    # Drop workflow_performance_trends table
    op.drop_index('idx_wf_trend_workflow_id', table_name='workflow_performance_trends')
    op.drop_index('idx_wf_trend_period', table_name='workflow_performance_trends')
    op.drop_index('idx_wf_trend_metric_type', table_name='workflow_performance_trends')
    op.drop_table('workflow_performance_trends')

    # Drop workflow_cache_entries table
    op.drop_index('idx_wf_cache_node_type', table_name='workflow_cache_entries')
    op.drop_index('idx_wf_cache_last_accessed', table_name='workflow_cache_entries')
    op.drop_index('idx_wf_cache_key', table_name='workflow_cache_entries')
    op.drop_index('idx_wf_cache_hit_count', table_name='workflow_cache_entries')
    op.drop_index('idx_wf_cache_expires_at', table_name='workflow_cache_entries')
    op.drop_table('workflow_cache_entries')

    # Drop workflow_optimization_recommendations table
    op.drop_index('idx_wf_opt_workflow_id', table_name='workflow_optimization_recommendations')
    op.drop_index('idx_wf_opt_status', table_name='workflow_optimization_recommendations')
    op.drop_index('idx_wf_opt_severity', table_name='workflow_optimization_recommendations')
    op.drop_index('idx_wf_opt_created_at', table_name='workflow_optimization_recommendations')
    op.drop_index('idx_wf_opt_category', table_name='workflow_optimization_recommendations')
    op.drop_index('idx_wf_opt_app_id', table_name='workflow_optimization_recommendations')
    op.drop_table('workflow_optimization_recommendations')

    # Drop workflow_node_performance table
    op.drop_index('idx_wf_node_perf_workflow_run_id', table_name='workflow_node_performance')
    op.drop_index('idx_wf_node_perf_node_type', table_name='workflow_node_performance')
    op.drop_index('idx_wf_node_perf_node_id', table_name='workflow_node_performance')
    op.drop_index('idx_wf_node_perf_created_at', table_name='workflow_node_performance')
    op.drop_table('workflow_node_performance')

    # Drop workflow_performance_metrics table
    op.drop_index('idx_wf_perf_workflow_id', table_name='workflow_performance_metrics')
    op.drop_index('idx_wf_perf_status', table_name='workflow_performance_metrics')
    op.drop_index('idx_wf_perf_created_at', table_name='workflow_performance_metrics')
    op.drop_index('idx_wf_perf_app_id', table_name='workflow_performance_metrics')
