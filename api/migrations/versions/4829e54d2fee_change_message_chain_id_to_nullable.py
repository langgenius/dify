...
def upgrade():
    ...
    with op.batch_alter_table("message_agent_thoughts", schema=None) as batch_op:
        batch_op.alter_column("message_chain_id", existing_type=postgresql.UUID(), nullable=True)
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table("message_agent_thoughts", schema=None) as batch_op:
        batch_op.alter_column("message_chain_id", existing_type=postgresql.UUID(), nullable=False)
