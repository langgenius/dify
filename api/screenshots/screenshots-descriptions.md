...
1. Has a basic test workflow (httpbin GET)
1. Already connected at some point → sees many branches
1. Shows successful GitHub OAuth + repo selection screen
1. Branch management view before creating new branch
1. Connected workflow with push/pull functionality enabled
1. Final push dialog when user wants to commit current workflow state
