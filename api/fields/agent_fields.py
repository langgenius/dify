...
class AgentRosterResponse(ResponseModel):
    ...
    active_config_snapshot: AgentConfigSnapshotSummaryResponse = None
...
class AgentLogConversationItemResponse(ResponseModel):
    ...
    unread: bool
    source: AgentLogSourceResponse = None
...
class WorkflowAgentComposerResponse(ResponseModel):
    ...
    agent: AgentComposerAgentResponse = None
    active_config_snapshot: AgentConfigSnapshotSummaryResponse = None
    binding: AgentComposerBindingResponse = None
    ...
    impact_summary: AgentComposerImpactResponse = None
