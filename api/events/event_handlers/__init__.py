...
from .create_installed_app_when_app_created import (
    handle as handle_create_installed_app_when_app_created,
)
from .create_site_record_when_app_created import (
    handle as handle_create_site_record_when_app_created,
)
...
from .update_provider_when_message_created import (
    handle as handle_update_provider_when_message_created,
)
