...
from .sync_knowledge_fs_bindings_when_app_published_workflow_updated import (
    handle as handle_sync_knowledge_fs_bindings_when_app_published_workflow_updated,
)
...
__all__ = [
    ...
    "handle_sync_knowledge_fs_bindings_when_app_published_workflow_updated",
