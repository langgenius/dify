...
class RedisClientWrapper:
    ...
    if TYPE_CHECKING:
        ...
        def setex(self, name: str | bytes, time: int | timedelta, value: Any): ...
        def setnx(self, name: str | bytes, value: Any): ...
        def delete(self, *names: str | bytes): ...
        def incr(self, name: str | bytes, amount: int = 1): ...
        def expire(
            self,
            name: str | bytes,
            time: int | timedelta,
        ...
        def zremrangebyscore(self, name: str | bytes, min: float | str, max: float | str): ...
        def zcard(self, name: str | bytes): ...
        def getdel(self, name: str | bytes): ...
