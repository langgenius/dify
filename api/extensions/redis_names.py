...
def serialize_redis_name(name: str, prefix: str = None) -> str:
...
def serialize_redis_name_arg(name: str | bytes, prefix: str = None) -> str | bytes:
...
def serialize_redis_name_args(names: tuple[str | bytes, ...], prefix: str = None) -> tuple[str | bytes, ...]:
