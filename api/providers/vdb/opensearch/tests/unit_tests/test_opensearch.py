...
from dify_vdb_opensearch.opensearch_vector import OpenSearchConfig, OpenSearchVector
...
class TestOpenSearchConfig:
    ...
    @patch("dify_vdb_opensearch.opensearch_vector.Urllib3AWSV4SignerAuth", autospec=True)
