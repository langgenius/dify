...
class TestWeaviateVector(unittest.TestCase):
    ...
    def test_shutdown_client_logs_debug_when_close_fails(self, caplog):
        ...
        with caplog.at_level(logging.DEBUG, logger=weaviate_vector_module.logger.name):
    ...
    def test_create_collection_logs_and_reraises_errors(self, mock_redis):
        ...
        with caplog.at_level(logging.ERROR, logger=weaviate_vector_module.logger.name):
    ...
    def test_ensure_properties_logs_warning_when_property_addition_fails(self, mock_weaviate_module, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger=weaviate_vector_module.logger.name):
            wv._ensure_properties()
