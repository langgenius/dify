...
class AgentDriveFile(DefaultFieldsMixin, Base):
    ...
    value_owned_by_drive: Mapped[bool] = mapped_column(sa.Boolean, nullable=False, default=False)
    is_skill: Mapped[bool] = mapped_column(sa.Boolean, nullable=False, default=False)
