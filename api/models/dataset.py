...
class Dataset(Base):
    ...
    data_source_type: Mapped[DataSourceType | None] = mapped_column(EnumText(DataSourceType, length=255))
...
class Document(Base):
    ...
    doc_type: Mapped[DocumentDocType | None] = mapped_column(EnumText(DocumentDocType, length=40), nullable=True)
