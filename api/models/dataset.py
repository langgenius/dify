...
class Document(db.Model):
    ...
    DATA_SOURCES = ['upload_file', 'notion_import', 'larkwiki_import', 'website_crawl']
    ...
    def data_source_detail_dict(self):
        if self.data_source_info:
            ...
            elif self.data_source_type == 'notion_import' or self.data_source_type == 'larkwiki_import' or self.data_source_type == 'website_crawl':
