...
class Dataset(TypeBase):
    ...
    retrieval_model: Mapped[Any | None] = mapped_column(AdjustedJSON, nullable=True)
    summary_index_setting: Mapped[Any | None] = mapped_column(AdjustedJSON, nullable=True)
    ...
    runtime_mode: Mapped[str | None] = mapped_column(sa.String(255), nullable=True, server_default=sa.text("'general'"))
