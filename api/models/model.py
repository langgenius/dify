...
class Conversation(Base):
    ...
    override_model_configs: Mapped[str] = mapped_column(LongText)
    ...
    from_end_user_id: Mapped[str] = mapped_column(StringUUID)
    from_account_id: Mapped[str] = mapped_column(StringUUID)
    read_at: Mapped[datetime | None] = mapped_column(sa.DateTime)
    read_account_id: Mapped[str] = mapped_column(StringUUID)
