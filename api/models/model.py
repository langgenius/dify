...
class App(Base):
    ...
    enable_site = mapped_column(db.Boolean, nullable=False)
    enable_api = mapped_column(db.Boolean, nullable=False)
    api_rpm = mapped_column(db.Integer, nullable=False, server_default=db.text("0"))
    api_rph = mapped_column(db.Integer, nullable=False, server_default=db.text("0"))
    is_demo = mapped_column(db.Boolean, nullable=False, server_default=db.text("false"))
    is_public = mapped_column(db.Boolean, nullable=False, server_default=db.text("false"))
    is_universal = mapped_column(db.Boolean, nullable=False, server_default=db.text("false"))
