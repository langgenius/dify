...
class MessageAgentThought(TypeBase):
    ...
    thought: Mapped[str | None] = mapped_column(LongText, nullable=True)
    tool: Mapped[str | None] = mapped_column(LongText, nullable=True)
    ...
    tool_input: Mapped[str | None] = mapped_column(LongText, nullable=True)
    observation: Mapped[str | None] = mapped_column(LongText, nullable=True)
    # plugin_id = mapped_column(StringUUID, nullable=True)  ## for future design
    tool_process_data: Mapped[str | None] = mapped_column(LongText, nullable=True)
    ...
    message_unit_price: Mapped[Decimal | None] = mapped_column(sa.Numeric, nullable=True)
    message_price_unit: Mapped[Decimal] = mapped_column(
        sa.Numeric(10, 7), nullable=False, server_default=sa.text("0.001")
    )
    message_files: Mapped[str | None] = mapped_column(LongText, nullable=True)
