...
including execution metrics, node-level profiling, caching, and optimization recommendations.
"""
...
class WorkflowPerformanceMetrics(Base, DefaultFieldsMixin):
    ...
    This table tracks high-level metrics for each workflow run, enabling
    performance analysis, trend detection, and optimization opportunities.
    """
    ...
    __table_args__ = (
        ...
        Index("idx_wf_perf_status", "execution_status"),
    ...
    # Resource usage
    total_tokens_used: Mapped[Optional[int]] = mapped_column(
...
class WorkflowNodePerformance(Base, DefaultFieldsMixin):
    ...
    __table_args__ = (
        Index("idx_wf_node_perf_workflow_run_id", "workflow_run_id"),
