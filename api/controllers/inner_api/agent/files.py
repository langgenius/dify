...
def _translate_service_error(exc: AgentFileRequestError) -> AgentFileRequestHttpError:
    return AgentFileRequestHttpError(
        error_code=exc.code,
...
class AgentFileUploadRequestApi(Resource):
    ...
    def post(self) -> dict[str, object]:
        ...
        try:
            ...
            upload_uri = AgentFileRequestService().request_upload_uri(
        ...
        except AgentFileRequestError as exc:
...
class AgentFileDownloadRequestApi(Resource):
    ...
    def post(self) -> dict[str, object]:
        ...
        try:
            result = AgentFileRequestService().request_download_uri(
        ...
        return AgentFileDownloadRequestResponse.model_validate(result).model_dump(mode="json")
