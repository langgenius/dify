...
def build_system_parameters_model(api_or_ns: Api | Namespace) -> Model:
...
def build_parameters_model(api_or_ns: Api | Namespace) -> Model:
...
def build_site_model(api_or_ns: Api | Namespace) -> Model:
