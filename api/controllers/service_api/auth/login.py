...
class LoginApi(Resource):
    ...
    def post(self):
        ...
        ---
        summary: User Login
        description: Authenticate user with the provided email, password and optional invite token.
        parameters:
          - in: body
            name: email
            required: true
          ...
          - in: body
            ...
            required: false
            type: boolean
            description: Flag to indicate persistent login.
          - in: body
            name: invite_token
            required: false
            type: string
            description: Invitation token if available.
          - in: body
            name: language
            required: false
            type: string
            description: Interface language for response.
        responses:
          200:
            description: Success, returns token pair data.
          401:
            description: Login failed due to invalid credentials or rate limits.
        """
...
class ResetPasswordSendEmailApi(Resource):
    def post(self):
        ...
        description: Sends a reset password email to the provided email address.
        parameters:
          - in: body
            name: email
            required: true
        ...
        responses:
          200:
            description: Successfully sent the reset email with token data.
          404:
