...
from flask_restful import Resource, inputs, marshal, marshal_with, reqparse, inputs
...
class AppListApi(Resource):
    ...
    def get(self):
        ...
        parser.add_argument("isCreatedByMe", type=inputs.boolean, location="args", required=False)
