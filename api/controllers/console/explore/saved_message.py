...
from fields.message_fields import build_saved_message_infinite_scroll_pagination
...
class SavedMessageListApi(InstalledAppResource):
    ...
    def get(self, installed_app):
        ...
        return build_saved_message_infinite_scroll_pagination(pagination).model_dump(mode="json")
