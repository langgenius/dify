...
from fields.message_fields import build_suggested_questions_response, build_web_message_infinite_scroll_pagination
...
class MessageListApi(WebApiResource):
    ...
    def get(self, app_model, end_user):
        ...
        try:
            ...
            return build_web_message_infinite_scroll_pagination(pagination).model_dump(mode="json")
