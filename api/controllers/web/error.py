...
class ProviderQuotaExceededError(BaseHTTPException):
    ...
    description = "Your quota for AiConec Studio Hosted OpenAI has been exhausted. " \
...
class ProviderModelCurrentlyNotSupportError(BaseHTTPException):
    ...
    description = "AiConec Studio Hosted OpenAI trial currently not support the GPT-4 model."
    code = 400
