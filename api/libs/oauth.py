...
def encode_oauth_state(invite_token: str | None = None, timezone: str | None = None) -> str | None:
    state: OAuthState = {}
    if invite_token:
...
class OAuth:
    ...
    def get_authorization_url(self, invite_token: str | None = None, timezone: str | None = None) -> str:
