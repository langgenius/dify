...
import { zGetWorkflowByWorkflowRunIdEventsPath, zGetWorkflowByWorkflowRunIdEventsResponse, zGetWorkflowByWorkflowRunIdPauseDetailsPath, zGetWorkflowByWorkflowRunIdPauseDetailsResponse } from './zod.gen';
...
export const get = oc.route({
    description: 'GET /console/api/workflow/<workflow_run_id>/events\n\nReturns Server-Sent Events stream.',
    ...
    tags: ['console']
}).input(z.object({ params: zGetWorkflowByWorkflowRunIdEventsPath })).output(zGetWorkflowByWorkflowRunIdEventsResponse);
...
export const get2 = oc.route({
    description: 'Get workflow pause details\nGET /console/api/workflow/<workflow_run_id>/pause-details\n\nReturns information about why and where the workflow is paused.',
    inputStructure: 'detailed',
    method: 'GET',
    ...
    tags: ['console']
}).input(z.object({ params: zGetWorkflowByWorkflowRunIdPauseDetailsPath })).output(zGetWorkflowByWorkflowRunIdPauseDetailsResponse);
