...
export const get = oc.route({
  ...
  tags: ['console'],
}).input(z.object({ params: zGetOauthDataSourceBindingByProviderPath, query: zGetOauthDataSourceBindingByProviderQuery })).output(zGetOauthDataSourceBindingByProviderResponse)
...
export const get2 = oc.route({
  ...
  tags: ['console'],
}).input(z.object({ params: zGetOauthDataSourceByProviderByBindingIdSyncPath })).output(zGetOauthDataSourceByProviderByBindingIdSyncResponse)
...
export const get3 = oc.route({
  ...
  tags: ['console'],
}).input(z.object({ params: zGetOauthDataSourceByProviderPath })).output(zGetOauthDataSourceByProviderResponse)
...
export const get4 = oc.route({
  ...
  tags: ['console'],
}).input(z.object({ params: zGetOauthPluginByProviderIdDatasourceGetAuthorizationUrlPath, query: zGetOauthPluginByProviderIdDatasourceGetAuthorizationUrlQuery.optional() })).output(zGetOauthPluginByProviderIdDatasourceGetAuthorizationUrlResponse)
...
export const get5 = oc.route({
  ...
  tags: ['console'],
}).input(z.object({ params: zGetOauthPluginByProviderToolAuthorizationUrlPath })).output(zGetOauthPluginByProviderToolAuthorizationUrlResponse)
...
export const post2 = oc.route({
  ...
  tags: ['console'],
}).input(z.object({ body: zPostOauthProviderAuthorizeBody })).output(zPostOauthProviderAuthorizeResponse)
...
export const post3 = oc.route({
  ...
  tags: ['console'],
}).input(z.object({ body: zPostOauthProviderTokenBody })).output(zPostOauthProviderTokenResponse)
...
export const post4 = oc.route({
  ...
  path: '/oauth/provider',
  tags: ['console'],
}).input(z.object({ body: zPostOauthProviderBody })).output(zPostOauthProviderResponse)
