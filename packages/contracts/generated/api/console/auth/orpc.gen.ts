...
export const post = oc.route({
  ...
  path: '/auth/plugin/datasource/{provider_id}/custom-client',
  tags: ['console'],
}).input(z.object({ body: zPostAuthPluginDatasourceByProviderIdCustomClientBody, params: zPostAuthPluginDatasourceByProviderIdCustomClientPath })).output(zPostAuthPluginDatasourceByProviderIdCustomClientResponse)
...
export const post2 = oc.route({
  ...
  tags: ['console'],
}).input(z.object({ body: zPostAuthPluginDatasourceByProviderIdDefaultBody, params: zPostAuthPluginDatasourceByProviderIdDefaultPath })).output(zPostAuthPluginDatasourceByProviderIdDefaultResponse)
...
export const post3 = oc.route({
  ...
  tags: ['console'],
}).input(z.object({ body: zPostAuthPluginDatasourceByProviderIdDeleteBody, params: zPostAuthPluginDatasourceByProviderIdDeletePath })).output(zPostAuthPluginDatasourceByProviderIdDeleteResponse)
...
export const post4 = oc.route({
  ...
  successStatus: 201,
  tags: ['console'],
}).input(z.object({ body: zPostAuthPluginDatasourceByProviderIdUpdateBody, params: zPostAuthPluginDatasourceByProviderIdUpdatePath })).output(zPostAuthPluginDatasourceByProviderIdUpdateResponse)
...
export const post5 = oc.route({
  ...
  tags: ['console'],
}).input(z.object({ body: zPostAuthPluginDatasourceByProviderIdUpdateNameBody, params: zPostAuthPluginDatasourceByProviderIdUpdateNamePath })).output(zPostAuthPluginDatasourceByProviderIdUpdateNameResponse)
...
export const get3 = oc.route({
  ...
  tags: ['console'],
}).input(z.object({ params: zGetAuthPluginDatasourceByProviderIdPath })).output(zGetAuthPluginDatasourceByProviderIdResponse)
...
export const post6 = oc.route({
  ...
  path: '/auth/plugin/datasource/{provider_id}',
  tags: ['console'],
}).input(z.object({ body: zPostAuthPluginDatasourceByProviderIdBody, params: zPostAuthPluginDatasourceByProviderIdPath })).output(zPostAuthPluginDatasourceByProviderIdResponse)
