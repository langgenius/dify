...
export const get41 = oc
  .meta(
    openapi({
      ...
      method: 'GET',
      operationId:
        'getWorkspacesCurrentRbacDatasetsByDatasetIdAccessPoliciesByPolicyIdRoleBindings',
...
export const put9 = oc
  .meta(
    openapi({
      ...
      method: 'PUT',
      operationId:
        'putWorkspacesCurrentRbacDatasetsByDatasetIdUsersByTargetAccountIdAccessPolicies',
...
export const get56 = oc
  .meta(
    openapi({
      ...
      method: 'GET',
      operationId:
        'getWorkspacesCurrentRbacWorkspaceDatasetsAccessPoliciesByPolicyIdMemberBindings',
