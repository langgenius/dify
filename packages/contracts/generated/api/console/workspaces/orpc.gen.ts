...
import {
  ...
  zGetWorkspacesCurrentNetworkAccessPolicyResponse,
  ...
  zPutWorkspacesCurrentNetworkAccessPolicyBody,
  zPutWorkspacesCurrentNetworkAccessPolicyResponse,
...
export const get21 = oc
  .route({
    inputStructure: 'detailed',
    method: 'GET',
    operationId: 'getWorkspacesCurrentNetworkAccessPolicy',
    path: '/workspaces/current/network-access-policy',
    tags: ['console'],
  })
  .output(zGetWorkspacesCurrentNetworkAccessPolicyResponse)

export const put4 = oc
  .route({
    inputStructure: 'detailed',
    method: 'PUT',
    operationId: 'putWorkspacesCurrentNetworkAccessPolicy',
    path: '/workspaces/current/network-access-policy',
    tags: ['console'],
  })
  .input(z.object({ body: zPutWorkspacesCurrentNetworkAccessPolicyBody }))
  .output(zPutWorkspacesCurrentNetworkAccessPolicyResponse)
