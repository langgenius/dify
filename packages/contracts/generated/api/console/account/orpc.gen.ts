...
export const get = oc.route({
  ...
  path: '/account/avatar',
  tags: ['console'],
}).input(z.object({ query: zGetAccountAvatarQuery })).output(zGetAccountAvatarResponse)
...
export const post = oc.route({
  ...
  path: '/account/avatar',
  tags: ['console'],
}).input(z.object({ body: zPostAccountAvatarBody })).output(zPostAccountAvatarResponse)
...
export const post2 = oc.route({
  ...
  tags: ['console'],
}).input(z.object({ body: zPostAccountChangeEmailCheckEmailUniqueBody })).output(zPostAccountChangeEmailCheckEmailUniqueResponse)
...
export const post3 = oc.route({
  ...
  tags: ['console'],
}).input(z.object({ body: zPostAccountChangeEmailResetBody })).output(zPostAccountChangeEmailResetResponse)
...
export const post4 = oc.route({
  ...
  tags: ['console'],
}).input(z.object({ body: zPostAccountChangeEmailValidityBody })).output(zPostAccountChangeEmailValidityResponse)
...
export const post5 = oc.route({
  ...
  tags: ['console'],
}).input(z.object({ body: zPostAccountChangeEmailBody })).output(zPostAccountChangeEmailResponse)
...
export const post6 = oc.route({
  ...
  tags: ['console'],
}).input(z.object({ body: zPostAccountDeleteFeedbackBody })).output(zPostAccountDeleteFeedbackResponse)
...
export const post7 = oc.route({
  ...
  path: '/account/delete',
  tags: ['console'],
}).input(z.object({ body: zPostAccountDeleteBody })).output(zPostAccountDeleteResponse)
...
export const get3 = oc.route({
  ...
  tags: ['console'],
}).input(z.object({ query: zGetAccountEducationAutocompleteQuery })).output(zGetAccountEducationAutocompleteResponse)
...
export const post8 = oc.route({
  ...
  path: '/account/education',
  tags: ['console'],
}).input(z.object({ body: zPostAccountEducationBody })).output(zPostAccountEducationResponse)
...
export const post9 = oc.route({
  ...
  path: '/account/init',
  tags: ['console'],
}).input(z.object({ body: zPostAccountInitBody })).output(zPostAccountInitResponse)
...
export const post10 = oc.route({
  ...
  tags: ['console'],
}).input(z.object({ body: zPostAccountInterfaceLanguageBody })).output(zPostAccountInterfaceLanguageResponse)
...
export const post11 = oc.route({
  ...
  tags: ['console'],
}).input(z.object({ body: zPostAccountInterfaceThemeBody })).output(zPostAccountInterfaceThemeResponse)
...
export const post12 = oc.route({
  ...
  path: '/account/name',
  tags: ['console'],
}).input(z.object({ body: zPostAccountNameBody })).output(zPostAccountNameResponse)
...
export const post14 = oc.route({
  ...
  tags: ['console'],
}).input(z.object({ body: zPostAccountTimezoneBody })).output(zPostAccountTimezoneResponse)
