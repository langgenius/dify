...
import { zDeleteApiBasedExtensionByIdPath, zDeleteApiBasedExtensionByIdResponse, zGetApiBasedExtensionByIdPath, zGetApiBasedExtensionByIdResponse, zGetApiBasedExtensionResponse, zPostApiBasedExtensionBody, zPostApiBasedExtensionByIdBody, zPostApiBasedExtensionByIdPath, zPostApiBasedExtensionByIdResponse, zPostApiBasedExtensionResponse } from './zod.gen'
...
export const delete_ = oc.route({
  ...
  successStatus: 204,
  tags: ['console'],
}).input(z.object({ params: zDeleteApiBasedExtensionByIdPath })).output(zDeleteApiBasedExtensionByIdResponse)
...
export const get = oc.route({
  ...
  path: '/api-based-extension/{id}',
  tags: ['console'],
}).input(z.object({ params: zGetApiBasedExtensionByIdPath })).output(zGetApiBasedExtensionByIdResponse)
...
export const post = oc.route({
  ...
  path: '/api-based-extension/{id}',
  tags: ['console'],
}).input(z.object({ body: zPostApiBasedExtensionByIdBody, params: zPostApiBasedExtensionByIdPath })).output(zPostApiBasedExtensionByIdResponse)
...
export const post2 = oc.route({
  ...
  successStatus: 201,
  tags: ['console'],
}).input(z.object({ body: zPostApiBasedExtensionBody })).output(zPostApiBasedExtensionResponse)
