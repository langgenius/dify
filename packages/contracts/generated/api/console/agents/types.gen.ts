...
export type AgentConfigRevisionOperation = 'create_version' | 'save_current_version' | 'save_new_agent' | 'save_new_version' | 'save_to_roster';
...
export type GetAgentsInviteOptionsResponse = GetAgentsInviteOptionsResponses[keyof GetAgentsInviteOptionsResponses];
...
export type GetAgentsByAgentIdVersionsResponse = GetAgentsByAgentIdVersionsResponses[keyof GetAgentsByAgentIdVersionsResponses];
...
export type GetAgentsByAgentIdVersionsByVersionIdResponse = GetAgentsByAgentIdVersionsByVersionIdResponses[keyof GetAgentsByAgentIdVersionsByVersionIdResponses];
