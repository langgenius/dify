...
import { zDeleteApiKeyAuthDataSourceByBindingIdPath, zDeleteApiKeyAuthDataSourceByBindingIdResponse, zGetApiKeyAuthDataSourceResponse, zPostApiKeyAuthDataSourceBindingBody, zPostApiKeyAuthDataSourceBindingResponse } from './zod.gen';
...
export const delete_ = oc.route({
    ...
    successStatus: 204,
    tags: ['console']
}).input(z.object({ params: zDeleteApiKeyAuthDataSourceByBindingIdPath })).output(zDeleteApiKeyAuthDataSourceByBindingIdResponse);
