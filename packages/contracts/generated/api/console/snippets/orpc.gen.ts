...
export const post = oc.route({
    description: 'Uses both the legacy stop flag mechanism and the graph engine\ncommand channel for backward compatibility.',
...
export const get2 = oc.route({
    ...
    tags: ['console']
}).input(z.object({ params: zGetSnippetsBySnippetIdWorkflowRunsByRunIdPath })).output(zGetSnippetsBySnippetIdWorkflowRunsByRunIdResponse);
...
export const get3 = oc.route({
    ...
    tags: ['console']
}).input(z.object({ params: zGetSnippetsBySnippetIdWorkflowRunsPath, query: zGetSnippetsBySnippetIdWorkflowRunsQuery.optional() })).output(zGetSnippetsBySnippetIdWorkflowRunsResponse);
...
export const get4 = oc.route({
    ...
    tags: ['console']
}).input(z.object({ params: zGetSnippetsBySnippetIdWorkflowsDefaultWorkflowBlockConfigsPath })).output(zGetSnippetsBySnippetIdWorkflowsDefaultWorkflowBlockConfigsResponse);
...
export const get5 = oc.route({
    ...
    tags: ['console']
}).input(z.object({ params: zGetSnippetsBySnippetIdWorkflowsDraftConfigPath })).output(zGetSnippetsBySnippetIdWorkflowsDraftConfigResponse);
...
export const get6 = oc.route({
    ...
    tags: ['console']
}).input(z.object({ params: zGetSnippetsBySnippetIdWorkflowsDraftConversationVariablesPath })).output(zGetSnippetsBySnippetIdWorkflowsDraftConversationVariablesResponse);
...
export const get7 = oc.route({
    ...
    tags: ['console']
}).input(z.object({ params: zGetSnippetsBySnippetIdWorkflowsDraftEnvironmentVariablesPath })).output(zGetSnippetsBySnippetIdWorkflowsDraftEnvironmentVariablesResponse);
...
export const post2 = oc.route({
    ...
    tags: ['console']
}).input(z.object({ body: zPostSnippetsBySnippetIdWorkflowsDraftIterationNodesByNodeIdRunBody, params: zPostSnippetsBySnippetIdWorkflowsDraftIterationNodesByNodeIdRunPath })).output(zPostSnippetsBySnippetIdWorkflowsDraftIterationNodesByNodeIdRunResponse);
...
export const get8 = oc.route({
    description: 'Get last run result for a node in snippet draft workflow\nReturns the most recent execution record for the given node,\nincluding status, inputs, outputs, and timing information.',
    inputStructure: 'detailed',
    method: 'GET',
    ...
    tags: ['console']
}).input(z.object({ params: zGetSnippetsBySnippetIdWorkflowsDraftNodesByNodeIdLastRunPath })).output(zGetSnippetsBySnippetIdWorkflowsDraftNodesByNodeIdLastRunResponse);
...
export const post4 = oc.route({
    description: 'Run a single node in snippet draft workflow (single-step debugging)\nExecutes a specific node with provided inputs for single-step debugging.\nReturns the node execution result including status, outputs, and timing.',
    inputStructure: 'detailed',
    method: 'POST',
    ...
    tags: ['console']
}).input(z.object({ body: zPostSnippetsBySnippetIdWorkflowsDraftNodesByNodeIdRunBody, params: zPostSnippetsBySnippetIdWorkflowsDraftNodesByNodeIdRunPath })).output(zPostSnippetsBySnippetIdWorkflowsDraftNodesByNodeIdRunResponse);
...
export const delete_ = oc.route({
    ...
    successStatus: 204,
    tags: ['console']
}).input(z.object({ params: zDeleteSnippetsBySnippetIdWorkflowsDraftNodesByNodeIdVariablesPath })).output(zDeleteSnippetsBySnippetIdWorkflowsDraftNodesByNodeIdVariablesResponse);
...
export const get9 = oc.route({
    ...
    path: '/snippets/{snippet_id}/workflows/draft/nodes/{node_id}/variables',
    tags: ['console']
}).input(z.object({ params: zGetSnippetsBySnippetIdWorkflowsDraftNodesByNodeIdVariablesPath })).output(zGetSnippetsBySnippetIdWorkflowsDraftNodesByNodeIdVariablesResponse);
...
export const post5 = oc.route({
    description: 'Executes the snippet\'s draft workflow with the provided inputs\nand returns an SSE event stream with execution progress and results.',
    inputStructure: 'detailed',
    method: 'POST',
    ...
    tags: ['console']
}).input(z.object({ body: zPostSnippetsBySnippetIdWorkflowsDraftRunBody, params: zPostSnippetsBySnippetIdWorkflowsDraftRunPath })).output(zPostSnippetsBySnippetIdWorkflowsDraftRunResponse);
...
export const put = oc.route({
    ...
    tags: ['console']
}).input(z.object({ params: zPutSnippetsBySnippetIdWorkflowsDraftVariablesByVariableIdResetPath })).output(zPutSnippetsBySnippetIdWorkflowsDraftVariablesByVariableIdResetResponse);
...
export const delete2 = oc.route({
    ...
    successStatus: 204,
    tags: ['console']
}).input(z.object({ params: zDeleteSnippetsBySnippetIdWorkflowsDraftVariablesByVariableIdPath })).output(zDeleteSnippetsBySnippetIdWorkflowsDraftVariablesByVariableIdResponse);
...
export const get11 = oc.route({
    ...
    path: '/snippets/{snippet_id}/workflows/draft/variables/{variable_id}',
    tags: ['console']
}).input(z.object({ params: zGetSnippetsBySnippetIdWorkflowsDraftVariablesByVariableIdPath })).output(zGetSnippetsBySnippetIdWorkflowsDraftVariablesByVariableIdResponse);
...
export const patch = oc.route({
    ...
    path: '/snippets/{snippet_id}/workflows/draft/variables/{variable_id}',
    tags: ['console']
}).input(z.object({ body: zPatchSnippetsBySnippetIdWorkflowsDraftVariablesByVariableIdBody, params: zPatchSnippetsBySnippetIdWorkflowsDraftVariablesByVariableIdPath })).output(zPatchSnippetsBySnippetIdWorkflowsDraftVariablesByVariableIdResponse);
...
export const delete3 = oc.route({
    ...
    successStatus: 204,
    tags: ['console']
}).input(z.object({ params: zDeleteSnippetsBySnippetIdWorkflowsDraftVariablesPath })).output(zDeleteSnippetsBySnippetIdWorkflowsDraftVariablesResponse);
...
export const get13 = oc.route({
    ...
    tags: ['console']
}).input(z.object({ params: zGetSnippetsBySnippetIdWorkflowsDraftPath })).output(zGetSnippetsBySnippetIdWorkflowsDraftResponse);
...
export const post6 = oc.route({
    ...
    tags: ['console']
}).input(z.object({ body: zPostSnippetsBySnippetIdWorkflowsDraftBody, params: zPostSnippetsBySnippetIdWorkflowsDraftPath })).output(zPostSnippetsBySnippetIdWorkflowsDraftResponse);
...
export const get14 = oc.route({
    ...
    tags: ['console']
}).input(z.object({ params: zGetSnippetsBySnippetIdWorkflowsPublishPath })).output(zGetSnippetsBySnippetIdWorkflowsPublishResponse);
...
export const get15 = oc.route({
    ...
    tags: ['console']
}).input(z.object({ params: zGetSnippetsBySnippetIdWorkflowsPath, query: zGetSnippetsBySnippetIdWorkflowsQuery.optional() })).output(zGetSnippetsBySnippetIdWorkflowsResponse);
