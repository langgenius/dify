import type { TestRunMenuRef, TriggerOption } from '@/app/components/workflow/header/test-run-menu'
...
import TestRunMenu, { TriggerType } from '@/app/components/workflow/header/test-run-menu'
