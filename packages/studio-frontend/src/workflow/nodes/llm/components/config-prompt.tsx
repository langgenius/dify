...
import type { ModelConfig, PromptItem, ValueSelector, Var, Variable } from '@/app/components/workflow/types'
...
import ConfigPromptItem from '@/app/components/workflow/nodes/llm/components/config-prompt-item'
