...
import type { SchemaEnumType } from '@/app/components/workflow/nodes/llm/types'
import type { AdvancedOptionsType } from '@/app/components/workflow/nodes/llm/components/json-schema-config-modal/visual-editor/edit-card/advanced-options'
import type { TypeItem } from '@/app/components/workflow/nodes/llm/components/json-schema-config-modal/visual-editor/edit-card/type-selector'
...
import Actions from '@/app/components/workflow/nodes/llm/components/json-schema-config-modal/visual-editor/edit-card/actions'
import AdvancedActions from '@/app/components/workflow/nodes/llm/components/json-schema-config-modal/visual-editor/edit-card/advanced-actions'
import AdvancedOptions from '@/app/components/workflow/nodes/llm/components/json-schema-config-modal/visual-editor/edit-card/advanced-options'
import AutoWidthInput from '@/app/components/workflow/nodes/llm/components/json-schema-config-modal/visual-editor/edit-card/auto-width-input'
import RequiredSwitch from '@/app/components/workflow/nodes/llm/components/json-schema-config-modal/visual-editor/edit-card/required-switch'
import TypeSelector from '@/app/components/workflow/nodes/llm/components/json-schema-config-modal/visual-editor/edit-card/type-selector'
