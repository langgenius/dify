...
import type { ToolIconProps } from '@/app/components/workflow/nodes/agent/components/tool-icon'
import type { AgentNodeType } from '@/app/components/workflow/nodes/agent/types'
import { memo, useMemo } from 'react'
import { useTranslation } from 'react-i18next'
import { FormTypeEnum } from '@/app/components/header/account-setting/model-provider-page/declarations'
import { useRenderI18nObject } from '@/hooks/use-i18n'
import { Group, GroupLabel } from '@/app/components/workflow/nodes/_base/components/group'
import { SettingItem } from '@/app/components/workflow/nodes/_base/components/setting-item'
import { ModelBar } from '@/app/components/workflow/nodes/agent/components/model-bar'
import { ToolIcon } from '@/app/components/workflow/nodes/agent/components/tool-icon'
import useConfig from '@/app/components/workflow/nodes/agent/use-config'
