...
import type { ToolIconProps } from '../../nodes/agent/components/tool-icon'
import type { AgentNodeType } from '../../nodes/agent/types'
import { memo, useMemo } from 'react'
import { useTranslation } from 'react-i18next'
import { FormTypeEnum } from '@/app/components/header/account-setting/model-provider-page/declarations'
import { useRenderI18nObject } from '@/hooks/use-i18n'
import { Group, GroupLabel } from '../../nodes/_base/components/group'
import { SettingItem } from '../../nodes/_base/components/setting-item'
import { ModelBar } from '../../nodes/agent/components/model-bar'
import { ToolIcon } from '../../nodes/agent/components/tool-icon'
import useConfig from '../../nodes/agent/use-config'
