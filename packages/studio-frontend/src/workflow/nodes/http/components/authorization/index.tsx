...
import type { Authorization as AuthorizationPayloadType } from '@/app/components/workflow/nodes/http/types'
...
import { APIType, AuthorizationType } from '@/app/components/workflow/nodes/http/types'
import RadioGroup from '@/app/components/workflow/nodes/http/components/authorization/radio-group'
