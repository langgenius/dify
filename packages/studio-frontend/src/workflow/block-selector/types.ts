import type { ParametersSchema, PluginMeta, PluginTriggerSubscriptionConstructor, SupportedCreationMethods, TriggerEvent } from '@/app/components/plugins/types'
import type { Collection, Event } from '@/app/components/tools/types'
