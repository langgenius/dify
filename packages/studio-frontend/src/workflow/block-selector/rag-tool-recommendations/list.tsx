...
import { groupItems } from '@/app/components/workflow/block-selector/index-bar'
...
import UninstalledItem from '@/app/components/workflow/block-selector/rag-tool-recommendations/uninstalled-item'
