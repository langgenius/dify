...
import type { Tool as ToolType } from '@/app/components/tools/types'
...
import { useMCPToolAvailability } from '../../nodes/_base/components/mcp-tool-availability'
...
import ActionItem from '../../block-selector/tool/action-item'
