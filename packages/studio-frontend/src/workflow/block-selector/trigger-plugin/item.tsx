...
import type { TriggerPluginActionPreviewCardHandle } from '@/app/components/workflow/block-selector/trigger-plugin/action-item'
...
import TriggerPluginActionItem from '@/app/components/workflow/block-selector/trigger-plugin/action-item'
