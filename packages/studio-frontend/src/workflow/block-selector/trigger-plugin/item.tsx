...
import type { TriggerPluginActionPreviewCardHandle } from '../../block-selector/trigger-plugin/action-item'
...
import TriggerPluginActionItem from '../../block-selector/trigger-plugin/action-item'
