...
import AppTypeSelector from '../../type-selector'
...
import AppCard from '../../create-app-dialog/app-card/index'
import Sidebar, { AppCategories, AppCategoryLabel } from '../../create-app-dialog/app-list/sidebar'
