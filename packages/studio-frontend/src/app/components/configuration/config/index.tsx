...
import HistoryPanel from '@/app/components/app/configuration/config-prompt/conversation-history/history-panel'
import ConfigVision from '@/app/components/app/configuration/config-vision/index'
import DatasetConfig from '@/app/components/app/configuration/dataset-config/index'
import { useFormattingChangedDispatcher } from '@/app/components/app/configuration/debug/hooks'
import AgentTools from '@/app/components/app/configuration/config/agent/agent-tools/index'
import ConfigAudio from '@/app/components/app/configuration/config/config-audio'
import ConfigDocument from '@/app/components/app/configuration/config/config-document'
