...
import InstructionEditorInBasic from '@/app/components/app/configuration/config/automatic/instruction-editor'
import InstructionEditorInWorkflow from '@/app/components/app/configuration/config/automatic/instruction-editor-in-workflow'
