...
import InstructionEditorInBasic from '../../../configuration/config/automatic/instruction-editor'
import InstructionEditorInWorkflow from '../../../configuration/config/automatic/instruction-editor-in-workflow'
