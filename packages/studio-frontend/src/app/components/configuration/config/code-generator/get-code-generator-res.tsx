...
import InstructionEditor from '@/app/components/app/configuration/config/automatic/instruction-editor-in-workflow'
import ResPlaceholder from '@/app/components/app/configuration/config/automatic/res-placeholder'
import Result from '@/app/components/app/configuration/config/automatic/result'
import s from '@/app/components/app/configuration/config/automatic/style.module.css'
import { GeneratorType } from '@/app/components/app/configuration/config/automatic/types'
import useGenData from '@/app/components/app/configuration/config/automatic/use-gen-data'
