...
import { languageMap } from '@/app/components/workflow/nodes/_base/components/editor/code-editor/index'
import IdeaOutput from '../../../configuration/config/automatic/idea-output'
import InstructionEditor from '../../../configuration/config/automatic/instruction-editor-in-workflow'
import ResPlaceholder from '../../../configuration/config/automatic/res-placeholder'
import Result from '../../../configuration/config/automatic/result'
...
import useGenData from '../../../configuration/config/automatic/use-gen-data'
