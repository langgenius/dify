...
import Panel from '../../configuration/base/feature-panel/index'
import EditModal from '../../configuration/config-var/config-modal/index'
import SelectVarType from '../../configuration/config-var/select-var-type'
import VarItem from '../../configuration/config-var/var-item'
