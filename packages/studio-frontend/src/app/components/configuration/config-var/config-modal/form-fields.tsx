...
import type { Item as SelectOptionItem } from '../../../configuration/config-var/config-modal/type-select'
...
import ConfigSelect from '../../../configuration/config-var/config-select/index'
import ConfigString from '../../../configuration/config-var/config-string/index'
import { jsonConfigPlaceHolder } from '../../../configuration/config-var/config-modal/config'
import Field from '../../../configuration/config-var/config-modal/field'
import TypeSelector from '../../../configuration/config-var/config-modal/type-select'
import { CHECKBOX_DEFAULT_FALSE_VALUE, CHECKBOX_DEFAULT_TRUE_VALUE, TEXT_MAX_LENGTH } from '../../../configuration/config-var/config-modal/utils'
