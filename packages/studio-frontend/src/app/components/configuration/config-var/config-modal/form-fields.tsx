...
import type { Item as SelectOptionItem } from '@/app/components/app/configuration/config-var/config-modal/type-select'
...
import ConfigSelect from '@/app/components/app/configuration/config-var/config-select/index'
import ConfigString from '@/app/components/app/configuration/config-var/config-string/index'
import { jsonConfigPlaceHolder } from '@/app/components/app/configuration/config-var/config-modal/config'
import Field from '@/app/components/app/configuration/config-var/config-modal/field'
import TypeSelector from '@/app/components/app/configuration/config-var/config-modal/type-select'
import { CHECKBOX_DEFAULT_FALSE_VALUE, CHECKBOX_DEFAULT_TRUE_VALUE, TEXT_MAX_LENGTH } from '@/app/components/app/configuration/config-var/config-modal/utils'
