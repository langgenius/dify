...
import { useDocToc } from '@/app/components/develop/hooks/use-doc-toc'
import TemplateEn from '@/app/components/develop/template/template.en.mdx'
import TemplateJa from '@/app/components/develop/template/template.ja.mdx'
import TemplateZh from '@/app/components/develop/template/template.zh.mdx'
import TemplateAdvancedChatEn from '@/app/components/develop/template/template_advanced_chat.en.mdx'
import TemplateAdvancedChatJa from '@/app/components/develop/template/template_advanced_chat.ja.mdx'
import TemplateAdvancedChatZh from '@/app/components/develop/template/template_advanced_chat.zh.mdx'
import TemplateChatEn from '@/app/components/develop/template/template_chat.en.mdx'
import TemplateChatJa from '@/app/components/develop/template/template_chat.ja.mdx'
import TemplateChatZh from '@/app/components/develop/template/template_chat.zh.mdx'
...
import TocPanel from '@/app/components/develop/toc-panel'
