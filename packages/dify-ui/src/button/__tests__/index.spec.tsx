  ...
  describe('variants', () => {
    ...
    it.each([
      ...
      { variant: 'secondary' as const, expectedClass: 'bg-components-button-secondary-bg' },
      {
        ...
        expectedClass: 'text-components-button-secondary-accent-text',
      },
    ...
    it('applies destructive tone with default variant', async () => {
      ...
      await expect
        ...
        .toHaveClass('bg-components-button-destructive-secondary-bg')
    })
    ...
    it('applies destructive tone with tertiary variant', async () => {
      ...
      await expect
        .element(screen.getByRole('button'))
        .toHaveClass('bg-components-button-destructive-tertiary-bg')
    })
    ...
    it('applies destructive tone with ghost variant', async () => {
      ...
      await expect
        .element(screen.getByRole('button'))
        .toHaveClass('text-components-button-destructive-ghost-text')
    })
  })
