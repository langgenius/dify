    ...
    <div
      ...
      className={cn(
        [
          ...
          'has-[>input[data-disabled]]:*:data-align:text-components-input-text-filled-disabled',
...
const inputGroupAddonVariants = cva(
  'flex shrink-0 items-center self-stretch system-sm-regular text-text-secondary select-none',
  {
    variants: {
      align: {
