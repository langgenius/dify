...
export { Infotip, InfotipContent, InfotipDescription, InfotipTitle, InfotipTrigger }
export type {
  InfotipContentProps,
  InfotipDescriptionProps,
  InfotipProps,
  InfotipTitleProps,
  InfotipTriggerProps,
}
