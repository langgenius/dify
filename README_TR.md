...
<p align="center">
  ...
  <a href="https://docs.dify.ai/getting-started/introduction/getting-started/introduction/self-hosting/quick-start/docker-compose">Kendi Sunucunuzda Barındırma</a> ·
  <a href="https://docs.dify.ai/getting-started/introduction/getting-started/introduction">Dokümantasyon</a> ·
...
- **Dify Topluluk Sürümünü Kendi Sunucunuzda Barındırma</br>**
  ...
  Daha fazla referans ve detaylı talimatlar için [dokümantasyonumuzu](https://docs.dify.ai/getting-started/introduction/getting-started/introduction) kullanın.
...
> Eğer Dify'a katkıda bulunmak veya ek geliştirmeler yapmak isterseniz, [kaynak koddan dağıtım kılavuzumuza](https://docs.dify.ai/getting-started/introduction/getting-started/introduction/self-hosting/advanced-deployments/local-source-code) başvurun.
