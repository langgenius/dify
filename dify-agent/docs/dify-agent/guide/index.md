...
| `DIFY_AGENT_SERVER_SECRET_KEY` | `MDEyMzQ1Njc4OWFiY2RlZjAxMjM0NTY3ODlhYmNkZWY` | Server-wide root secret used to derive Agent Stub JWE keys. The default is for development; set a unique unpadded base64url 32-byte secret in production. |
...
# The default below is for local development only.
