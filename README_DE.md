...
<p align="center">
  ...
  <a href="https://docs.dify.ai/self-hosting/quick-start/docker-compose">Selbstgehostetes</a> ·
...
Bitte beachten Sie unsere [FAQ](https://docs.dify.ai/self-hosting/quick-start/faqs), wenn Sie Probleme bei der Einrichtung von Dify haben. Wenden Sie sich an [die Community und uns](#community--contact), falls weiterhin Schwierigkeiten auftreten.

> Wenn Sie zu Dify beitragen oder zusätzliche Entwicklungen durchführen möchten, lesen Sie bitte unseren [Leitfaden zur Bereitstellung aus dem Quellcode](https://docs.dify.ai/self-hosting/advanced-deployments/local-source-code).
