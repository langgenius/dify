...
export const env = createEnv({
  server: {
    /**
     * Build-time source map switches for production build.
     * Priority is handled in next.config.ts.
     */
    ENABLE_PROD_SOURCEMAP: z.string().optional(),
    ENABLE_SOURCE_MAP: z.string().optional(),
    /**
