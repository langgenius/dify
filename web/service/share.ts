...
export const sendChatMessage = async (body: Record<string, any>, { onData, onCompleted, onError, getAbortController, onCitation }: {
  onData: IOnData
  ...
  }, { onData, onCompleted, isPublicAPI: !isInstalledApp, onError, getAbortController, onCitation })
}
