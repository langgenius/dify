import type { IOnCitation, IOnCompleted, IOnData, IOnError, IOnThought } from './base'
import {
...
export const sendChatMessage = async (body: Record<string, any>, { onData, onCompleted, onError, onThought, onCitation, getAbortController }: {
  onData: IOnData
  ...
  }, { onData, onCompleted, onThought, onError, getAbortController, onCitation })
}
