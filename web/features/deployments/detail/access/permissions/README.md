...
| ---------------------------------- | ----------------------------------------------------------------------------- |
| `web/app/components/base/skeleton` | Reuses skeleton primitives for permission loading states.                     |
| `web/models/access-control`        | Reuses app access-control enums for policy conversion and permission dialogs. |
...
| `detail/access/state`              | Reads access route query data for environment access policies.                |
