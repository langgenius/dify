# Deployment Instances Tab

Instances tab for listing environment deployments and running deployment row actions.
...
| `../../shared/components/empty-state`         | Reuses deployment empty/error state presentation for the instances tab.                           |
