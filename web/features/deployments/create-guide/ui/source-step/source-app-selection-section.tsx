...
import { useCreateGuideSourceApps } from '../../queries/source'
import {
  selectSourceAppAtom,
...
export function SourceAppSelectionSection() {
  ...
  const filteredApps = sourceSearchText.trim()
    ? sourceApps.filter(app => sourceAppSearchText(app).includes(sourceSearchText.trim().toLowerCase()))
    : sourceApps
