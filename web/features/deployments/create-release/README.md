...
| ------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| `web/app/components/app/create-from-dsl-modal/uploader` | Reuses the existing DSL file uploader for the DSL release source.                              |
| `web/app/components/base/app-icon`                      | Renders source app icons consistently in the source app picker.                                |
| `web/app/components/base/skeleton`                      | Reuses skeleton primitives for source app picker loading rows.                                 |
