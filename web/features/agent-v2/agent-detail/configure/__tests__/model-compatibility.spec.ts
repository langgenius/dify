...
describe('isAgentCompatibleModel', () => {
  it('should reject configured GPT models below the Agent-compatible baseline', () => {
    ...
    expect(isAgentCompatibleModel(provider, createModelItem('gpt-5'))).toBe(false)
    expect(isAgentCompatibleModel(provider, createModelItem('gpt-5-pro'))).toBe(false)
    expect(isAgentCompatibleModel(provider, createModelItem('gpt-5.1'))).toBe(false)
    expect(isAgentCompatibleModel(provider, createModelItem('gpt-5.2'))).toBe(false)
    expect(isAgentCompatibleModel(provider, createModelItem('gpt-5-mini'))).toBe(false)
    expect(isAgentCompatibleModel(provider, createModelItem('gpt-5-nano'))).toBe(false)
    expect(isAgentCompatibleModel(provider, createModelItem('gpt-5-chat'))).toBe(false)
    ...
    expect(isAgentCompatibleModel(provider, createModelItem('o1'))).toBe(false)
    expect(isAgentCompatibleModel(provider, createModelItem('o1-preview'))).toBe(false)
    expect(isAgentCompatibleModel(provider, createModelItem('o3-mini'))).toBe(false)
    expect(isAgentCompatibleModel(provider, createModelItem('o3'))).toBe(false)
    expect(isAgentCompatibleModel(provider, createModelItem('o4-mini'))).toBe(false)
    expect(isAgentCompatibleModel(provider, createModelItem('o4'))).toBe(false)
  })
  ...
  it('should reject specifically configured models that do not meet the Agent baseline', () => {
    ...
    expect(isAgentCompatibleModel(provider, createModelItem('minimax-m2'))).toBe(false)
    expect(isAgentCompatibleModel(provider, createModelItem('minimax-m2-chat'))).toBe(false)
    expect(isAgentCompatibleModel(provider, createModelItem('kimi-k2-thinking'))).toBe(false)
    expect(isAgentCompatibleModel(provider, createModelItem('moonshot-v1-128k'))).toBe(false)
    expect(isAgentCompatibleModel(provider, createModelItem('qvq-max'))).toBe(false)
...
describe('isAgentSuggestedModel', () => {
  it('should suggest configured Agent baseline models by English label', () => {
    ...
    expect(isAgentSuggestedModel(provider, createModelItem('glm-5.1'))).toBe(true)
