...
Owns the Agent V2 configure workflow, including editable composer draft wiring, build chat sessions, version viewing, build draft mode, and preview side panels.
