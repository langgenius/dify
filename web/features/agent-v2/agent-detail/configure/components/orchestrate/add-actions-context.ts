...
export type AgentOrchestrateAddedItem =
  | AgentCliTool
  | AgentFileNode
  | AgentKnowledgeRetrievalItem
  | AgentSkill
...
export type AgentOrchestrateAddActions = Partial<
  Record<AgentOrchestrateAddActionKey, AgentOrchestrateAddAction>
>
...
export const AgentOrchestrateAddActionsContext =
  createContext<AgentOrchestrateAddActionsContextValue | null>(null)
