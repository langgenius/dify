...
export function AgentBuildDraftBar({
  ...
  return (
    <CollapsibleRoot
      ...
      className="group/build-draft pointer-events-auto relative w-fit max-w-full min-w-0 overflow-hidden rounded-xl border-[1.5px] border-[#A0BDFF] bg-components-panel-bg-blur shadow-lg shadow-shadow-shadow-5 backdrop-blur-[10px] data-open:w-full"
    >
