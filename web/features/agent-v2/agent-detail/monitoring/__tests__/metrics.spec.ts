...
const statisticsSummary: AgentStatisticSummaryEnvelopeResponse = {
  ...
  charts: {
    average_response_time: [{ date: '2026-06-16', latency: 1250 }],
    average_session_interactions: [{ date: '2026-06-16', interactions: 1.5 }],
    daily_conversations: [{ date: '2026-06-16', conversation_count: 2 }],
    daily_end_users: [{ date: '2026-06-16', terminal_count: 3 }],
    daily_messages: [{ date: '2026-06-16', message_count: 1250 }],
    token_usage: [{ date: '2026-06-16', token_count: 2500, total_price: '0.005', currency: 'USD' }],
    tokens_per_second: [{ date: '2026-06-16', tps: 4 }],
    user_satisfaction_rate: [{ date: '2026-06-16', rate: 66.67 }],
  },
}
