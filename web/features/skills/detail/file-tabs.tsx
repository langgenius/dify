...
export function FileTabs({
  ...
  return (
    <div className="flex h-11 shrink-0 items-stretch overflow-x-auto overflow-y-hidden rounded-t-lg border-b-[0.5px] border-divider-subtle bg-components-panel-bg-alt">
