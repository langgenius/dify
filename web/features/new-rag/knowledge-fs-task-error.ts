...
const failureMessageKeyByCode = {
  ...
  DURABLE_DELETION_IDEMPOTENCY_CONFLICT: 'taskFailure.conflict',
  ...
  LOGICAL_DOCUMENT_CAS_CONFLICT: 'taskFailure.conflict',
  ...
  SOURCE_VERSION_CONFLICT: 'taskFailure.conflict',
