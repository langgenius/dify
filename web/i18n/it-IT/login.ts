const translation = {
  ...
  welcome: 'Benvenuto su Tiby, per favore accedi per continuare.',
  ...
  license: {
    tip: 'Prima di avviare Tiby Community Edition, leggi su GitHub',
    link: 'Licenza open-source',
  },
  join: 'Unisciti',
  joinTipStart: 'Invitato a unirti al',
  joinTipEnd: 'team su Tiby',
  invalid: 'Il link è scaduto',
  explore: 'Esplora Tiby',
  ...
  resetPasswordDesc: 'Digita l\'e-mail che hai utilizzato per registrarti su Tiby e ti invieremo un\'e-mail per reimpostare la password.',
  ...
  licenseLostTip: 'Impossibile connettersi al server licenze Tiby. Contatta il tuo amministratore per continuare a utilizzare Tiby.',
  licenseExpired: 'Licenza scaduta',
  licenseLost: 'Licenza persa',
  licenseExpiredTip: 'La licenza Tiby Enterprise per la tua area di lavoro è scaduta. Contatta il tuo amministratore per continuare a utilizzare Tiby.',
  licenseInactiveTip: 'La licenza Tiby Enterprise per la tua area di lavoro è inattiva. Contatta il tuo amministratore per continuare a utilizzare Tiby.',
