const translation = {
  ...
  settings: {
    ...
    workspaceApiKey: 'Chiavi API dello Spazio di Lavoro',
  },
  account: {
    avatar: 'Avatar',
    name: 'Nome',
  ...
  you: 'Tu',
  workspaceApiKey: {
    title: 'Chiavi API dello Spazio di Lavoro',
    description: 'Gestisci le chiavi API che consentono ai membri dello spazio di lavoro di autenticarsi con le API Dify. Le chiavi API sono legate ai singoli membri dello spazio di lavoro.',
    add: 'Aggiungi Chiave API',
    manage: 'Gestisci Chiavi API',
    regenerate: 'Rigenera Chiave API',
    updateSuccess: 'Chiave API aggiornata con successo',
    updateFailed: 'Aggiornamento chiave API fallito',
    selectorPlaceholder: 'Seleziona una chiave API',
    createdAt: 'Creata il',
    expiresAt: 'Scade il',
    ...
    deleteFailed: 'Eliminazione chiave API fallita',
    newApiKey: 'La tua nuova Chiave API',
    regeneratedApiKey: 'La tua Chiave API rigenerata',
    newApiKeyDescription: 'Copia la tua chiave API ora. Non potrai più vederla!',
    securityWarning: 'Mantieni la tua chiave API al sicuro! Non condividerla pubblicamente o commetterla nel controllo di versione.',
    yourApiKey: 'La tua Chiave API',

    modal: {
      addTitle: 'Aggiungi Chiave API',
      addDescription: 'Le chiavi API sono utilizzate per semplificare la gestione e l\'utilizzo nelle applicazioni in tutto lo spazio di lavoro Dify.',
      editTitle: 'Modifica Chiave API',
      editDescription: 'Aggiorna il nome, i permessi e le impostazioni di scadenza per questa chiave API.',
      deleteTitle: 'Elimina Chiave API',
      deleteDescription: 'L\'eliminazione di una chiave API la invaliderà e la renderà inutilizzabile nelle applicazioni.',
      deleteFailed: 'Eliminazione chiave API fallita',
      deleteSuccess: 'Chiave API eliminata con successo',
      deleteConfirm: 'Sei sicuro di voler eliminare questa chiave API?',
      nameLabel: 'Nome Chiave API',
      namePlaceholder: 'Inserisci il nome della chiave API',
      nameError: 'Il nome è obbligatorio',
      expiresLabel: 'Scadenza (giorni)',
      expiresPlaceholder: 'Inserisci i giorni di scadenza (predefinito: 30 giorni)',
      expiresDescription: 'Imposta il periodo di scadenza per la chiave API. Il valore predefinito è 30 giorni.',
      ...
      addFailed: 'Aggiunta chiave API fallita',
      regenerateTitle: 'Rigenera Chiave API',
      regenerateDescription: 'La rigenerazione della chiave API invaliderà la chiave attuale e ne emetterà una nuova. Dovrai configurare la nuova chiave nelle tue applicazioni.',
      regenerateFailed: 'Rigenerazione chiave API fallita',
    },
  },
}
