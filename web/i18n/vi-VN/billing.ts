const translation = {
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: [
        'Giải pháp triển khai có thể mở rộng cấp doanh nghiệp',
        'Ủy quyền giấy phép thương mại',
        'Các tính năng dành riêng cho doanh nghiệp',
        'Nhiều không gian làm việc & quản lý doanh nghiệp',
        'SSO',
        'SLA được đàm phán bởi Dify Partners',
        'Bảo mật & Kiểm soát nâng cao',
        'Cập nhật và bảo trì bởi Dify chính thức',
    ...
    community: {
      features: [
        'Tất cả các tính năng cốt lõi được phát hành trong kho lưu trữ công cộng',
        'Không gian làm việc đơn',
        'Tuân thủ Giấy phép nguồn mở Dify',
      ],
    ...
    premium: {
      features: [
        'Độ tin cậy tự quản lý của các nhà cung cấp đám mây khác nhau',
        'Không gian làm việc đơn',
        'Logo WebApp & Tùy chỉnh thương hiệu',
        'Hỗ trợ email & trò chuyện ưu tiên',
      ],
