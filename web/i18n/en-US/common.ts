const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Vigie account',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Vigie\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Vigie {{version}} is now available.',
    latestAvailable: 'Vigie {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Overview',
