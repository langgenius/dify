const translation = {
  ...
  userProfile: {
    ...
    helpCenter: 'Help',
    roadmapAndFeedback: 'Contact',
    community: 'Our Nators',
    about: 'About',
    logout: 'Log out',
  },
  settings: {
  ...
  account: {
    ...
    langGeniusAccount: 'GNator account',
    langGeniusAccountTip: 'Your GNator account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to GNator to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by GNator allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across GNator\'s applications.',
    link: 'Learn how to develop your own API Extension.',
    linkUrl: 'https://docs.GNator.ai/features/extension/api_based_extension',
  ...
  about: {
    ...
    nowAvailable: 'GNator {{version}} is now available.',
    latestAvailable: 'GNator {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
