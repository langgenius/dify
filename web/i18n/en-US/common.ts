const translation = {
  ...
  settings: {
    ...
    workspaceApiKey: 'API Keys for Workspace',
  },
  account: {
    account: 'Account',
  ...
  workspaceApiKey: {
    ...
    description: 'Manage API keys that allow workspace members to authenticate with Dify APIs. API keys are tied to individual workspace members.',
    add: 'Add API Key',
    manage: 'Manage API Keys',
    regenerate: 'Regenerate API Key',
    updateSuccess: 'API key updated successfully',
    updateFailed: 'Failed to update API key',
    selectorPlaceholder: 'Please select an API key',
    createdAt: 'Created',
    expiresAt: 'Expires',
    ...
    regeneratedApiKey: 'Your Regenerated API Key',
    newApiKeyDescription: 'Copy your API key now. You won\'t be able to see it again!',
    securityWarning: 'Keep your API key secure! Do not share it publicly or commit it to version control.',
    yourApiKey: 'Your API Key',

    modal: {
      addTitle: 'Add API Key',
      addDescription: 'API keys are used to simplify management and usage in applications across the entire Dify workspace.',
      editTitle: 'Edit API Key',
      editDescription: 'Update the name, permissions, and expiry settings for this API key.',
      deleteTitle: 'Delete API Key',
      deleteDescription: 'Deleting an API key will invalidate it and make it unusable in applications.',
      deleteFailed: 'Failed to delete API key',
      deleteSuccess: 'API key deleted successfully',
      ...
      expiresPlaceholder: 'Enter expiry days (default: 30 days)',
      expiresDescription: 'Set the expiry period for the API key. Default is 30 days.',
      ...
      addFailed: 'Failed to add API key',
      regenerateTitle: 'Regenerate API Key',
      regenerateDescription: 'Regenerating the API key will invalidate the current key and issue a new one. You will need to configure the new key in your applications.',
