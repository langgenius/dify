const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'iEchor account',
    langGeniusAccountTip: 'Your iEchor account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to iEchor to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by iEchor allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across iEchor\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'iEchor {{version}} is now available.',
    latestAvailable: 'iEchor {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Overview',
