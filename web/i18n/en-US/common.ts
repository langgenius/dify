const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'AiConec Studio account',
    langGeniusAccountTip: 'Your AiConec Studio account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to AiConec Studio to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by AiConec Studio allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across AiConec Studio\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'AiConec Studio {{version}} is now available.',
    latestAvailable: 'AiConec Studio {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Overview',
