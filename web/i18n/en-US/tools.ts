const translation = {
  ...
  createTool: {
    ...
    nameForToolCallTip: 'Name for tool call is used for machine recognition, such as getcurrentweather, list_pets. Do not use Chinese characters, spaces, special characters.',
