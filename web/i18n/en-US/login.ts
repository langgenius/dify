const translation = {
  ...
  welcome: '👋 Welcome to Tiby, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Tiby Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on Tiby',
  invalid: 'The link has expired',
  explore: 'Explore Tiby',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on Tiby and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The Tiby Enterprise license for your workspace has expired. Please contact your administrator to continue using Tiby.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect Tiby license server. Please contact your administrator to continue using Tiby.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The Tiby Enterprise license for your workspace is inactive. Please contact your administrator to continue using Tiby.',
}
