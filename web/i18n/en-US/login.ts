const translation = {
  ...
  welcome: 'Welcome to iEchor, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting iEchor Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on iEchor',
  invalid: 'The link has expired',
  explore: 'Explore iEchor',
