const translation = {
  ...
  scrapfly: {
    configScrapfly: 'Configure Scrapfly',
    apiKeyPlaceholder: 'API key from scrapfly.io',
    getApiKeyLinkText: 'Get your API key from scrapfly.io',
  },
  jinaReader: {
  ...
  stepOne: {
    ...
    website: {
      ...
      scrapflyNotConfigured: 'Scrapfly is not configured',
      scrapflyNotConfiguredDescription: 'Configure Scrapfly with API key to use it.',
      configure: 'Configure',
      configureFirecrawl: 'Configure Firecrawl',
      configureWatercrawl: 'Configure Watercrawl',
      configureScrapfly: 'Configure Scrapfly',
      ...
      scrapflyTitle: 'Extract web content with Scrapfly',
      scrapflyDoc: 'Scrapfly docs',
      ...
      antiScrapingProtection: 'Enable anti-scraping protection',
