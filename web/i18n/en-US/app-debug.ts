const translation = {
  ...
  vision: {
    ...
    visionSettings: {
      ...
      extractAudiotip: 'The audio content of the video is extracted and converted into text, which is used as the context of the LLM to assist image recognition',
      extractAudioWordTimestamps: 'Keep Text Timestamp',
      extractAudioWordTimestampstip: 'Separate the audio content in the video and convert the audio to text with or without keeping the text timestamp aligned with the video timeline',
      InextractAudioWordTimestamps: 'Enabled',
      ExextractAudioWordTimestamps: 'Disabled',
      extractVideo: 'Extract Video',
      extractVideotip: 'Through video extraction image frame to achieve video understanding, support mp4, mov, mpeg, mpga. All the picture frames are finally combined into a temporal width map',
      InextractAudio: 'Enabled',
      ExextractAudio: 'Disabled',
      VideoTips: 'Note: Currently only the Gemini model supports native video inference, other visual models only support video frame inference.',
      similarityThreshold: 'Similarity Threshold',
      blurThreshold: 'Blur Threshold',
      MaxCollectFrames: 'Max Collect Frames',
      spliceMode: 'Splice Mode',
      spliceModetip: 'Splice the pictures in the vertical or horizontal direction, or output a list of all pictures directly',
      Vertical: 'Vertical',
