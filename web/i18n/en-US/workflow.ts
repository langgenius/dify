const translation = {
  ...
  nodes: {
    ...
    triggerPlugin: {
      ...
      subscriptionNamePlaceholder: 'Enter a name for this subscription',
      ...
      buildingSubscription: 'Building Subscription',
      unifiedConfigDescription: 'Complete all configuration steps in one place',
      parametersPreview: 'The following parameters will be configured next:',
      credentialVerificationFailed: 'Credential verification failed: {{error}}',
      parameterConfigurationFailed: 'Parameter configuration failed: {{error}}',
      subscriptionConfigured: 'Subscription configured successfully',
      subscriptionBuildFailed: 'Subscription build failed: {{error}}',
    },
    questionClassifiers: {
      model: 'model',
      inputVars: 'Input Variables',
