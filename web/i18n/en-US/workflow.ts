const translation = {
  ...
  nodes: {
    ...
    questionClassifiers: {
      ...
      systemPromptPlaceholder: 'Custom system prompt for chat models. Use {histories} placeholder.',
      customCompletionPrompt: 'Completion Prompt',
      completionPromptPlaceholder: 'Custom completion prompt for completion models. Use {histories}, {input_text}, {categories}, and {classification_instructions} placeholders.',
    },
    parameterExtractor: {
      ...
      customPrompts: 'Custom Prompts',
      customSystemPrompt: 'System Prompt',
      systemPromptPlaceholder: 'Custom system prompt for function call mode. Use {histories} and {instruction} placeholders.',
      customUserPromptTemplate: 'User Prompt Template',
      userPromptTemplatePlaceholder: 'Custom user prompt template for function call mode. Use {content} and {structure} placeholders.',
      customChatPrompt: 'Chat Prompt',
      chatPromptPlaceholder: 'Custom chat prompt for prompt engineering mode. Use {histories} and {instructions} placeholders.',
      customCompletionPrompt: 'Completion Prompt',
      completionPromptPlaceholder: 'Custom completion prompt for prompt engineering mode. Use {histories}, {text}, and {instruction} placeholders.',
    },
    iteration: {
