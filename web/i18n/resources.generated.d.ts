...
export default interface Resources {
  ...
  modelProvider: {
    ...
    'modelProvider.tokenerAllowancePeriod': 'allowance period {{period}} (UTC)'
    'modelProvider.tokenerAllowanceRemaining': 'allowance remaining'
    'modelProvider.tokenerAllowanceTotal': 'allowance this period'
    'modelProvider.tokenerAvailableUsd': 'USD available'
    'modelProvider.tokenerBilledThisMonth': 'billed this month (UTC through {{date}})'
    'modelProvider.tokenerEntitlementFailed': 'Paid Tokener credits could not be applied. The available balance has not been increased.'
    ...
    'modelProvider.tokenerUsageSetupFailed': 'Tokener setup failed, so usage is temporarily unavailable.'
    'modelProvider.tokenerUsageTip': 'Balance and monthly billing data update near real time.'
    'modelProvider.tokenerUsageUnavailable': 'Tokener usage is temporarily unavailable.'
