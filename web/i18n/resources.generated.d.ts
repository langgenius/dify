...
export default interface Resources {
  ...
  app: {
    ...
    'newApp.blank': 'Blank'
    'newApp.buildFromBlank': 'Build from blank'
    'newApp.builderDescription': 'With <builderIcon/> App Builder or by hand'
    'newApp.builderPromptPlaceholder': 'Build a finance expense workflow'
    ...
    'newApp.creationMethod': 'Creation method'
    'newApp.defaultName': 'Untitled App'
    ...
    'newApp.menu.agentDescription': 'Chat where the model decides which tools to call, for research assistants, data lookups, or multi-step tasks.'
    'newApp.menu.chatbotDescription': 'A chat app you write as a prompt, with no canvas, for customer support, writing help, or role-play.'
    'newApp.menu.chatflowDescription': 'Holds a conversation, for a support bot, doc Q&A, or an onboarding assistant.'
    'newApp.menu.completionDescription': 'A single-output app you write as a prompt, for copywriting, rewriting, or email drafts.'
    'newApp.menu.importDSLHint': 'Or drag a DSL file onto the studio'
    'newApp.menu.moreTypes': 'More app types'
    'newApp.menu.startFromTemplate': 'Start from a template'
    'newApp.menu.workflowDescription': 'Runs a task and finishes, for translating documents, summarizing tickets, or cleaning up spreadsheets.'
    ...
    'newApp.optimizeFailed': "Couldn't optimize the prompt. Try again."
    'newApp.optimizeModelContactAdmin': 'Ask a workspace administrator to complete the setup.'
    'newApp.optimizeModelRequired': 'Configure an available system default language model in Model Settings before optimizing the prompt.'
    'newApp.optimizeNoChange': 'No changes were made to your prompt.'
    'newApp.optimizeWithAI': 'Optimize with AI'
    'newApp.optional': 'Optional'
    'newApp.startFromAppBuilder': 'Create from App Builder'
    'newApp.startFromBlank': 'Create from Blank'
    'newApp.startFromTemplate': 'Create from Template'
    'newApp.starter.chatflowTitle': 'Build your next chatflow'
    'newApp.starter.invoices': 'Invoices to spreadsheet'
    'newApp.starter.openBlank': 'Open a blank canvas'
    'newApp.starter.placeholder': 'Pull amounts from my receipts into a spreadsheet'
    'newApp.starter.templateDescription': 'Start from a working app and reshape it'
    'newApp.starter.tickets': 'Daily ticket summary'
    'newApp.starter.translate': 'Translate documents'
    'newApp.starter.workflowTitle': 'Build your next workflow'
    'newApp.untitled': 'Untitled'
  ...
  workflow: {
    ...
    'difyBuilder.affectedNodes': 'Affected nodes'
    'difyBuilder.buttonTooltip': 'App Builder'
    'difyBuilder.cardCategory.checks': 'Checks'
    'difyBuilder.cardCategory.error': 'Error'
    'difyBuilder.cardCategory.form': 'Form'
    'difyBuilder.cardCategory.learning': 'Learning'
    'difyBuilder.cardCategory.plan': 'Plan'
    'difyBuilder.cardCategory.publish': 'Publish'
    'difyBuilder.cardCategory.resources': 'Resources'
    'difyBuilder.cardCategory.run': 'Run'
    'difyBuilder.cardCategory.summary': 'Summary'
    'difyBuilder.cardCategory.test': 'Test'
    'difyBuilder.changeDetails': 'Change details'
    'difyBuilder.changes': 'Changes'
    'difyBuilder.checklistIssues': 'Checklist issues'
    'difyBuilder.emptyBuildTitle': 'Nothing here yet'
    'difyBuilder.emptyDescription': 'Tell me what you want to build — I’ll show you a plan first. Nothing is built until you approve.'
    'difyBuilder.exportDebugLog': 'Export debug log'
    'difyBuilder.failedRun': 'Failed run'
    'difyBuilder.fixRun': 'Fix with <builder><icon/>App Builder</builder>'
    'difyBuilder.helpDescription': 'Describe your goal. App Builder proposes a plan, executes it after your approval, and helps test and fix issues.'
    'difyBuilder.helpTitle': 'How App Builder works'
    'difyBuilder.interrupted': 'The previous operation was interrupted. Choose an available action to continue.'
    'difyBuilder.invalidated': 'Superseded by a revert'
    'difyBuilder.messagePlaceholder': 'Describe what you want to build or change'
    'difyBuilder.messageSend': 'Send'
    'difyBuilder.modelContactAdmin': 'No models are available. Ask a workspace administrator to configure one.'
    'difyBuilder.modelLoadFailed': "Couldn't load models. Try again."
    'difyBuilder.modelLoading': 'Loading models…'
    'difyBuilder.modelUnavailable': 'This model is unavailable. Choose another model or update its configuration, then try again.'
    'difyBuilder.noChanges': 'No changes'
    'difyBuilder.panelTitle': 'App Builder'
    ...
    'difyBuilder.status.clarifying': 'Clarifying'
    'difyBuilder.status.done': 'Done'
    'difyBuilder.status.editing': 'Editing'
    'difyBuilder.status.failed': 'Failed'
    'difyBuilder.status.paused': 'Paused'
    'difyBuilder.status.planning': 'Planning'
    'difyBuilder.status.publishing': 'Publishing'
    'difyBuilder.status.reading': 'Reading'
    'difyBuilder.status.review': 'Review'
    'difyBuilder.status.testing': 'Testing'
    'difyBuilder.status.waitingForConfirmation': 'Waiting for confirmation'
    'difyBuilder.status.waitingForInput': 'Waiting for input'
    ...
    'draftConflict.message': 'This workflow was updated elsewhere. Auto-save is paused.'
    'draftConflict.reload': 'Reload draft'
    'draftConflict.reloadFailed': 'Could not reload the draft. Please try again.'
    'draftConflict.unsaved': 'Unsaved · Auto-save paused'
