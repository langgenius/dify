  ...
  plans: {
    ...
    enterprise: {
      ...
      features: [
        ...
        'Несколько рабочих пространств и управление предприятием',
        'ССО',
        'Согласованные SLA от Dify Partners',
    ...
    community: {
      features: [
        'Все основные функции выпущены в общедоступном репозитории',
        'Единое рабочее пространство',
        'Соответствует лицензии Dify с открытым исходным кодом',
      ],
      name: 'Сообщество',
    ...
    premium: {
      features: [
        'Самостоятельное управление надежностью от различных поставщиков облачных услуг',
        'Единое рабочее пространство',
        'Настройка логотипа и брендинга WebApp',
