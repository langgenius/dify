const translation = {
  ...
  metadata: {
    createMetadata: {
      ...
      descriptionPlaceholder: 'Добавить описание метаданных (необязательно)',
      descriptionTooltip: 'Помогает модели лучше извлекать информацию о метаданных из ввода пользователя при использовании автоматической фильтрации метаданных.',
    },
    checkName: {
