const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Compte Vigie',
  ...
  apiBasedExtension: {
    title: 'Les extensions API fournissent une gestion centralisée des API, simplifiant la configuration pour une utilisation facile à travers les applications de Vigie.',
  ...
  about: {
    ...
    nowAvailable: 'Vigie {{version}} est maintenant disponible.',
    latestAvailable: 'Vigie {{version}} est la dernière version disponible.',
  },
  appMenus: {
    overview: 'Aperçu',
