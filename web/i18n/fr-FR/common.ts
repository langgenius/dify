const translation = {
  ...
  settings: {
    ...
    workspaceApiKey: 'Clés API de l\'espace de travail',
  },
  account: {
    avatar: 'Avatar',
    name: 'Nom',
  ...
  you: 'Vous',
  workspaceApiKey: {
    title: 'Clés API de l\'espace de travail',
    description: 'Gérez les clés API qui permettent aux membres de l\'espace de travail de s\'authentifier auprès des API Dify. Les clés API sont liées aux membres individuels de l\'espace de travail.',
    add: 'Ajouter une clé API',
    manage: 'Gérer les clés API',
    regenerate: 'Régénérer la clé API',
    updateSuccess: 'Clé API mise à jour avec succès',
    updateFailed: 'Échec de la mise à jour de la clé API',
    selectorPlaceholder: 'Veuillez sélectionner une clé API',
    createdAt: 'Créé le',
    expiresAt: 'Expire le',
    ...
    deleteFailed: 'Échec de la suppression de la clé API',
    newApiKey: 'Votre nouvelle clé API',
    regeneratedApiKey: 'Votre clé API régénérée',
    newApiKeyDescription: 'Copiez votre clé API maintenant. Vous ne pourrez plus la revoir !',
    securityWarning: 'Gardez votre clé API en sécurité ! Ne la partagez pas publiquement et ne la commitez pas dans le contrôle de version.',
    yourApiKey: 'Votre clé API',

    modal: {
      addTitle: 'Ajouter une clé API',
      addDescription: 'Les clés API sont utilisées pour simplifier la gestion et l\'utilisation dans les applications de l\'ensemble de l\'espace de travail Dify.',
      editTitle: 'Modifier la clé API',
      editDescription: 'Mettez à jour le nom, les autorisations et les paramètres d\'expiration de cette clé API.',
      deleteTitle: 'Supprimer la clé API',
      deleteDescription: 'La suppression d\'une clé API l\'invalidera et la rendra inutilisable dans les applications.',
      deleteFailed: 'Échec de la suppression de la clé API',
      deleteSuccess: 'Clé API supprimée avec succès',
      deleteConfirm: 'Êtes-vous sûr de vouloir supprimer cette clé API ?',
      nameLabel: 'Nom de la clé API',
      namePlaceholder: 'Entrez le nom de la clé API',
      nameError: 'Le nom est requis',
      expiresLabel: 'Expiration (jours)',
      expiresPlaceholder: 'Entrez les jours d\'expiration (par défaut : 30 jours)',
      expiresDescription: 'Définissez la période d\'expiration de la clé API. La valeur par défaut est de 30 jours.',
      ...
      addFailed: 'Échec de l\'ajout de la clé API',
      regenerateTitle: 'Régénérer la clé API',
      regenerateDescription: 'La régénération de la clé API invalidera la clé actuelle et en émettra une nouvelle. Vous devrez configurer la nouvelle clé dans vos applications.',
      regenerateFailed: 'Échec de la régénération de la clé API',
    },
  },
}
