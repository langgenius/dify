  ...
  plans: {
    ...
    enterprise: {
      ...
      features: [
        ...
        'Fonctionnalités exclusives à l’entreprise',
        'Espaces de travail multiples et gestion d’entreprise',
        'SSO',
        'SLA négociés par les partenaires Dify',
    ...
    community: {
      features: [
        'Toutes les fonctionnalités de base publiées dans le dépôt public',
    ...
    premium: {
      features: [
        'Fiabilité autogérée par différents fournisseurs de cloud',
        'Espace de travail unique',
        'Personnalisation du logo et de l’image de marque WebApp',
