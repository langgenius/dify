const translation = {
  ...
  welcome: 'Bienvenue sur Tiby, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer Tiby Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur Tiby',
  invalid: 'Le lien a expiré',
  explore: 'Explorez Tiby',
  ...
  resetPasswordDesc: 'Tapez l’adresse e-mail que vous avez utilisée pour vous inscrire sur Tiby et nous vous enverrons un e-mail de réinitialisation de mot de passe.',
  usePassword: 'Utiliser le mot de passe',
  licenseInactiveTip: 'La licence Tiby Enterprise de votre espace de travail est inactive. Veuillez contacter votre administrateur pour continuer à utiliser Tiby.',
  licenseLostTip: 'Échec de la connexion au serveur de licences Tiby. Veuillez contacter votre administrateur pour continuer à utiliser Tiby.',
  licenseExpired: 'Licence expirée',
  licenseLost: 'Licence perdue',
  licenseExpiredTip: 'La licence Tiby Enterprise de votre espace de travail a expiré. Veuillez contacter votre administrateur pour continuer à utiliser Tiby.',
