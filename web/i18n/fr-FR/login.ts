const translation = {
  ...
  welcome: 'Bienvenue sur iEchor, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer iEchor Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur iEchor',
  invalid: 'Le lien a expiré',
  explore: 'Explorez iEchor',
