const translation = {
  ...
  welcome: 'Bienvenue sur Vigie, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer Vigie Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur Vigie',
  invalid: 'Le lien a expiré',
  explore: 'Explorez Vigie',
