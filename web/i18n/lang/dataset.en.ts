const translation = {
  ...
  deleteDatasetConfirmTitle: 'Delete this knowledge base?',
  ...
  datasetDeleted: 'Knowledge base deleted',
  datasetDeleteFailed: 'Failed to delete knowledge base',
  didYouKnow: 'Did you know?',
  intro1: 'The knowledge base can be integrated into the Dify application ',
  intro2: 'as a context',
  intro3: ',',
  intro4: 'or it ',
