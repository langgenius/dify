const translation = {
  ...
  error: {
    unavailable: 'This knowledge base is not avaliable',
  },
  stepOne: {
    ...
    button: 'next',
    emptyDatasetCreation: 'I want to create an empty knowledge base',
    modal: {
      title: 'Create an empty knowledge base',
      tip: 'An empty knowledge base will contain no documents, and you can upload documents any time.',
  ...
  stepThree: {
    ...
    creationContent: 'We automatically named the knowledge base, you can modify it at any time',
    label: 'Knowledge base name',
    additionTitle: '🎉 Document uploaded',
    additionP1: 'The document has been uploaded to the knowledge base',
    additionP2: ', you can find it in the document list of the knowledge base.',
    stop: 'Stop processing',
    resume: 'Resume processing',
    navTo: 'Go to document',
    sideTipTitle: 'What\'s next',
    sideTipContent: 'After the document finishes indexing, the knowledge base can be integrated into the application as context, you can find the context setting in the prompt orchestration page. You can also create it as an independent ChatGPT indexing plugin for release.',
