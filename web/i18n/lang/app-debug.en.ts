const translation = {
  ...
  feature: {
    ...
    dataSet: {
      title: 'Context',
      noData: 'You can import knowledge base as context',
      words: 'Words',
      textBlocks: 'Text Blocks',
      selectTitle: 'Select reference knowledge base',
      selected: 'Knowledge base selected',
      noDataSet: 'No knowledge base found',
      toCreate: 'Go to create',
      notSupportSelectMulti: 'Currently only support one knowledge base',
      queryVariable: {
        ...
        unableToQueryDataSet: 'Unable to query the knowledge base',
        unableToQueryDataSetTip: 'Unable to query the knowledge base successfully, please choose a context query variable in the context section.',
        ok: 'OK',
        contextVarNotEmpty: 'context query variable can not be empty',
        deleteContextVarTitle: 'Delete variable “{{varName}}”?',
        deleteContextVarTip: 'This variable has been set as a context query variable, and removing it will impact the normal use of the knowledge base. If you still need to delete it, please reselect it in the context section.',
      },
    },
    tools: {
      title: 'Tools',
  ...
  datasetConfig: {
    ...
    retrieveOneWay: {
      ...
      description: 'Based on user intent and knowledge base descriptions, the Agent autonomously selects the best knowledge base for querying. Best for applications with distinct, limited knowledge base.',
    },
    retrieveMultiWay: {
      title: 'Multi-path retrieval',
      description: 'Based on user intent, queries across all knowledge base, retrieves relevant text from multi-sources, and selects the best results matching the user query after reranking. Configuration of the Rerank model API is required.',
    },
    ...
    retrieveChangeTip: 'Modifying the index mode and retrieval mode may affect applications associated with this knowledge base.',
  },
}
