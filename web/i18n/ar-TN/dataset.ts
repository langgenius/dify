const translation = {
  ...
  metadata: {
    ...
    createMetadata: {
      ...
      description: 'الوصف',
      descriptionPlaceholder: 'إضافة وصف البيانات الوصفية (اختياري)',
      descriptionTooltip: 'يساعد النموذج على استخراج معلومات البيانات الوصفية بشكل أفضل من إدخال المستخدم عند استخدام تصفية البيانات الوصفية التلقائية.',
    },
    checkName: {
