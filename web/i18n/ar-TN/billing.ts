  ...
  plans: {
    ...
    community: {
      ...
      features: [
        ...
        'مساحة عمل واحدة',
        'يتوافق مع ترخيص Dify مفتوح المصدر',
      ],
    },
    premium: {
      name: 'بريميوم',
      ...
      features: [
        'موثوقية مدارة ذاتيًا من قبل مختلف مزودي السحابة',
        'مساحة عمل واحدة',
        'تخصيص شعار وعلامة WebApp التجارية',
        'أولوية دعم البريد الإلكتروني والدردشة',
      ],
    },
    enterprise: {
      ...
      features: [
        'حلول نشر قابلة للتطوير على مستوى المؤسسة',
        'ترخيص تجاري',
        'ميزات المؤسسة الحصرية',
        'مساحات عمل متعددة وإدارة المؤسسة',
        'SSO',
        'اتفاقيات مستوى الخدمة المتفاوض عليها من قبل شركاء Dify',
        'أمان وضوابط متقدمة',
        'التحديثات والصيانة من قبل Dify رسميًا',
        'دعم فني احترافي',
      ],
    },
  },
