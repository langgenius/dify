const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Sau încercați versiunea cloud a Tiby cu cotă gratuită',
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajută vizitatorii să înțeleagă datele pe care le colectează aplicația, consultați <privacyPolicyLink>Politica de confidențialitate</privacyPolicyLink> a Tiby.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalați extensia Chrome Tiby Chatbot',
        copied: 'Copiat',
        copy: 'Copiați',
      },
      qrcode: {
