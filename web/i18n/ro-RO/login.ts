const translation = {
  ...
  welcome: 'Bine ai venit la Vigie, te rugăm să te autentifici pentru a continua.',
  ...
  license: {
    tip: 'Înainte de a începe Vigie Community Edition, citește',
