const translation = {
  ...
  welcome: 'Bine ai venit la Tiby, te rugăm să te autentifici pentru a continua.',
  ...
  license: {
    tip: 'Înainte de a începe Tiby Community Edition, citește',
  ...
  or: 'SAU',
  resetPasswordDesc: 'Tastați e-mailul pe care l-ați folosit pentru a vă înscrie pe Tiby și vă vom trimite un e-mail de resetare a parolei.',
  changePasswordBtn: 'Setați o parolă',
  licenseLostTip: 'Nu s-a reușit conectarea serverului de licențe Tiby. Contactați administratorul pentru a continua să utilizați Tiby.',
  licenseInactive: 'Licență inactivă',
  licenseInactiveTip: 'Licența Tiby Enterprise pentru spațiul de lucru este inactivă. Contactați administratorul pentru a continua să utilizați Tiby.',
  licenseExpired: 'Licență expirată',
  licenseLost: 'Licență pierdută',
  licenseExpiredTip: 'Licența Tiby Enterprise pentru spațiul de lucru a expirat. Contactați administratorul pentru a continua să utilizați Tiby.',
}
