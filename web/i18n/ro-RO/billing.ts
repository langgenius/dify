const translation = {
  ...
  plans: {
    ...
    community: {
      features: ['Toate Funcționalitățile de Bază Lansate în Repozitoriul Public', 'Spațiu de lucru unic', 'Respectă Licența Open Source Dify'],
    ...
    premium: {
      features: ['Fiabilitate autogestionată de diferiți furnizori de cloud', 'Spațiu de lucru unic', 'Personalizare Logo și Branding pentru WebApp', 'Asistență prioritară prin e-mail și chat'],
