  ...
  plans: {
    ...
    enterprise: {
      ...
      features: [
        ...
        'Autorizare licență comercială',
        'Funcții exclusive pentru întreprinderi',
        'Mai multe spații de lucru și managementul întreprinderii',
        'SSO',
        'SLA-uri negociate de partenerii Dify',
        'Securitate și controale avansate',
    ...
    community: {
      features: [
        'Toate caracteristicile de bază lansate în depozitul public',
        'Spațiu de lucru unic',
        'Respectă licența Dify Open Source',
      ],
    ...
    premium: {
      features: [
        'Fiabilitate autogestionată de diverși furnizori de cloud',
        'Spațiu de lucru unic',
        'Personalizarea logo-ului și brandingului WebApp',
