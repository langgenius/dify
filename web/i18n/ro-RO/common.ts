const translation = {
  ...
  settings: {
    ...
    workspaceApiKey: 'Chei API spațiu de lucru',
  },
  account: {
    avatar: 'Avatar',
    name: 'Nume',
  ...
  you: 'Tu',
  workspaceApiKey: {
    title: 'Chei API spațiu de lucru',
    description: 'Gestionați cheile API care permit membrilor spațiului de lucru să se autentifice cu API-urile Dify. Cheile API sunt legate de membrii individuali ai spațiului de lucru.',
    add: 'Adaugă cheie API',
    manage: 'Gestionează cheile API',
    regenerate: 'Regenerează cheia API',
    updateSuccess: 'Cheia API a fost actualizată cu succes',
    updateFailed: 'Actualizarea cheii API a eșuat',
    selectorPlaceholder: 'Vă rugăm să selectați o cheie API',
    createdAt: 'Creat la',
    expiresAt: 'Expiră la',
    lastUsedAt: 'Ultima utilizare',
    type: 'Tip',
    none: 'Niciunul',
    deleteSuccess: 'Cheia API a fost ștearsă cu succes',
    deleteFailed: 'Ștergerea cheii API a eșuat',
    newApiKey: 'Noua dvs. cheie API',
    regeneratedApiKey: 'Cheia dvs. API regenerată',
    newApiKeyDescription: 'Copiați cheia API acum. Nu o veți mai putea vedea!',
    securityWarning: 'Păstrați cheia API în siguranță! Nu o partajați public sau nu o comiteți în controlul versiunilor.',
    yourApiKey: 'Cheia dvs. API',

    modal: {
      addTitle: 'Adaugă cheie API',
      addDescription: 'Cheile API sunt utilizate pentru a simplifica gestionarea și utilizarea în aplicații în întregul spațiu de lucru Dify.',
      editTitle: 'Editează cheia API',
      editDescription: 'Actualizați numele, permisiunile și setările de expirare pentru această cheie API.',
      deleteTitle: 'Șterge cheia API',
      deleteDescription: 'Ștergerea unei chei API o va invalida și o va face inutilizabilă în aplicații.',
      deleteFailed: 'Ștergerea cheii API a eșuat',
      deleteSuccess: 'Cheia API a fost ștearsă cu succes',
      deleteConfirm: 'Sunteți sigur că doriți să ștergeți această cheie API?',
      nameLabel: 'Nume cheie API',
      namePlaceholder: 'Introduceți numele cheii API',
      nameError: 'Numele este obligatoriu',
      expiresLabel: 'Expiră (zile)',
      expiresPlaceholder: 'Introduceți zilele de expirare (implicit: 30 de zile)',
      expiresDescription: 'Setați perioada de expirare pentru cheia API. Implicit este 30 de zile.',
      ...
      addFailed: 'Adăugarea cheii API a eșuat',
      regenerateTitle: 'Regenerează cheia API',
      regenerateDescription: 'Regenerarea cheii API va invalida cheia curentă și va emite una nouă. Va trebui să configurați noua cheie în aplicațiile dvs.',
      regenerateFailed: 'Regenerarea cheii API a eșuat',
    },
  },
}
