const translation = {
  ...
  apiBasedExtension: {
    title: 'Extensiile bazate pe API oferă o gestionare centralizată a API-urilor, simplificând configurația pentru o utilizare ușoară în aplicațiile Vigie.',
  ...
  about: {
    ...
    nowAvailable: 'Vigie {{version}} este acum disponibil.',
    latestAvailable: 'Vigie {{version}} este ultima versiune disponibilă.',
  },
  appMenus: {
