const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Cont iEchor',
    langGeniusAccountTip: 'Contul iEchor și datele de utilizator asociate.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitația a fost trimisă și pot să se autentifice în iEchor pentru a accesa datele echipei dvs.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Serviciul de găzduire OpenAI furnizat de iEchor vă permite să utilizați modele precum GPT-3.5. Înainte ca cota de probă să fie epuizată, trebuie să configurați alți furnizori de modele.',
      callTimes: 'Apeluri',
  ...
  apiBasedExtension: {
    title: 'Extensiile bazate pe API oferă o gestionare centralizată a API-urilor, simplificând configurația pentru o utilizare ușoară în aplicațiile iEchor.',
  ...
  about: {
    ...
    nowAvailable: 'iEchor {{version}} este acum disponibil.',
    latestAvailable: 'iEchor {{version}} este ultima versiune disponibilă.',
  },
  appMenus: {
