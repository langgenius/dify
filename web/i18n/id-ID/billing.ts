  ...
  plans: {
    ...
    community: {
      features: [
        ...
        'Ruang Kerja Tunggal',
        'Sesuai dengan Lisensi Sumber Terbuka Dify',
      ],
      price: 'Bebas',
    ...
    premium: {
      features: [
        ...
        'Ruang Kerja Tunggal',
        'Kustomisasi Logo & Branding WebApp',
    ...
    enterprise: {
      features: [
        'Solusi Penerapan yang Dapat Diskalakan Tingkat Perusahaan',
        ...
        'Keamanan & Kontrol Tingkat Lanjut',
