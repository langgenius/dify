const translation = {
  ...
  settings: {
    ...
    generalGroup: 'عمومی',
    workspaceApiKey: 'کلیدهای API فضای کاری',
  },
  account: {
    avatar: 'آواتار',
    name: 'نام',
  ...
  you: 'تو',
  workspaceApiKey: {
    title: 'کلیدهای API فضای کاری',
    description: 'مدیریت کلیدهای API که به اعضای فضای کاری اجازه می‌دهد با APIهای Dify احراز هویت کنند. کلیدهای API به اعضای فضای کاری جداگانه مرتبط هستند.',
    add: 'افزودن کلید API',
    manage: 'مدیریت کلیدهای API',
    regenerate: 'بازسازی کلید API',
    updateSuccess: 'کلید API با موفقیت به‌روزرسانی شد',
    updateFailed: 'به‌روزرسانی کلید API ناموفق بود',
    selectorPlaceholder: 'لطفاً یک کلید API را انتخاب کنید',
    createdAt: 'ایجاد شده در',
    expiresAt: 'منقضی می‌شود در',
    lastUsedAt: 'آخرین استفاده در',
    type: 'نوع',
    none: 'هیچ‌کدام',
    deleteSuccess: 'کلید API با موفقیت حذف شد',
    deleteFailed: 'حذف کلید API ناموفق بود',
    newApiKey: 'کلید API جدید شما',
    regeneratedApiKey: 'کلید API بازسازی شده شما',
    newApiKeyDescription: 'اکنون کلید API خود را کپی کنید. دیگر نمی‌توانید آن را ببینید!',
    securityWarning: 'کلید API خود را ایمن نگه دارید! آن را به صورت عمومی به اشتراک نگذارید یا در کنترل نسخه قرار ندهید.',
    yourApiKey: 'کلید API شما',

    modal: {
      addTitle: 'افزودن کلید API',
      addDescription: 'کلیدهای API برای ساده‌سازی مدیریت و استفاده در برنامه‌ها در سراسر فضای کاری Dify استفاده می‌شوند.',
      editTitle: 'ویرایش کلید API',
      editDescription: 'نام، مجوزها و تنظیمات انقضا را برای این کلید API به‌روزرسانی کنید.',
      deleteTitle: 'حذف کلید API',
      deleteDescription: 'حذف یک کلید API آن را نامعتبر کرده و در برنامه‌ها غیرقابل استفاده می‌کند.',
      deleteFailed: 'حذف کلید API ناموفق بود',
      deleteSuccess: 'کلید API با موفقیت حذف شد',
      deleteConfirm: 'آیا مطمئن هستید که می‌خواهید این کلید API را حذف کنید؟',
      nameLabel: 'نام کلید API',
      namePlaceholder: 'نام کلید API را وارد کنید',
      nameError: 'نام الزامی است',
      expiresLabel: 'انقضا (روز)',
      expiresPlaceholder: 'روزهای انقضا را وارد کنید (پیش‌فرض: 30 روز)',
      expiresDescription: 'دوره انقضا را برای کلید API تنظیم کنید. پیش‌فرض 30 روز است.',
      ...
      addFailed: 'افزودن کلید API ناموفق بود',
      regenerateTitle: 'بازسازی کلید API',
      regenerateDescription: 'بازسازی کلید API، کلید فعلی را نامعتبر کرده و یک کلید جدید صادر می‌کند. باید کلید جدید را در برنامه‌های خود پیکربندی کنید.',
      regenerateFailed: 'بازسازی کلید API ناموفق بود',
    },
  },
}
