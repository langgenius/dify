const translation = {
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: [
        'راه حل های استقرار مقیاس پذیر در سطح سازمانی',
        'مجوز جواز تجاری',
        'ویژگی های انحصاری سازمانی',
        'فضاهای کاری چندگانه و مدیریت سازمانی',
        'Sso',
        'SLA های مذاکره شده توسط Dify Partners',
        'امنیت و کنترل پیشرفته',
        'به روز رسانی و نگهداری توسط Dify به طور رسمی',
    ...
    community: {
      ...
      features: [
        'تمام ویژگی های اصلی در مخزن عمومی منتشر شده است',
        'فضای کاری واحد',
        'با مجوز منبع باز Dify مطابقت دارد',
      ],
    },
    premium: {
      ...
      features: [
        'قابلیت اطمینان خود مدیریت شده توسط ارائه دهندگان مختلف ابر',
        'فضای کاری واحد',
        'لوگوی وب اپلیکیشن و سفارشی سازی برندینگ',
        'پشتیبانی از ایمیل و چت اولویت دار',
      ],
    },
  },
  vectorSpace: {
