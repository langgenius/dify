const translation = {
  ...
  metadata: {
    createMetadata: {
      ...
      type: 'نوع',
      description: 'توضیحات',
      descriptionPlaceholder: 'افزودن توضیحات متاداده (اختیاری)',
      descriptionTooltip: 'به مدل کمک می‌کند تا اطلاعات متاداده را بهتر از ورودی کاربر هنگام استفاده از فیلتر کردن خودکار متاداده استخراج کند.',
    },
    checkName: {
