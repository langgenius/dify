const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Oder probieren Sie die Cloud-Version von iEchor mit kostenlosem Angebot aus',
  },
  overview: {
    title: 'Übersicht',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Hilft Besuchern zu verstehen, welche Daten die Anwendung sammelt, siehe iEchors <privacyPolicyLink>Datenschutzrichtlinie</privacyPolicyLink>.',
        },
      },
      embedded: {
        entry: 'Eingebettet',
        ...
        chromePlugin: 'Installieren Sie die iEchor Chatbot Chrome-Erweiterung',
        copied: 'Kopiert',
        copy: 'Kopieren',
      },
      qrcode: {
