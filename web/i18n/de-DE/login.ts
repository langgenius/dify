const translation = {
  ...
  welcome: 'Willkommen bei iEchor, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit iEchor Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf iEchor beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'iEchor erkunden',
