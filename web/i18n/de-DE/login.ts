const translation = {
  ...
  welcome: 'Willkommen bei GNator, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit GNator Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf GNator beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'GNator erkunden',
