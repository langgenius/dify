const translation = {
  ...
  welcome: 'Willkommen bei Tiby, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit Tiby Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf Tiby beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'Tiby erkunden',
  ...
  resetPasswordDesc: 'Geben Sie die E-Mail-Adresse ein, mit der Sie sich bei Tiby angemeldet haben, und wir senden Ihnen eine E-Mail zum Zurücksetzen des Passworts.',
  ...
  licenseLostTip: 'Fehler beim Verbinden des Tiby-Lizenzservers. Wenden Sie sich an Ihren Administrator, um Tiby weiterhin zu verwenden.',
  licenseInactive: 'Lizenz inaktiv',
  licenseInactiveTip: 'Die Tiby Enterprise-Lizenz für Ihren Arbeitsbereich ist inaktiv. Wenden Sie sich an Ihren Administrator, um Tiby weiterhin zu verwenden.',
  licenseExpiredTip: 'Die Tiby Enterprise-Lizenz für Ihren Arbeitsbereich ist abgelaufen. Wenden Sie sich an Ihren Administrator, um Tiby weiterhin zu verwenden.',
