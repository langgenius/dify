const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'iEchor-Konto',
    langGeniusAccountTip: 'Ihr iEchor-Konto und zugehörige Benutzerdaten.',
  ...
  members: {
    ...
    invitationSentTip: 'Einladung gesendet, und sie können sich bei iEchor anmelden, um auf Ihre Teamdaten zuzugreifen.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Der OpenAI-Hostingdienst von iEchor ermöglicht es Ihnen, Modelle wie GPT-3.5 zu verwenden. Bevor Ihr Probe-Kontingent aufgebraucht ist, müssen Sie andere Modellanbieter einrichten.',
  ...
  apiBasedExtension: {
    title: 'API-Erweiterungen bieten zentralisiertes API-Management und vereinfachen die Konfiguration für eine einfache Verwendung in iEchors Anwendungen.',
  ...
  about: {
    ...
    nowAvailable: 'iEchor {{version}} ist jetzt verfügbar.',
    latestAvailable: 'iEchor {{version}} ist die neueste verfügbare Version.',
  },
  appMenus: {
    overview: 'Übersicht',
