const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Tiby-Konto',
    langGeniusAccountTip: 'Ihr Tiby-Konto und zugehörige Benutzerdaten.',
  ...
  members: {
    ...
    invitationSentTip: 'Einladung gesendet, und sie können sich bei Tiby anmelden, um auf Ihre Teamdaten zuzugreifen.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Der OpenAI-Hostingdienst von Tiby ermöglicht es Ihnen, Modelle wie GPT-3.5 zu verwenden. Bevor Ihr Probe-Kontingent aufgebraucht ist, müssen Sie andere Modellanbieter einrichten.',
  ...
  about: {
    ...
    nowAvailable: 'Tiby {{version}} ist jetzt verfügbar.',
    latestAvailable: 'Tiby {{version}} ist die neueste verfügbare Version.',
  },
  appMenus: {
    overview: 'Übersicht',
