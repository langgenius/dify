const translation = {
  ...
  settings: {
    ...
    workspaceApiKey: 'Arbeitsbereichs-API-Schlüssel',
  },
  account: {
    avatar: 'Avatar',
    name: 'Name',
  ...
  you: 'Du',
  workspaceApiKey: {
    title: 'API-Schlüssel des Arbeitsbereichs',
    description: 'Verwalten Sie API-Schlüssel, die es Arbeitsbereichsmitgliedern ermöglichen, sich bei Dify-APIs zu authentifizieren. API-Schlüssel sind an einzelne Arbeitsbereichsmitglieder gebunden.',
    add: 'API-Schlüssel hinzufügen',
    manage: 'API-Schlüssel verwalten',
    regenerate: 'API-Schlüssel neu generieren',
    updateSuccess: 'API-Schlüssel erfolgreich aktualisiert',
    updateFailed: 'API-Schlüssel konnte nicht aktualisiert werden',
    selectorPlaceholder: 'Bitte wählen Sie einen API-Schlüssel aus',
    ...
    newApiKey: 'Ihr neuer API-Schlüssel',
    regeneratedApiKey: 'Ihr neu generierter API-Schlüssel',
    newApiKeyDescription: 'Kopieren Sie Ihren API-Schlüssel jetzt. Sie können ihn später nicht mehr sehen!',
    securityWarning: 'Halten Sie Ihren API-Schlüssel sicher! Teilen Sie ihn nicht öffentlich und committen Sie ihn nicht in die Versionskontrolle.',
    yourApiKey: 'Ihr API-Schlüssel',

    modal: {
      addTitle: 'API-Schlüssel hinzufügen',
      addDescription: 'API-Schlüssel werden verwendet, um die Verwaltung und Nutzung in Anwendungen im gesamten Dify-Arbeitsbereich zu vereinfachen.',
      editTitle: 'API-Schlüssel bearbeiten',
      editDescription: 'Aktualisieren Sie den Namen, die Berechtigungen und die Ablauf-Einstellungen für diesen API-Schlüssel.',
      deleteTitle: 'API-Schlüssel löschen',
      deleteDescription: 'Das Löschen eines API-Schlüssels macht ihn ungültig und in Anwendungen unbrauchbar.',
      deleteFailed: 'API-Schlüssel konnte nicht gelöscht werden',
      deleteSuccess: 'API-Schlüssel erfolgreich gelöscht',
      deleteConfirm: 'Möchten Sie diesen API-Schlüssel wirklich löschen?',
      nameLabel: 'API-Schlüsselname',
      namePlaceholder: 'API-Schlüsselnamen eingeben',
      nameError: 'Name ist erforderlich',
      expiresLabel: 'Ablauf (Tage)',
      expiresPlaceholder: 'Ablauftage eingeben (Standard: 30 Tage)',
      expiresDescription: 'Legen Sie die Ablaufzeit für den API-Schlüssel fest. Standard ist 30 Tage.',
      ...
      regenerateDescription: 'Das Neugenerieren des API-Schlüssels macht den aktuellen Schlüssel ungültig und stellt einen neuen aus. Sie müssen den neuen Schlüssel in Ihren Anwendungen konfigurieren.',
      regenerateFailed: 'API-Schlüssel konnte nicht neu generiert werden',
    },
  },
}
