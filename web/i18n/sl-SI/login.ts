const translation = {
  ...
  welcome: 'Dobrodošli v Tiby, prosimo, prijavite se za nadaljevanje.',
  ...
  license: {
    tip: 'Preden začnete z Tiby Community Edition, preberite GitHub',
    link: 'Licenco odprte kode',
  },
  join: 'Pridruži se',
  joinTipStart: 'Vabimo vas, da se pridružite',
  joinTipEnd: 'ekipi na Tiby',
  invalid: 'Povezava je potekla',
  explore: 'Razišči Tiby',
  ...
  licenseExpiredTip: 'Licenca za Tiby Enterprise za vaš delovni prostor je potekla. Če želite še naprej uporabljati Tiby, se obrnite na skrbnika.',
  usePassword: 'Uporaba gesla',
  sendVerificationCode: 'Pošlji kodo za preverjanje',
  resetPasswordDesc: 'Vnesite e-poštni naslov, ki ste ga uporabili za prijavo na Tiby, in poslali vam bomo e-poštno sporočilo za ponastavitev gesla.',
  ...
  licenseLostTip: 'Povezava z licenčnim strežnikom Tiby ni uspela. Če želite še naprej uporabljati Tiby, se obrnite na skrbnika.',
  licenseInactiveTip: 'Licenca Tiby Enterprise za vaš delovni prostor je neaktivna. Če želite še naprej uporabljati Tiby, se obrnite na skrbnika.',
}
