const translation = {
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: [
        'Prilagodljive rešitve za uvajanje na ravni podjetij',
        'Dovoljenje za komercialno licenco',
        'Ekskluzivne funkcije za podjetja',
        'Več delovnih prostorov in upravljanje podjetja',
        'SSO',
        'Dogovorjene pogodbe o ravni storitev s strani Dify Partners',
        'Napredna varnost in nadzor',
        'Posodobitve in vzdrževanje s strani Dify Official',
    ...
    community: {
      features: [
        'Vse osnovne funkcije, izdane v javnem repozitoriju',
        'En delovni prostor',
        'Skladen z odprtokodno licenco Dify',
      ],
    ...
    premium: {
      features: [
        'Samostojna zanesljivost različnih ponudnikov storitev v oblaku',
        'En delovni prostor',
        'Prilagajanje logotipa in blagovne znamke WebApp',
        'Prednostna podpora po e-pošti in klepetu',
      ],
      name: 'Premium',
