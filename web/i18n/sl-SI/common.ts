const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Tiby račun',
    langGeniusAccountTip: 'Vaš Tiby račun in povezani uporabniški podatki.',
    editName: 'Uredi ime',
  ...
  members: {
    ...
    invitationSentTip: 'Povabilo poslano, in po prijavi v Tiby bodo imeli dostop do vaših podatkov ekipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Gostitvena storitev OpenAI, ki jo ponuja Tiby, vam omogoča uporabo modelov, kot je GPT-3.5. Preden porabite kvoto za preizkus, morate nastaviti druge ponudnike modelov.',
  ...
  modelProvider: {
    ...
    about: {
      ...
      nowAvailable: 'Tiby {{version}} je zdaj na voljo.',
      latestAvailable: 'Tiby {{version}} je najnovejša različica na voljo.',
    },
    appMenus: {
      overview: 'Nadzor',
  ...
  about: {
    updateNow: 'Posodobi zdaj',
    nowAvailable: 'Tiby {{version}} je zdaj na voljo.',
    latestAvailable: 'Tiby {{version}} je najnovejša različica, ki je na voljo.',
    changeLog: 'Dnevnik sprememb',
  },
  appMenus: {
