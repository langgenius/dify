const translation = {
  ...
  settings: {
    ...
    workspaceApiKey: 'API ključi delovnega prostora',
  },
  account: {
    account: 'Račun',
    myAccount: 'Moj račun',
  ...
  you: 'Ti',
  workspaceApiKey: {
    title: 'API ključi delovnega prostora',
    description: 'Upravljajte API ključe, ki članom delovnega prostora omogočajo avtentikacijo z Dify API-ji. API ključi so vezani na posamezne člane delovnega prostora.',
    add: 'Dodaj API ključ',
    manage: 'Upravljaj API ključe',
    regenerate: 'Ponovno generiraj API ključ',
    updateSuccess: 'API ključ uspešno posodobljen',
    updateFailed: 'Posodobitev API ključa ni uspela',
    selectorPlaceholder: 'Prosimo, izberite API ključ',
    createdAt: 'Ustvarjeno',
    expiresAt: 'Poteče',
    lastUsedAt: 'Zadnja uporaba',
    type: 'Tip',
    none: 'Noben',
    deleteSuccess: 'API ključ uspešno izbrisan',
    deleteFailed: 'Izbris API ključa ni uspel',
    newApiKey: 'Vaš novi API ključ',
    regeneratedApiKey: 'Vaš ponovno generiran API ključ',
    newApiKeyDescription: 'Kopirajte svoj API ključ zdaj. Ne boste ga mogli več videti!',
    securityWarning: 'Varujte svoj API ključ! Ne delite ga javno ali ga ne shranjujte v nadzor različic.',
    yourApiKey: 'Vaš API ključ',

    modal: {
      addTitle: 'Dodaj API ključ',
      addDescription: 'API ključi se uporabljajo za poenostavitev upravljanja in uporabe v aplikacijah po celotnem delovnem prostoru Dify.',
      editTitle: 'Uredi API ključ',
      editDescription: 'Posodobite ime, dovoljenja in nastavitve poteka za ta API ključ.',
      deleteTitle: 'Izbriši API ključ',
      deleteDescription: 'Izbris API ključa ga bo razveljavil in ga naredil neuporabnega v aplikacijah.',
      deleteFailed: 'Izbris API ključa ni uspel',
      deleteSuccess: 'API ključ uspešno izbrisan',
      deleteConfirm: 'Ali ste prepričani, da želite izbrisati ta API ključ?',
      nameLabel: 'Ime API ključa',
      namePlaceholder: 'Vnesite ime API ključa',
      nameError: 'Ime je obvezno',
      expiresLabel: 'Potek (dni)',
      expiresPlaceholder: 'Vnesite dni poteka (privzeto: 30 dni)',
      expiresDescription: 'Nastavite obdobje poteka za API ključ. Privzeto je 30 dni.',
      ...
      addFailed: 'Dodajanje API ključa ni uspelo',
      regenerateTitle: 'Ponovno generiraj API ključ',
      regenerateDescription: 'Ponovno generiranje API ključa bo razveljavilo trenutni ključ in izdalo novega. Novi ključ boste morali konfigurirati v svojih aplikacijah.',
      regenerateFailed: 'Ponovno generiranje API ključa ni uspelo',
    },
  },
}
