const translation = {
  ...
  settings: {
    ...
    workspaceApiKey: 'Claves API del Espacio de Trabajo',
  },
  account: {
    avatar: 'Avatar',
    name: 'Nombre',
  ...
  you: 'Tú',
  workspaceApiKey: {
    title: 'Claves API del Espacio de Trabajo',
    description: 'Administre las claves API que permiten a los miembros del espacio de trabajo autenticarse con las API de Dify. Las claves API están vinculadas a miembros individuales del espacio de trabajo.',
    add: 'Agregar clave API',
    manage: 'Administrar claves API',
    regenerate: 'Regenerar clave API',
    updateSuccess: 'Clave API actualizada exitosamente',
    updateFailed: 'Error al actualizar la clave API',
    selectorPlaceholder: 'Por favor, seleccione una clave API',
    createdAt: 'Creado el',
    expiresAt: 'Expira el',
    lastUsedAt: 'Último uso',
    type: 'Tipo',
    none: 'Ninguno',
    deleteSuccess: 'Clave API eliminada exitosamente',
    deleteFailed: 'Error al eliminar la clave API',
    newApiKey: 'Su nueva clave API',
    regeneratedApiKey: 'Su clave API regenerada',
    newApiKeyDescription: 'Copie su clave API ahora. ¡No podrá verla de nuevo!',
    securityWarning: '¡Mantenga su clave API segura! No la comparta públicamente ni la suba al control de versiones.',
    yourApiKey: 'Su clave API',

    modal: {
      addTitle: 'Agregar clave API',
      addDescription: 'Las claves API se utilizan para simplificar la gestión y el uso en aplicaciones en todo el espacio de trabajo de Dify.',
      editTitle: 'Editar clave API',
      editDescription: 'Actualice el nombre, los permisos y la configuración de caducidad para esta clave API.',
      deleteTitle: 'Eliminar clave API',
      deleteDescription: 'La eliminación de una clave API la invalidará y la hará inutilizable en las aplicaciones.',
      deleteFailed: 'Error al eliminar la clave API',
      deleteSuccess: 'Clave API eliminada exitosamente',
      deleteConfirm: '¿Está seguro de que desea eliminar esta clave API?',
      nameLabel: 'Nombre de la clave API',
      namePlaceholder: 'Ingrese el nombre de la clave API',
      nameError: 'El nombre es obligatorio',
      expiresLabel: 'Caducidad (días)',
      expiresPlaceholder: 'Ingrese los días de caducidad (predeterminado: 30 días)',
      expiresDescription: 'Establezca el período de caducidad para la clave API. El valor predeterminado es 30 días.',
      ...
      addFailed: 'Error al agregar la clave API',
      regenerateTitle: 'Regenerar clave API',
      regenerateDescription: 'La regeneración de la clave API invalidará la clave actual y emitirá una nueva. Deberá configurar la nueva clave en sus aplicaciones.',
      regenerateFailed: 'Error al regenerar la clave API',
    },
  },
}
