const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'O prueba la versión en la nube de  con una cotización gratuita',
  },
  overview: {
    title: 'Resumen',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ayuda a los visitantes a comprender los datos que recopila la aplicación, consulta la <privacyPolicyLink>Política de privacidad</privacyPolicyLink> de .',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalar la extensión de Chrome de  Chatbot',
        copied: 'Copiado',
        copy: 'Copiar',
      },
      qrcode: {
