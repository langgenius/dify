const translation = {
  ...
  account: {
    ...
    delete: '删除账户',
    deleteTip: '此操作无法撤销。这将永久删除您的整个账户。您拥有的所有工作空间都将被删除，您将被移出所有共享的工作空间。',
    deleteSuccessTip: '您的账户需要时间来完成删除。完成后我们会给您发送邮件。',
    deleteLabel: '请输入您的邮箱以确认删除',
