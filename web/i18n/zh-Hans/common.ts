const translation = {
  ...
  workspaceApiKey: {
    title: '工作空间 API 密钥',
    description: '管理允许工作空间成员使用 Dify API 进行身份验证的 API 密钥。API 密钥与单个工作空间成员绑定。',
    add: '添加 API 密钥',
    manage: '管理 API 密钥',
    regenerate: '重新生成 API 密钥',
    updateSuccess: 'API 密钥更新成功',
    updateFailed: '更新 API 密钥失败',
    selectorPlaceholder: '请选择一个 API 密钥',
    createdAt: '创建于',
    expiresAt: '过期于',
    lastUsedAt: '上次使用',
    type: '类型',
    ...
    newApiKey: '您的新 API 密钥',
    regeneratedApiKey: '您重新生成的 API 密钥',
    newApiKeyDescription: '立即复制您的 API 密钥。您将无法再次看到它！',
    securityWarning: '请妥善保管您的 API 密钥！请勿公开分享或提交到版本控制。',
    yourApiKey: '您的 API 密钥',

    modal: {
      addTitle: '添加 API 密钥',
      addDescription: 'API 密钥用于简化 Dify 整个工作空间中应用程序的管理和使用。',
      editTitle: '编辑 API 密钥',
      editDescription: '更新此 API 密钥的名称、权限和过期设置。',
      deleteTitle: '删除 API 密钥',
      deleteDescription: '删除 API 密钥将使其失效，并在应用程序中无法使用。',
      deleteFailed: '删除 API 密钥失败',
      deleteSuccess: 'API 密钥删除成功',
      deleteConfirm: '您确定要删除此 API 密钥吗？',
      nameLabel: 'API 密钥名称',
      namePlaceholder: '输入 API 密钥名称',
      nameError: '名称为必填项',
      expiresLabel: '过期时间（天）',
      expiresPlaceholder: '输入过期天数（默认：30 天）',
      expiresDescription: '设置 API 密钥的过期时间。默认为 30 天。',
      expiresError: '过期时间必须至少为 1 天',
      scopesLabel: '权限',
      scopeRequired: '至少需要一个权限',
      validationHint: {
        nameAndScope: '请输入API密钥名称并选择权限',
        nameOnly: '请输入API密钥名称',
        scopeOnly: '请选择权限',
      },
      apiKeyLabel: 'API 密钥',
      apiKeyPlaceholder: '输入 API 密钥',
      apiKeyError: 'API 密钥必须至少为 5 个字符',
      addFailed: '添加 API 密钥失败',
      regenerateTitle: '重新生成 API 密钥',
      regenerateDescription: '重新生成 API 密钥将使当前密钥失效并颁发新密钥。您需要在应用程序中配置新密钥。',
