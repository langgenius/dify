const translation = {
  ...
  generate: {
    title: '提示生成器',
    descriptionInApp: '提示词生成器可以将输入的任务指令转换为高质量、结构化的提示。请尽可能详细地编写清晰、具体的指令。提示词生成器使用当前编排设置中配置的模型和参数。',
    descriptionLLM: '提示词生成器可以将输入的任务指令转换为高质量、结构化的提示。请尽可能详细地编写清晰、具体的指令。提示词生成器使用当前 LLM 节点中配置的模型和参数。',
    tryIt: '试一试',
    instruction: '指令',
