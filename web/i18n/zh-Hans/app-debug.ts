const translation = {
  ...
  vision: {
    ...
    visionSettings: {
      ...
      url: 'URL',
      uploadLimit: '上传数量限制',
      video_extraction: '视频设置',
      extractAudio: '音频提取',
      extractAudiotip: '提取视频中的音频内容并转为文本，作为 LLM 的上下文用以辅助图像识别',
      extractAudioWordTimestamps: '是否保留时间戳',
      extractAudioWordTimestampstip: '分离视频中的音频内容，并将音频转换文本时是否保留文本时间戳与视频时间线对齐',
      InextractAudioWordTimestamps: '是',
      ExextractAudioWordTimestamps: '否',
      extractVideo: '视频抽帧',
      extractVideotip: '通过视频抽取图像帧的方式实现视频理解，支持 mp4, mov, mpeg, mpga。所有图片帧组最终合成一张时序宽图',
      InextractAudio: '是',
      ExextractAudio: '否',
      InextractVideo: '是',
      ExextractVideo: '否',
      VideoTips: '注意: 当前仅Gemini模型支持原生视频推理，其他视觉模型仅支持视频抽帧推理.',
      similarityThreshold: '相似度阈值',
      blurThreshold: '模糊度阈值',
      MaxCollectFrames: '最大抽帧数量',
      spliceMode: '拼接模式',
      spliceModetip: '将抽帧后的图片按垂直或水平方向进行拼接，或者直接输出所有图片列表',
      Vertical: '垂直拼接',
      Horizontal: '水平拼接',
      Images: '图片列表',
    },
