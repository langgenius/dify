const translation = {
  ...
  generation: {
    ...
    savedNoData: {
      ...
      startCreateContent: '콘텐츠 생성 시작',
    },
    title: 'AI 텍스트 생성',
    queryTitle: '쿼리 내용',
    completionResult: '생성 결과',
    ...
    errorMsg: {
      ...
      emptyLine: '{{rowIndex}}행이 비어 있습니다.',
      invalidLine: '{{rowIndex}}행: {{varName}} 값은 비워둘 수 없습니다.',
      moreThanMaxLengthLine: '{{rowIndex}}행: {{varName}} 값은 {{maxLength}}자를 초과할 수 없습니다.',
