const translation = {
  common: {
    ...
    viewDetailInTracingPanel: '상세 정보 보기',
    importDSL: 'DSL 가져오기',
    ...
    workflowAsToolDisabledHint: '최신 워크플로우를 게시하고 도구로 구성하기 전에 연결된 사용자 입력 노드가 있는지 확인하세요.',
  },
  env: {
    envPanelTitle: '환경 변수',
    envDescription:
  ...
  singleRun: {
    ...
    loop: '루프',
    reRun: '다시 실행',
    preparingDataSource: '데이터 소스 준비 중',
  },
  tabs: {
    'tools': '도구',
    'allTool': '전체',
