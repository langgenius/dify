const translation = {
  ...
  createTool: {
    ...
    authMethod: {
      ...
      types: {
        ...
        queryParamPlaceholder: 'API 키의 쿼리 매개변수 이름',
        api_key_header: '헤더',
      },
      key: '키',
      value: '값',
    ...
    toolInput: {
      ...
      method: '방식',
      methodSetting: '설정',
      methodSettingTip: '도구 설정에서 사용자가 입력',
      methodParameter: '매개변수',
      methodParameterTip: '추론 중에 LLM이 입력',
      label: '태그',
    ...
    deleteToolConfirmContent: '도구를 삭제하면 되돌릴 수 없습니다. 사용자는 더 이상 이 도구에 액세스할 수 없습니다.',
    toolOutput: {
      title: '도구 출력',
      name: '이름',
      reserved: '예약됨',
  ...
  mcp: {
    ...
    modal: {
      ...
      headersTip: 'MCP 서버 요청 시 함께 보낼 추가 HTTP 헤더',
