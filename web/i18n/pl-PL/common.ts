const translation = {
  ...
  settings: {
    ...
    generalGroup: 'OGÓLNE',
    workspaceApiKey: 'Klucze API przestrzeni roboczej',
  },
  account: {
    avatar: 'Awatar',
    name: 'Nazwa',
  ...
  you: 'Ty',
  workspaceApiKey: {
    title: 'Klucze API obszaru roboczego',
    description: 'Zarządzaj kluczami API, które umożliwiają członkom obszaru roboczego uwierzytelnianie się w interfejsach API Dify. Klucze API są powiązane z indywidualnymi członkami obszaru roboczego.',
    add: 'Dodaj klucz API',
    manage: 'Zarządzaj kluczami API',
    regenerate: 'Wygeneruj ponownie klucz API',
    updateSuccess: 'Klucz API zaktualizowany pomyślnie',
    updateFailed: 'Nie udało się zaktualizować klucza API',
    selectorPlaceholder: 'Wybierz klucz API',
    createdAt: 'Utworzono',
    expiresAt: 'Wygasa',
    ...
    deleteFailed: 'Nie udało się usunąć klucza API',
    newApiKey: 'Twój nowy klucz API',
    regeneratedApiKey: 'Twój ponownie wygenerowany klucz API',
    newApiKeyDescription: 'Skopiuj swój klucz API teraz. Nie będziesz mógł go ponownie zobaczyć!',
    securityWarning: 'Zachowaj bezpieczeństwo swojego klucza API! Nie udostępniaj go publicznie ani nie zatwierdzaj w kontroli wersji.',
    yourApiKey: 'Twój klucz API',

    modal: {
      addTitle: 'Dodaj klucz API',
      addDescription: 'Klucze API służą do uproszczenia zarządzania i użytkowania w aplikacjach w całym obszarze roboczym Dify.',
      editTitle: 'Edytuj klucz API',
      editDescription: 'Zaktualizuj nazwę, uprawnienia i ustawienia wygaśnięcia dla tego klucza API.',
      deleteTitle: 'Usuń klucz API',
      deleteDescription: 'Usunięcie klucza API unieważni go i sprawi, że będzie bezużyteczny w aplikacjach.',
      deleteFailed: 'Nie udało się usunąć klucza API',
      deleteSuccess: 'Klucz API usunięty pomyślnie',
      deleteConfirm: 'Czy na pewno chcesz usunąć ten klucz API?',
      nameLabel: 'Nazwa klucza API',
      namePlaceholder: 'Wprowadź nazwę klucza API',
      nameError: 'Nazwa jest wymagana',
      expiresLabel: 'Wygasa (dni)',
      expiresPlaceholder: 'Wprowadź dni wygaśnięcia (domyślnie: 30 dni)',
      expiresDescription: 'Ustaw okres ważności klucza API. Domyślnie 30 dni.',
      ...
      addFailed: 'Nie udało się dodać klucza API',
      regenerateTitle: 'Wygeneruj ponownie klucz API',
      regenerateDescription: 'Ponowne wygenerowanie klucza API unieważni bieżący klucz i wyda nowy. Będziesz musiał skonfigurować nowy klucz w swoich aplikacjach.',
      regenerateFailed: 'Nie udało się ponownie wygenerować klucza API',
    },
  },
}
