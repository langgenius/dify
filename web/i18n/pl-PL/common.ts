const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Konto Tiby',
    langGeniusAccountTip: 'Twoje konto Tiby i powiązane dane użytkownika.',
  ...
  members: {
    ...
    invitationSentTip:
      'Zaproszenie zostało wysłane, a oni mogą zalogować się do Tiby, aby uzyskać dostęp do danych Twojego zespołu.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Usługa hostowania OpenAI dostarczana przez Tiby pozwala korzystać z modeli takich jak GPT-3.5. Przed wyczerpaniem limitu próbnego należy skonfigurować inne dostawców modeli.',
  ...
  apiBasedExtension: {
    title:
      'Rozszerzenia oparte na interfejsie API zapewniają scentralizowane zarządzanie interfejsami API, upraszczając konfigurację dla łatwego użytkowania w aplikacjach Tiby.',
  ...
  about: {
    ...
    nowAvailable: 'Tiby {{version}} jest teraz dostępny.',
    latestAvailable: 'Tiby {{version}} jest najnowszą dostępną wersją.',
  },
  appMenus: {
