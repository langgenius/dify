const translation = {
  ...
  intro1: 'Wiedzę można zintegrować z aplikacją  ',
  ...
  externalAPIPanelDescription: 'Interfejs API wiedzy zewnętrznej służy do łączenia się z bazą wiedzy poza  i pobierania wiedzy z tej bazy wiedzy.',
}
