const translation = {
  ...
  welcome: 'Witaj w Tiby, zaloguj się, aby kontynuować.',
  email: 'Adres e-mail',
  ...
  license: {
    tip: 'Przed rozpoczęciem wersji społecznościowej Tiby, przeczytaj GitHub',
    link: 'Licencję open-source',
  },
  join: 'Dołącz',
  joinTipStart: 'Zapraszam Cię do dołączenia do',
  joinTipEnd: 'zespołu na Tiby',
  invalid: 'Link wygasł',
  explore: 'Odkryj Tiby',
  ...
  resetPasswordDesc: 'Wpisz adres e-mail, którego użyłeś do rejestracji w Tiby, a my wyślemy Ci wiadomość e-mail z prośbą o zresetowanie hasła.',
  or: 'LUB',
  ...
  licenseExpiredTip: 'Licencja Tiby Enterprise dla Twojego obszaru roboczego wygasła. Skontaktuj się z administratorem, aby kontynuować korzystanie z Tiby.',
  licenseLostTip: 'Nie udało się nawiązać połączenia z serwerem licencji Tiby. Skontaktuj się z administratorem, aby kontynuować korzystanie z Tiby.',
  licenseInactiveTip: 'Licencja Tiby Enterprise dla Twojego obszaru roboczego jest nieaktywna. Skontaktuj się z administratorem, aby kontynuować korzystanie z Tiby.',
}
