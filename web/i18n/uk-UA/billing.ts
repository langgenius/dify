  ...
  plans: {
    ...
    enterprise: {
      ...
      features: [
        ...
        'Ексклюзивні функції підприємства',
        'Кілька робочих областей і управління підприємством',
        'Єдиний вхід',
        'Угода про рівень обслуговування за домовленістю від Dify Partners',
        'Розширені функції безпеки та керування',
        'Оновлення та обслуговування від Dify Official',
    ...
    community: {
      features: [
        'Усі основні функції випущено в загальнодоступному репозиторії',
        'Єдине робоче місце',
        'Відповідає ліцензії Dify з відкритим вихідним кодом',
      ],
    ...
    premium: {
      features: [
        'Самокерована надійність різними хмарними провайдерами',
        'Єдине робоче місце',
        'Налаштування логотипу WebApp та брендингу',
        'Пріоритетна підтримка електронною поштою та в чаті',
      ],
