const translation = {
  ...
  settings: {
    ...
    workspaceApiKey: 'Ключі API робочого простору',
  },
  account: {
    avatar: 'Аватар',
    name: 'Ім\'я',
  ...
  you: 'Ти',
  workspaceApiKey: {
    title: 'Ключі API робочого простору',
    description: 'Керуйте ключами API, які дозволяють учасникам робочого простору автентифікуватися за допомогою API Dify. Ключі API прив’язані до окремих учасників робочого простору.',
    add: 'Додати ключ API',
    manage: 'Керувати ключами API',
    regenerate: 'Відновити ключ API',
    updateSuccess: 'Ключ API успішно оновлено',
    updateFailed: 'Не вдалося оновити ключ API',
    selectorPlaceholder: 'Будь ласка, виберіть ключ API',
    createdAt: 'Створено',
    expiresAt: 'Термін дії',
    lastUsedAt: 'Останнє використання',
    type: 'Тип',
    none: 'Немає',
    deleteSuccess: 'Ключ API успішно видалено',
    deleteFailed: 'Не вдалося видалити ключ API',
    newApiKey: 'Ваш новий ключ API',
    regeneratedApiKey: 'Ваш відновлений ключ API',
    newApiKeyDescription: 'Скопіюйте свій ключ API зараз. Ви більше не зможете його побачити!',
    securityWarning: 'Зберігайте свій ключ API в безпеці! Не діліться ним публічно та не фіксуйте його в системі контролю версій.',
    yourApiKey: 'Ваш ключ API',

    modal: {
      addTitle: 'Додати ключ API',
      addDescription: 'Ключі API використовуються для спрощення керування та використання в програмах у всьому робочому просторі Dify.',
      editTitle: 'Редагувати ключ API',
      editDescription: 'Оновіть назву, дозволи та налаштування терміну дії для цього ключа API.',
      deleteTitle: 'Видалити ключ API',
      deleteDescription: 'Видалення ключа API зробить його недійсним і непридатним для використання в програмах.',
      deleteFailed: 'Не вдалося видалити ключ API',
      deleteSuccess: 'Ключ API успішно видалено',
      deleteConfirm: 'Ви впевнені, що хочете видалити цей ключ API?',
      nameLabel: 'Назва ключа API',
      namePlaceholder: 'Введіть назву ключа API',
      nameError: 'Назва обов’язкова',
      expiresLabel: 'Термін дії (дні)',
      expiresPlaceholder: 'Введіть термін дії (за замовчуванням: 30 днів)',
      expiresDescription: 'Встановіть термін дії для ключа API. За замовчуванням 30 днів.',
      ...
      addFailed: 'Не вдалося додати ключ API',
      regenerateTitle: 'Відновити ключ API',
      regenerateDescription: 'Відновлення ключа API зробить поточний ключ недійсним і видасть новий. Вам потрібно буде налаштувати новий ключ у своїх програмах.',
      regenerateFailed: 'Не вдалося відновити ключ API',
    },
  },
}
