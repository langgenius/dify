const translation = {
  common: {
    ...
    needConnectTip: 'Цей крок ні до чого не підключений', maxTreeDepth: 'Максимальний ліміт {{depth}} вузлів на гілку',
    needAdd: '{{node}} вузол повинен бути доданий',
  ...
  nodes: {
    ...
    iteration: {
      ...
      flattenOutput: 'Згладити вихід',
      flattenOutputDesc: 'Якщо цей параметр увімкнено, якщо всі результати ітерації є масивами, вони будуть зведені в один масив. Якщо вимкнено, вихідні дані підтримуватимуть вкладену структуру масиву.',
    },
    note: {
      editor: {
        large: 'Великий',
  ...
  debug: {
    ...
    lastRunInputsCopied: '{{count}} входи скопійовано з останнього запуску',
