const translation = {
  ...
  metadata: {
    createMetadata: {
      ...
      name: 'Ім\'я',
      description: 'Опис',
      descriptionPlaceholder: 'Додати опис метаданих (необов\'язково)',
      descriptionTooltip: 'Допомагає моделі краще витягувати інформацію про метадані з введення користувача при використанні автоматичної фільтрації метаданих.',
    },
    checkName: {
