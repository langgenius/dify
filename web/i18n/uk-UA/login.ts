const translation = {
  ...
  welcome: 'Ласкаво просимо до Vigie, будь ласка, увійдіть, щоб продовжити.',
  ...
  license: {
    tip: 'Перед запуском Vigie Community Edition ознайомтеся з ліцензією з відкритим кодом на GitHub',
    link: 'Ліцензія з відкритим кодом',
  },
  join: 'Приєднуйтесь',
  joinTipStart: 'Запрошуємо вас приєднатися',
  joinTipEnd: 'команда Vigie',
  invalid: 'Посилання застаріло',
  explore: 'Досліджуйте Vigie',
