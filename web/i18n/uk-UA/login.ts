const translation = {
  ...
  welcome: 'Ласкаво просимо до AiConec Studio, будь ласка, увійдіть, щоб продовжити.',
  ...
  license: {
    tip: 'Перед запуском AiConec Studio Community Edition ознайомтеся з ліцензією з відкритим кодом на GitHub',
    link: 'Ліцензія з відкритим кодом',
  },
  join: 'Приєднуйтесь',
  joinTipStart: 'Запрошуємо вас приєднатися',
  joinTipEnd: 'команда AiConec Studio',
  invalid: 'Посилання застаріло',
  explore: 'Досліджуйте AiConec Studio',
