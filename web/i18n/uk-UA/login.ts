const translation = {
  ...
  forgotPasswordDesc: 'Будь ласка, введіть свою електронну адресу, щоб скинути пароль. Ми надішлемо вам листа з інструкціями щодо скидання пароля.',
  forgotPasswordBtn: 'Надіслати посилання для скидання',
  error: {
