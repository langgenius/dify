const translation = {
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: [
        'โซลูชันการปรับใช้ที่ปรับขนาดได้ระดับองค์กร',
        'การอนุญาตใบอนุญาตเชิงพาณิชย์',
        'คุณสมบัติพิเศษสําหรับองค์กร',
        'พื้นที่ทํางานหลายแห่งและการจัดการองค์กร',
        'SSO',
        'SLA ที่เจรจาโดย Dify Partners',
        'การรักษาความปลอดภัยและการควบคุมขั้นสูง',
        'การอัปเดตและบํารุงรักษาโดย Dify อย่างเป็นทางการ',
    ...
    community: {
      features: [
        'คุณสมบัติหลักทั้งหมดที่เผยแพร่ภายใต้ที่เก็บสาธารณะ',
        'พื้นที่ทํางานเดียว',
        'สอดคล้องกับใบอนุญาตโอเพ่นซอร์ส Dify',
      ],
      name: 'ชุมชน',
      price: 'ฟรี',
    ...
    premium: {
      features: [
        'ความน่าเชื่อถือที่จัดการด้วยตนเองโดยผู้ให้บริการคลาวด์ต่างๆ',
        'พื้นที่ทํางานเดียว',
        'โลโก้ WebApp และการปรับแต่งแบรนด์',
        'การสนับสนุนทางอีเมลและแชทลําดับความสําคัญ',
      ],
