const translation = {
  ...
  metadata: {
    createMetadata: {
      ...
      descriptionPlaceholder: 'เพิ่มคำอธิบายข้อมูลเมตา (ไม่จำเป็น)',
      descriptionTooltip: 'ช่วยให้โมเดลดึงข้อมูลเมตาดาต้าได้ดีขึ้นจากอินพุตของผู้ใช้เมื่อใช้การกรองข้อมูลเมตาดาต้าอัตโนมัติ',
    },
    checkName: {
