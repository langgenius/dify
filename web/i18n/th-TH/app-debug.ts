const translation = {
  feature: {
    ...
    dataSet: {
      queryVariable: {
        ...
        deleteContextVarTitle: 'ลบตัวแปร “{{varName}}” หรือไม่?',
    ...
    tools: {
      ...
      title: 'เครื่อง มือ',
      toolsInUse: '{{count}} เครื่องมือที่กำลังใช้งาน',
    ...
    conversationHistory: {
      ...
      tip: 'ยังไม่ได้เปิดใช้งานประวัติการสนทนา โปรดเพิ่ม <histories> ในพรอมต์ด้านบน',
  ...
  errorMessage: {
    nameOfKeyRequired: 'ชื่อคีย์: {{key}} จำเป็นต้องระบุ',
    valueOfVarRequired: 'ค่า {{key}} ต้องไม่ว่างเปล่า',
  ...
  varKeyError: {
    canNoBeEmpty: '{{key}} ต้องไม่เว้นว่าง',
    tooLong: '{{key}} ยาวเกินไป ต้องไม่เกิน 30 อักขระ',
    notValid: '{{key}} ไม่ถูกต้อง ต้องประกอบด้วยตัวอักษร ตัวเลข และขีดล่างเท่านั้น',
    notStartWithNumber: '{{key}} ห้ามเริ่มต้นด้วยตัวเลข',
  ...
  variableConfig: {
    ...
    'notSet': 'ยังไม่ได้ตั้งค่า ลองพิมพ์ {{input}} ในพรอมต์คำนำ',
    'file': {
      image: {
        name: 'ภาพ',
      },
  ...
  vision: {
    visionSettings: {
      resolution: 'มติ',
      resolutionTooltip: `ความละเอียดต่ำช่วยให้โมเดลรับภาพเวอร์ชันความละเอียด 512x512 และแสดงภาพด้วยงบประมาณ 65 โทเค็น ช่วยให้ API ตอบกลับได้เร็วขึ้นและใช้โทเค็นอินพุตน้อยลงสำหรับกรณีที่ไม่ต้องการรายละเอียดสูง
\n
ความละเอียดสูงจะให้โมเดลดูภาพความละเอียดต่ำก่อน จากนั้นสร้างแผ่นรายละเอียดของภาพอินพุตเป็นสี่เหลี่ยม 512 พิกเซล แต่ละแผ่นใช้โทเค็นเพิ่มเป็นสองเท่า รวมเป็น 129 โทเค็น`,
      uploadMethod: 'วิธีการอัปโหลด',
      localUpload: 'อัปโหลดในเครื่อง',
      low: 'ต่ํา',
      high: 'สูง',
  ...
  openingStatement: {
    ...
    openingQuestionPlaceholder: 'คุณสามารถใช้ตัวแปร ลองพิมพ์ {{variable}}',
    varTip: 'คุณสามารถใช้ตัวแปร ลองพิมพ์ {{variable}}',
    notIncludeKey: 'พรอมต์เริ่มต้นไม่มีตัวแปร {{key}} โปรดเพิ่มลงในพรอมต์',
  ...
  promptTip: 'พรอมต์ช่วยกำหนดทิศทางการตอบของ AI ด้วยคำสั่งและข้อจำกัด ใส่ตัวแปรอย่าง {{input}} พรอมต์นี้ผู้ใช้จะไม่เห็น',
  ...
  notSetVar: 'ตัวแปรช่วยให้ผู้ใช้เพิ่มคำหรือข้อความเปิดในพรอมต์เมื่อกรอกแบบฟอร์ม ลองพิมพ์ "{{input}}" ในพรอมต์',
}
