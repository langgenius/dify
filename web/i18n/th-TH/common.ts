const translation = {
  ...
  settings: {
    ...
    generalGroup: 'ทั่วไป',
    workspaceApiKey: 'คีย์ API ของพื้นที่ทำงาน',
  },
  account: {
    account: 'บัญชี',
  ...
  you: 'คุณ',
  workspaceApiKey: {
    title: 'คีย์ API ของพื้นที่ทำงาน',
    description: 'จัดการคีย์ API ที่อนุญาตให้สมาชิกพื้นที่ทำงานยืนยันตัวตนด้วย Dify API คีย์ API จะผูกกับสมาชิกพื้นที่ทำงานแต่ละคน',
    add: 'เพิ่มคีย์ API',
    manage: 'จัดการคีย์ API',
    regenerate: 'สร้างคีย์ API ใหม่',
    updateSuccess: 'อัปเดตคีย์ API สำเร็จ',
    updateFailed: 'อัปเดตคีย์ API ล้มเหลว',
    selectorPlaceholder: 'โปรดเลือกคีย์ API',
    createdAt: 'สร้างเมื่อ',
    expiresAt: 'หมดอายุเมื่อ',
    lastUsedAt: 'ใช้งานล่าสุด',
    type: 'ประเภท',
    none: 'ไม่มี',
    deleteSuccess: 'ลบคีย์ API สำเร็จ',
    deleteFailed: 'ลบคีย์ API ล้มเหลว',
    newApiKey: 'คีย์ API ใหม่ของคุณ',
    regeneratedApiKey: 'คีย์ API ที่สร้างใหม่ของคุณ',
    newApiKeyDescription: 'คัดลอกคีย์ API ของคุณตอนนี้ คุณจะไม่สามารถเห็นได้อีก!',
    securityWarning: 'เก็บคีย์ API ของคุณให้ปลอดภัย! อย่าแชร์ต่อสาธารณะหรือคอมมิตไปยังระบบควบคุมเวอร์ชัน',
    yourApiKey: 'คีย์ API ของคุณ',

    modal: {
      addTitle: 'เพิ่มคีย์ API',
      addDescription: 'คีย์ API ใช้เพื่อลดความซับซ้อนในการจัดการและการใช้งานในแอปพลิเคชันทั่วทั้งพื้นที่ทำงาน Dify',
      editTitle: 'แก้ไขคีย์ API',
      editDescription: 'อัปเดตชื่อ สิทธิ์ และการตั้งค่าการหมดอายุสำหรับคีย์ API นี้',
      deleteTitle: 'ลบคีย์ API',
      deleteDescription: 'การลบคีย์ API จะทำให้คีย์นั้นไม่ถูกต้องและไม่สามารถใช้งานได้ในแอปพลิเคชัน',
      deleteFailed: 'ลบคีย์ API ล้มเหลว',
      deleteSuccess: 'ลบคีย์ API สำเร็จ',
      deleteConfirm: 'คุณแน่ใจหรือไม่ว่าต้องการลบคีย์ API นี้',
      nameLabel: 'ชื่อคีย์ API',
      namePlaceholder: 'ป้อนชื่อคีย์ API',
      nameError: 'ชื่อจำเป็น',
      expiresLabel: 'หมดอายุ (วัน)',
      expiresPlaceholder: 'ป้อนวันหมดอายุ (ค่าเริ่มต้น: 30 วัน)',
      expiresDescription: 'ตั้งค่าระยะเวลาหมดอายุสำหรับคีย์ API ค่าเริ่มต้นคือ 30 วัน',
      ...
      addFailed: 'เพิ่มคีย์ API ล้มเหลว',
      regenerateTitle: 'สร้างคีย์ API ใหม่',
      regenerateDescription: 'การสร้างคีย์ API ใหม่จะทำให้คีย์ปัจจุบันไม่ถูกต้องและออกคีย์ใหม่ คุณจะต้องกำหนดค่าคีย์ใหม่ในแอปพลิเคชันของคุณ',
      regenerateFailed: 'สร้างคีย์ API ใหม่ล้มเหลว',
    },
  },
}
