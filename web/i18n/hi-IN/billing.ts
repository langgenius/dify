const translation = {
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: [
        'उद्योग स्तर के बड़े पैमाने पर वितरण समाधान',
        'Commercial License Authorization',
        'विशेष उद्यम सुविधाएँ',
        'अनेक कार्यक्षेत्र और उद्यम प्रबंधक',
        'SSO',
        'डिफाई पार्टनर्स द्वारा बातचीत किए गए एसएलए',
        'उन्नत सुरक्षा और नियंत्रण',
        'डिफी द्वारा आधिकारिक रूप से अपडेट और रखरखाव',
        'प्रोफेशनल तकनीकी समर्थन',
      ],
      price: 'कस्टम',
    ...
    community: {
      features: [
        'सभी मुख्य सुविधाएं सार्वजनिक संग्रह के तहत जारी की गई हैं।',
        'एकल कार्यक्षेत्र',
        'डिफी ओपन सोर्स लाइसेंस के अनुपालन में',
      ],
    ...
    premium: {
      features: [
        'विभिन्न क्लाउड प्रदाताओं द्वारा आत्म-प्रबंधित विश्वसनीयता',
        'एकल कार्यक्षेत्र',
        'वेब ऐप लोगो और ब्रांडिंग कस्टमाइजेशन',
