const translation = {
  ...
  settings: {
    ...
    workspaceApiKey: 'कार्यस्थान API कुंजी',
  },
  account: {
    avatar: 'अवतार',
    name: 'नाम',
  ...
  you: 'आप',
  workspaceApiKey: {
    title: 'कार्यस्थान API कुंजियाँ',
    description: 'API कुंजियों का प्रबंधन करें जो कार्यस्थान सदस्यों को Dify API के साथ प्रमाणित करने की अनुमति देती हैं। API कुंजियाँ व्यक्तिगत कार्यस्थान सदस्यों से बंधी होती हैं।',
    add: 'API कुंजी जोड़ें',
    manage: 'API कुंजियाँ प्रबंधित करें',
    regenerate: 'API कुंजी पुन: उत्पन्न करें',
    updateSuccess: 'API कुंजी सफलतापूर्वक अपडेट की गई',
    updateFailed: 'API कुंजी अपडेट करने में विफल',
    selectorPlaceholder: 'कृपया एक API कुंजी का चयन करें',
    createdAt: 'बनाया गया',
    expiresAt: 'समाप्त होता है',
    lastUsedAt: 'अंतिम बार उपयोग किया गया',
    type: 'प्रकार',
    none: 'कोई नहीं',
    deleteSuccess: 'API कुंजी सफलतापूर्वक हटाई गई',
    deleteFailed: 'API कुंजी हटाने में विफल',
    newApiKey: 'आपकी नई API कुंजी',
    regeneratedApiKey: 'आपकी पुन: उत्पन्न API कुंजी',
    newApiKeyDescription: 'अपनी API कुंजी अभी कॉपी करें। आप इसे फिर कभी नहीं देख पाएंगे!',
    securityWarning: 'अपनी API कुंजी सुरक्षित रखें! इसे सार्वजनिक रूप से साझा न करें या संस्करण नियंत्रण में न डालें।',
    yourApiKey: 'आपकी API कुंजी',

    modal: {
      addTitle: 'API कुंजी जोड़ें',
      addDescription: 'API कुंजियों का उपयोग पूरे Dify कार्यस्थान में अनुप्रयोगों में प्रबंधन और उपयोग को सरल बनाने के लिए किया जाता है।',
      editTitle: 'API कुंजी संपादित करें',
      editDescription: 'इस API कुंजी के लिए नाम, अनुमतियाँ और समाप्ति सेटिंग्स अपडेट करें।',
      deleteTitle: 'API कुंजी हटाएँ',
      deleteDescription: 'एक API कुंजी को हटाने से वह अमान्य हो जाएगी और अनुप्रयोगों में अनुपयोगी हो जाएगी।',
      deleteFailed: 'API कुंजी हटाने में विफल',
      deleteSuccess: 'API कुंजी सफलतापूर्वक हटाई गई',
      deleteConfirm: 'क्या आप वाकई इस API कुंजी को हटाना चाहते हैं?',
      nameLabel: 'API कुंजी का नाम',
      namePlaceholder: 'API कुंजी का नाम दर्ज करें',
      nameError: 'नाम आवश्यक है',
      expiresLabel: 'समाप्ति (दिन)',
      expiresPlaceholder: 'समाप्ति के दिन दर्ज करें (डिफ़ॉल्ट: 30 दिन)',
      expiresDescription: 'API कुंजी के लिए समाप्ति अवधि सेट करें। डिफ़ॉल्ट 30 दिन है।',
      ...
      addFailed: 'API कुंजी जोड़ने में विफल',
      regenerateTitle: 'API कुंजी पुन: उत्पन्न करें',
      regenerateDescription: 'API कुंजी को पुन: उत्पन्न करने से वर्तमान कुंजी अमान्य हो जाएगी और एक नई कुंजी जारी की जाएगी। आपको अपने अनुप्रयोगों में नई कुंजी को कॉन्फ़िगर करना होगा।',
      regenerateFailed: 'API कुंजी पुन: उत्पन्न करने में विफल',
    },
  },
}
