const translation = {
  ...
  metadata: {
    createMetadata: {
      ...
      back: 'पीछे',
      description: 'विवरण',
      descriptionPlaceholder: 'मेटाडेटा विवरण जोड़ें (वैकल्पिक)',
      descriptionTooltip: 'स्वचालित मेटाडेटा फ़िल्टरिंग का उपयोग करते समय मॉडल को उपयोगकर्ता इनपुट से मेटाडेटा जानकारी को बेहतर ढंग से निकालने में मदद करता है।',
    },
    checkName: {
