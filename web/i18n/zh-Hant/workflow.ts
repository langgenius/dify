const translation = {
  ...
  env: {
    modal: {
      ...
      type: '類型',
      value: '價值',
      secretTip: '用於定義敏感資訊或數據，並配置了DSL設置以防止洩漏。',
      name: '名字',
      valuePlaceholder: 'ENV 值',
    },
    export: {
      title: '匯出 Secret 環境變數？',
      checkbox: '匯出機密值',
      export: '匯出具有機密值的 DSL',
      ignore: '匯出 DSL',
    },
    envPanelButton: '添加變數',
    envDescription: '環境變數可用於存儲私有資訊和憑據。它們是只讀的，可以在導出過程中與 DSL 檔分離。',
    envPanelTitle: '環境變數',
  },
}
