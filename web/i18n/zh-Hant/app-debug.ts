const translation = {
  ...
  vision: {
    ...
    visionSettings: {
      ...
      url: 'URL',
      uploadLimit: '上傳數量限制',
      video_extraction: '視頻設定',
      extractAudio: '音訊選取',
      extractAudiotip: '選取視頻中的音訊內容並轉為文字，作為LLM的上下文用以輔助圖像識別',
      extractVideo: '視頻抽幀',
      extractVideotip: '通過視頻抽取影像幀的管道實現視頻理解，支持mp4，mov，mpeg，mpga。 所有圖片幀組最終合成一張時序寬圖',
      InextractAudio: '是',
      ExextractAudio: '否',
      InextractVideo: '是',
      ExextractVideo: '否',
