const translation = {
  ...
  workspaceApiKey: {
    title: '工作空間 API 金鑰',
    description: '管理允許工作空間成員使用 Dify API 進行身份驗證的 API 金鑰。API 金鑰與單個工作空間成員綁定。',
    add: '新增 API 金鑰',
    manage: '管理 API 金鑰',
    regenerate: '重新生成 API 金鑰',
    updateSuccess: 'API 金鑰更新成功',
    updateFailed: '更新 API 金鑰失敗',
    selectorPlaceholder: '請選擇一個 API 金鑰',
    createdAt: '建立於',
    expiresAt: '過期於',
    lastUsedAt: '上次使用',
    type: '類型',
    ...
    deleteFailed: '刪除 API 金鑰失敗',
    newApiKey: '您的新 API 金鑰',
    regeneratedApiKey: '您重新生成的 API 金鑰',
    newApiKeyDescription: '立即複製您的 API 金鑰。您將無法再次看到它！',
    securityWarning: '請妥善保管您的 API 金鑰！請勿公開分享或提交到版本控制。',
    yourApiKey: '您的 API 金鑰',

    modal: {
      addTitle: '新增 API 金鑰',
      addDescription: 'API 金鑰用於簡化 Dify 整個工作空間中應用程式的管理和使用。',
      editTitle: '編輯 API 金鑰',
      editDescription: '更新此 API 金鑰的名稱、權限和過期設定。',
      deleteTitle: '刪除 API 金鑰',
      deleteDescription: '刪除 API 金鑰將使其失效，並在應用程式中無法使用。',
      deleteFailed: '刪除 API 金鑰失敗',
      deleteSuccess: 'API 金鑰刪除成功',
      deleteConfirm: '您確定要刪除此 API 金鑰嗎？',
      nameLabel: 'API 金鑰名稱',
      namePlaceholder: '輸入 API 金鑰名稱',
      nameError: '名稱為必填項',
      expiresLabel: '過期時間（天）',
      expiresPlaceholder: '輸入過期天數（預設：30 天）',
      expiresDescription: '設定 API 金鑰的過期時間。預設為 30 天。',
      ...
      addFailed: '新增 API 金鑰失敗',
      regenerateTitle: '重新生成 API 金鑰',
      regenerateDescription: '重新生成 API 金鑰將使目前金鑰失效並頒發新金鑰。您需要在應用程式中配置新金鑰。',
      regenerateFailed: '重新生成 API 金鑰失敗',
    },
  },
}
