  ...
  plans: {
    ...
    enterprise: {
      ...
      features: [
        ...
        'Recursos exclusivos da empresa',
        'Vários espaços de trabalho e gerenciamento corporativo',
        'SSO',
        'SLAs negociados pela Dify Partners',
        'Segurança e controles avançados',
        'Atualizações e manutenção por Dify oficialmente',
    ...
    community: {
      features: [
        'Todos os principais recursos lançados no repositório público',
    ...
    premium: {
      features: [
        'Confiabilidade autogerenciada por vários provedores de nuvem',
        'Espaço de trabalho individual',
        'Personalização do logotipo e da marca do WebApp',
        'Suporte prioritário por e-mail e bate-papo',
      ],
