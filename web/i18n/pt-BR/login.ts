const translation = {
  ...
  welcome: 'Bem-vindo ao AiConec Studio, faça login para continuar.',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária do AiConec Studio, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe no AiConec Studio',
  invalid: 'O link expirou',
  explore: 'Explorar o AiConec Studio',
