const translation = {
  ...
  welcome: 'Bem-vindo ao Tiby, faça login para continuar.',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária do Tiby, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe no Tiby',
  invalid: 'O link expirou',
  explore: 'Explorar o Tiby',
  ...
  resetPasswordDesc: 'Digite o e-mail que você usou para se inscrever no Tiby e enviaremos um e-mail de redefinição de senha.',
  sendVerificationCode: 'Enviar código de verificação',
  usePassword: 'Usar senha',
  licenseInactiveTip: 'A licença do Tiby Enterprise para seu espaço de trabalho está inativa. Entre em contato com o administrador para continuar usando o Tiby.',
  licenseLostTip: 'Falha ao conectar o servidor de licenças Tiby. Entre em contato com o administrador para continuar usando o Tiby.',
  licenseExpired: 'Licença expirada',
  licenseLost: 'Licença perdida',
  licenseInactive: 'Licença inativa',
  licenseExpiredTip: 'A licença do Tiby Enterprise para seu espaço de trabalho expirou. Entre em contato com o administrador para continuar usando o Tiby.',
}
