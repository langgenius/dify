const translation = {
  ...
  speechToText: {
    ...
    speechToTextSettings: {
      title: 'Configurações de reconhecimento de fala',
      languageRecognition: 'Reconhecimento de idioma',
      resolutionTooltip: 'Idioma de suporte de voz para reconhecimento de fala.',
      auto: 'Automático',
