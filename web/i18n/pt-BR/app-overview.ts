const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Ou experimente a versão em nuvem do AiConec Studio com cota gratuita',
  },
  overview: {
    title: 'Visão geral',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajuda os visitantes a entender os dados que o aplicativo coleta, consulte a <privacyPolicyLink>Política de Privacidade</privacyPolicyLink> do AiConec Studio.',
        },
      },
      embedded: {
        entry: 'Embutido',
        ...
        chromePlugin: 'Instalar Extensão do Chatbot AiConec Studio para o Chrome',
        copied: 'Copiado',
        copy: 'Copiar',
      },
      qrcode: {
