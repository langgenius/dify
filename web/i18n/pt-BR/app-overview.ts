const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Ou experimente a versão em nuvem do  com cota gratuita',
  },
  overview: {
    title: 'Visão Geral',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajuda os visitantes a entender os dados coletados pelo aplicativo, consulte a <privacyPolicyLink>Política de Privacidade</privacyPolicyLink> do .',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalar a Extensão do Chrome  Chatbot',
        copied: 'Copiado',
        copy: 'Copiar',
      },
      qrcode: {
