const translation = {
  ...
  settings: {
    ...
    generalGroup: 'GERAL',
    workspaceApiKey: 'Chaves de API do Espaço de Trabalho',
  },
  account: {
    avatar: 'Avatar',
    name: 'Nome',
  ...
  you: 'Você',
  workspaceApiKey: {
    title: 'Chaves de API do Espaço de Trabalho',
    description: 'Gerencie as chaves de API que permitem aos membros do espaço de trabalho autenticar-se com as APIs Dify. As chaves de API estão vinculadas a membros individuais do espaço de trabalho.',
    add: 'Adicionar Chave de API',
    manage: 'Gerenciar Chaves de API',
    regenerate: 'Regenerar Chave de API',
    updateSuccess: 'Chave de API atualizada com sucesso',
    updateFailed: 'Falha ao atualizar a chave de API',
    selectorPlaceholder: 'Por favor, selecione uma chave de API',
    createdAt: 'Criado em',
    expiresAt: 'Expira em',
    ...
    deleteFailed: 'Falha ao excluir a chave de API',
    newApiKey: 'Sua Nova Chave de API',
    regeneratedApiKey: 'Sua Chave de API Regenerada',
    newApiKeyDescription: 'Copie sua chave de API agora. Você não poderá vê-la novamente!',
    securityWarning: 'Mantenha sua chave de API segura! Não a compartilhe publicamente ou a comite no controle de versão.',
    yourApiKey: 'Sua Chave de API',

    modal: {
      addTitle: 'Adicionar Chave de API',
      addDescription: 'As chaves de API são usadas para simplificar o gerenciamento e o uso em aplicativos em todo o espaço de trabalho Dify.',
      editTitle: 'Editar Chave de API',
      editDescription: 'Atualize o nome, as permissões e as configurações de expiração para esta chave de API.',
      deleteTitle: 'Excluir Chave de API',
      deleteDescription: 'A exclusão de uma chave de API a invalidará e a tornará inutilizável em aplicativos.',
      deleteFailed: 'Falha ao excluir a chave de API',
      deleteSuccess: 'Chave de API excluída com sucesso',
      deleteConfirm: 'Tem certeza de que deseja excluir esta chave de API?',
      nameLabel: 'Nome da Chave de API',
      namePlaceholder: 'Insira o nome da chave de API',
      nameError: 'O nome é obrigatório',
      expiresLabel: 'Expiração (dias)',
      expiresPlaceholder: 'Insira os dias de expiração (padrão: 30 dias)',
      expiresDescription: 'Defina o período de expiração para a chave de API. O padrão é 30 dias.',
      expiresError: 'A expiração deve ser de pelo menos 1 dia',
      scopesLabel: 'Permissões',
      scopeRequired: 'Pelo menos uma permissão é obrigatória',
      validationHint: {
        nameAndScope: 'Por favor, insira um nome para a chave de API e selecione permissões',
        nameOnly: 'Por favor, insira um nome para a chave de API',
        scopeOnly: 'Por favor, selecione permissões',
      },
      apiKeyLabel: 'Chave de API',
      apiKeyPlaceholder: 'Insira a chave de API',
      apiKeyError: 'A chave de API deve ter pelo menos 5 caracteres',
      addFailed: 'Falha ao adicionar a chave de API',
      regenerateTitle: 'Regenerar Chave de API',
      regenerateDescription: 'A regeneração da chave de API invalidará a chave atual e emitirá uma nova. Você precisará configurar a nova chave em seus aplicativos.',
      regenerateFailed: 'Falha ao regenerar a chave de API',
    },
  },
}
