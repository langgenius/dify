const translation = {
  ...
  apiBasedExtension: {
    title: 'As extensões de API fornecem gerenciamento centralizado de API, simplificando a configuração para uso fácil em todos os aplicativos da Vigie.',
  ...
  about: {
    ...
    nowAvailable: 'Vigie {{version}} já está disponível.',
    latestAvailable: 'Vigie {{version}} é a última versão disponível.',
  },
  appMenus: {
