  ...
  plans: {
    ...
    enterprise: {
      ...
      features: [
        ...
        'Çoklu Çalışma Alanları ve Kurumsal Yönetim',
        'SSO',
        'Dify Partners tarafından müzakere edilen SLA',
        'Gelişmiş Güvenlik ve Kontroller',
        'Resmi olarak Dify tarafından Güncellemeler ve Bakım',
    ...
    community: {
      features: [
        'Genel depo altında yayınlanan tüm temel özellikler',
        'Tek Çalışma Alanı',
        'Dify Açık Kaynak Lisansı ile uyumludur',
      ],
      price: 'Ücretsiz',
    ...
    premium: {
      features: [
        'Çeşitli Bulut Sağlayıcıları Tarafından Kendi Kendini Yöneten Güvenilirlik',
        'Tek Çalışma Alanı',
        'WebApp Logosu ve Marka Özelleştirmesi',
