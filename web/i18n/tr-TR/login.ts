const translation = {
  ...
  welcome: 'Tiby\'ye hoş geldiniz, devam etmek için lütfen giriş yapın.',
  ...
  license: {
    tip: 'Tiby Community Edition\'ı başlatmadan önce GitHub\'daki',
  ...
  resetPasswordDesc: 'Tiby\'a kaydolmak için kullandığınız e-postayı yazın, size bir şifre sıfırlama e-postası gönderelim.',
  ...
  back: 'Geri',
  licenseExpiredTip: 'Çalışma alanınız için Tiby Enterprise lisansının süresi doldu. Tiby\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseLostTip: 'Tiby lisans sunucusuna bağlanılamadı. Tiby\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseInactiveTip: 'Çalışma alanınız için Tiby Enterprise lisansı etkin değil. Tiby\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
