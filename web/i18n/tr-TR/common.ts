const translation = {
  ...
  settings: {
    ...
    generalGroup: 'GENEL',
    workspaceApiKey: 'Çalışma Alanı API Anahtarları',
  },
  account: {
    avatar: 'Avatar',
    name: 'İsim',
  ...
  you: 'Sen',
  workspaceApiKey: {
    title: 'Çalışma Alanı API Anahtarları',
    description: 'Çalışma alanı üyelerinin Dify API\'leri ile kimlik doğrulaması yapmasına olanak tanıyan API anahtarlarını yönetin. API anahtarları, bireysel çalışma alanı üyelerine bağlıdır.',
    add: 'API Anahtarı Ekle',
    manage: 'API Anahtarlarını Yönet',
    regenerate: 'API Anahtarını Yeniden Oluştur',
    updateSuccess: 'API anahtarı başarıyla güncellendi',
    updateFailed: 'API anahtarını güncelleme başarısız oldu',
    selectorPlaceholder: 'Lütfen bir API anahtarı seçin',
    createdAt: 'Oluşturulma Tarihi',
    expiresAt: 'Sona Erme Tarihi',
    lastUsedAt: 'Son Kullanım Tarihi',
    type: 'Tür',
    none: 'Yok',
    deleteSuccess: 'API anahtarı başarıyla silindi',
    deleteFailed: 'API anahtarını silme başarısız oldu',
    newApiKey: 'Yeni API Anahtarınız',
    regeneratedApiKey: 'Yeniden Oluşturulan API Anahtarınız',
    newApiKeyDescription: 'API anahtarınızı şimdi kopyalayın. Bir daha göremeyeceksiniz!',
    securityWarning: 'API anahtarınızı güvende tutun! Genel olarak paylaşmayın veya sürüm kontrolüne kaydetmeyin.',
    yourApiKey: 'API Anahtarınız',

    modal: {
      addTitle: 'API Anahtarı Ekle',
      addDescription: 'API anahtarları, Dify çalışma alanındaki uygulamalarda yönetimi ve kullanımı basitleştirmek için kullanılır.',
      editTitle: 'API Anahtarını Düzenle',
      editDescription: 'Bu API anahtarı için adı, izinleri ve sona erme ayarlarını güncelleyin.',
      deleteTitle: 'API Anahtarını Sil',
      deleteDescription: 'Bir API anahtarını silmek, onu geçersiz kılar ve uygulamalarda kullanılamaz hale getirir.',
      deleteFailed: 'API anahtarını silme başarısız oldu',
      deleteSuccess: 'API anahtarı başarıyla silindi',
      deleteConfirm: 'Bu API anahtarını silmek istediğinizden emin misiniz?',
      nameLabel: 'API Anahtarı Adı',
      namePlaceholder: 'API anahtarı adını girin',
      nameError: 'Ad gereklidir',
      expiresLabel: 'Sona Erme (gün)',
      expiresPlaceholder: 'Sona erme günlerini girin (varsayılan: 30 gün)',
      expiresDescription: 'API anahtarı için sona erme süresini ayarlayın. Varsayılan 30 gündür.',
      ...
      addFailed: 'API anahtarı ekleme başarısız oldu',
      regenerateTitle: 'API Anahtarını Yeniden Oluştur',
      regenerateDescription: 'API anahtarını yeniden oluşturmak, mevcut anahtarı geçersiz kılar ve yeni bir anahtar verir. Yeni anahtarı uygulamalarınızda yapılandırmanız gerekecektir.',
      regenerateFailed: 'API anahtarını yeniden oluşturma başarısız oldu',
    },
  },
}
