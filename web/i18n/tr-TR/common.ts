const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Tiby hesabı',
    langGeniusAccountTip: 'Tiby hesabınız ve ilişkili kullanıcı verileri.',
  ...
  members: {
    ...
    invitationSentTip: 'Davet gönderildi, Tiby\'ye giriş yaparak takım verilerinize erişebilirler.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      onTrial: 'DENEMEDE',
      exhausted: 'KOTA DOLU',
      desc: 'Tiby tarafından sağlanan OpenAI barındırma hizmeti, GPT-3.5 gibi modelleri kullanmanıza olanak tanır. Deneme kotanız bitmeden önce, diğer model sağlayıcılarını ayarlamanız gerekir.',
  ...
  about: {
    ...
    nowAvailable: 'Tiby {{version}} şimdi mevcut.',
    latestAvailable: 'Tiby {{version}} en son mevcut sürüm.',
  },
  appMenus: {
    overview: 'İzleme',
