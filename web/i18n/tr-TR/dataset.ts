const translation = {
  ...
  externalAPIPanelDescription: 'Harici bilgi API\'si,  dışındaki bir bilgi bankasına bağlanmak ve bu bilgi bankasından bilgi almak için kullanılır.',
