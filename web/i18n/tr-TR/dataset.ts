const translation = {
  ...
  intro1: 'Bilgi, Tiby uygulamasına ',
  ...
  externalAPIPanelDescription: 'Harici bilgi API\'si, Tiby dışındaki bir bilgi bankasına bağlanmak ve bu bilgi bankasından bilgi almak için kullanılır.',
