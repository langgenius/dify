const translation = {
  ...
  chatVariable: {
    panelTitle: '会話変数',
    panelDescription: '会話変数は、LLMが記憶する必要のあるインタラクティブな情報（会話履歴、アップロードされたファイル、ユーザー設定など）を保存するために使用されます。これらは読み書き可能です。',
    docLink: '詳細については、ドキュメントをご覧ください。',
    button: '変数を追加',
    modal: {
      title: '会話変数を追加',
      editTitle: '会話変数を編集',
      ...
      type: 'タイプ',
      value: 'デフォルト値',
      valuePlaceholder: 'デフォルト値（設定しない場合は空白）',
      description: '説明',
  ...
  blocksAbout: {
    ...
    'assigner': '変数割り当てノードは、書き込み可能な変数（会話変数など）に値を割り当てるために使用されます。',
  ...
  nodes: {
    ...
    assigner: {
      'assignedVariable': '割り当てられた変数',
      'writeMode': '書き込みモード',
      'writeModeTip': '割り当てられた変数が配列の場合、追加モードは末尾に追加します。',
      'over-write': '上書き',
      'append': '追加',
      'plus': 'プラス',
      'clear': 'クリア',
