const translation = {
  ...
  nodes: {
    ...
    iteration: {
      ...
      flattenOutput: '出力を平坦化',
      flattenOutputDesc: '有効にすると、すべての反復出力が配列である場合、それらは単一の配列に平坦化されます。無効にすると、出力はネストされた配列構造のままになります。',
    },
    loop: {
    ...
    triggerWebhook: {
      ...
      debugUrlPrivateAddressWarning: 'このURLは内部アドレスのようで、Webhookリクエストが失敗する可能性があります。TRIGGER_URLを公開アドレスに変更できます。',
    },
    triggerPlugin: {
      authorized: '認可された',
