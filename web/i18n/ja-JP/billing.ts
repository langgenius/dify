const translation = {
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: ['エンタープライズ向けスケーラブルな展開ソリューション', '商用ライセンス認可', 'エンタープライズ専用機能', '複数ワークスペースとエンタープライズ管理', 'シングルサインオン', 'Difyのパートナーによって交渉されたSLA', '高度なセキュリティと制御', 'Dify公式による更新とメンテナンス', 'プロフェッショナル技術サポート'],
    },
  },
  vectorSpace: {
