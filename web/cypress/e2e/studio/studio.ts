...
Then('The nav item {string} should be active', (path: string) => {
  cy.get(`[data-testid="nav-item${path}"] > div`).should('have.class', 'text-components-main-nav-nav-button-text-active')
})
