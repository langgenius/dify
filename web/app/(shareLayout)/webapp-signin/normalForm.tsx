      ...
      <div className="mx-auto mt-8 w-full">
        <div className="relative">
          <div className="rounded-lg bg-linear-to-r from-workflow-workflow-progress-bg-1 to-workflow-workflow-progress-bg-2 p-4">
            <div className="relative mb-2 flex size-10 items-center justify-center rounded-xl bg-components-card-bg shadow-lg">
      ...
      <div className="mx-auto mt-8 w-full">
        ...
        <div className="relative">
          ...
          {allMethodsAreDisabled && (
            <>
              <div className="rounded-lg bg-linear-to-r from-workflow-workflow-progress-bg-1 to-workflow-workflow-progress-bg-2 p-4">
                <div className="mb-2 flex size-10 items-center justify-center rounded-xl bg-components-card-bg shadow-lg">
