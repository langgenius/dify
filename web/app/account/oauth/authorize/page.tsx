...
export default function OAuthAuthorize() {
  ...
  const oauthAppInfoInput =
    client_id && redirect_uri ? { body: { client_id, redirect_uri } } : skipToken
  const {
    data: authAppInfo,
  ...
  const fallbackAppLabel = authAppInfo?.app_label.en_US
  const appLabel =
    (typeof localizedAppLabel === 'string' && localizedAppLabel) ||
    (typeof fallbackAppLabel === 'string' && fallbackAppLabel) ||
