...
const ConfirmModal = ({ show, onConfirm, onClose }: ConfirmModalProps) => {
  ...
  return (
    ...
    >
      ...
      <div className='bg-background-section border-divider-regular h-12 w-12 rounded-xl border-[0.5px] p-3 shadow-xl'>
        <AlertTriangle className='h-6 w-6 text-[rgb(247,144,9)]' />
      </div>
      <div className='text-text-primary relative mt-3 text-xl font-semibold leading-[30px]'>{t('tools.createTool.confirmTitle')}</div>
