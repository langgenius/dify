    ...
    <Popover key={tool.name}>
      <PopoverTrigger
        ...
        render={(
          <button
            type="button"
            className={cn('bg-components-panel-item-bg w-full rounded-xl border-[0.5px] border-components-panel-border-subtle px-4 py-3 text-left shadow-xs outline-hidden hover:bg-components-panel-on-panel-item-bg-hover focus-visible:ring-1 focus-visible:ring-components-input-border-hover')}
          >
