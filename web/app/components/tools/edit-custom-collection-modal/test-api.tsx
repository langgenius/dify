                ...
                <div className="min-h-0 flex-1 overflow-y-auto px-6 pt-2">
                          ...
                          <thead className="text-text-tertiary uppercase">
                            <tr className="border-b border-divider-regular">
                              <th className="p-2 pl-3 font-medium">
                                {t(($) => $['test.parameters'], { ns: 'tools' })}
                              </th>
                              <th className="p-2 pl-3 font-medium">
                                {t(($) => $['test.value'], { ns: 'tools' })}
                              </th>
                            </tr>
                          </thead>
                          <tbody>
                              ...
                              >
                                ...
                                <td className="">
                                  <Input
                                    ...
                                    type="text"
                                    className="border-transparent! bg-transparent! hover:border-transparent! hover:bg-transparent! focus:border-transparent! focus:bg-transparent!"
                                  />
                                </td>
                              </tr>
                            ))}
                  ...
                  <div className="mt-6">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="h-px w-0 grow bg-[rgb(243,244,246)]"></div>
                    </div>
