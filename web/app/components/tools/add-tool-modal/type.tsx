...
const Types = ({
  ...
  return (
    <div className='mb-3'>
      ...
      <div className={cn('mb-0.5 p-1 pl-3 flex items-center cursor-pointer text-gray-700 text-sm leading-5 rounded-lg hover:bg-white', value === 'custom' && '!bg-white !text-primary-600 font-medium')} onClick={() => onSelect('custom')}>{t('tools.type.custom')}</div>
