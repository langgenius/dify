...
export const stepByStepTourUiStateAtom = atom<StepByStepTourUiState>(createDefaultStepByStepTourUiState())
const stepByStepTourSkipRecoveryVisibleAtom = atom(false)

export const useStepByStepTourUiStateValue = () =>
  useAtomValue(stepByStepTourUiStateAtom)

export const useSetStepByStepTourUiState = () =>
  useSetAtom(stepByStepTourUiStateAtom)
