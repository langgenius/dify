...
export const integrationSidebarInactiveNavItemClassName =
  'text-components-menu-item-text hover:bg-state-base-hover hover:text-components-menu-item-text-hover data-popup-open:bg-state-base-hover data-popup-open:text-components-menu-item-text-hover'
export const integrationSidebarDisabledNavItemClassName =
  'cursor-not-allowed text-components-menu-item-text-disabled'
