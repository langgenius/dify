    ...
    >
      <Link href={link}>
        <div
          ...
          className={cn('flex h-7 cursor-pointer items-center rounded-lg px-2.5', isActivated ? 'text-components-main-nav-nav-button-text-active' : 'text-components-main-nav-nav-button-text', curNav && isActivated && 'hover:bg-components-main-nav-nav-button-bg-active-hover')}
