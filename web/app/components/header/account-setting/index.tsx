...
export default function AccountSettingModal({
  ...
  return (
    ...
    >
      <AccountSettingsBackup onCancel={onCancel} activeTab={activeTab} />
    </Modal>
  );
}

export function AccountSettingsBackup({
  onCancel,
  activeTab = "account",
}: IAccountSettingProps) {
...
export function AccountSettings({
  ...
  return (
    <div className="flex min-h-screen ">
      <div className="w-[44px] max-h-screen sticky top-0 sm:w-[200px] px-[1px] py-4 sm:p-4 border border-gray-100 shrink-0 sm:shrink-1 flex flex-col items-center sm:items-start">
        <div className="mb-8 ml-0 sm:ml-2 text-sm sm:text-base font-medium leading-6 text-gray-900">
          {t("common.userProfile.settings")}
        </div>
      ...
      <div ref={scrollRef} className="relative w-full pb-4 ">
        <div
          className={cn(
            "sticky top-0 px-6 py-4 flex items-center h-14 mb-4 bg-white text-base font-medium text-gray-900 z-20",
            scrolled && scrolledClassName
        ...
        <div className="px-4 sm:px-8 pt-2 max-w-5xl">
          {activeMenu === "account" && <AccountPage />}
          {activeMenu === "members" && <MembersPage />}
          {activeMenu === "billing" && <BillingPage />}
          {activeMenu === "integrations" && <IntegrationsPage />}
