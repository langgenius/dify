...
Owns the workspace member invitation form, including email recipient composition, role selection, submission errors, invitation request state, and coordination with the feature-preview Contacts upgrade confirmation.
...
| `features/contacts/management`               | Checks mock External Contact conflicts and confirms upgrades. |
