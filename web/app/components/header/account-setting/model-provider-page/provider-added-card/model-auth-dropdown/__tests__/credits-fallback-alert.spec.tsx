...
describe('CreditsFallbackAlert', () => {
  it('should render the credential fallback copy and description when credentials exist', () => {
    ...
    expect(
      screen.getByText('common.modelProvider.card.apiKeyUnavailableFallback'),
    ).toBeInTheDocument()
    expect(
      screen.getByText('common.modelProvider.card.apiKeyUnavailableFallbackDescription'),
    ).toBeInTheDocument()
  })
  ...
  it('should render the no-credentials fallback copy without the description', () => {
    ...
    expect(
      screen.queryByText('common.modelProvider.card.apiKeyUnavailableFallbackDescription'),
