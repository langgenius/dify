...
vi.mock('@/app/components/base/icons/src/public/llm', () => ({
  AnthropicDark: ({ className }: { className: string }) => (
    <div data-testid="anthropic-dark" className={className} />
  ),
  AnthropicLight: ({ className }: { className: string }) => (
    <div data-testid="anthropic-light" className={className} />
  ),
}))

vi.mock('@/app/components/base/icons/src/vender/other', () => ({
  Openai: ({ className }: { className: string }) => (
    <div data-testid="openai-icon" className={className} />
  ),
}))
...
describe('ProviderIcon', () => {
  ...
  it('should use dark icon in dark theme for generic provider', () => {
    ...
    const provider = createProvider({
      icon_small_dark: {
        en_US: 'https://example.com/dark.png',
        zh_Hans: 'https://example.com/dark.png',
      },
    })
  ...
  it('should fall back to light icon when dark icon is empty', () => {
    ...
    const provider = createProvider({
      icon_small: {
        en_US: 'https://example.com/light.png',
        zh_Hans: 'https://example.com/light.png',
      },
