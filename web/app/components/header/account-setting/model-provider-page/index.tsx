  ...
  return (
    <div className="relative -mt-2 pt-1">
      <div className={cn('mb-2 flex items-center')}>
        <div className="grow system-md-semibold text-text-primary">
        ...
        <div
          className={cn(
            ...
            showWarning &&
              'border-components-panel-border bg-components-panel-bg-blur pl-2 shadow-xs',
          )}
        >
          {showWarning && (
            <div
          ...
          {showWarning && (
            <div className="flex items-center gap-1 system-xs-medium text-text-primary">
              ...
              <span className="max-w-[460px] truncate" title={t(warningTextKey, { ns: 'common' })}>
      ...
      {!!filteredNotConfiguredProviders?.length && (
        <>
          <div className="mb-2 flex items-center pt-2 system-md-semibold text-text-primary">
