...
export default function Operate({
  ...
  const handleSync = async () => {
    await syncDataSourceFeishu({ url: `/oauth/data-source/feishu/${payload.id}/sync` })
    updateIntegrates()
  }
                ...
                <div className="px-1 py-1">
                  <Menu.Item>
                    ...
                    >
                      ...
                      <div>
                        <div className='leading-5'>{t('common.dataSource.feishu.changeAuthorizedPages')}</div>
                        <div className='leading-5 text-xs text-gray-500'>
                          {payload.total} {t('common.dataSource.feishu.pagesAuthorized')}
                        </div>
                      </div>
                    </div>
                  </Menu.Item>
                  <Menu.Item>
                    <div className={itemClassName} onClick={handleSync}>
                      ...
                      <div className='leading-5'>{t('common.dataSource.feishu.sync')}</div>
                    </div>
                  </Menu.Item>
                </div>
                <Menu.Item>
                  <div className='p-1'>
                    <div className={itemClassName} onClick={handleRemove}>
                      ...
                      <div className='leading-5'>{t('common.dataSource.feishu.remove')}</div>
                    </div>
                  </div>
                </Menu.Item>
              </Menu.Items>
