...
const Item = () => {
  ...
  return (
    <div className='group flex items-center mb-2 px-4 py-2 border-[0.5px] border-transparent rounded-xl bg-gray-50 hover:border-gray-200 hover:shadow-xs'>
      <div className='grow'>
        <div className='mb-0.5 text-[13px] font-medium text-gray-700'>Data Search API</div>
        <div className='text-xs text-gray-500'>https://r6mcikypmxsidrom.us-east-l.azure.com</div>
      </div>
