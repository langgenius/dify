...
function MaintenanceNotice() {
  if (!env.NEXT_PUBLIC_MAINTENANCE_NOTICE) return null
...
function MaintenanceNoticeContent() {
  ...
  return (
    <div className="z-20 flex h-9.5 shrink-0 items-center border-[0.5px] border-b border-b-[#FEF0C7] bg-[#FFFAEB] px-4">
      <div className="mr-2 flex h-5.5 shrink-0 items-center rounded-xl bg-[#F79009] px-2 text-[11px] font-medium text-white">
