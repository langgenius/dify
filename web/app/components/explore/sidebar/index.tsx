...
const SideBar: FC<IExploreSideBarProps> = ({
  ...
  return (
    <div className='w-fit sm:w-[366px] shrink-0 pt-6 px-4 border-gray-200 cursor-pointer'>
      {/* <div> */}
      {/*  <Link */}
      {/*    href='/explore/apps' */}
      ...
      {installedApps.length > 0 && (
        <div className='mt-10'>
          <p className='pl-2 mobile:px-0 text-base text-gray-500 break-all font-medium uppercase'>{t('explore.sidebar.workspace')}</p>
