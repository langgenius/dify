...
const SnippetCard = ({
  ...
  return (
    <article className="group relative col-span-1 inline-flex h-[160px] w-full flex-col rounded-xl border border-components-card-border bg-components-card-bg shadow-sm transition-all duration-200 ease-in-out hover:-translate-y-0.5 hover:shadow-lg">
      <Link href={`/snippets/${snippet.id}/orchestrate`} className="flex min-h-0 grow flex-col">
        <div className="relative flex min-h-0 grow flex-col">
          ...
          <div className="flex h-[52px] items-center px-[14px] pt-[14px] pb-3">
          ...
          <div className="h-[54px] px-[14px] text-xs leading-normal text-text-tertiary">
