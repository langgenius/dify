...
type MockWorkflowWithInnerContextProps = Pick<WorkflowProps, 'nodes' | 'edges' | 'viewport'> & {
  onWorkflowDataUpdate?: (payload: Pick<FetchWorkflowDraftResponse, 'features' | 'conversation_variables' | 'environment_variables'>) => void
      ...
      <div data-testid="workflow-inner-context">
        <button
          ...
          onClick={() => onWorkflowDataUpdate?.({
            ...
            conversation_variables: [{ id: 'conversation-1', name: 'conversation-1', value_type: ChatVarType.String, value: '', description: '' }],
            environment_variables: [{ id: 'env-1', name: 'env-1', value: '', value_type: 'string', description: '' }],
          })}
        >
        ...
        <button
          type="button"
          onClick={() => onWorkflowDataUpdate?.({
            conversation_variables: [{ id: 'conversation-only', name: 'conversation-only', value_type: ChatVarType.String, value: '', description: '' }],
          })}
        >
