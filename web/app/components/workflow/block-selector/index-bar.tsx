...
const IndexBar: FC<IndexBarProps> = ({ letters, itemRefs, className }) => {
  ...
  return (
    <div className={classNames('index-bar absolute right-0 top-36 flex w-6 flex-col items-center justify-center text-xs font-medium text-text-quaternary', className)}>
