...
const Tabs: FC<TabsProps> = ({
  ...
  const normalizedBuiltInTools = useMemo(() => normalizeToolList(buildInTools, basePath), [buildInTools, basePath])
  const normalizedCustomTools = useMemo(() => normalizeToolList(customTools, basePath), [customTools, basePath])
  const normalizedWorkflowTools = useMemo(() => normalizeToolList(workflowTools, basePath), [workflowTools, basePath])
  const normalizedMcpTools = useMemo(() => normalizeToolList(mcpTools, basePath), [mcpTools, basePath])
