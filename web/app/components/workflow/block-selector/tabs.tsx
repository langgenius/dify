  ...
  return (
    <Tabs defaultValue={defaultTab} className="w-full min-w-0">
      ...
      >
        ...
        <TabsIndicator
          className="pointer-events-none absolute left-0 rounded-t-lg bg-components-panel-bg shadow-sm-no-bottom transition-[translate,width] duration-150 ease-in-out motion-reduce:transition-none"
          style={{
