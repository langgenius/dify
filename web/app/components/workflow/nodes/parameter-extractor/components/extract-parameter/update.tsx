...
const AddExtractParameter: FC<Props> = ({ type, payload, onSave, onCancel }) => {
  ...
  const checkValid = useCallback(() => {
    ...
    if (!errMessage && !param.description)
      errMessage = t(`${errorI18nPrefix}.fieldRequired`, {
        ns: 'workflow',
        field: t(`${i18nPrefix}.addExtractParameterContent.description`, { ns: 'workflow' }),
      })
          ...
          <DialogContent className="w-[400px]! max-w-[400px]! overflow-hidden! border-none p-4! text-left align-middle">
            ...
            <div>
              <div className="space-y-2">
                <Field
                  title={t(`${i18nPrefix}.addExtractParameterContent.name`, { ns: 'workflow' })}
                >
                  <Input
                    value={param.name}
                ...
                <Field
                  title={t(`${i18nPrefix}.addExtractParameterContent.type`, { ns: 'workflow' })}
                >
                  <Select
                    value={param.type}
                ...
                >
                  <Textarea
                    ...
                    placeholder={
                      t(`${i18nPrefix}.addExtractParameterContent.descriptionPlaceholder`, {
                        ns: 'workflow',
                      })!
                    }
                  />
                ...
                <Field
                  title={t(`${i18nPrefix}.addExtractParameterContent.required`, { ns: 'workflow' })}
                >
                  <>
