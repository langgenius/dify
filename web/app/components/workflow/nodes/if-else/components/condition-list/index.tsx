...
const ConditionList = ({
  ...
  return (
    <div className={cn('relative', !isSubVariable && 'pl-15')}>
      {conditions.length > 1 && (
        <div
          className={cn(
            'absolute top-0 bottom-0 left-0 w-15',
            isSubVariable && logical_operator === LogicalOperator.and && '-left-2.5',
            isSubVariable && logical_operator === LogicalOperator.or && '-left-4.5',
          )}
        >
