...
import type { BoxGroupProps, FieldProps } from '.'
import { memo } from 'react'
import { BoxGroup, Field } from '.'
...
export const BoxGroupField = memo(({ children, fieldProps, boxGroupProps }: BoxGroupFieldProps) => {
  return (
