...
import { RiAlignLeft, RiCheckboxMultipleLine, RiFileCopy2Line, RiFileList2Line, RiHashtag, RiLockLine, RiTextSnippet } from '@remixicon/react'
...
const getIcon = (type: InputVarType) => {
  return ({
    ...
    [InputVarType.secret]: RiLockLine,
