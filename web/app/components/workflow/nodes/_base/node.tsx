...
const BaseNode: FC<BaseNodeProps> = ({ id, data, children }) => {
  ...
  const LoopIndex = useMemo(() => {
    ...
    const text = translationKey ? t(translationKey, { ns: 'workflow', count: data._loopIndex }) : ''
    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="mr-1 flex min-w-0 grow items-center system-sm-semibold-uppercase text-text-primary">
        ...
        <NodeBody data={data} child={cloneElement(children, { id, data } as any)} />
