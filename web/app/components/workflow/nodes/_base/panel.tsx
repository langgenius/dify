...
const BasePanel: FC<BasePanelProps> = ({
  ...
  return (
    <div className={cn(
      ...
      <div
        ref={containerRef}
        className={cn('relative h-full bg-state-warning-active shadow-lg border-[0.5px] border-gray-200 rounded-2xl', showSingleRunPanel ? 'overflow-hidden' : 'overflow-y-auto')}
        style={{
          width: `${panelWidth}px`,
        }}
      >
