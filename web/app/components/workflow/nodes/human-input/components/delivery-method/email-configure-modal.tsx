  ...
  return (
    ...
    >
      ...
      <div className="space-y-5 px-6 py-3">
        ...
        <div className="flex items-start justify-between gap-2 rounded-lg border-[0.5px] border-components-panel-border bg-components-panel-on-panel-item-bg p-3 pl-2.5 shadow-xs">
          <div className="rounded-xs border border-divider-regular bg-components-icon-bg-orange-dark-solid p-0.5">
