      ...
      <PortalToFollowElemContent className="z-50">
        <div className="w-[360px] rounded-xl border-[0.5px] border-components-panel-border bg-components-panel-bg-blur shadow-lg backdrop-blur-xs">
          <div className="p-1">
            ...
            >
              <div className={cn('rounded-xs border border-divider-regular bg-components-icon-bg-indigo-solid p-1', webAppDeliveryInfo.disabled && 'opacity-50')}>
            ...
            >
              <div
                className={cn(
                  'rounded-xs border border-divider-regular bg-components-icon-bg-blue-solid p-1',
            ...
            >
              <div className={cn('rounded-xs border border-divider-regular bg-background-default-dodge p-1', 'opacity-50')}>
            ...
            <div
              className={cn('relative flex cursor-pointer items-center gap-1 rounded-lg p-1 pl-3 hover:bg-state-base-hover', 'cursor-not-allowed bg-transparent hover:bg-transparent')}
            >
              <div className={cn('rounded-xs border border-divider-regular bg-components-icon-bg-indigo-solid p-0.5', 'opacity-50')}>
        ...
        {!IS_CE_EDITION && (
          <div className="mt-1 rounded-xl border-[0.5px] border-components-panel-border bg-components-panel-bg-blur shadow-lg backdrop-blur-xs">
            <div className="flex items-center gap-2 px-4 py-3">
              <div className={cn('rounded-xs border border-divider-regular bg-components-icon-bg-midnight-solid p-1')}>
