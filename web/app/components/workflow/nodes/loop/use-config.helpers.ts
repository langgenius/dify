...
export const removeBreakCondition = (inputs: LoopNodeType, conditionId: string) =>
  produce(inputs, (draft) => {
...
export const updateBreakCondition = (
  ...
  produce(inputs, (draft) => {
    ...
    if (targetCondition) Object.assign(targetCondition, condition)
  })

export const toggleConditionOperator = (inputs: LoopNodeType) =>
  produce(inputs, (draft) => {
    draft.logical_operator =
      draft.logical_operator === LogicalOperator.and ? LogicalOperator.or : LogicalOperator.and
  })

export const addSubVariableCondition = (inputs: LoopNodeType, conditionId: string, key?: string) =>
  produce(inputs, (draft) => {
...
export const removeSubVariableCondition = (
  ...
  produce(inputs, (draft) => {
    ...
    condition.sub_variable_condition.conditions =
      condition.sub_variable_condition.conditions.filter((item) => item.id !== subConditionId)
  })
...
export const updateSubVariableCondition = (
  ...
  produce(inputs, (draft) => {
    ...
    if (targetSubCondition) Object.assign(targetSubCondition, condition)
  })

export const toggleSubVariableConditionOperator = (inputs: LoopNodeType, conditionId: string) =>
  produce(inputs, (draft) => {
    const targetCondition = draft.break_conditions?.find((item) => item.id === conditionId)
...
export const updateLoopCount = (inputs: LoopNodeType, value: number) =>
  produce(inputs, (draft) => {
    draft.loop_count = value
  })

export const addLoopVariable = (inputs: LoopNodeType) =>
  produce(inputs, (draft) => {
...
export const removeLoopVariable = (inputs: LoopNodeType, id: string) =>
  produce(inputs, (draft) => {
