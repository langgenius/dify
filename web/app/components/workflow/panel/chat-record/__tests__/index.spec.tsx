...
describe('ChatRecord', () => {
  ...
  it('renders fetched chat history with the real chat shell and switches siblings', async () => {
    ...
    // Answers render through the lazily-imported Markdown component, so wait for
    // the first one instead of asserting synchronously: the question now renders
    // as plain text and resolves immediately, no longer masking the async answer.
