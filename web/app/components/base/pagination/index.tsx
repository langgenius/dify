...
const CustomizedPagination: FC<Props> = ({
  ...
  return (
    <Pagination
      ...
      truncableText="..."
    >
      <div className="flex items-center gap-0.5 rounded-lg bg-background-section-burn p-0.5">
      ...
      {onLimitChange && (
        <div className="flex shrink-0 items-center gap-2">
          ...
          <div
            className="flex items-center gap-px rounded-lg bg-components-segmented-control-bg-normal p-0.5"
