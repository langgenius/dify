    ...
    <div className="inline-flex items-center">
      <DropdownMenu>
        <div className="relative">
          <DropdownMenuTrigger className="flex min-h-8 cursor-pointer items-center rounded-l-lg border-none bg-components-input-bg-normal px-2 py-1 hover:bg-state-base-hover-alt data-popup-open:bg-state-base-hover-alt! data-popup-open:hover:bg-state-base-hover-alt">
            ...
            >
              {items.map((item) => (
                ...
                >
                  ...
                  {value === item.value && (
                    <RiCheckLine className="size-4 shrink-0 text-util-colors-blue-light-blue-light-600" />
                  )}
                </DropdownMenuRadioItem>
              ))}
            </DropdownMenuRadioGroup>
      ...
      >
        {!order && (
          <RiSortAsc className="size-4 text-components-button-tertiary-text" aria-hidden="true" />
        )}
        {order && (
          <RiSortDesc className="size-4 text-components-button-tertiary-text" aria-hidden="true" />
        )}
      </button>
    </div>
  )
