...
describe('ImageGallery', () => {
  ...
  describe('Width Styles', () => {
    ...
    it('should apply calc(50% - 4px) width for 2 images', () => {
      const { container } = render(
        <ImageGallery srcs={['https://example.com/1.png', 'https://example.com/2.png']} />,
      )
    ...
    it('should apply calc(33.3333% - 5.3333px) width for 3 images', () => {
      ...
      getImages(container).forEach((img) =>
        expect(img.style.width).toBe('calc(33.3333% - 5.3333px)'),
      )
    })
  ...
  describe('Image Preview', () => {
    it('should show ImagePreview when an image is clicked', async () => {
      ...
      expect(previewContainer?.querySelector('img'))!.toHaveAttribute(
        'src',
