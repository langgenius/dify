        ...
        {isEdit
          ...
          : (
              ...
              >
                ...
                <span className="mr-0.5 flex h-4 items-center rounded-xs bg-components-kbd-bg-white px-1 system-kbd">{getKeyboardKeyNameBySystem('ctrl')}</span>
                <span className="flex h-4 items-center rounded-xs bg-components-kbd-bg-white px-1 system-kbd">↩︎</span>
              </Button>
            )}
