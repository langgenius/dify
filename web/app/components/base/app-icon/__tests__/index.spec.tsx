...
describe('AppIcon', () => {
  ...
  it('applies size classes correctly', () => {
    ...
    expect(xsContainer.firstChild).toHaveClass('w-4 h-4 rounded-xs')
    ...
    expect(mediumContainer.firstChild).toHaveClass('w-9 h-9 rounded-lg')

    const { container: largeContainer } = render(<AppIcon size="large" />)
    expect(largeContainer.firstChild).toHaveClass('w-10 h-10 rounded-lg')
