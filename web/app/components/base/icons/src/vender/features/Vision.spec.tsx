...
describe('Vision Icon Component', () => {
  ...
  it('applies custom className and style props', () => {
    const { container } = render(
      <Vision className="custom-icon" style={{ opacity: '0.8' }} />,
    )
  ...
  it('handles click events', () => {
    const onClick = vi.fn()
    const { container } = render(<Vision onClick={onClick} />)
    const svg = container.querySelector('svg')
