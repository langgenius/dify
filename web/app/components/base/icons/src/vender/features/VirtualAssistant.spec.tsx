...
describe('VirtualAssistant Icon Component', () => {
  ...
  it('applies custom className and style props', () => {
    const { container } = render(
      <VirtualAssistant className="custom-icon" style={{ opacity: '0.8' }} />,
    )
  ...
  it('handles click events', () => {
    const onClick = vi.fn()
    const { container } = render(<VirtualAssistant onClick={onClick} />)
    const svg = container.querySelector('svg')
