...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Radio card for rich single-choice options. Put selectable cards inside `RadioGroup`; the card passes radio props through to `RadioRoot` and uses `RadioControl` for the visual dot.',
      },
    },
  },
  tags: ['autodocs'],
