...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Brand assets rendered in different contexts. DifyLogo adapts to the active theme while other variants target specific surfaces.',
      },
    },
  },
  args: {
      ...
      <ThemePreview theme="dark">
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            <span className="text-xs tracking-[0.18em] text-text-tertiary uppercase">
              Primary logo
            </span>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="flex flex-col gap-2 rounded-xl border border-divider-subtle bg-background-default p-4">
              <span className="text-[11px] font-medium tracking-widest text-text-tertiary uppercase">
                Site favicon
              </span>
              <LogoSite />
            </div>
