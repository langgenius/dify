...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Auto-resizing textarea component that expands and contracts based on content, with configurable min/max height constraints.',
      },
    },
  },
  tags: ['autodocs'],
...
export const Default: Story = {
  ...
  args: {
    ...
    maxHeight: 96,
    className:
      'w-full p-2 border border-gray-300 rounded-lg focus:outline-hidden focus:ring-2 focus:ring-blue-500',
  },
}
...
export const CustomStyling: Story = {
  ...
  args: {
    ...
    maxHeight: 150,
    className:
      'w-full p-3 bg-gray-50 border-2 border-blue-400 rounded-xl text-lg focus:outline-hidden focus:bg-white focus:border-blue-600',
...
export const ChatInput: Story = {
  ...
  args: {
    ...
    maxHeight: 120,
    className:
      'w-full px-4 py-2 bg-gray-100 border border-gray-300 rounded-2xl text-sm focus:outline-hidden focus:bg-white focus:ring-2 focus:ring-blue-500',
  },
}
...
export const CommentBox: Story = {
  ...
  args: {
    ...
    maxHeight: 200,
    className:
      'w-full p-3 border border-gray-300 rounded-lg text-sm focus:outline-hidden focus:ring-2 focus:ring-indigo-500',
  },
}
