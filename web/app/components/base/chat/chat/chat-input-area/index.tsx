...
const ChatInputArea = ({
  ...
  return (
    <>
      <div
        className={cn(
          'bg-components-panel-bg-blur border-components-chat-input-border relative z-10 rounded-xl border pb-[9px] shadow-md',
          isDragActive && 'border-components-option-card-option-selected-border border border-dashed',
        )}
      >
          ...
          >
            <div className='relative flex w-full grow items-center'>
              ...
              <Textarea
                ref={textareaRef}
                className={cn(
                  'body-lg-regular text-text-tertiary w-full bg-transparent p-1 leading-6 outline-none',
                )}
