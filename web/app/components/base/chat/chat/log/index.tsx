...
const Log: FC<LogProps> = ({
  ...
  return (
    <div
      className="ml-1 flex items-center gap-0.5 rounded-lg border-[0.5px] border-components-actionbar-border bg-components-actionbar-bg p-0.5 shadow-md backdrop-blur-xs"
      onClick={(e) => {
        e.stopPropagation()
