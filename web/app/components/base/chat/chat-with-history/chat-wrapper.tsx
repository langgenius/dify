...
const ChatWrapper = () => {
  ...
  return (
    <Chat
      ...
      chatContainerInnerClassName={`mx-auto pt-6 w-full max-w-full ${isMobile ? 'px-4' : 'pl-10 pr-10'}`}
      chatFooterClassName='pb-4'
      chatFooterInnerClassName={`mx-auto w-full max-w-full ${isMobile ? 'px-4' : 'pl-10 pr-10'}`}
      onSend={doSend}
