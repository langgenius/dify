          ...
          <div className="flex shrink-0 items-center gap-0.5">
            ...
            {!!features.moderation?.enabled && (
              <Tooltip>
                ...
                />
                <TooltipContent>{t('feature.moderation.title', { ns: 'appDebug' })}</TooltipContent>
              </Tooltip>
            )}
            ...
            {showFileUpload && !!features.file?.enabled && (
              <Tooltip>
                ...
                />
                <TooltipContent>{t('feature.fileUpload.title', { ns: 'appDebug' })}</TooltipContent>
              </Tooltip>
            )}
            ...
            {isChatMode && !!features.citation?.enabled && (
              <Tooltip>
                ...
                />
                <TooltipContent>{t('feature.citation.title', { ns: 'appDebug' })}</TooltipContent>
              </Tooltip>
            )}
            {isChatMode && !!features.annotationReply?.enabled && (
              <Tooltip>
                ...
                />
                <TooltipContent>{t('feature.annotation.title', { ns: 'appDebug' })}</TooltipContent>
              </Tooltip>
            )}
          </div>
