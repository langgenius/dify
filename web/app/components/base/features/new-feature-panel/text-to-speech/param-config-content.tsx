          ...
          <div className="relative h-8">
            ...
            >
              <span className={cn('block truncate text-left text-text-secondary', !languageItem?.name && 'text-text-tertiary')}>
                {languageItem?.name ? t(`common.voice.language.${languageItem?.value.replace('-', '')}` as any) : localLanguagePlaceholder}
              </span>
                  ...
                  >
                    {({ /* active, */ selected }) => (
                      <>
                        ...
                        >
                          {t(`common.voice.language.${(item.value).toString().replace('-', '')}` as any)}
                        </span>
