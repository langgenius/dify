export const menuRowBaseClassName = 'mx-1 flex h-8 cursor-pointer select-none items-center gap-1 rounded-lg px-2 outline-none'
...
export const menuSeparatorClassName = 'my-1 h-px bg-divider-subtle pointer-events-none'
