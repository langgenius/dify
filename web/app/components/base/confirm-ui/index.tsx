  ...
  return (
    <div className="w-[420px] max-w-full rounded-lg p-7 bg-white">
      ...
      <div className='flex gap-3 mt-4 ml-12'>
        ...
        <Button onClick={onCancel} className='flex items-center justify-center w-21 text-center text-gray-500 border rounded-lg cursor-pointer h-9 border-color-gray-200'>{cancelText || t('common.operation.cancel')}</Button>
      </div>
    </div>
