  ...
  return (
    <div className='flex h-6 items-center justify-between'>
      <div className='flex items-center'>
        <div className='text-base font-medium text-text-secondary'>{t(`${I18N_PREFIX}.scrapflyTitle`)}</div>
        ...
        <Button className='flex h-6 items-center gap-x-[1px] px-1.5' onClick={onSetting}>
          ...
          <span className='px-[3px] text-xs font-medium text-components-button-secondary-text'>
            {t(`${I18N_PREFIX}.configureScrapfly`)}
          </span>
        </Button>
      </div>
      <a
      ...
      >
        ...
        <span>{t(`${I18N_PREFIX}.scrapflyDoc`)}</span>
      </a>
    </div>
  )
}
