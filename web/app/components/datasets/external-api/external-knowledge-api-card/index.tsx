...
const ExternalKnowledgeAPICard: React.FC<ExternalKnowledgeAPICardProps> = ({
  ...
  return (
    <>
      <div
        className={`flex items-start self-stretch rounded-lg border-[0.5px] border-components-panel-border-subtle bg-components-panel-on-panel-item-bg p-2 pl-3 shadow-xs ${isHovered ? 'border-state-destructive-border bg-state-destructive-hover' : ''}`}
      >
