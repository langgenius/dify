...
vi.mock('@remixicon/react', () => ({
  RiArrowLeftLine: () => <span data-testid="back-arrow" />,
  RiLayoutLeft2Line: () => <span data-testid="layout-left" />,
  RiLayoutRight2Line: () => <span data-testid="layout-right" />,
}))
...
describe('DocumentDetail', () => {
  ...
  describe('Metadata Panel', () => {
    ...
    it('should toggle metadata panel when button clicked', () => {
      ...
      const toggleBtn = screen.getByTestId('layout-left').closest('button')!
