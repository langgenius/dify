    ...
    <div className="mt-6">
      ...
      <div ref={dropRef}>
        {!file && (
          <div
            className={cn(
              'flex h-20 items-center rounded-xl border border-dashed border-components-panel-border bg-components-panel-bg-blur text-sm font-normal',
              dragging && 'border border-divider-subtle bg-components-panel-on-panel-item-bg-hover',
            )}
          >
        ...
        {file && (
          <div
            className={cn(
              'group flex h-20 items-center rounded-xl border border-components-panel-border bg-components-panel-bg-blur px-6 text-sm font-normal',
          ...
          >
            ...
            <div className="ml-2 flex w-0 grow">
              <span
                ...
                title={file.file.name.replace(/.csv$/, '')}
              >
