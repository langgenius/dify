...
const HitTesting: FC<Props> = ({ datasetId }: Props) => {
  ...
  const [isShowRightPanel, { setTrue: showRightPanel, setFalse: hideRightPanel }] = useBoolean(!isMobile)
  ...
  return (
    <div className={s.container}>
      ...
      <FloatRightContainer showClose isMobile={isMobile} isOpen={isShowRightPanel} onClose={hideRightPanel} footer={null}>
