...
const ModifyExternalRetrievalModal: React.FC<ModifyExternalRetrievalModalProps> = ({
  ...
  return (
    <div className="absolute top-9 right-3.5 z-10 flex w-[320px] flex-col items-start rounded-2xl border-[0.5px] border-components-panel-border bg-components-panel-bg shadow-2xl">
