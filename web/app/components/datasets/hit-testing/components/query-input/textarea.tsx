          ...
          <Tooltip>
            <TooltipTrigger
              render={
                <div
                  className={cn(
                    'bg-util-colors-red-red-100 py-1 pr-2 system-2xs-medium-uppercase text-util-colors-red-red-600',
                  )}
                >
                  {`${text.length}/200`}
                </div>
            ...
            />
            <TooltipContent>{t('input.countWarning', { ns: 'datasetHitTesting' })}</TooltipContent>
          </Tooltip>
        ) : (
          <div
            className={cn(
