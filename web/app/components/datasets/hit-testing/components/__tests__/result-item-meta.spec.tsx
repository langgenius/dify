...
describe('ResultItemMeta', () => {
  ...
  describe('Rendering', () => {
    it('should render the segment index tag with prefix and position', () => {
      render(<ResultItemMeta labelPrefix="Chunk" positionId={3} wordCount={150} score={0.9} />)

      expect(screen.getByText('Chunk-03')).toBeInTheDocument()
    })

    it('should render the word count', () => {
      render(<ResultItemMeta labelPrefix="Chunk" positionId={1} wordCount={250} score={0.8} />)
    ...
    it('should render dot separator', () => {
      render(<ResultItemMeta labelPrefix="Chunk" positionId={1} wordCount={100} score={0.5} />)
