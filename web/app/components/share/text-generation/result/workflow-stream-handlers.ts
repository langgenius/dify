  ...
  const otherOptions: IOtherOptions = {
    ...
    onWorkflowFinished: ({ data }) => {
      ...
      if (workflowStatus === WorkflowRunningStatus.Stopped) {
        setWorkflowProcessData(
          applyWorkflowFinishedState(getWorkflowProcessData(), WorkflowRunningStatus.Stopped),
        )
        finishWithFailure()
        return
      }
      ...
      if (data.error) {
        ...
        setWorkflowProcessData(
          applyWorkflowFinishedState(getWorkflowProcessData(), WorkflowRunningStatus.Failed),
        )
        finishWithFailure()
        return
      }
