...
import PipelineFill from '@/app/components/base/icons/src/vender/pipeline/PipelineFill'
import PipelineLine from '@/app/components/base/icons/src/vender/pipeline/PipelineLine'
