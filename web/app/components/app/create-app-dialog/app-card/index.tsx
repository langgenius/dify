...
const AppCard = ({
  ...
  return (
    <div className={cn('bg-components-panel-on-panel-item-bg border-components-panel-border shadow-xs group relative flex h-[132px] cursor-pointer flex-col overflow-hidden rounded-xl border-[0.5px]  p-4 hover:shadow-lg')}>
      ...
      <div className="system-xs-regular text-text-tertiary py-1">
        <div className='line-clamp-3'>
          {app.description}
        </div>
      </div>
      <div className={cn('from-components-panel-gradient-2 absolute bottom-0 left-0 right-0 hidden bg-gradient-to-t from-[60.27%] to-transparent p-4 pt-8 group-hover:flex')}>
