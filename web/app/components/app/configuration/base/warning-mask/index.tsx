  ...
  return (
    <div className={`${s.mask} absolute inset-0 z-10 bg-components-panel-bg-blur pt-16`}>
      <div className="mx-auto px-10">
        <div
          className={`${s.icon} flex size-11 items-center justify-center rounded-xl bg-components-panel-bg`}
        >
          {warningIcon}
        </div>
        ...
        <div className="mt-3 text-base text-text-secondary">{description}</div>
