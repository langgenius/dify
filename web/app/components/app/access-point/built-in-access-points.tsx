...
import { getPublishedWorkflowState, isAdvancedApp } from './utils'
...
export function BuiltInAccessPoints({ appId, highlightedAccessPoint }: BuiltInAccessPointsProps) {
  ...
  const actions = useBuiltInAccessPointActions(appId, capabilities.canEdit)
  ...
  const appCardsUnavailable =
    ...
    (workflowState.isUnpublished || !workflowState.hasStartNode || workflowState.hasTriggerNode)
