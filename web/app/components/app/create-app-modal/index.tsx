...
const CreateAppModal = ({ show, onSuccess, onClose }: CreateAppDialogProps) => {
  ...
  return (
    ...
    >
      ...
      {/* {showChatBotType && (
        <div className="py-2 px-8">
          <div className="py-2 text-sm leading-[20px] font-medium text-gray-900">
          ...
          <div className="flex gap-2">
            <div
              className={cn(
                ...
                appMode === "chat" &&
                  "bg-white shadow-xs border-[1.5px] border-primary-400 hover:border-[1.5px] hover:border-primary-400"
              )}
              onClick={() => {
                setAppMode("chat");
              }}
            >
                ...
                <div className="group">
                  ...
                  >
                    ...
                    <div className="px-4 pb-2">
                      <div className="flex items-center justify-between">
                        <div className="text-gray-700 text-md leading-6 font-semibold">
                          {t("app.newApp.basic")}
                        </div>
                        <div className="text-orange-500 text-xs leading-[18px] font-medium">
              ...
              <div className="mt-[2px] text-gray-500 text-xs leading-[18px]">
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <span className="px-1 rounded-[5px] bg-white border border-black/8 text-gray-500 text-[10px] leading-[18px] font-medium">
                    BETA
                  </span>
                </div>
                <div className="group">
                  ...
                  >
                    ...
                    <div className="px-4 pb-2">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          <div className="mr-1 text-gray-700 text-md leading-6 font-semibold">
                            {t("app.newApp.advanced")}
                          </div>
                          <span className="px-1 rounded-[5px] bg-white border border-black/8 text-gray-500 text-[10px] leading-[18px] font-medium">
                            BETA
      ...
      <div className="pt-2 px-8">
        ...
        {showEmojiPicker && (
          <EmojiPicker
            ...
            onClose={() => {
              setEmoji({ icon: "🐼", icon_background: "#E5E4E2" });
              setShowEmojiPicker(false);
            }}
          />
        )}
      ...
      <div
        className="absolute right-6 top-6 p-2 cursor-pointer z-20"
        onClick={onClose}
      >
