...
describe('md.tsx components', () => {
  ...
  describe('PropertyInstruction', () => {
    it('should render children', () => {
      render(<PropertyInstruction>This is an instruction</PropertyInstruction>)
      expect(screen.getByText('This is an instruction')).toBeInTheDocument()
    })

    it('should render as li element', () => {
      const { container } = render(<PropertyInstruction>Instruction text</PropertyInstruction>)
      expect(container.querySelector('li')).toBeInTheDocument()
    })

    it('should have m-0 class', () => {
      const { container } = render(<PropertyInstruction>Instruction</PropertyInstruction>)
      const li = container.querySelector('li')!
      expect(li.className).toContain('m-0')
    })
  ...
  describe('integration tests', () => {
    ...
    it('should render PropertyInstruction inside Properties', () => {
      render(
        <Properties anchor={false}>
          <PropertyInstruction>Note: All fields are required</PropertyInstruction>
