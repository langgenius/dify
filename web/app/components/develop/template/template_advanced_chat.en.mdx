...
<Row>
  <Col>
    ...
    <Properties>
      ...
      (Optional) Workflow tag to specify a specific version of workflow. System searches in the following priority order: workflow_tag > workflow_id > latest published version.
      </Property>
