...
<Row>
  <Col>
    ...
    <Properties>
      ...
      (Optional) Workflow alias to specify a specific version of workflow. System searches in the following priority order: workflow_alias > workflow_id > latest published version.
      </Property>
