...
<Row>
  <Col>
    ...
    <Properties>
      ...
      (Optional) Workflow alias to specify a specific version of workflow. Priority: workflow_alias > workflow_id > latest published version.
      </Property>
    ...
    - 404, `workflow_alias_not_found`, specified workflow alias not found
