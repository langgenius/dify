...
const Empty = () => {
  ...
  return (
    <>
      <DefaultCards />
      <div className='pointer-events-none absolute bottom-0 left-0 right-0 top-0 z-20 flex items-center justify-center bg-gradient-to-t from-background-body to-transparent'>
