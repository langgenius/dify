...
const CreateAppCard = ({
  ...
  const controlHideCreateFromTemplatePanel = useContextSelector(
    AppListContext,
    (ctx) => ctx.controlHideCreateFromTemplatePanel,
  )
  useEffect(() => {
  ...
  return (
    ...
    >
      <div className="grow rounded-t-xl p-2">
        ...
        <button
          type="button"
          className="mb-1 flex w-full cursor-pointer items-center rounded-lg px-6 py-[7px] text-[13px] leading-[18px] font-medium text-text-tertiary hover:bg-state-base-hover hover:text-text-secondary"
