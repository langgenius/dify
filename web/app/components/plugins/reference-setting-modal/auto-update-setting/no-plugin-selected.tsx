...
const NoPluginSelected: FC<Props> = ({
  ...
  return (
    <div className="rounded-lg border border-components-option-card-option-border bg-background-section p-3 text-center system-xs-regular text-text-tertiary">
      {text}
    </div>
  )
}
