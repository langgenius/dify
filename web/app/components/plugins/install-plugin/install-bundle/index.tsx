    ...
    >
      <DialogContent
        ...
        className={cn(
          ...
          cn(
            modalClassName,
            'flex max-h-[calc(100dvh-48px)] min-w-140 flex-col items-start rounded-2xl border-[0.5px] border-components-panel-border bg-components-panel-bg p-0 shadow-xl',
          ),
        )}
      >
        <DialogClose
