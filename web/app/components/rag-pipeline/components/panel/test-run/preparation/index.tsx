...
import { useOnlineDocument, useOnlineDrive, useTestRunSteps, useWebsiteCrawl } from './hooks'
...
const Preparation = () => {
  ...
  const { steps, currentStep, handleNextStep, handleBackStep } = useTestRunSteps()
