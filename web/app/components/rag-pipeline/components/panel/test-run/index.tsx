...
const TestRunPanel = () => {
  ...
  return (
    <div className="nokey relative flex h-full w-120 flex-col rounded-l-2xl border-y-[0.5px] border-l-[0.5px] border-components-panel-border bg-components-panel-bg shadow-xl shadow-shadow-shadow-1">
      <Header />
