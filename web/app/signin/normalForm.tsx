        ...
        <div className="bg-white ">
          ...
          <div className="w-hull text-center block mt-2 text-xs text-gray-600">
            ...
            <Link
              ...
              target={'_blank'}
              href={locale === 'en' ? 'https://docs.dify.ai/user-agreement/terms-of-service' : 'https://docs.dify.ai/v/zh-hans/yong-hu-xie-yi/terms-of-service'}
            >{t('login.tos')}</Link>
            &nbsp;&&nbsp;
            <Link
              className='text-primary-600'
              target={'_blank'}
              href={locale === 'en' ? 'https://docs.dify.ai/user-agreement/privacy-policy' : 'https://docs.dify.ai/v/zh-hans/yong-hu-xie-yi/privacy-policy'}
            >{t('login.pp')}</Link>
          </div>
