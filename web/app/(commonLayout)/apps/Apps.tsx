...
const getKey = (
  ...
  if (!pageIndex || previousPageData.has_more) {
    const params: any = { url: 'apps', params: { page: pageIndex + 1, limit: 30, name: keywords, isCreatedByMe } }
...
const Apps = () => {
  ...
  const options = [
    ...
    // { value: 'my-apps', text: 'My apps', icon: <RiApps2Line className='w-[14px] h-[14px] mr-1' /> },
