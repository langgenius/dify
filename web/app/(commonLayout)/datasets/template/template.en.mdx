...
<Heading
  ...
  method='POST'
  title='Dataset documents hit testing'
  ...
  <Col>
    ...
    <Properties>
      <Property name='query' type='string' key='query'>
        retrieval keyword，required
      </Property>
      <Property name='retrieval_model' type='object' key='retrieval_model'>
        retrieval model config，required
        - <code>search_method</code> (text) search method：keyword_search/semantic_search/full_text_search/hybrid_search，required
        - <code>reranking_enable</code> (bool) whether to enable reranking，optional, if search_method is semantic_search or hybrid_search，then reranking_enable is required
        - <code>reranking_mode</code> (object) Rerank model config，required if reranking_enable is true
            - <code>reranking_provider_name</code> (string) Reranking model provider name
            - <code>reranking_model_name</code> (string) Reranking model name
        - <code>weights</code> (double) weights for hybrid search, required if search_method is hybrid_search
        - <code>top_k</code> (integer) top k results, optional, default is 2
        - <code>score_threshold_enabled</code> (bool) whether to enable score threshold, optional, default is false
        - <code>score_threshold</code> (double) Score threshold, required if score_threshold_enabled is true
      </Property>
    </Properties>
  </Col>
  <Col sticky>
