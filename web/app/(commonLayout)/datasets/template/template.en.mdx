...
<Row>
  <Col>
    This api is based on an existing knowledge base and creates a new document through text based on this knowledge base.
...
<Row>
  <Col>
    This api is based on an existing knowledge base and creates a new document through a file based on this knowledge base.
...
<Row>
  <Col>
    This api is based on an existing knowledge base and updates the document through text based on this knowledge base.
...
<Row>
  <Col>
    This api is based on an existing knowledge base, and updates documents through files based on this knowledge base
...
<Heading
  ...
  method='GET'
  title='Knowledge base document list'
