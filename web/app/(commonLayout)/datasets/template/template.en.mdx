...
<Row>
  ...
  <Col sticky>
    <CodeGroup
      ...
      targetCode={`curl --location --request POST '${props.apiBaseUrl}/datasets/{dataset_id}/document/create_by_text' \\\n--header 'Authorization: Bearer {api_key}' \\\n--header 'Content-Type: application/json' \\\n--data-raw '{"name":"text","text":"text","indexing_technique":"high_quality","process_rule":{"mode":"automatic"},"doc_metadata":{"issue_id":"issue_id","project_id":"project_id","keyword":"keyword","last_edit_date":"2023-06-21 22:52:32"},"doc_type":"jira_issues"}'`}
    >
    ```bash {{ title: 'cURL' }}
