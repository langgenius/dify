...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl --location --request 'https://api.dify.dev/v1/datasets' \
    ...
    ```json {{ title: 'Response' }}
    {
      ...
      "word_count": 0,
      "created_by": "",
      "created_at": 1695312374,
      "updated_by": "",
      "updated_at": 1695312374,
...
<Row>
  ...
  <Col sticky>
    <CodeGroup title="Request" tag="POST" label="/datasets">
    ```bash {{ title: 'cURL' }}
    curl 'https://api.dify.ai/v1/datasets' \
      --header 'Authorization: Bearer {api_key}' \
      --header 'Content-Type: application/json' \
      --data-raw '{"name":"dify"}' \
      --compressed
...
<Row>
  <Col>
    此接口基于已存在数据集，在此数据集的基础上通过文本创建新的文档的操作。
    ...
    <Properties>
      ...
      <Property name='indexing_technique' type='string' key='indexing_technique'>
        索引方式
          - high_quaility 高质量：使用  embedding 模型进行嵌入，构建为向量数据库索引
...
<Row>
  <Col>
    此接口基于已存在数据集，在此数据集的基础上通过文件创建新的文档的操作。
...
<Row>
  ...
  <Col sticky>
    <CodeGroup title="Request" tag="GET">
    ```bash {{ title: 'cURL' }}
    curl --location --request POST 'https://api.dify.ai/v1/datasets/{dataset_id}/document/{document_id}/update_by_text'
    --header 'Authorization: Bearer {api_key}'
    --header 'Content-Type: application/json'
    --data-raw '{
      "name": "Dify",
...
<Row>
  ...
  <Col sticky>
    ...
    ```json {{ title: 'Response' }}
    {
      "data": [
        {
          "id": "1e87da99-00b3-4d43-8a6d-34cbb9f3a3f1",
          "position": 1,
          ...
          "name": "dify",
          "created_from": "",
          "created_by": "52b6e9a1-fd0e-48a5-89e9-3b6518658fd2",
...
<Row>
  ...
  <Col sticky>
    <CodeGroup title="Request" tag="POST" label="/datasets">
    ```bash {{ title: 'cURL' }}
    curl 'https://api.dify.ai/v1/datasets/{dataset_id}/documents/{document_id}/segment'
    --header 'Authorization: Bearer {api_key}'
    --header 'Content-Type: application/json'
    --data-raw $'"segments":[
