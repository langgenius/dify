...
<Row>
  ...
  <Col sticky>
    ...
    >
    ```bash {{ title: 'cURL' }}
    curl --location --request POST 'https://dify.cvte.com/v1/datasets' \
    --header 'Authorization: Bearer {api_key}' \
    --header 'Content-Type: application/json' \
    --data-raw '{
      "name": "name"
...
<Row>
  ...
  <Col sticky>
    ...
    >
    ```bash {{ title: 'cURL' }}
    curl --location --request GET 'https://dify.cvte.com/v1/datasets?page=1&limit=20' \
    --header 'Authorization: Bearer {api_key}'
    ```
    </CodeGroup>
    <CodeGroup title="Response">
...
<Row>
  ...
  <Col sticky>
    ...
    >
    ```bash {{ title: 'cURL' }}
    curl --location --request POST 'https://dify.cvte.com/v1/datasets/{dataset_id}/document/create_by_text' \
    --header 'Authorization: Bearer {api_key}' \
    --header 'Content-Type: application/json' \
    --data-raw '{
        "name": "text",
...
<Row>
  ...
  <Col sticky>
    ...
    >
    ```bash {{ title: 'cURL' }}
    curl --location POST 'https://dify.cvte.com/v1/datasets/{dataset_id}/document/create_by_file' \
    --header 'Authorization: Bearer {api_key}' \
    --form 'data="{\"name\":\"Dify\",\"indexing_technique\":\"high_quality\",\"process_rule\":{\"rules\":{\"pre_processing_rules\":[{\"id\":\"remove_extra_spaces\",\"enabled\":true},{\"id\":\"remove_urls_emails\",\"enabled\":true}],\"segmentation\":{\"separator\":\"###\",\"max_tokens\":500}},\"mode\":\"custom\"}}";type=text/plain' \
    --form 'file=@"/path/to/file"'
    ```
...
<Row>
  ...
  <Col sticky>
    ...
    >
    ```bash {{ title: 'cURL' }}
    curl --location --request POST 'https://dify.cvte.com/v1/datasets/{dataset_id}/documents/{document_id}/update_by_text' \
    --header 'Authorization: Bearer {api_key}' \
    --header 'Content-Type: application/json' \
    --data-raw '{
        "name": "name",
...
<Row>
  ...
  <Col sticky>
    ...
    >
    ```bash {{ title: 'cURL' }}
    curl --location POST 'https://dify.cvte.com/v1/datasets/{dataset_id}/document/{document_id}/create_by_file' \
    --header 'Authorization: Bearer {api_key}' \
    --form 'data="{\"name\":\"Dify\",\"indexing_technique\":\"high_quality\",\"process_rule\":{\"rules\":{\"pre_processing_rules\":[{\"id\":\"remove_extra_spaces\",\"enabled\":true},{\"id\":\"remove_urls_emails\",\"enabled\":true}],\"segmentation\":{\"separator\":\"###\",\"max_tokens\":500}},\"mode\":\"custom\"}}";type=text/plain' \
    --form 'file=@"/path/to/file"'
    ```
...
<Row>
  ...
  <Col sticky>
    ...
    >
    ```bash {{ title: 'cURL' }}
    curl --location --request GET 'https://dify.cvte.com/v1/datasets/{dataset_id}/documents/{batch}/indexing-status' \
    --header 'Authorization: Bearer {api_key}' \
    ```
    </CodeGroup>
    <CodeGroup title="Response">
...
<Row>
  ...
  <Col sticky>
    ...
    >
    ```bash {{ title: 'cURL' }}
    curl --location --request DELETE 'https://dify.cvte.com/v1/datasets/{dataset_id}/documents/{document_id}' \
    --header 'Authorization: Bearer {api_key}' \
    ```
    </CodeGroup>
    <CodeGroup title="Response">
...
<Row>
  ...
  <Col sticky>
    ...
    >
    ```bash {{ title: 'cURL' }}
    curl --location --request GET 'https://dify.cvte.com/v1/datasets/{dataset_id}/documents' \
    --header 'Authorization: Bearer {api_key}' \
    ```
    </CodeGroup>
    <CodeGroup title="Response">
...
<Row>
  ...
  <Col sticky>
    ...
    >
    ```bash {{ title: 'cURL' }}
    curl --location --request POST 'https://dify.cvte.com/v1/datasets/{dataset_id}/documents/{document_id}/segments' \
    --header 'Authorization: Bearer {api_key}' \
    --header 'Content-Type: application/json' \
    --data-raw '{
      "segments": [
...
<Row>
  ...
  <Col sticky>
    ...
    >
    ```bash {{ title: 'cURL' }}
    curl --location --request GET 'https://dify.cvte.com/v1/datasets/{dataset_id}/documents/{document_id}/segments' \
    --header 'Authorization: Bearer {api_key}' \
    --header 'Content-Type: application/json'
    ```
    </CodeGroup>
...
<Row>
  ...
  <Col sticky>
    ...
    >
    ```bash {{ title: 'cURL' }}
    curl --location --request DELETE 'https://dify.cvte.com/v1/datasets/{dataset_id}/segments/{segment_id}' \
    --header 'Authorization: Bearer {api_key}' \
    --header 'Content-Type: application/json'
    ```
    </CodeGroup>
...
<Row>
  ...
  <Col sticky>
    <CodeGroup
      ...
      tag="POST"
      label="/datasets/{dataset_id}/segments/{segment_id}"
      targetCode={`curl --location --request POST '${props.apiBaseUrl}/datasets/{dataset_id}/segments/{segment_id}' \\\n--header 'Authorization: Bearer {api_key}' \\\n--header 'Content-Type: application/json'`}
    >
    ```bash {{ title: 'cURL' }}
    curl --location --request POST 'https://dify.cvte.com/v1/datasets/{dataset_id}/segments/{segment_id}' \
    --header 'Authorization: Bearer {api_key}' \
    --header 'Content-Type: application/json' \
    --data-raw '{
      "segments": {
