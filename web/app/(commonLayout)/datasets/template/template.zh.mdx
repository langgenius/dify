...
<Heading
  url='/datasets/{dataset_id}/documents/create_by_text'
  method='POST'
  title='通过文本创建文档'
  name='#create_by_text'
/>
...
<Row>
  ...
  <Col sticky>
    <CodeGroup title="Request" tag="GET" label="/datasets/{dataset_id}/documents/create_by_file">
    ```bash {{ title: 'cURL' }}
...
<Row>
  ...
  <Col sticky>
    <CodeGroup title="Request" tag="GET" label="/datasets/{dataset_id}/documents/{document_id}/update_by_file">
    ```bash {{ title: 'cURL' }}
