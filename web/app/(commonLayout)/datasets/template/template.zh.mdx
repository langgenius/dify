...
import { Row, Col, Properties, Property, Heading } from '@/app/components/develop/md.tsx'
...
<Row>
    ...
    <Properties>
      ...
      <Property name='doc_type' type='string' key='doc_type'>
        文档类型
          ...
          - <code>paper</code>
          - <code>web_page</code>
          - <code>social_media_post</code>
          - <code>wikipedia_entry</code>
          - <code>personal_document</code>
          - <code>business_document</code>
          - <code>im_chat_log</code>
          - <code>synced_from_notion</code>
          - <code>synced_from_github</code>
          - <code>jira_issues</code>
          - <code>confluence_page</code>
          - <code>others</code>
      </Property>
    </Properties>
  </Col>
  <Col sticky>
    <CodeGroup
      ...
      targetCode={`curl --location --request POST '${props.apiBaseUrl}/datasets/{dataset_id}/document/create_by_text' \\\n--header 'Authorization: Bearer {api_key}' \\\n--header 'Content-Type: application/json' \\\n--data-raw '{"name":"text","text":"text","indexing_technique":"high_quality","process_rule":{"mode":"automatic"},"doc_metadata":{"issue_id":"issue_id","project_key":"project_key","keyword":"keyword","last_edit_date":"2023-06-21 22:52:32"},"doc_type":"jira_issues"}'`}
    >
    ```bash {{ title: 'cURL' }}
    ...
    --data-raw '{
        ...
        "doc_metadata": {
            ...
            "keyword": "keyword",
            "last_edit_date": "2023-06-21 22:52:32"
        },
        "doc_type": "jira_issues"
    }'
    ```
    </CodeGroup>
