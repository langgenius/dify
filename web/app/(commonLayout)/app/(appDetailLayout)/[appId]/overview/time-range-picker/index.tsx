...
import HourglassShape from '@/app/components/base/icons/src/vender/other/HourglassShape'
...
const TimeRangePicker: FC<Props> = ({ ranges, onSelect, queryDateFormat }) => {
