...
const LocaleLayout = async ({
  ...
  const datasetMap: Record<DatasetAttr, string | undefined> = {
    ...
    [DatasetAttr.DATA_PUBLIC_ENABLE_FIELD_ENCRYPTION]: process.env.NEXT_PUBLIC_ENABLE_FIELD_ENCRYPTION,
    [DatasetAttr.DATA_PUBLIC_ENCRYPTION_KEY]: process.env.NEXT_PUBLIC_ENCRYPTION_KEY,
  }
