    ...
    return (
      <div className={cn('flex h-full w-full flex-col items-center justify-center')}>
        <div className="max-w-[640px] min-w-[480px]">
          <div className="border-components-divider-subtle flex h-[320px] flex-col gap-4 rounded-3xl border bg-chat-bubble-bg p-10 pb-9 shadow-lg backdrop-blur-xs">
  ...
  return (
    <div className={cn('mx-auto flex h-full w-full max-w-[720px] flex-col items-center')}>
      ...
      <div className="h-0 w-full grow overflow-y-auto">
        <div className="border-components-divider-subtle rounded-3xl border bg-chat-bubble-bg p-4 shadow-lg backdrop-blur-xs">
