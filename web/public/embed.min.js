async function embedChatbot(){const t=window.difyChatbotConfig;if(t&&t.token&&t.appBaseUrl){const o=!!t.isDev,n=`<svg
            id="openIcon"
            width="24"
            height="24"
            viewBox="0 0 24 24"
