(()=>{let n="difyChatbotConfig",a="dify-chatbot-bubble-button",c="dify-chatbot-bubble-window",p=window[n],h={open:`<svg id="openIcon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      `);let t=document.createElement("div");if(t.style.cssText="position: relative; display: flex; align-items: center; justify-content: center; width: 100%; height: 100%; z-index: 2147483647;",t.innerHTML=h.open,n.appendChild(t),document.body.appendChild(n),n.addEventListener("click",function(){var e=document.getElementById(c);e?(e.style.display="none"===e.style.display?"block":"none",t.innerHTML="none"===e.style.display?h.open:h.close,"none"===e.style.display?document.removeEventListener("keydown",s):document.addEventListener("keydown",s),r()):(n.prepend(((e=document.createElement("iframe")).allow="fullscreen;microphone",e.title="dify chatbot bubble window",e.id=c,e.src=o,e.style.cssText=`
        ...
        overflow: hidden;
        user-select: none;
      `,e)),r(),this.title="Exit (ESC)",t.innerHTML=h.close,document.addEventListener("keydown",s))}),p.draggable){var d=n;var l=p.dragAxis||"both";let i=!1,r,s;d.addEventListener("mousedown",function(e){i=!0,r=e.clientX-d.offsetLeft,s=e.clientY-d.offsetTop}),document.addEventListener("mousemove",function(e){var t,n,o;i&&(d.style.transition="none",d.style.cursor="grabbing",(t=document.getElementById(c))&&(t.style.display="none",d.querySelector("div").innerHTML=h.open),t=e.clientX-r,e=window.innerHeight-e.clientY-s,o=d.getBoundingClientRect(),n=window.innerWidth-o.width,o=window.innerHeight-o.height,"x"!==l&&"both"!==l||d.style.setProperty(`--${a}-left`,Math.max(0,Math.min(t,n))+"px"),"y"!==l&&"both"!==l||d.style.setProperty(`--${a}-bottom`,Math.max(0,Math.min(e,o))+"px"))}),document.addEventListener("mouseup",function(){i=!1,d.style.transition="",d.style.cursor="pointer"})}}2048<o.length&&console.error("The URL is too long, please reduce the number of inputs to prevent the bot from failing to load"),document.getElementById(a)||t()}else console.error(n+" is empty or token is not provided")}function s(e){var t;"Escape"===e.key&&(e=document.getElementById(c),t=document.getElementById(a),e)&&"none"!==e.style.display&&(e.style.display="none",t.querySelector("div").innerHTML=h.open)}document.addEventListener("keydown",s),p?.dynamicScript?e():document.body.onload=e})();