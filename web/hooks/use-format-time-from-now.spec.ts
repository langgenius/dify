...
describe('useFormatTimeFromNow', () => {
  ...
  describe('Basic functionality', () => {
    ...
    it('should format time from now in English', () => {
      ;(useI18N as vi.Mock).mockReturnValue({ locale: 'en-US' })
  ...
  describe('Locale support', () => {
    ...
    it('should format time in Chinese (Simplified)', () => {
      ;(useI18N as vi.Mock).mockReturnValue({ locale: 'zh-Hans' })
    ...
    it('should format time in Spanish', () => {
      ;(useI18N as vi.Mock).mockReturnValue({ locale: 'es-ES' })
    ...
    it('should format time in French', () => {
      ;(useI18N as vi.Mock).mockReturnValue({ locale: 'fr-FR' })
    ...
    it('should format time in Japanese', () => {
      ;(useI18N as vi.Mock).mockReturnValue({ locale: 'ja-JP' })
    ...
    it('should format time in Portuguese (Brazil)', () => {
      ;(useI18N as vi.Mock).mockReturnValue({ locale: 'pt-BR' })
    ...
    it('should fallback to English for unsupported locale', () => {
      ;(useI18N as vi.Mock).mockReturnValue({ locale: 'xx-XX' as any })
  ...
  describe('Locale mapping', () => {
    ...
    it('should handle all mapped locales', () => {
      ...
      locales.forEach((locale) => {
        ;(useI18N as vi.Mock).mockReturnValue({ locale })
