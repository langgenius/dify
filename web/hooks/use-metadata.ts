  ...
  return {
    book: {
      ...
      subFieldsMap: {
        ...
        publisher: {
          label: t(($) => $[`${fieldPrefix}.book.publisher`], { ns: 'datasetDocuments' }),
        },
        publication_date: {
    ...
    web_page: {
      ...
      subFieldsMap: {
        ...
        description: {
          label: t(($) => $[`${fieldPrefix}.webPage.description`], { ns: 'datasetDocuments' }),
        },
      },
    },
    paper: {
      ...
      subFieldsMap: {
        ...
        publish_date: {
          label: t(($) => $[`${fieldPrefix}.paper.publishDate`], { ns: 'datasetDocuments' }),
        },
    ...
    social_media_post: {
      ...
      subFieldsMap: {
        ...
        publish_date: {
          label: t(($) => $[`${fieldPrefix}.socialMediaPost.publishDate`], {
            ns: 'datasetDocuments',
          }),
        },
        post_url: {
        ...
        'topics/tags': {
          label: t(($) => $[`${fieldPrefix}.socialMediaPost.topicsTags`], {
            ns: 'datasetDocuments',
          }),
        },
      },
    ...
    personal_document: {
      ...
      subFieldsMap: {
        title: {
          label: t(($) => $[`${fieldPrefix}.personalDocument.title`], { ns: 'datasetDocuments' }),
        },
        author: {
          label: t(($) => $[`${fieldPrefix}.personalDocument.author`], { ns: 'datasetDocuments' }),
        },
        creation_date: {
    ...
    business_document: {
      ...
      subFieldsMap: {
        title: {
          label: t(($) => $[`${fieldPrefix}.businessDocument.title`], { ns: 'datasetDocuments' }),
        },
        author: {
          label: t(($) => $[`${fieldPrefix}.businessDocument.author`], { ns: 'datasetDocuments' }),
        },
        creation_date: {
    ...
    im_chat_log: {
      ...
      subFieldsMap: {
        ...
        start_date: {
          label: t(($) => $[`${fieldPrefix}.IMChat.startDate`], { ns: 'datasetDocuments' }),
        },
        end_date: {
          label: t(($) => $[`${fieldPrefix}.IMChat.endDate`], { ns: 'datasetDocuments' }),
        },
        participants: {
        ...
        fileType: {
          label: t(($) => $[`${fieldPrefix}.IMChat.fileType`], { ns: 'datasetDocuments' }),
        },
      },
    },
    wikipedia_entry: {
      ...
      subFieldsMap: {
        title: {
          label: t(($) => $[`${fieldPrefix}.wikipediaEntry.title`], { ns: 'datasetDocuments' }),
        },
        language: {
        ...
        web_page_url: {
          label: t(($) => $[`${fieldPrefix}.wikipediaEntry.webpageURL`], {
            ns: 'datasetDocuments',
          }),
        },
        'editor/contributor': {
    ...
    synced_from_notion: {
      ...
      subFieldsMap: {
        ...
        'author/creator': {
          label: t(($) => $[`${fieldPrefix}.notion.author`], { ns: 'datasetDocuments' }),
        },
        creation_date: {
        ...
        notion_page_link: {
          label: t(($) => $[`${fieldPrefix}.notion.url`], { ns: 'datasetDocuments' }),
        },
        'category/tags': {
          label: t(($) => $[`${fieldPrefix}.notion.tag`], { ns: 'datasetDocuments' }),
        },
        description: {
          label: t(($) => $[`${fieldPrefix}.notion.description`], { ns: 'datasetDocuments' }),
        },
      },
    },
    synced_from_github: {
      ...
      subFieldsMap: {
        repository_name: {
          label: t(($) => $[`${fieldPrefix}.github.repoName`], { ns: 'datasetDocuments' }),
        },
        ...
        code_filename: {
          label: t(($) => $[`${fieldPrefix}.github.fileName`], { ns: 'datasetDocuments' }),
        },
        code_file_path: {
          label: t(($) => $[`${fieldPrefix}.github.filePath`], { ns: 'datasetDocuments' }),
        },
        programming_language: {
          label: t(($) => $[`${fieldPrefix}.github.programmingLang`], { ns: 'datasetDocuments' }),
        },
        github_link: {
          label: t(($) => $[`${fieldPrefix}.github.url`], { ns: 'datasetDocuments' }),
        },
        open_source_license: {
    ...
    originInfo: {
      ...
      subFieldsMap: {
        name: {
          label: t(($) => $[`${fieldPrefix}.originInfo.originalFilename`], {
            ns: 'datasetDocuments',
          }),
        },
