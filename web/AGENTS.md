...
- User-facing strings must use `web/i18n/locales/locales/en-US/` keys. When adding or renaming a key, update every supported locale with the correct localized value.
