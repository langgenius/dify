...
- Use feature-owned storage modules built with `createLocalStorageState` for low-frequency, client-only persistence such as user preferences, dismissed notices, and UI defaults.
