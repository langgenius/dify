...
class Logger:
    ...
    def __init__(self, name: Optional[str] = None, use_colors: bool = True):
        """Initialize logger.
    ...
    def spinner_stop(self, success: bool = True, message: Optional[str] = None) -> None:
...
class ProgressLogger:
    ...
    def __init__(self, total_steps: int, logger: Optional[Logger] = None):
