"""Compatibility shim — implementation moved to api/core/dsl_agent/dependency_normalizer.py.

This forwarder keeps the standalone CLI scripts and smoke tests working with
their existing `from dependency_normalizer import ...` calls. All logic now lives in the
...
from core.dsl_agent import dependency_normalizer as _impl  # noqa: E402
