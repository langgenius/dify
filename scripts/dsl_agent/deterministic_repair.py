"""Compatibility shim — implementation moved to api/core/dsl_agent/deterministic_repair.py.

This forwarder keeps the standalone CLI scripts and smoke tests working with
their existing `from deterministic_repair import ...` calls. All logic now lives in the
...
from core.dsl_agent import deterministic_repair as _impl  # noqa: E402
