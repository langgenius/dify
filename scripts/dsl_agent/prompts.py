"""Compatibility shim — implementation moved to api/core/dsl_agent/prompts.py.

This forwarder keeps the standalone CLI scripts and smoke tests working with
their existing `from prompts import ...` calls. All logic now lives in the
...
from core.dsl_agent import prompts as _impl  # noqa: E402
