"""Compatibility shim — implementation moved to api/core/dsl_agent/validator.py.

This forwarder keeps the standalone CLI scripts and smoke tests working with
their existing `from validator import ...` calls. All logic now lives in the
...
from core.dsl_agent import validator as _impl  # noqa: E402
