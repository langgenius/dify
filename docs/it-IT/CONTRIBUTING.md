...
## शुरू करने से पहले (Before you jump in)
...
2. PR ड्राफ्ट करने से पहले, कृपया अपने बदलावों पर चर्चा करने के लिए एक issue बनाएँ  
3. अपने परिवर्तनों के लिए एक नई शाखा (branch) बनाएँ  
4. अपने बदलावों के लिए उपयुक्त टेस्ट जोड़ें  
5. सुनिश्चित करें कि आपका कोड मौजूदा टेस्ट पास करता है  
6. PR विवरण में issue लिंक करें, जैसे: `fixes #<issue_number>`  
7. मर्ज हो जाएँ! 🎉  
