---
title: Data Fixtures v1.17 F-003 — Knowledge and RAG
id: F-003
status: draft
owner: TBD
updated: 2026-09-20
...
# Data Fixtures v1.17 F-003 — Knowledge and RAG
...
`fixtures/fixtures_v1.17_F-003.json` holds one minimal valid record for each of 5 entities:

`datasets`, `documents`, `document_segments`, `dataset_process_rules`, `pipelines`
