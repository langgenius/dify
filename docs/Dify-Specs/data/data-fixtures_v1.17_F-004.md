---
title: Data Fixtures v1.17 F-004 — Agent
id: F-004
status: draft
owner: TBD
updated: 2026-09-20
...
# Data Fixtures v1.17 F-004 — Agent
...
`fixtures/fixtures_v1.17_F-004.json` holds one minimal valid record for each of 5 entities:

`agents`, `agent_config_drafts`, `agent_config_revisions`, `skills`, `skill_versions`
