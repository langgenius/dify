---
title: Data Fixtures v1.17 F-005 — Workspace, Identity and Access
id: F-005
status: draft
owner: TBD
updated: 2026-09-20
...
# Data Fixtures v1.17 F-005 — Workspace, Identity and Access
...
`fixtures/fixtures_v1.17_F-005.json` holds one minimal valid record for each of 5 entities:

`accounts`, `tenants`, `tenant_account_joins`, `providers`, `api_tokens`
