---
title: Data Fixtures v1.17 F-001 — App Studio and Publishing
id: F-001
status: draft
owner: TBD
updated: 2026-09-20
...
# Data Fixtures v1.17 F-001 — App Studio and Publishing
...
`fixtures/fixtures_v1.17_F-001.json` holds one minimal valid record for each of 5 entities:

`apps`, `app_model_configs`, `conversations`, `messages`, `sites`
