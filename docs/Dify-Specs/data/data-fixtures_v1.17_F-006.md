---
title: Data Fixtures v1.17 F-006 — Published App Surfaces
id: F-006
status: draft
owner: TBD
updated: 2026-09-20
...
# Data Fixtures v1.17 F-006 — Published App Surfaces
...
`fixtures/fixtures_v1.17_F-006.json` holds one minimal valid record for each of 4 entities:
