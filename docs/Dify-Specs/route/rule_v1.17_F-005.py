...
document set grows, then re-run this file to regenerate the JSON.
    ...
    python rule_v1.17_F-005.py
"""
from route import build, emit

VERSION = "v1.17"
FEATURE_ID = "F-005"
FEATURE_TITLE = "Workspace Identity and Access"

EXTRA = {
    "domain": ["docs/Dify-Specs/ddd/domain_DOM-005-workspace-identity-and-access.md"],
    ...
    "tests": ["docs/Dify-Specs/tests/test_v1.17_F-005.md"],
}
