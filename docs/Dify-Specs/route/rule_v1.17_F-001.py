...
document set grows, then re-run this file to regenerate the JSON.
    ...
    python rule_v1.17_F-001.py
"""
from route import build, emit

VERSION = "v1.17"
FEATURE_ID = "F-001"
FEATURE_TITLE = "App Studio and Publishing"

EXTRA = {
    "domain": ["docs/Dify-Specs/ddd/domain_DOM-001-app-studio-and-publishing.md"],
    ...
    "tests": ["docs/Dify-Specs/tests/test_v1.17_F-001.md"],
}
