...
document set grows, then re-run this file to regenerate the JSON.
    ...
    python rule_v1.17_F-003.py
"""
from route import build, emit

VERSION = "v1.17"
FEATURE_ID = "F-003"
FEATURE_TITLE = "Knowledge and RAG"

EXTRA = {
    "domain": ["docs/Dify-Specs/ddd/domain_DOM-003-knowledge-and-rag.md"],
    ...
    "tests": ["docs/Dify-Specs/tests/test_v1.17_F-003.md"],
}
