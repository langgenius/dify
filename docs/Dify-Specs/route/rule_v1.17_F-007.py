...
document set grows, then re-run this file to regenerate the JSON.
    ...
    python rule_v1.17_F-007.py
"""
from route import build, emit

VERSION = "v1.17"
FEATURE_ID = "F-007"
FEATURE_TITLE = "difyctl CLI"

EXTRA = {
    "domain": ["docs/Dify-Specs/ddd/domain_DOM-007-difyctl-cli.md"],
    ...
    "tests": ["docs/Dify-Specs/tests/test_v1.17_F-007.md"],
}
