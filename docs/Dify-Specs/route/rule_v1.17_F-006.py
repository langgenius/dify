...
document set grows, then re-run this file to regenerate the JSON.
    ...
    python rule_v1.17_F-006.py
"""
from route import build, emit

VERSION = "v1.17"
FEATURE_ID = "F-006"
FEATURE_TITLE = "Published App Surfaces"

EXTRA = {
    "domain": ["docs/Dify-Specs/ddd/domain_DOM-006-published-app-surfaces.md"],
    ...
    "tests": ["docs/Dify-Specs/tests/test_v1.17_F-006.md"],
}
