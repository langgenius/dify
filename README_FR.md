...
<p align="center">
  ...
  <a href="https://docs.iechor.com/getting-started/install-self-hosted">Auto-hébergement</a> ·
  <a href="https://docs.iechor.com">Documentation</a> ·
  <a href="https://cal.com/guchenhe/iechor-demo">Planifier une démo</a>
</p>
...
<p align="center">
    ...
    <a href="https://hub.docker.com/u/iechor" target="_blank">
        <img alt="Tirages Docker" src="https://img.shields.io/docker/pulls/iechor/iechor-web?labelColor=%20%23FDB062&color=%20%23f79009"></a>
    <a href="https://github.com/iechor/iechor/graphs/commit-activity" target="_blank">
        <img alt="Commits le mois dernier" src="https://img.shields.io/github/commit-activity/m/iechor/iechor?labelColor=%20%2332b583&color=%20%2312b76a"></a>
    <a href="https://github.com/iechor/iechor/" target="_blank">
        <img alt="Problèmes fermés" src="https://img.shields.io/github/issues-search?query=repo%3Aiechor%2Fiechor%20is%3Aclosed&label=issues%20closed&labelColor=%20%237d89b0&color=%20%235d6b98"></a>
    <a href="https://github.com/iechor/iechor/discussions/" target="_blank">
        <img alt="Messages de discussion" src="https://img.shields.io/github/discussions/iechor/iechor?labelColor=%20%239b8afb&color=%20%237a5af8"></a>
</p>
...
iEchor est une plateforme de développement d'applications LLM open source. Son interface intuitive combine un flux de travail d'IA, un pipeline RAG, des capacités d'agent, une gestion de modèles, des fonctionnalités d'observabilité, et plus encore, vous permettant de passer rapidement du prototype à la production. Voici une liste des fonctionnalités principales:
</br> </br>
...
ités d'agent**: 
  Vous pouvez définir des agents basés sur l'appel de fonction LLM ou ReAct, et ajouter des outils pré-construits ou personnalisés pour l'agent. iEchor fournit plus de 50 outils intégrés pour les agents d'IA, tels que la recherche Google, DELL·E, Stable Diffusion et WolframAlpha.
...
**7. Backend-as-a-Service**: 
  Toutes les offres de iEchor sont accompagnées d'API correspondantes, vous permettant d'intégrer facilement iEchor dans votre propre logique métier.
...
- **Cloud </br>**
Nous hébergeons un service [iEchor Cloud](https://iechor.com) pour que tout le monde puisse l'essayer sans aucune configuration. Il fournit toutes les capacités de la version auto-hébergée et comprend 200 appels GPT-4 gratuits dans le plan bac à sable.

- **Auto-hébergement iEchor Community Edition</br>**
Lancez rapidement iEchor dans votre environnement avec ce [guide de démarrage](#quick-start).
Utilisez notre [documentation](https://docs.iechor.com) pour plus de références et des instructions plus détaillées.

- **iEchor pour les entreprises / organisations</br>**
Nous proposons des fonctionnalités supplémentaires adaptées aux entreprises. [Planifiez une réunion avec nous](https://cal.com/guchenhe/30min) ou [envoyez-nous un e-mail](mailto:business@iechor.com?subject=[GitHub]Business%20License%20Inquiry) pour discuter des besoins de l'entreprise. </br>
  > Pour les startups et les petites entreprises utilisant AWS, consultez [iEchor Premium sur AWS Marketplace](https://aws.amazon.com/marketplace/pp/prodview-t22mebxzwjhu6) et déployez-le dans votre propre VPC AWS en un clic. C'est une offre AMI abordable avec la possibilité de créer des applications avec un logo et une marque personnalisés.


## Rester en avance

Mettez une étoile à iEchor sur GitHub et soyez instantanément informé des nouvelles versions.
...
## Démarrage rapide
> Avant d'installer iEchor, assurez-vous que votre machine répond aux exigences système minimales suivantes:
> 
>- CPU >= 2 cœurs
>- RAM >= 4 Go
...
Après l'exécution, vous pouvez accéder au tableau de bord iEchor dans votre navigateur à [http://localhost/install](http://localhost/install) et commencer le processus d'initialisation.

> Si vous souhaitez contribuer à iEchor ou effectuer un développement supplémentaire, consultez notre [guide de déploiement à partir du code source](https://docs.iechor.com/getting-started/install-self-hosted/local-source-code)
...
Si vous souhaitez configurer une installation hautement disponible, il existe des [Helm Charts](https://helm.sh/) contribués par la communauté qui permettent de déployer iEchor sur Kubernetes.

- [Helm Chart par @LeoQuote](https://github.com/douban/charts/tree/master/charts/iechor)
- [Helm Chart par @BorisPolonsky](https://github.com/BorisPolonsky/iechor-helm)


## Contribuer

Pour ceux qui souhaitent contribuer du code, consultez notre [Guide de contribution](https://github.com/iechor/iechor/blob/main/CONTRIBUTING.md). 
Dans le même temps, veuillez envisager de soutenir iEchor en le partageant sur les réseaux sociaux et lors d'événements et de conférences.


> Nous recherchons des contributeurs pour aider à traduire iEchor dans des langues autres que le mandarin ou l'anglais. Si vous êtes intéressé à aider, veuillez consulter le [README i18n](https://github.com/iechor/iechor/blob/main/web/i18n/README.md) pour plus d'informations, et laissez-nous un commentaire dans le canal `global-users` de notre [Serveur communautaire Discord](https://discord.gg/8Tpq4AcN9c).
...
* [Discussion GitHub](https://github.com/iechor/iechor/discussions). Meilleur pour: partager des commentaires et poser des questions.
* [Problèmes GitHub](https://github.com/iechor/iechor/issues). Meilleur pour: les bogues que vous rencontrez en utilisant iEchor.AI et les propositions de fonctionnalités. Consultez notre [Guide de contribution](https://github.com/iechor/iechor/blob/main/CONTRIBUTING.md).
* [E-mail](mailto:support@iechor.com?subject=[GitHub]Questions%20About%20iEchor). Meilleur pour: les questions que vous avez sur l'utilisation de iEchor.AI.
* [Discord](https://discord.gg/FngNHpbcY7). Meilleur pour: partager vos applications et passer du temps avec la communauté.
* [Twitter](https://twitter.com/iechor_ai). Meilleur pour: partager vos applications et passer du temps avec la communauté.
...
[![Graphique de l'historique des étoiles](https://api.star-history.com/svg?repos=iechor/iechor&type=Date)](https://star-history.com/#iechor/iechor&Date)


## Divulgation de sécurité

Pour protéger votre vie privée, veuillez éviter de publier des problèmes de sécurité sur GitHub. Au lieu de cela, envoyez vos questions à security@iechor.com et nous vous fournirons une réponse plus détaillée.

## Licence

Ce référentiel est disponible sous la [Licence open source iEchor](LICENSE), qui est essentiellement l'Apache 2.0 avec quelques restrictions supplémentaires.
