...
### New Capabilities
- `human-input-console-management-api`: workspace console 上的 contact、IM integration、manual sync、draft preview 与 message template test API contract。
...
- `api/core/workflow/nodes/human_input_v2/entities.py`
