...
- Add a request-scoped composition root that exposes provider-independent Resend reads and deletes while keeping Resend save/test and every IM operation explicitly unimplemented.
- Preserve provider-specific request unions as future transport contracts without implementing provider-dependent operations.
