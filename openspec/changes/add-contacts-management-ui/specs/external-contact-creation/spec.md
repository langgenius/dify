...
mock repository MUST 使用整条 Email lower-case 后完全相等的规则比较当前 workspace Contacts 与 mock Organization identity，并 MUST 返回可区分的 typed result。
...
- **WHEN** normalized Email 命中 Organization 内可解释的 Platform contact
