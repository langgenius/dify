...
Authorization MUST use one coherent tenant-scoped context containing current Contact, Account, workspace availability, Email and relevant IM binding facts rather than relying only on form creation snapshots.
