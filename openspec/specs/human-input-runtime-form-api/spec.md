# human-input-runtime-form-api Specification
...
- **WHEN** a public Email form token for an `External contact`, one-time Email, or Dynamic Email grant is presented to the authenticated Contact approval surface
- **THEN** the console handler MUST reject it without invoking OTP submission logic or Contact-session approval logic, and MUST NOT forward the request to the public web handler
